...
}`;function ap(n,e,t){let i=new bs;const r=new Xe,s=new Xe,o=new mt,a=new np({depthPacking:Gl}),l=new ip,c={},h=t.maxTextureSize,d={[Rn]:Pt,[Pt]:Rn,[dn]:dn},f=new qn({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Xe},radius:{value:4}},vertexShader:rp,fragmentShader:sp}),m=f.clone();m.defines.HORIZONTAL_PASS=1;const v=new en;v.setAttribute("position",new Zt(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const x=new Ot(v,f),p=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=uo;let u=this.type;this.render=function(b,R,A){if(p.enabled===!1||p.autoUpdate===!1&&p.needsUpdate===!1||b.length===0)return;const B=n.getRenderTarget(),M=n.getActiveCubeFace(),T=n.getActiveMipmapLevel(),X=n.state;X.setBlending(bn),X.buffers.color.setClear(1,1,1,1),X.buffers.depth.setTest(!0),X.setScissorTest(!1);const Z=u!==un&&this.type===un,ne=u===un&&this.type!==un;for(let P=0,H=b.length;P<H;P++){const q=b[P],Y=q.shadow;if(Y===void 0){console.warn("THREE.WebGLShadowMap:",q,"has no shadow.");continue}if(Y.autoUpdate===!1&&Y.needsUpdate===!1)continue;r.copy(Y.mapSize);const te=Y.getFrameExtents();if(r.multiply(te),s.copy(Y.mapSize),(r.x>h||r.y>h)&&(r.x>h&&(s.x=Math.floor(h/te.x),r.x=s.x*te.x,Y.mapSize.x=s.x),r.y>h&&(s.y=Math.floor(h/te.y),r.y=s.y*te.y,Y.mapSize.y=s.y)),Y.map===null||Z===!0||ne===!0){const Q=this.type!==un?{minFilter:Rt,magFilter:Rt}:{};Y.map!==null&&Y.map.dispose(),Y.map=new Wn(r.x,r.y,Q),Y.map.texture.name=q.name+".shadowMap",Y.camera.updateProjectionMatrix()}n.setRenderTarget(Y.map),n.clear();const j=Y.getViewportCount();for(let Q=0;Q<j;Q++){const D=Y.getViewport(Q);o.set(s.x*D.x,s.y*D.y,s.x*D.z,s.y*D.w),X.viewport(o),Y.updateMatrices(q,Q),i=Y.getFrustum(),w(R,A,Y.camera,q,this.type)}Y.isPointLightShadow!==!0&&this.type===un&&y(Y,A),Y.needsUpdate=!1}u=this.type,p.needsUpdate=!1,n.setRenderTarget(B,M,T)};function y(b,R){const A=e.update(x);f.defines.VSM_SAMPLES!==b.blurSamples&&(f.defines.VSM_SAMPLES=b.blurSamples,m.defines.VSM_SAMPLES=b.blurSamples,f.needsUpdate=!0,m.needsUpdate=!0),b.mapPass===null&&(b.mapPass=new Wn(r.x,r.y)),f.uniforms.shadow_pass.value=b.map.texture,f.uniforms.resolution.value=b.mapSize,f.uniforms.radius.value=b.radius,n.setRenderTarget(b.mapPass),n.clear(),n.renderBufferDirect(R,null,A,f,x,null),m.uniforms.shadow_pass.value=b.mapPass.texture,m.uniforms.resolution.value=b.mapSize,m.uniforms.radius.value=b.radius,n.setRenderTarget(b.map),n.clear(),n.renderBufferDirect(R,null,A,m,x,null)}function g(b,R,A,B){let M=null;const T=A.isPointLight===!0?b.customDistanceMaterial:b.customDepthMaterial;if(T!==void 0)M=T;else if(M=A.isPointLight===!0?l:a,n.localClippingEnabled&&R.clipShadows===!0&&Array.isArray(R.clippingPlanes)&&R.clippingPlanes.length!==0||R.displacementMap&&R.displacementScale!==0||R.alphaMap&&R.alphaTest>0||R.map&&R.alphaTest>0){const X=M.uuid,Z=R.uuid;let ne=c[X];ne===void 0&&(ne={},c[X]=ne);let P=ne[Z];P===void 0&&(P=M.clone(),ne[Z]=P),M=P}if(M.visible=R.visible,M.wireframe=R.wireframe,B===un?M.side=R.shadowSide!==null?R.shadowSide:R.side:M.side=R.shadowSide!==null?R.shadowSide:d[R.side],M.alphaMap=R.alphaMap,M.alphaTest=R.alphaTest,M.map=R.map,M.clipShadows=R.clipShadows,M.clippingPlanes=R.clippingPlanes,M.clipIntersection=R.clipIntersection,M.displacementMap=R.displacementMap,M.displacementScale=R.displacementScale,M.displacementBias=R.displacementBias,M.wireframeLinewidth=R.wireframeLinewidth,M.linewidth=R.linewidth,A.isPointLight===!0&&M.isMeshDistanceMaterial===!0){const X=n.properties.get(M);X.light=A}return M}function w(b,R,A,B,M){if(b.visible===!1)return;if(b.layers.test(R.layers)&&(b.isMesh||b.isLine||b.isPoints)&&(b.castShadow||b.receiveShadow&&M===un)&&(!b.frustumCulled||i.intersectsObject(b))){b.modelViewMatrix.multiplyMatrices(A.matrixWorldInverse,b.matrixWorld);const Z=e.update(b),ne=b.material;if(Array.isArray(ne)){const P=Z.groups;for(let H=0,q=P.length;H<q;H++){const Y=P[H],te=ne[Y.materialIndex];if(te&&te.visible){const j=g(b,te,B,M);n.renderBufferDirect(A,null,Z,j,b,Y)}}}else if(ne.visible){const P=g(b,ne,B,M);n.renderBufferDirect(A,null,Z,P,b,null)}}const X=b.children;for(let Z=0,ne=X.length;Z<ne;Z++)w(X[Z],R,A,B,M)}}function op(n,e,t){const i=t.isWebGL2;function r(){let L=!1;const me=new mt;let se=null;const K=new mt(0,0,0,0);return{setMask:function(ce){se!==ce&&!L&&(n.colorMask(ce,ce,ce,ce),se=ce)},setLocked:function(ce){L=ce},setClear:function(ce,Pe,Fe,Ze,nt){nt===!0&&(ce*=Ze,Pe*=Ze,Fe*=Ze),me.set(ce,Pe,Fe,Ze),K.equals(me)===!1&&(n.clearColor(ce,Pe,Fe,Ze),K.copy(me))},reset:function(){L=!1,se=null,K.set(-1,0,0,0)}}}function s(){let L=!1,me=null,se=null,K=null;return{setTest:function(ce){ce?he(n.DEPTH_TEST):ve(n.DEPTH_TEST)},setMask:function(ce){me!==ce&&!L&&(n.depthMask(ce),me=ce)},setFunc:function(ce){if(se!==ce){switch(ce){case gl:n.depthFunc(n.NEVER);break;case _l:n.depthFunc(n.ALWAYS);break;case vl:n.depthFunc(n.LESS);break;case mr:n.depthFunc(n.LEQUAL);break;case xl:n.depthFunc(n.EQUAL);break;case Ml:n.depthFunc(n.GEQUAL);break;case Sl:n.depthFunc(n.GREATER);break;case El:n.depthFunc(n.NOTEQUAL);break;default:n.depthFunc(n.LEQUAL)}se=ce}},setLocked:function(ce){L=ce},setClear:function(ce){K!==ce&&(n.clearDepth(ce),K=ce)},reset:function(){L=!1,me=null,se=null,K=null}}}function o(){let L=!1,me=null,se=null,K=null,ce=null,Pe=null,Fe=null,Ze=null,nt=null;return{setTest:function(je){L||(je?he(n.STENCIL_TEST):ve(n.STENCIL_TEST))},setMask:function(je){me!==je&&!L&&(n.stencilMask(je),me=je)},setFunc:function(je,de,ot){(se!==je||K!==de||ce!==ot)&&(n.stencilFunc(je,de,ot),se=je,K=de,ce=ot)},setOp:function(je,de,ot){(Pe!==je||Fe!==de||Ze!==ot)&&(n.stencilOp(je,de,ot),Pe=je,Fe=de,Ze=ot)},setLocked:function(je){L=je},setClear:function(je){nt!==je&&(n.clearStencil(je),nt=je)},reset:function(){L=!1,me=null,se=null,K=null,ce=null,Pe=null,Fe=null,Ze=null,nt=null}}}const a=new r,l=new s,c=new o,h=new WeakMap,d=new WeakMap;let f={},m={},v=new WeakMap,x=[],p=null,u=!1,y=null,g=null,w=null,b=null,R=null,A=null,B=null,M=new Je(0,0,0),T=0,X=!1,Z=null,ne=null,P=null,H=null,q=null;const Y=n.getParameter(n.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let te=!1,j=0;const Q=n.getParameter(n.VERSION);Q.indexOf("WebGL")!==-1?(j=parseFloat(/^WebGL (\d)/.exec(Q)[1]),te=j>=1):Q.indexOf("OpenGL ES")!==-1&&(j=parseFloat(/^OpenGL ES (\d)/.exec(Q)[1]),te=j>=2);let D=null,F={};const pe=n.getParameter(n.SCISSOR_BOX),fe=n.getParameter(n.VIEWPORT),I=new mt().fromArray(pe),k=new mt().fromArray(fe);function ae(L,me,se,K){const ce=new Uint8Array(4),Pe=n.createTexture();n.bindTexture(L,Pe),n.texParameteri(L,n.TEXTURE_MIN_FILTER,n.NEAREST),n.texParameteri(L,n.TEXTURE_MAG_FILTER,n.NEAREST);for(let Fe=0;Fe<se;Fe++)i&&(L===n.TEXTURE_3D||L===n.TEXTURE_2D_ARRAY)?n.texImage3D(me,0,n.RGBA,1,1,K,0,n.RGBA,n.UNSIGNED_BYTE,ce):n.texImage2D(me+Fe,0,n.RGBA,1,1,0,n.RGBA,n.UNSIGNED_BYTE,ce);return Pe}const J={};J[n.TEXTURE_2D]=ae(n.TEXTURE_2D,n.TEXTURE_2D,1),J[n.TEXTURE_CUBE_MAP]=ae(n.TEXTURE_CUBE_MAP,n.TEXTURE_CUBE_MAP_POSITIVE_X,6),i&&(J[n.TEXTURE_2D_ARRAY]=ae(n.TEXTURE_2D_ARRAY,n.TEXTURE_2D_ARRAY,1,1),J[n.TEXTURE_3D]=ae(n.TEXTURE_3D,n.TEXTURE_3D,1,1)),a.setClear(0,0,0,1),l.setClear(1),c.setClear(0),he(n.DEPTH_TEST),l.setFunc(mr),Me(!1),Ee(Ls),he(n.CULL_FACE),Ae(bn);function he(L){f[L]!==!0&&(n.enable(L),f[L]=!0)}function ve(L){f[L]!==!1&&(n.disable(L),f[L]=!1)}function _e(L,me){return m[L]!==me?(n.bindFramebuffer(L,me),m[L]=me,i&&(L===n.DRAW_FRAMEBUFFER&&(m[n.FRAMEBUFFER]=me),L===n.FRAMEBUFFER&&(m[n.DRAW_FRAMEBUFFER]=me)),!0):!1}function U(L,me){let se=x,K=!1;if(L)if(se=v.get(me),se===void 0&&(se=[],v.set(me,se)),L.isWebGLMultipleRenderTargets){const ce=L.texture;if(se.length!==ce.length||se[0]!==n.COLOR_ATTACHMENT0){for(let Pe=0,Fe=ce.length;Pe<Fe;Pe++)se[Pe]=n.COLOR_ATTACHMENT0+Pe;se.length=ce.length,K=!0}}else se[0]!==n.COLOR_ATTACHMENT0&&(se[0]=n.COLOR_ATTACHMENT0,K=!0);else se[0]!==n.BACK&&(se[0]=n.BACK,K=!0);K&&(t.isWebGL2?n.drawBuffers(se):e.get("WEBGL_draw_buffers").drawBuffersWEBGL(se))}function ke(L){return p!==L?(n.useProgram(L),p=L,!0):!1}const ue={[Fn]:n.FUNC_ADD,[tl]:n.FUNC_SUBTRACT,[nl]:n.FUNC_REVERSE_SUBTRACT};if(i)ue[Is]=n.MIN,ue[Ns]=n.MAX;else{const L=e.get("EXT_blend_minmax");L!==null&&(ue[Is]=L.MIN_EXT,ue[Ns]=L.MAX_EXT)}const xe={[il]:n.ZERO,[rl]:n.ONE,[sl]:n.SRC_COLOR,[os]:n.SRC_ALPHA,[ul]:n.SRC_ALPHA_SATURATE,[cl]:n.DST_COLOR,[ol]:n.DST_ALPHA,[al]:n.ONE_MINUS_SRC_COLOR,[ls]:n.ONE_MINUS_SRC_ALPHA,[hl]:n.ONE_MINUS_DST_COLOR,[ll]:n.ONE_MINUS_DST_ALPHA,[dl]:n.CONSTANT_COLOR,[fl]:n.ONE_MINUS_CONSTANT_COLOR,[pl]:n.CONSTANT_ALPHA,[ml]:n.ONE_MINUS_CONSTANT_ALPHA};function Ae(L,me,se,K,ce,Pe,Fe,Ze,nt,je){if(L===bn){u===!0&&(ve(n.BLEND),u=!1);return}if(u===!1&&(he(n.BLEND),u=!0),L!==el){if(L!==y||je!==X){if((g!==Fn||R!==Fn)&&(n.blendEquation(n.FUNC_ADD),g=Fn,R=Fn),je)switch(L){case mi:n.blendFuncSeparate(n.ONE,n.ONE_MINUS_SRC_ALPHA,n.ONE,n.ONE_MINUS_SRC_ALPHA);break;case Ps:n.blendFunc(n.ONE,n.ONE);break;case Ds:n.blendFuncSeparate(n.ZERO,n.ONE_MINUS_SRC_COLOR,n.ZERO,n.ONE);break;case Us:n.blendFuncSeparate(n.ZERO,n.SRC_COLOR,n.ZERO,n.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",L);break}else switch(L){case mi:n.blendFuncSeparate(n.SRC_ALPHA,n.ONE_MINUS_SRC_ALPHA,n.ONE,n.ONE_MINUS_SRC_ALPHA);break;case Ps:n.blendFunc(n.SRC_ALPHA,n.ONE);break;case Ds:n.blendFuncSeparate(n.ZERO,n.ONE_MINUS_SRC_COLOR,n.ZERO,n.ONE);break;case Us:n.blendFunc(n.ZERO,n.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",L);break}w=null,b=null,A=null,B=null,M.set(0,0,0),T=0,y=L,X=je}return}ce=ce||me,Pe=Pe||se,Fe=Fe||K,(me!==g||ce!==R)&&(n.blendEquationSeparate(ue[me],ue[ce]),g=me,R=ce),(se!==w||K!==b||Pe!==A||Fe!==B)&&(n.blendFuncSeparate(xe[se],xe[K],xe[Pe],xe[Fe]),w=se,b=K,A=Pe,B=Fe),(Ze.equals(M)===!1||nt!==T)&&(n.blendColor(Ze.r,Ze.g,Ze.b,nt),M.copy(Ze),T=nt),y=L,X=!1}function De(L,me){L.side===dn?ve(n.CULL_FACE):he(n.CULL_FACE);let se=L.side===Pt;me&&(se=!se),Me(se),L.blending===mi&&L.transparent===!1?Ae(bn):Ae(L.blending,L.blendEquation,L.blendSrc,L.blendDst,L.blendEquationAlpha,L.blendSrcAlpha,L.blendDstAlpha,L.blendColor,L.blendAlpha,L.premultipliedAlpha),l.setFunc(L.depthFunc),l.setTest(L.depthTest),l.setMask(L.depthWrite),a.setMask(L.colorWrite);const K=L.stencilWrite;c.setTest(K),K&&(c.setMask(L.stencilWriteMask),c.setFunc(L.stencilFunc,L.stencilRef,L.stencilFuncMask),c.setOp(L.stencilFail,L.stencilZFail,L.stencilZPass)),Ie(L.polygonOffset,L.polygonOffsetFactor,L.polygonOffsetUnits),L.alphaToCoverage===!0?he(n.SAMPLE_ALPHA_TO_COVERAGE):ve(n.SAMPLE_ALPHA_TO_COVERAGE)}function Me(L){Z!==L&&(L?n.frontFace(n.CW):n.frontFace(n.CCW),Z=L)}function Ee(L){L!==Jo?(he(n.CULL_FACE),L!==ne&&(L===Ls?n.cullFace(n.BACK):L===Qo?n.cullFace(n.FRONT):n.cullFace(n.FRONT_AND_BACK))):ve(n.CULL_FACE),ne=L}function Le(L){L!==P&&(te&&n.lineWidth(L),P=L)}function Ie(L,me,se){L?(he(n.POLYGON_OFFSET_FILL),(H!==me||q!==se)&&(n.polygonOffset(me,se),H=me,q=se)):ve(n.POLYGON_OFFSET_FILL)}function Ve(L){L?he(n.SCISSOR_TEST):ve(n.SCISSOR_TEST)}function E(L){L===void 0&&(L=n.TEXTURE0+Y-1),D!==L&&(n.activeTexture(L),D=L)}function _(L,me,se){se===void 0&&(D===null?se=n.TEXTURE0+Y-1:se=D);let K=F[se];K===void 0&&(K={type:void 0,texture:void 0},F[se]=K),(K.type!==L||K.texture!==me)&&(D!==se&&(n.activeTexture(se),D=se),n.bindTexture(L,me||J[L]),K.type=L,K.texture=me)}function N(){const L=F[D];L!==void 0&&L.type!==void 0&&(n.bindTexture(L.type,null),L.type=void 0,L.texture=void 0)}function ie(){try{n.compressedTexImage2D.apply(n,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function ee(){try{n.compressedTexImage3D.apply(n,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function oe(){try{n.texSubImage2D.apply(n,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function Te(){try{n.texSubImage3D.apply(n,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function le(){try{n.compressedTexSubImage2D.apply(n,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function ge(){try{n.compressedTexSubImage3D.apply(n,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function C(){try{n.texStorage2D.apply(n,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function re(){try{n.texStorage3D.apply(n,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function $(){try{n.texImage2D.apply(n,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function Ue(){try{n.texImage3D.apply(n,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function Ce(L){I.equals(L)===!1&&(n.scissor(L.x,L.y,L.z,L.w),I.copy(L))}function we(L){k.equals(L)===!1&&(n.viewport(L.x,L.y,L.z,L.w),k.copy(L))}function Se(L,me){let se=d.get(me);se===void 0&&(se=new WeakMap,d.set(me,se));let K=se.get(L);K===void 0&&(K=n.getUniformBlockIndex(me,L.name),se.set(L,K))}function ye(L,me){const K=d.get(me).get(L);h.get(me)!==K&&(n.uniformBlockBinding(me,K,L.__bindingPointIndex),h.set(me,K))}function ze(){n.disable(n.BLEND),n.disable(n.CULL_FACE),n.disable(n.DEPTH_TEST),n.disable(n.POLYGON_OFFSET_FILL),n.disable(n.SCISSOR_TEST),n.disable(n.STENCIL_TEST),n.disable(n.SAMPLE_ALPHA_TO_COVERAGE),n.blendEquation(n.FUNC_ADD),n.blendFunc(n.ONE,n.ZERO),n.blendFuncSeparate(n.ONE,n.ZERO,n.ONE,n.ZERO),n.blendColor(0,0,0,0),n.colorMask(!0,!0,!0,!0),n.clearColor(0,0,0,0),n.depthMask(!0),n.depthFunc(n.LESS),n.clearDepth(1),n.stencilMask(4294967295),n.stencilFunc(n.ALWAYS,0,4294967295),n.stencilOp(n.KEEP,n.KEEP,n.KEEP),n.clearStencil(0),n.cullFace(n.BACK),n.frontFace(n.CCW),n.polygonOffset(0,0),n.activeTexture(n.TEXTURE0),n.bindFramebuffer(n.FRAMEBUFFER,null),i===!0&&(n.bindFramebuffer(n.DRAW_FRAMEBUFFER,null),n.bindFramebuffer(n.READ_FRAMEBUFFER,null)),n.useProgram(null),n.lineWidth(1),n.scissor(0,0,n.canvas.width,n.canvas.height),n.viewport(0,0,n.canvas.width,n.canvas.height),f={},D=null,F={},m={},v=new WeakMap,x=[],p=null,u=!1,y=null,g=null,w=null,b=null,R=null,A=null,B=null,M=new Je(0,0,0),T=0,X=!1,Z=null,ne=null,P=null,H=null,q=null,I.set(0,0,n.canvas.width,n.canvas.height),k.set(0,0,n.canvas.width,n.canvas.height),a.reset(),l.reset(),c.reset()}return{buffers:{color:a,depth:l,stencil:c},enable:he,disable:ve,bindFramebuffer:_e,drawBuffers:U,useProgram:ke,setBlending:Ae,setMaterial:De,setFlipSided:Me,setCullFace:Ee,setLineWidth:Le,setPolygonOffset:Ie,setScissorTest:Ve,activeTexture:E,bindTexture:_,unbindTexture:N,compressedTexImage2D:ie,compressedTexImage3D:ee,texImage2D:$,texImage3D:Ue,updateUBOMapping:Se,uniformBlockBinding:ye,texStorage2D:C,texStorage3D:re,texSubImage2D:oe,texSubImage3D:Te,compressedTexSubImage2D:le,compressedTexSubImage3D:ge,scissor:Ce,viewport:we,reset:ze}}function lp(n,e,t,i,r,s,o){const a=r.isWebGL2,l=r.maxTextures,c=r.maxCubemapSize,h=r.maxTextureSize,d=r.maxSamples,f=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,m=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),v=new WeakMap;let x;const p=new WeakMap;let u=!1;try{u=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function y(E,_){return u?new OffscreenCanvas(E,_):Sr("canvas")}function g(E,_,N,ie){let ee=1;if((E.width>ie||E.height>ie)&&(ee=ie/Math.max(E.width,E.height)),ee<1||_===!0)if(typeof HTMLImageElement<"u"&&E instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&E instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&E instanceof ImageBitmap){const oe=_?Mr:Math.floor,Te=oe(ee*E.width),le=oe(ee*E.height);x===void 0&&(x=y(Te,le));const ge=N?y(Te,le):x;return ge.width=Te,ge.height=le,ge.getContext("2d").drawImage(E,0,0,Te,le),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+E.width+"x"+E.height+") to ("+Te+"x"+le+")."),ge}else return"data"in E&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+E.width+"x"+E.height+")."),E;return E}function w(E){return ps(E.width)&&ps(E.height)}function b(E){return a?!1:E.wrapS!==jt||E.wrapT!==jt||E.minFilter!==Rt&&E.minFilter!==Gt}function R(E,_){return E.generateMipmaps&&_&&E.minFilter!==Rt&&E.minFilter!==Gt}function A(E){n.generateMipmap(E)}function B(E,_,N,ie,ee=!1){if(a===!1)return _;if(E!==null){if(n[E]!==void 0)return n[E];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+E+"'")}let oe=_;if(_===n.RED&&(N===n.FLOAT&&(oe=n.R32F),N===n.HALF_FLOAT&&(oe=n.R16F),N===n.UNSIGNED_BYTE&&(oe=n.R8)),_===n.RED_INTEGER&&(N===n.UNSIGNED_BYTE&&(oe=n.R8UI),N===n.UNSIGNED_SHORT&&(oe=n.R16UI),N===n.UNSIGNED_INT&&(oe=n.R32UI),N===n.BYTE&&(oe=n.R8I),N===n.SHORT&&(oe=n.R16I),N===n.INT&&(oe=n.R32I)),_===n.RG&&(N===n.FLOAT&&(oe=n.RG32F),N===n.HALF_FLOAT&&(oe=n.RG16F),N===n.UNSIGNED_BYTE&&(oe=n.RG8)),_===n.RGBA){const Te=ee?gr:Qe.getTransfer(ie);N===n.FLOAT&&(oe=n.RGBA32F),N===n.HALF_FLOAT&&(oe=n.RGBA16F),N===n.UNSIGNED_BYTE&&(oe=Te===rt?n.SRGB8_ALPHA8:n.RGBA8),N===n.UNSIGNED_SHORT_4_4_4_4&&(oe=n.RGBA4),N===n.UNSIGNED_SHORT_5_5_5_1&&(oe=n.RGB5_A1)}return(oe===n.R16F||oe===n.R32F||oe===n.RG16F||oe===n.RG32F||oe===n.RGBA16F||oe===n.RGBA32F)&&e.get("EXT_color_buffer_float"),oe}function M(E,_,N){return R(E,N)===!0||E.isFramebufferTexture&&E.minFilter!==Rt&&E.minFilter!==Gt?Math.log2(Math.max(_.width,_.height))+1:E.mipmaps!==void 0&&E.mipmaps.length>0?E.mipmaps.length:E.isCompressedTexture&&Array.isArray(E.image)?_.mipmaps.length:1}function T(E){return E===Rt||E===Fs||E===Rr?n.NEAREST:n.LINEAR}function X(E){const _=E.target;_.removeEventListener("dispose",X),ne(_),_.isVideoTexture&&v.delete(_)}function Z(E){const _=E.target;_.removeEventListener("dispose",Z),H(_)}function ne(E){const _=i.get(E);if(_.__webglInit===void 0)return;const N=E.source,ie=p.get(N);if(ie){const ee=ie[_.__cacheKey];ee.usedTimes--,ee.usedTimes===0&&P(E),Object.keys(ie).length===0&&p.delete(N)}i.remove(E)}function P(E){const _=i.get(E);n.deleteTexture(_.__webglTexture);const N=E.source,ie=p.get(N);delete ie[_.__cacheKey],o.memory.textures--}function H(E){const _=E.texture,N=i.get(E),ie=i.get(_);if(ie.__webglTexture!==void 0&&(n.deleteTexture(ie.__webglTexture),o.memory.textures--),E.depthTexture&&E.depthTexture.dispose(),E.isWebGLCubeRenderTarget)for(let ee=0;ee<6;ee++){if(Array.isArray(N.__webglFramebuffer[ee]))for(let oe=0;oe<N.__webglFramebuffer[ee].length;oe++)n.deleteFramebuffer(N.__webglFramebuffer[ee][oe]);else n.deleteFramebuffer(N.__webglFramebuffer[ee]);N.__webglDepthbuffer&&n.deleteRenderbuffer(N.__webglDepthbuffer[ee])}else{if(Array.isArray(N.__webglFramebuffer))for(let ee=0;ee<N.__webglFramebuffer.length;ee++)n.deleteFramebuffer(N.__webglFramebuffer[ee]);else n.deleteFramebuffer(N.__webglFramebuffer);if(N.__webglDepthbuffer&&n.deleteRenderbuffer(N.__webglDepthbuffer),N.__webglMultisampledFramebuffer&&n.deleteFramebuffer(N.__webglMultisampledFramebuffer),N.__webglColorRenderbuffer)for(let ee=0;ee<N.__webglColorRenderbuffer.length;ee++)N.__webglColorRenderbuffer[ee]&&n.deleteRenderbuffer(N.__webglColorRenderbuffer[ee]);N.__webglDepthRenderbuffer&&n.deleteRenderbuffer(N.__webglDepthRenderbuffer)}if(E.isWebGLMultipleRenderTargets)for(let ee=0,oe=_.length;ee<oe;ee++){const Te=i.get(_[ee]);Te.__webglTexture&&(n.deleteTexture(Te.__webglTexture),o.memory.textures--),i.remove(_[ee])}i.remove(_),i.remove(E)}let q=0;function Y(){q=0}function te(){const E=q;return E>=l&&console.warn("THREE.WebGLTextures: Trying to use "+E+" texture units while this GPU supports only "+l),q+=1,E}function j(E){const _=[];return _.push(E.wrapS),_.push(E.wrapT),_.push(E.wrapR||0),_.push(E.magFilter),_.push(E.minFilter),_.push(E.anisotropy),_.push(E.internalFormat),_.push(E.format),_.push(E.type),_.push(E.generateMipmaps),_.push(E.premultiplyAlpha),_.push(E.flipY),_.push(E.unpackAlignment),_.push(E.colorSpace),_.join()}function Q(E,_){const N=i.get(E);if(E.isVideoTexture&&Ie(E),E.isRenderTargetTexture===!1&&E.version>0&&N.__version!==E.version){const ie=E.image;if(ie===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(ie.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{he(N,E,_);return}}t.bindTexture(n.TEXTURE_2D,N.__webglTexture,n.TEXTURE0+_)}function D(E,_){const N=i.get(E);if(E.version>0&&N.__version!==E.version){he(N,E,_);return}t.bindTexture(n.TEXTURE_2D_ARRAY,N.__webglTexture,n.TEXTURE0+_)}function F(E,_){const N=i.get(E);if(E.version>0&&N.__version!==E.version){he(N,E,_);return}t.bindTexture(n.TEXTURE_3D,N.__webglTexture,n.TEXTURE0+_)}function pe(E,_){const N=i.get(E);if(E.version>0&&N.__version!==E.version){ve(N,E,_);return}t.bindTexture(n.TEXTURE_CUBE_MAP,N.__webglTexture,n.TEXTURE0+_)}const fe={[us]:n.REPEAT,[jt]:n.CLAMP_TO_EDGE,[ds]:n.MIRRORED_REPEAT},I={[Rt]:n.NEAREST,[Fs]:n.NEAREST_MIPMAP_NEAREST,[Rr]:n.NEAREST_MIPMAP_LINEAR,[Gt]:n.LINEAR,[Ll]:n.LINEAR_MIPMAP_NEAREST,[Ni]:n.LINEAR_MIPMAP_LINEAR},k={[kl]:n.NEVER,[Zl]:n.ALWAYS,[Wl]:n.LESS,[ql]:n.LEQUAL,[Xl]:n.EQUAL,[Kl]:n.GEQUAL,[Yl]:n.GREATER,[jl]:n.NOTEQUAL};function ae(E,_,N){if(N?(n.texParameteri(E,n.TEXTURE_WRAP_S,fe[_.wrapS]),n.texParameteri(E,n.TEXTURE_WRAP_T,fe[_.wrapT]),(E===n.TEXTURE_3D||E===n.TEXTURE_2D_ARRAY)&&n.texParameteri(E,n.TEXTURE_WRAP_R,fe[_.wrapR]),n.texParameteri(E,n.TEXTURE_MAG_FILTER,I[_.magFilter]),n.texParameteri(E,n.TEXTURE_MIN_FILTER,I[_.minFilter])):(n.texParameteri(E,n.TEXTURE_WRAP_S,n.CLAMP_TO_EDGE),n.texParameteri(E,n.TEXTURE_WRAP_T,n.CLAMP_TO_EDGE),(E===n.TEXTURE_3D||E===n.TEXTURE_2D_ARRAY)&&n.texParameteri(E,n.TEXTURE_WRAP_R,n.CLAMP_TO_EDGE),(_.wrapS!==jt||_.wrapT!==jt)&&console.warn("THREE.WebGLRenderer: Texture is not power of two. Texture.wrapS and Texture.wrapT should be set to THREE.ClampToEdgeWrapping."),n.texParameteri(E,n.TEXTURE_MAG_FILTER,T(_.magFilter)),n.texParameteri(E,n.TEXTURE_MIN_FILTER,T(_.minFilter)),_.minFilter!==Rt&&_.minFilter!==Gt&&console.warn("THREE.WebGLRenderer: Texture is not power of two. Texture.minFilter should be set to THREE.NearestFilter or THREE.LinearFilter.")),_.compareFunction&&(n.texParameteri(E,n.TEXTURE_COMPARE_MODE,n.COMPARE_REF_TO_TEXTURE),n.texParameteri(E,n.TEXTURE_COMPARE_FUNC,k[_.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){const ie=e.get("EXT_texture_filter_anisotropic");if(_.magFilter===Rt||_.minFilter!==Rr&&_.minFilter!==Ni||_.type===Tn&&e.has("OES_texture_float_linear")===!1||a===!1&&_.type===Fi&&e.has("OES_texture_half_float_linear")===!1)return;(_.anisotropy>1||i.get(_).__currentAnisotropy)&&(n.texParameterf(E,ie.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(_.anisotropy,r.getMaxAnisotropy())),i.get(_).__currentAnisotropy=_.anisotropy)}}function J(E,_){let N=!1;E.__webglInit===void 0&&(E.__webglInit=!0,_.addEventListener("dispose",X));const ie=_.source;let ee=p.get(ie);ee===void 0&&(ee={},p.set(ie,ee));const oe=j(_);if(oe!==E.__cacheKey){ee[oe]===void 0&&(ee[oe]={texture:n.createTexture(),usedTimes:0},o.memory.textures++,N=!0),ee[oe].usedTimes++;const Te=ee[E.__cacheKey];Te!==void 0&&(ee[E.__cacheKey].usedTimes--,Te.usedTimes===0&&P(_)),E.__cacheKey=oe,E.__webglTexture=ee[oe].texture}return N}function he(E,_,N){let ie=n.TEXTURE_2D;(_.isDataArrayTexture||_.isCompressedArrayTexture)&&(ie=n.TEXTURE_2D_ARRAY),_.isData3DTexture&&(ie=n.TEXTURE_3D);const ee=J(E,_),oe=_.source;t.bindTexture(ie,E.__webglTexture,n.TEXTURE0+N);const Te=i.get(oe);if(oe.version!==Te.__version||ee===!0){t.activeTexture(n.TEXTURE0+N);const le=Qe.getPrimaries(Qe.workingColorSpace),ge=_.colorSpace===kt?null:Qe.getPrimaries(_.colorSpace),C=_.colorSpace===kt||le===ge?n.NONE:n.BROWSER_DEFAULT_WEBGL;n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,_.flipY),n.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,_.premultiplyAlpha),n.pixelStorei(n.UNPACK_ALIGNMENT,_.unpackAlignment),n.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,C);const re=b(_)&&w(_.image)===!1;let $=g(_.image,re,!1,h);$=Ve(_,$);const Ue=w($)||a,Ce=s.convert(_.format,_.colorSpace);let we=s.convert(_.type),Se=B(_.internalFormat,Ce,we,_.colorSpace,_.isVideoTexture);ae(ie,_,Ue);let ye;const ze=_.mipmaps,L=a&&_.isVideoTexture!==!0,me=Te.__version===void 0||ee===!0,se=M(_,$,Ue);if(_.isDepthTexture)Se=n.DEPTH_COMPONENT,a?_.type===Tn?Se=n.DEPTH_COMPONENT32F:_.type===yn?Se=n.DEPTH_COMPONENT24:_.type===Gn?Se=n.DEPTH24_STENCIL8:Se=n.DEPTH_COMPONENT16:_.type===Tn&&console.error("WebGLRenderer: Floating point depth texture requires WebGL2."),_.format===Vn&&Se===n.DEPTH_COMPONENT&&_.type!==Ms&&_.type!==yn&&(console.warn("THREE.WebGLRenderer: Use UnsignedShortType or UnsignedIntType for DepthFormat DepthTexture."),_.type=yn,we=s.convert(_.type)),_.format===xi&&Se===n.DEPTH_COMPONENT&&(Se=n.DEPTH_STENCIL,_.type!==Gn&&(console.warn("THREE.WebGLRenderer: Use UnsignedInt248Type for DepthStencilFormat DepthTexture."),_.type=Gn,we=s.convert(_.type))),me&&(L?t.texStorage2D(n.TEXTURE_2D,1,Se,$.width,$.height):t.texImage2D(n.TEXTURE_2D,0,Se,$.width,$.height,0,Ce,we,null));else if(_.isDataTexture)if(ze.length>0&&Ue){L&&me&&t.texStorage2D(n.TEXTURE_2D,se,Se,ze[0].width,ze[0].height);for(let K=0,ce=ze.length;K<ce;K++)ye=ze[K],L?t.texSubImage2D(n.TEXTURE_2D,K,0,0,ye.width,ye.height,Ce,we,ye.data):t.texImage2D(n.TEXTURE_2D,K,Se,ye.width,ye.height,0,Ce,we,ye.data);_.generateMipmaps=!1}else L?(me&&t.texStorage2D(n.TEXTURE_2D,se,Se,$.width,$.height),t.texSubImage2D(n.TEXTURE_2D,0,0,0,$.width,$.height,Ce,we,$.data)):t.texImage2D(n.TEXTURE_2D,0,Se,$.width,$.height,0,Ce,we,$.data);else if(_.isCompressedTexture)if(_.isCompressedArrayTexture){L&&me&&t.texStorage3D(n.TEXTURE_2D_ARRAY,se,Se,ze[0].width,ze[0].height,$.depth);for(let K=0,ce=ze.length;K<ce;K++)ye=ze[K],_.format!==Kt?Ce!==null?L?t.compressedTexSubImage3D(n.TEXTURE_2D_ARRAY,K,0,0,0,ye.width,ye.height,$.depth,Ce,ye.data,0,0):t.compressedTexImage3D(n.TEXTURE_2D_ARRAY,K,Se,ye.width,ye.height,$.depth,0,ye.data,0,0):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):L?t.texSubImage3D(n.TEXTURE_2D_ARRAY,K,0,0,0,ye.width,ye.height,$.depth,Ce,we,ye.data):t.texImage3D(n.TEXTURE_2D_ARRAY,K,Se,ye.width,ye.height,$.depth,0,Ce,we,ye.data)}else{L&&me&&t.texStorage2D(n.TEXTURE_2D,se,Se,ze[0].width,ze[0].height);for(let K=0,ce=ze.length;K<ce;K++)ye=ze[K],_.format!==Kt?Ce!==null?L?t.compressedTexSubImage2D(n.TEXTURE_2D,K,0,0,ye.width,ye.height,Ce,ye.data):t.compressedTexImage2D(n.TEXTURE_2D,K,Se,ye.width,ye.height,0,ye.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):L?t.texSubImage2D(n.TEXTURE_2D,K,0,0,ye.width,ye.height,Ce,we,ye.data):t.texImage2D(n.TEXTURE_2D,K,Se,ye.width,ye.height,0,Ce,we,ye.data)}else if(_.isDataArrayTexture)L?(me&&t.texStorage3D(n.TEXTURE_2D_ARRAY,se,Se,$.width,$.height,$.depth),t.texSubImage3D(n.TEXTURE_2D_ARRAY,0,0,0,0,$.width,$.height,$.depth,Ce,we,$.data)):t.texImage3D(n.TEXTURE_2D_ARRAY,0,Se,$.width,$.height,$.depth,0,Ce,we,$.data);else if(_.isData3DTexture)L?(me&&t.texStorage3D(n.TEXTURE_3D,se,Se,$.width,$.height,$.depth),t.texSubImage3D(n.TEXTURE_3D,0,0,0,0,$.width,$.height,$.depth,Ce,we,$.data)):t.texImage3D(n.TEXTURE_3D,0,Se,$.width,$.height,$.depth,0,Ce,we,$.data);else if(_.isFramebufferTexture){if(me)if(L)t.texStorage2D(n.TEXTURE_2D,se,Se,$.width,$.height);else{let K=$.width,ce=$.height;for(let Pe=0;Pe<se;Pe++)t.texImage2D(n.TEXTURE_2D,Pe,Se,K,ce,0,Ce,we,null),K>>=1,ce>>=1}}else if(ze.length>0&&Ue){L&&me&&t.texStorage2D(n.TEXTURE_2D,se,Se,ze[0].width,ze[0].height);for(let K=0,ce=ze.length;K<ce;K++)ye=ze[K],L?t.texSubImage2D(n.TEXTURE_2D,K,0,0,Ce,we,ye):t.texImage2D(n.TEXTURE_2D,K,Se,Ce,we,ye);_.generateMipmaps=!1}else L?(me&&t.texStorage2D(n.TEXTURE_2D,se,Se,$.width,$.height),t.texSubImage2D(n.TEXTURE_2D,0,0,0,Ce,we,$)):t.texImage2D(n.TEXTURE_2D,0,Se,Ce,we,$);R(_,Ue)&&A(ie),Te.__version=oe.version,_.onUpdate&&_.onUpdate(_)}E.__version=_.version}function ve(E,_,N){if(_.image.length!==6)return;const ie=J(E,_),ee=_.source;t.bindTexture(n.TEXTURE_CUBE_MAP,E.__webglTexture,n.TEXTURE0+N);const oe=i.get(ee);if(ee.version!==oe.__version||ie===!0){t.activeTexture(n.TEXTURE0+N);const Te=Qe.getPrimaries(Qe.workingColorSpace),le=_.colorSpace===kt?null:Qe.getPrimaries(_.colorSpace),ge=_.colorSpace===kt||Te===le?n.NONE:n.BROWSER_DEFAULT_WEBGL;n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,_.flipY),n.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,_.premultiplyAlpha),n.pixelStorei(n.UNPACK_ALIGNMENT,_.unpackAlignment),n.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,ge);const C=_.isCompressedTexture||_.image[0].isCompressedTexture,re=_.image[0]&&_.image[0].isDataTexture,$=[];for(let K=0;K<6;K++)!C&&!re?$[K]=g(_.image[K],!1,!0,c):$[K]=re?_.image[K].image:_.image[K],$[K]=Ve(_,$[K]);const Ue=$[0],Ce=w(Ue)||a,we=s.convert(_.format,_.colorSpace),Se=s.convert(_.type),ye=B(_.internalFormat,we,Se,_.colorSpace),ze=a&&_.isVideoTexture!==!0,L=oe.__version===void 0||ie===!0;let me=M(_,Ue,Ce);ae(n.TEXTURE_CUBE_MAP,_,Ce);let se;if(C){ze&&L&&t.texStorage2D(n.TEXTURE_CUBE_MAP,me,ye,Ue.width,Ue.height);for(let K=0;K<6;K++){se=$[K].mipmaps;for(let ce=0;ce<se.length;ce++){const Pe=se[ce];_.format!==Kt?we!==null?ze?t.compressedTexSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+K,ce,0,0,Pe.width,Pe.height,we,Pe.data):t.compressedTexImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+K,ce,ye,Pe.width,Pe.height,0,Pe.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):ze?t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+K,ce,0,0,Pe.width,Pe.height,we,Se,Pe.data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+K,ce,ye,Pe.width,Pe.height,0,we,Se,Pe.data)}}}else{se=_.mipmaps,ze&&L&&(se.length>0&&me++,t.texStorage2D(n.TEXTURE_CUBE_MAP,me,ye,$[0].width,$[0].height));for(let K=0;K<6;K++)if(re){ze?t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+K,0,0,0,$[K].width,$[K].height,we,Se,$[K].data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+K,0,ye,$[K].width,$[K].height,0,we,Se,$[K].data);for(let ce=0;ce<se.length;ce++){const Fe=se[ce].image[K].image;ze?t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+K,ce+1,0,0,Fe.width,Fe.height,we,Se,Fe.data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+K,ce+1,ye,Fe.width,Fe.height,0,we,Se,Fe.data)}}else{ze?t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+K,0,0,0,we,Se,$[K]):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+K,0,ye,we,Se,$[K]);for(let ce=0;ce<se.length;ce++){const Pe=se[ce];ze?t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+K,ce+1,0,0,we,Se,Pe.image[K]):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+K,ce+1,ye,we,Se,Pe.image[K])}}}R(_,Ce)&&A(n.TEXTURE_CUBE_MAP),oe.__version=ee.version,_.onUpdate&&_.onUpdate(_)}E.__version=_.version}function _e(E,_,N,ie,ee,oe){const Te=s.convert(N.format,N.colorSpace),le=s.convert(N.type),ge=B(N.internalFormat,Te,le,N.colorSpace);if(!i.get(_).__hasExternalTextures){const re=Math.max(1,_.width>>oe),$=Math.max(1,_.height>>oe);ee===n.TEXTURE_3D||ee===n.TEXTURE_2D_ARRAY?t.texImage3D(ee,oe,ge,re,$,_.depth,0,Te,le,null):t.texImage2D(ee,oe,ge,re,$,0,Te,le,null)}t.bindFramebuffer(n.FRAMEBUFFER,E),Le(_)?f.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,ie,ee,i.get(N).__webglTexture,0,Ee(_)):(ee===n.TEXTURE_2D||ee>=n.TEXTURE_CUBE_MAP_POSITIVE_X&&ee<=n.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&n.framebufferTexture2D(n.FRAMEBUFFER,ie,ee,i.get(N).__webglTexture,oe),t.bindFramebuffer(n.FRAMEBUFFER,null)}function U(E,_,N){if(n.bindRenderbuffer(n.RENDERBUFFER,E),_.depthBuffer&&!_.stencilBuffer){let ie=a===!0?n.DEPTH_COMPONENT24:n.DEPTH_COMPONENT16;if(N||Le(_)){const ee=_.depthTexture;ee&&ee.isDepthTexture&&(ee.type===Tn?ie=n.DEPTH_COMPONENT32F:ee.type===yn&&(ie=n.DEPTH_COMPONENT24));const oe=Ee(_);Le(_)?f.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,oe,ie,_.width,_.height):n.renderbufferStorageMultisample(n.RENDERBUFFER,oe,ie,_.width,_.height)}else n.renderbufferStorage(n.RENDERBUFFER,ie,_.width,_.height);n.framebufferRenderbuffer(n.FRAMEBUFFER,n.DEPTH_ATTACHMENT,n.RENDERBUFFER,E)}else if(_.depthBuffer&&_.stencilBuffer){const ie=Ee(_);N&&Le(_)===!1?n.renderbufferStorageMultisample(n.RENDERBUFFER,ie,n.DEPTH24_STENCIL8,_.width,_.height):Le(_)?f.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,ie,n.DEPTH24_STENCIL8,_.width,_.height):n.renderbufferStorage(n.RENDERBUFFER,n.DEPTH_STENCIL,_.width,_.height),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.DEPTH_STENCIL_ATTACHMENT,n.RENDERBUFFER,E)}else{const ie=_.isWebGLMultipleRenderTargets===!0?_.texture:[_.texture];for(let ee=0;ee<ie.length;ee++){const oe=ie[ee],Te=s.convert(oe.format,oe.colorSpace),le=s.convert(oe.type),ge=B(oe.internalFormat,Te,le,oe.colorSpace),C=Ee(_);N&&Le(_)===!1?n.renderbufferStorageMultisample(n.RENDERBUFFER,C,ge,_.width,_.height):Le(_)?f.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,C,ge,_.width,_.height):n.renderbufferStorage(n.RENDERBUFFER,ge,_.width,_.height)}}n.bindRenderbuffer(n.RENDERBUFFER,null)}function ke(E,_){if(_&&_.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(t.bindFramebuffer(n.FRAMEBUFFER,E),!(_.depthTexture&&_.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");(!i.get(_.depthTexture).__webglTexture||_.depthTexture.image.width!==_.width||_.depthTexture.image.height!==_.height)&&(_.depthTexture.image.width=_.width,_.depthTexture.image.height=_.height,_.depthTexture.needsUpdate=!0),Q(_.depthTexture,0);const ie=i.get(_.depthTexture).__webglTexture,ee=Ee(_);if(_.depthTexture.format===Vn)Le(_)?f.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,n.DEPTH_ATTACHMENT,n.TEXTURE_2D,ie,0,ee):n.framebufferTexture2D(n.FRAMEBUFFER,n.DEPTH_ATTACHMENT,n.TEXTURE_2D,ie,0);else if(_.depthTexture.format===xi)Le(_)?f.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,n.DEPTH_STENCIL_ATTACHMENT,n.TEXTURE_2D,ie,0,ee):n.framebufferTexture2D(n.FRAMEBUFFER,n.DEPTH_STENCIL_ATTACHMENT,n.TEXTURE_2D,ie,0);else throw new Error("Unknown depthTexture format")}function ue(E){const _=i.get(E),N=E.isWebGLCubeRenderTarget===!0;if(E.depthTexture&&!_.__autoAllocateDepthBuffer){if(N)throw new Error("target.depthTexture not supported in Cube render targets");ke(_.__webglFramebuffer,E)}else if(N){_.__webglDepthbuffer=[];for(let ie=0;ie<6;ie++)t.bindFramebuffer(n.FRAMEBUFFER,_.__webglFramebuffer[ie]),_.__webglDepthbuffer[ie]=n.createRenderbuffer(),U(_.__webglDepthbuffer[ie],E,!1)}else t.bindFramebuffer(n.FRAMEBUFFER,_.__webglFramebuffer),_.__webglDepthbuffer=n.createRenderbuffer(),U(_.__webglDepthbuffer,E,!1);t.bindFramebuffer(n.FRAMEBUFFER,null)}function xe(E,_,N){const ie=i.get(E);_!==void 0&&_e(ie.__webglFramebuffer,E,E.texture,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,0),N!==void 0&&ue(E)}function Ae(E){const _=E.texture,N=i.get(E),ie=i.get(_);E.addEventListener("dispose",Z),E.isWebGLMultipleRenderTargets!==!0&&(ie.__webglTexture===void 0&&(ie.__webglTexture=n.createTexture()),ie.__version=_.version,o.memory.textures++);const ee=E.isWebGLCubeRenderTarget===!0,oe=E.isWebGLMultipleRenderTargets===!0,Te=w(E)||a;if(ee){N.__webglFramebuffer=[];for(let le=0;le<6;le++)if(a&&_.mipmaps&&_.mipmaps.length>0){N.__webglFramebuffer[le]=[];for(let ge=0;ge<_.mipmaps.length;ge++)N.__webglFramebuffer[le][ge]=n.createFramebuffer()}else N.__webglFramebuffer[le]=n.createFramebuffer()}else{if(a&&_.mipmaps&&_.mipmaps.length>0){N.__webglFramebuffer=[];for(let le=0;le<_.mipmaps.length;le++)N.__webglFramebuffer[le]=n.createFramebuffer()}else N.__webglFramebuffer=n.createFramebuffer();if(oe)if(r.drawBuffers){const le=E.texture;for(let ge=0,C=le.length;ge<C;ge++){const re=i.get(le[ge]);re.__webglTexture===void 0&&(re.__webglTexture=n.createTexture(),o.memory.textures++)}}else console.warn("THREE.WebGLRenderer: WebGLMultipleRenderTargets can only be used with WebGL2 or WEBGL_draw_buffers extension.");if(a&&E.samples>0&&Le(E)===!1){const le=oe?_:[_];N.__webglMultisampledFramebuffer=n.createFramebuffer(),N.__webglColorRenderbuffer=[],t.bindFramebuffer(n.FRAMEBUFFER,N.__webglMultisampledFramebuffer);for(let ge=0;ge<le.length;ge++){const C=le[ge];N.__webglColorRenderbuffer[ge]=n.createRenderbuffer(),n.bindRenderbuffer(n.RENDERBUFFER,N.__webglColorRenderbuffer[ge]);const re=s.convert(C.format,C.colorSpace),$=s.convert(C.type),Ue=B(C.internalFormat,re,$,C.colorSpace,E.isXRRenderTarget===!0),Ce=Ee(E);n.renderbufferStorageMultisample(n.RENDERBUFFER,Ce,Ue,E.width,E.height),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+ge,n.RENDERBUFFER,N.__webglColorRenderbuffer[ge])}n.bindRenderbuffer(n.RENDERBUFFER,null),E.depthBuffer&&(N.__webglDepthRenderbuffer=n.createRenderbuffer(),U(N.__webglDepthRenderbuffer,E,!0)),t.bindFramebuffer(n.FRAMEBUFFER,null)}}if(ee){t.bindTexture(n.TEXTURE_CUBE_MAP,ie.__webglTexture),ae(n.TEXTURE_CUBE_MAP,_,Te);for(let le=0;le<6;le++)if(a&&_.mipmaps&&_.mipmaps.length>0)for(let ge=0;ge<_.mipmaps.length;ge++)_e(N.__webglFramebuffer[le][ge],E,_,n.COLOR_ATTACHMENT0,n.TEXTURE_CUBE_MAP_POSITIVE_X+le,ge);else _e(N.__webglFramebuffer[le],E,_,n.COLOR_ATTACHMENT0,n.TEXTURE_CUBE_MAP_POSITIVE_X+le,0);R(_,Te)&&A(n.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(oe){const le=E.texture;for(let ge=0,C=le.length;ge<C;ge++){const re=le[ge],$=i.get(re);t.bindTexture(n.TEXTURE_2D,$.__webglTexture),ae(n.TEXTURE_2D,re,Te),_e(N.__webglFramebuffer,E,re,n.COLOR_ATTACHMENT0+ge,n.TEXTURE_2D,0),R(re,Te)&&A(n.TEXTURE_2D)}t.unbindTexture()}else{let le=n.TEXTURE_2D;if((E.isWebGL3DRenderTarget||E.isWebGLArrayRenderTarget)&&(a?le=E.isWebGL3DRenderTarget?n.TEXTURE_3D:n.TEXTURE_2D_ARRAY:console.error("THREE.WebGLTextures: THREE.Data3DTexture and THREE.DataArrayTexture only supported with WebGL2.")),t.bindTexture(le,ie.__webglTexture),ae(le,_,Te),a&&_.mipmaps&&_.mipmaps.length>0)for(let ge=0;ge<_.mipmaps.length;ge++)_e(N.__webglFramebuffer[ge],E,_,n.COLOR_ATTACHMENT0,le,ge);else _e(N.__webglFramebuffer,E,_,n.COLOR_ATTACHMENT0,le,0);R(_,Te)&&A(le),t.unbindTexture()}E.depthBuffer&&ue(E)}function De(E){const _=w(E)||a,N=E.isWebGLMultipleRenderTargets===!0?E.texture:[E.texture];for(let ie=0,ee=N.length;ie<ee;ie++){const oe=N[ie];if(R(oe,_)){const Te=E.isWebGLCubeRenderTarget?n.TEXTURE_CUBE_MAP:n.TEXTURE_2D,le=i.get(oe).__webglTexture;t.bindTexture(Te,le),A(Te),t.unbindTexture()}}}function Me(E){if(a&&E.samples>0&&Le(E)===!1){const _=E.isWebGLMultipleRenderTargets?E.texture:[E.texture],N=E.width,ie=E.height;let ee=n.COLOR_BUFFER_BIT;const oe=[],Te=E.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,le=i.get(E),ge=E.isWebGLMultipleRenderTargets===!0;if(ge)for(let C=0;C<_.length;C++)t.bindFramebuffer(n.FRAMEBUFFER,le.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+C,n.RENDERBUFFER,null),t.bindFramebuffer(n.FRAMEBUFFER,le.__webglFramebuffer),n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0+C,n.TEXTURE_2D,null,0);t.bindFramebuffer(n.READ_FRAMEBUFFER,le.__webglMultisampledFramebuffer),t.bindFramebuffer(n.DRAW_FRAMEBUFFER,le.__webglFramebuffer);for(let C=0;C<_.length;C++){oe.push(n.COLOR_ATTACHMENT0+C),E.depthBuffer&&oe.push(Te);const re=le.__ignoreDepthValues!==void 0?le.__ignoreDepthValues:!1;if(re===!1&&(E.depthBuffer&&(ee|=n.DEPTH_BUFFER_BIT),E.stencilBuffer&&(ee|=n.STENCIL_BUFFER_BIT)),ge&&n.framebufferRenderbuffer(n.READ_FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.RENDERBUFFER,le.__webglColorRenderbuffer[C]),re===!0&&(n.invalidateFramebuffer(n.READ_FRAMEBUFFER,[Te]),n.invalidateFramebuffer(n.DRAW_FRAMEBUFFER,[Te])),ge){const $=i.get(_[C]).__webglTexture;n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,$,0)}n.blitFramebuffer(0,0,N,ie,0,0,N,ie,ee,n.NEAREST),m&&n.invalidateFramebuffer(n.READ_FRAMEBUFFER,oe)}if(t.bindFramebuffer(n.READ_FRAMEBUFFER,null),t.bindFramebuffer(n.DRAW_FRAMEBUFFER,null),ge)for(let C=0;C<_.length;C++){t.bindFramebuffer(n.FRAMEBUFFER,le.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+C,n.RENDERBUFFER,le.__webglColorRenderbuffer[C]);const re=i.get(_[C]).__webglTexture;t.bindFramebuffer(n.FRAMEBUFFER,le.__webglFramebuffer),n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0+C,n.TEXTURE_2D,re,0)}t.bindFramebuffer(n.DRAW_FRAMEBUFFER,le.__webglMultisampledFramebuffer)}}function Ee(E){return Math.min(d,E.samples)}function Le(E){const _=i.get(E);return a&&E.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&_.__useRenderToTexture!==!1}function Ie(E){const _=o.render.frame;v.get(E)!==_&&(v.set(E,_),E.update())}function Ve(E,_){const N=E.colorSpace,ie=E.format,ee=E.type;return E.isCompressedTexture===!0||E.isVideoTexture===!0||E.format===fs||N!==mn&&N!==kt&&(Qe.getTransfer(N)===rt?a===!1?e.has("EXT_sRGB")===!0&&ie===Kt?(E.format=fs,E.minFilter=Gt,E.generateMipmaps=!1):_=bo.sRGBToLinear(_):(ie!==Kt||ee!==wn)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",N)),_}this.allocateTextureUnit=te,this.resetTextureUnits=Y,this.setTexture2D=Q,this.setTexture2DArray=D,this.setTexture3D=F,this.setTextureCube=pe,this.rebindTextures=xe,this.setupRenderTarget=Ae,this.updateRenderTargetMipmap=De,this.updateMultisampleRenderTarget=Me,this.setupDepthRenderbuffer=ue,this.setupFrameBufferTexture=_e,this.useMultisampledRTT=Le}function cp(n,e,t){const i=t.isWebGL2;function r(s,o=kt){let a;const l=Qe.getTransfer(o);if(s===wn)return n.UNSIGNED_BYTE;if(s===_o)return n.UNSIGNED_SHORT_4_4_4_4;if(s===vo)return n.UNSIGNED_SHORT_5_5_5_1;if(s===Pl)return n.BYTE;if(s===Dl)return n.SHORT;if(s===Ms)return n.UNSIGNED_SHORT;if(s===go)return n.INT;if(s===yn)return n.UNSIGNED_INT;if(s===Tn)return n.FLOAT;if(s===Fi)return i?n.HALF_FLOAT:(a=e.get("OES_texture_half_float"),a!==null?a.HALF_FLOAT_OES:null);if(s===Ul)return n.ALPHA;if(s===Kt)return n.RGBA;if(s===Il)return n.LUMINANCE;if(s===Nl)return n.LUMINANCE_ALPHA;if(s===Vn)return n.DEPTH_COMPONENT;if(s===xi)return n.DEPTH_STENCIL;if(s===fs)return a=e.get("EXT_sRGB"),a!==null?a.SRGB_ALPHA_EXT:null;if(s===Fl)return n.RED;if(s===xo)return n.RED_INTEGER;if(s===Ol)return n.RG;if(s===Mo)return n.RG_INTEGER;if(s===So)return n.RGBA_INTEGER;if(s===Cr||s===Lr||s===Pr||s===Dr)if(l===rt)if(a=e.get("WEBGL_compressed_texture_s3tc_srgb"),a!==null){if(s===Cr)return a.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(s===Lr)return a.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(s===Pr)return a.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(s===Dr)return a.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(a=e.get("WEBGL_compressed_texture_s3tc"),a!==null){if(s===Cr)return a.COMPRESSED_RGB_S3TC_DXT1_EXT;if(s===Lr)return a.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(s===Pr)return a.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(s===Dr)return a.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(s===Os||s===zs||s===Bs||s===Hs)if(a=e.get("WEBGL_compressed_texture_pvrtc"),a!==null){if(s===Os)return a.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(s===zs)return a.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(s===Bs)return a.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(s===Hs)return a.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(s===zl)return a=e.get("WEBGL_compressed_texture_etc1"),a!==null?a.COMPRESSED_RGB_ETC1_WEBGL:null;if(s===Gs||s===Vs)if(a=e.get("WEBGL_compressed_texture_etc"),a!==null){if(s===Gs)return l===rt?a.COMPRESSED_SRGB8_ETC2:a.COMPRESSED_RGB8_ETC2;if(s===Vs)return l===rt?a.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:a.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(s===ks||s===Ws||s===Xs||s===qs||s===Ys||s===js||s===Ks||s===Zs||s===$s||s===Js||s===Qs||s===ea||s===ta||s===na)if(a=e.get("WEBGL_compressed_texture_astc"),a!==null){if(s===ks)return l===rt?a.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:a.COMPRESSED_RGBA_ASTC_4x4_KHR;if(s===Ws)return l===rt?a.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:a.COMPRESSED_RGBA_ASTC_5x4_KHR;if(s===Xs)return l===rt?a.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:a.COMPRESSED_RGBA_ASTC_5x5_KHR;if(s===qs)return l===rt?a.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:a.COMPRESSED_RGBA_ASTC_6x5_KHR;if(s===Ys)return l===rt?a.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:a.COMPRESSED_RGBA_ASTC_6x6_KHR;if(s===js)return l===rt?a.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:a.COMPRESSED_RGBA_ASTC_8x5_KHR;if(s===Ks)return l===rt?a.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:a.COMPRESSED_RGBA_ASTC_8x6_KHR;if(s===Zs)return l===rt?a.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:a.COMPRESSED_RGBA_ASTC_8x8_KHR;if(s===$s)return l===rt?a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:a.COMPRESSED_RGBA_ASTC_10x5_KHR;if(s===Js)return l===rt?a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:a.COMPRESSED_RGBA_ASTC_10x6_KHR;if(s===Qs)return l===rt?a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:a.COMPRESSED_RGBA_ASTC_10x8_KHR;if(s===ea)return l===rt?a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:a.COMPRESSED_RGBA_ASTC_10x10_KHR;if(s===ta)return l===rt?a.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:a.COMPRESSED_RGBA_ASTC_12x10_KHR;if(s===na)return l===rt?a.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:a.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(s===Ur||s===ia||s===ra)if(a=e.get("EXT_texture_compression_bptc"),a!==null){if(s===Ur)return l===rt?a.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:a.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(s===ia)return a.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(s===ra)return a.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(s===Bl||s===sa||s===aa||s===oa)if(a=e.get("EXT_texture_compression_rgtc"),a!==null){if(s===Ur)return a.COMPRESSED_RED_RGTC1_EXT;if(s===sa)return a.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(s===aa)return a.COMPRESSED_RED_GREEN_RGTC2_EXT;if(s===oa)return a.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return s===Gn?i?n.UNSIGNED_INT_24_8:(a=e.get("WEBGL_depth_texture"),a!==null?a.UNSIGNED_INT_24_8_WEBGL:null):n[s]!==void 0?n[s]:null}return{convert:r}}class hp extends Vt{constructor(e=[]){super(),this.isArrayCamera=!0,this.cameras=e}}class Li extends gt{constructor(){super(),this.isGroup=!0,this.type="Group"}}const up={type:"move"};class ns{constructor(){this._targetRay=null,this._grip=null,this._hand=null}getHandSpace(){return this._hand===null&&(this._hand=new Li,this._hand.matrixAutoUpdate=!1,this._hand.visible=!1,this._hand.joints={},this._hand.inputState={pinching:!1}),this._hand}getTargetRaySpace(){return this._targetRay===null&&(this._targetRay=new Li,this._targetRay.matrixAutoUpdate=!1,this._targetRay.visible=!1,this._targetRay.hasLinearVelocity=!1,this._targetRay.linearVelocity=new z,this._targetRay.hasAngularVelocity=!1,this._targetRay.angularVelocity=new z),this._targetRay}getGripSpace(){return this._grip===null&&(this._grip=new Li,this._grip.matrixAutoUpdate=!1,this._grip.visible=!1,this._grip.hasLinearVelocity=!1,this._grip.linearVelocity=new z,this._grip.hasAngularVelocity=!1,this._grip.angularVelocity=new z),this._grip}dispatchEvent(e){return this._targetRay!==null&&this._targetRay.dispatchEvent(e),this._grip!==null&&this._grip.dispatchEvent(e),this._hand!==null&&this._hand.dispatchEvent(e),this}connect(e){if(e&&e.hand){const t=this._hand;if(t)for(const i of e.hand.values())this._getHandJoint(t,i)}return this.dispatchEvent({type:"connected",data:e}),this}disconnect(e){return this.dispatchEvent({type:"disconnected",data:e}),this._targetRay!==null&&(this._targetRay.visible=!1),this._grip!==null&&(this._grip.visible=!1),this._hand!==null&&(this._hand.visible=!1),this}update(e,t,i){let r=null,s=null,o=null;const a=this._targetRay,l=this._grip,c=this._hand;if(e&&t.session.visibilityState!=="visible-blurred"){if(c&&e.hand){o=!0;for(const x of e.hand.values()){const p=t.getJointPose(x,i),u=this._getHandJoint(c,x);p!==null&&(u.matrix.fromArray(p.transform.matrix),u.matrix.decompose(u.position,u.rotation,u.scale),u.matrixWorldNeedsUpdate=!0,u.jointRadius=p.radius),u.visible=p!==null}const h=c.joints["index-finger-tip"],d=c.joints["thumb-tip"],f=h.position.distanceTo(d.position),m=.02,v=.005;c.inputState.pinching&&f>m+v?(c.inputState.pinching=!1,this.dispatchEvent({type:"pinchend",handedness:e.handedness,target:this})):!c.inputState.pinching&&f<=m-v&&(c.inputState.pinching=!0,this.dispatchEvent({type:"pinchstart",handedness:e.handedness,target:this}))}else l!==null&&e.gripSpace&&(s=t.getPose(e.gripSpace,i),s!==null&&(l.matrix.fromArray(s.transform.matrix),l.matrix.decompose(l.position,l.rotation,l.scale),l.matrixWorldNeedsUpdate=!0,s.linearVelocity?(l.hasLinearVelocity=!0,l.linearVelocity.copy(s.linearVelocity)):l.hasLinearVelocity=!1,s.angularVelocity?(l.hasAngularVelocity=!0,l.angularVelocity.copy(s.angularVelocity)):l.hasAngularVelocity=!1));a!==null&&(r=t.getPose(e.targetRaySpace,i),r===null&&s!==null&&(r=s),r!==null&&(a.matrix.fromArray(r.transform.matrix),a.matrix.decompose(a.position,a.rotation,a.scale),a.matrixWorldNeedsUpdate=!0,r.linearVelocity?(a.hasLinearVelocity=!0,a.linearVelocity.copy(r.linearVelocity)):a.hasLinearVelocity=!1,r.angularVelocity?(a.hasAngularVelocity=!0,a.angularVelocity.copy(r.angularVelocity)):a.hasAngularVelocity=!1,this.dispatchEvent(up)))}return a!==null&&(a.visible=r!==null),l!==null&&(l.visible=s!==null),c!==null&&(c.visible=o!==null),this}_getHandJoint(e,t){if(e.joints[t.jointName]===void 0){const i=new Li;i.matrixAutoUpdate=!1,i.visible=!1,e.joints[t.jointName]=i,e.add(i)}return e.joints[t.jointName]}}class dp extends zt{constructor(e,t,i,r,s,o,a,l,c,h){if(h=h!==void 0?h:Vn,h!==Vn&&h!==xi)throw new Error("DepthTexture format must be either THREE.DepthFormat or THREE.DepthStencilFormat");i===void 0&&h===Vn&&(i=yn),i===void 0&&h===xi&&(i=Gn),super(null,r,s,o,a,l,h,i,c),this.isDepthTexture=!0,this.image={width:e,height:t},this.magFilter=a!==void 0?a:Rt,this.minFilter=l!==void 0?l:Rt,this.flipY=!1,this.generateMipmaps=!1,this.compareFunction=null}copy(e){return super.copy(e),this.compareFunction=e.compareFunction,this}toJSON(e){const t=super.toJSON(e);return this.compareFunction!==null&&(t.compareFunction=this.compareFunction),t}}class fp extends Yn{constructor(e,t){super();const i=this;let r=null,s=1,o=null,a="local-floor",l=1,c=null,h=null,d=null,f=null,m=null,v=null;const x=t.getContextAttributes();let p=null,u=null;const y=[],g=[],w=new Vt;w.layers.enable(1),w.viewport=new mt;const b=new Vt;b.layers.enable(2),b.viewport=new mt;const R=[w,b],A=new hp;A.layers.enable(1),A.layers.enable(2);let B=null,M=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(D){let F=y[D];return F===void 0&&(F=new ns,y[D]=F),F.getTargetRaySpace()},this.getControllerGrip=function(D){let F=y[D];return F===void 0&&(F=new ns,y[D]=F),F.getGripSpace()},this.getHand=function(D){let F=y[D];return F===void 0&&(F=new ns,y[D]=F),F.getHandSpace()};function T(D){const F=g.indexOf(D.inputSource);if(F===-1)return;const pe=y[F];pe!==void 0&&(pe.update(D.inputSource,D.frame,c||o),pe.dispatchEvent({type:D.type,data:D.inputSource}))}function X(){r.removeEventListener("select",T),r.removeEventListener("selectstart",T),r.removeEventListener("selectend",T),r.removeEventListener("squeeze",T),r.removeEventListener("squeezestart",T),r.removeEventListener("squeezeend",T),r.removeEventListener("end",X),r.removeEventListener("inputsourceschange",Z);for(let D=0;D<y.length;D++){const F=g[D];F!==null&&(g[D]=null,y[D].disconnect(F))}B=null,M=null,e.setRenderTarget(p),m=null,f=null,d=null,r=null,u=null,Q.stop(),i.isPresenting=!1,i.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(D){s=D,i.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(D){a=D,i.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return c||o},this.setReferenceSpace=function(D){c=D},this.getBaseLayer=function(){return f!==null?f:m},this.getBinding=function(){return d},this.getFrame=function(){return v},this.getSession=function(){return r},this.setSession=async function(D){if(r=D,r!==null){if(p=e.getRenderTarget(),r.addEventListener("select",T),r.addEventListener("selectstart",T),r.addEventListener("selectend",T),r.addEventListener("squeeze",T),r.addEventListener("squeezestart",T),r.addEventListener("squeezeend",T),r.addEventListener("end",X),r.addEventListener("inputsourceschange",Z),x.xrCompatible!==!0&&await t.makeXRCompatible(),r.renderState.layers===void 0||e.capabilities.isWebGL2===!1){const F={antialias:r.renderState.layers===void 0?x.antialias:!0,alpha:!0,depth:x.depth,stencil:x.stencil,framebufferScaleFactor:s};m=new XRWebGLLayer(r,t,F),r.updateRenderState({baseLayer:m}),u=new Wn(m.framebufferWidth,m.framebufferHeight,{format:Kt,type:wn,colorSpace:e.outputColorSpace,stencilBuffer:x.stencil})}else{let F=null,pe=null,fe=null;x.depth&&(fe=x.stencil?t.DEPTH24_STENCIL8:t.DEPTH_COMPONENT24,F=x.stencil?xi:Vn,pe=x.stencil?Gn:yn);const I={colorFormat:t.RGBA8,depthFormat:fe,scaleFactor:s};d=new XRWebGLBinding(r,t),f=d.createProjectionLayer(I),r.updateRenderState({layers:[f]}),u=new Wn(f.textureWidth,f.textureHeight,{format:Kt,type:wn,depthTexture:new dp(f.textureWidth,f.textureHeight,pe,void 0,void 0,void 0,void 0,void 0,void 0,F),stencilBuffer:x.stencil,colorSpace:e.outputColorSpace,samples:x.antialias?4:0});const k=e.properties.get(u);k.__ignoreDepthValues=f.ignoreDepthValues}u.isXRRenderTarget=!0,this.setFoveation(l),c=null,o=await r.requestReferenceSpace(a),Q.setContext(r),Q.start(),i.isPresenting=!0,i.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(r!==null)return r.environmentBlendMode};function Z(D){for(let F=0;F<D.removed.length;F++){const pe=D.removed[F],fe=g.indexOf(pe);fe>=0&&(g[fe]=null,y[fe].disconnect(pe))}for(let F=0;F<D.added.length;F++){const pe=D.added[F];let fe=g.indexOf(pe);if(fe===-1){for(let k=0;k<y.length;k++)if(k>=g.length){g.push(pe),fe=k;break}else if(g[k]===null){g[k]=pe,fe=k;break}if(fe===-1)break}const I=y[fe];I&&I.connect(pe)}}const ne=new z,P=new z;function H(D,F,pe){ne.setFromMatrixPosition(F.matrixWorld),P.setFromMatrixPosition(pe.matrixWorld);const fe=ne.distanceTo(P),I=F.projectionMatrix.elements,k=pe.projectionMatrix.elements,ae=I[14]/(I[10]-1),J=I[14]/(I[10]+1),he=(I[9]+1)/I[5],ve=(I[9]-1)/I[5],_e=(I[8]-1)/I[0],U=(k[8]+1)/k[0],ke=ae*_e,ue=ae*U,xe=fe/(-_e+U),Ae=xe*-_e;F.matrixWorld.decompose(D.position,D.quaternion,D.scale),D.translateX(Ae),D.translateZ(xe),D.matrixWorld.compose(D.position,D.quaternion,D.scale),D.matrixWorldInverse.copy(D.matrixWorld).invert();const De=ae+xe,Me=J+xe,Ee=ke-Ae,Le=ue+(fe-Ae),Ie=he*J/Me*De,Ve=ve*J/Me*De;D.projectionMatrix.makePerspective(Ee,Le,Ie,Ve,De,Me),D.projectionMatrixInverse.copy(D.projectionMatrix).invert()}function q(D,F){F===null?D.matrixWorld.copy(D.matrix):D.matrixWorld.multiplyMatrices(F.matrixWorld,D.matrix),D.matrixWorldInverse.copy(D.matrixWorld).invert()}this.updateCamera=function(D){if(r===null)return;A.near=b.near=w.near=D.near,A.far=b.far=w.far=D.far,(B!==A.near||M!==A.far)&&(r.updateRenderState({depthNear:A.near,depthFar:A.far}),B=A.near,M=A.far);const F=D.parent,pe=A.cameras;q(A,F);for(let fe=0;fe<pe.length;fe++)q(pe[fe],F);pe.length===2?H(A,w,b):A.projectionMatrix.copy(w.projectionMatrix),Y(D,A,F)};function Y(D,F,pe){pe===null?D.matrix.copy(F.matrixWorld):(D.matrix.copy(pe.matrixWorld),D.matrix.invert(),D.matrix.multiply(F.matrixWorld)),D.matrix.decompose(D.position,D.quaternion,D.scale),D.updateMatrixWorld(!0),D.projectionMatrix.copy(F.projectionMatrix),D.projectionMatrixInverse.copy(F.projectionMatrixInverse),D.isPerspectiveCamera&&(D.fov=Oi*2*Math.atan(1/D.projectionMatrix.elements[5]),D.zoom=1)}this.getCamera=function(){return A},this.getFoveation=function(){if(!(f===null&&m===null))return l},this.setFoveation=function(D){l=D,f!==null&&(f.fixedFoveation=D),m!==null&&m.fixedFoveation!==void 0&&(m.fixedFoveation=D)};let te=null;function j(D,F){if(h=F.getViewerPose(c||o),v=F,h!==null){const pe=h.views;m!==null&&(e.setRenderTargetFramebuffer(u,m.framebuffer),e.setRenderTarget(u));let fe=!1;pe.length!==A.cameras.length&&(A.cameras.length=0,fe=!0);for(let I=0;I<pe.length;I++){const k=pe[I];let ae=null;if(m!==null)ae=m.getViewport(k);else{const he=d.getViewSubImage(f,k);ae=he.viewport,I===0&&(e.setRenderTargetTextures(u,he.colorTexture,f.ignoreDepthValues?void 0:he.depthStencilTexture),e.setRenderTarget(u))}let J=R[I];J===void 0&&(J=new Vt,J.layers.enable(I),J.viewport=new mt,R[I]=J),J.matrix.fromArray(k.transform.matrix),J.matrix.decompose(J.position,J.quaternion,J.scale),J.projectionMatrix.fromArray(k.projectionMatrix),J.projectionMatrixInverse.copy(J.projectionMatrix).invert(),J.viewport.set(ae.x,ae.y,ae.width,ae.height),I===0&&(A.matrix.copy(J.matrix),A.matrix.decompose(A.position,A.quaternion,A.scale)),fe===!0&&A.cameras.push(J)}}for(let pe=0;pe<y.length;pe++){const fe=g[pe],I=y[pe];fe!==null&&I!==void 0&&I.update(fe,F,c||o)}te&&te(D,F),F.detectedPlanes&&i.dispatchEvent({type:"planesdetected",data:F}),v=null}const Q=new No;Q.setAnimationLoop(j),this.setAnimationLoop=function(D){te=D},this.dispose=function(){}}}function pp(n,e){function t(p,u){p.matrixAutoUpdate===!0&&p.updateMatrix(),u.value.copy(p.matrix)}function i(p,u){u.color.getRGB(p.fogColor.value,Do(n)),u.isFog?(p.fogNear.value=u.near,p.fogFar.value=u.far):u.isFogExp2&&(p.fogDensity.value=u.density)}function r(p,u,y,g,w){u.isMeshBasicMaterial||u.isMeshLambertMaterial?s(p,u):u.isMeshToonMaterial?(s(p,u),d(p,u)):u.isMeshPhongMaterial?(s(p,u),h(p,u)):u.isMeshStandardMaterial?(s(p,u),f(p,u),u.isMeshPhysicalMaterial&&m(p,u,w)):u.isMeshMatcapMaterial?(s(p,u),v(p,u)):u.isMeshDepthMaterial?s(p,u):u.isMeshDistanceMaterial?(s(p,u),x(p,u)):u.isMeshNormalMaterial?s(p,u):u.isLineBasicMaterial?(o(p,u),u.isLineDashedMaterial&&a(p,u)):u.isPointsMaterial?l(p,u,y,g):u.isSpriteMaterial?c(p,u):u.isShadowMaterial?(p.color.value.copy(u.color),p.opacity.value=u.opacity):u.isShaderMaterial&&(u.uniformsNeedUpdate=!1)}function s(p,u){p.opacity.value=u.opacity,u.color&&p.diffuse.value.copy(u.color),u.emissive&&p.emissive.value.copy(u.emissive).multiplyScalar(u.emissiveIntensity),u.map&&(p.map.value=u.map,t(u.map,p.mapTransform)),u.alphaMap&&(p.alphaMap.value=u.alphaMap,t(u.alphaMap,p.alphaMapTransform)),u.bumpMap&&(p.bumpMap.value=u.bumpMap,t(u.bumpMap,p.bumpMapTransform),p.bumpScale.value=u.bumpScale,u.side===Pt&&(p.bumpScale.value*=-1)),u.normalMap&&(p.normalMap.value=u.normalMap,t(u.normalMap,p.normalMapTransform),p.normalScale.value.copy(u.normalScale),u.side===Pt&&p.normalScale.value.negate()),u.displacementMap&&(p.displacementMap.value=u.displacementMap,t(u.displacementMap,p.displacementMapTransform),p.displacementScale.value=u.displacementScale,p.displacementBias.value=u.displacementBias),u.emissiveMap&&(p.emissiveMap.value=u.emissiveMap,t(u.emissiveMap,p.emissiveMapTransform)),u.specularMap&&(p.specularMap.value=u.specularMap,t(u.specularMap,p.specularMapTransform)),u.alphaTest>0&&(p.alphaTest.value=u.alphaTest);const y=e.get(u).envMap;if(y&&(p.envMap.value=y,p.flipEnvMap.value=y.isCubeTexture&&y.isRenderTargetTexture===!1?-1:1,p.reflectivity.value=u.reflectivity,p.ior.value=u.ior,p.refractionRatio.value=u.refractionRatio),u.lightMap){p.lightMap.value=u.lightMap;const g=n._useLegacyLights===!0?Math.PI:1;p.lightMapIntensity.value=u.lightMapIntensity*g,t(u.lightMap,p.lightMapTransform)}u.aoMap&&(p.aoMap.value=u.aoMap,p.aoMapIntensity.value=u.aoMapIntensity,t(u.aoMap,p.aoMapTransform))}function o(p,u){p.diffuse.value.copy(u.color),p.opacity.value=u.opacity,u.map&&(p.map.value=u.map,t(u.map,p.mapTransform))}function a(p,u){p.dashSize.value=u.dashSize,p.totalSize.value=u.dashSize+u.gapSize,p.scale.value=u.scale}function l(p,u,y,g){p.diffuse.value.copy(u.color),p.opacity.value=u.opacity,p.size.value=u.size*y,p.scale.value=g*.5,u.map&&(p.map.value=u.map,t(u.map,p.uvTransform)),u.alphaMap&&(p.alphaMap.value=u.alphaMap,t(u.alphaMap,p.alphaMapTransform)),u.alphaTest>0&&(p.alphaTest.value=u.alphaTest)}function c(p,u){p.diffuse.value.copy(u.color),p.opacity.value=u.opacity,p.rotation.value=u.rotation,u.map&&(p.map.value=u.map,t(u.map,p.mapTransform)),u.alphaMap&&(p.alphaMap.value=u.alphaMap,t(u.alphaMap,p.alphaMapTransform)),u.alphaTest>0&&(p.alphaTest.value=u.alphaTest)}function h(p,u){p.specular.value.copy(u.specular),p.shininess.value=Math.max(u.shininess,1e-4)}function d(p,u){u.gradientMap&&(p.gradientMap.value=u.gradientMap)}function f(p,u){p.metalness.value=u.metalness,u.metalnessMap&&(p.metalnessMap.value=u.metalnessMap,t(u.metalnessMap,p.metalnessMapTransform)),p.roughness.value=u.roughness,u.roughnessMap&&(p.roughnessMap.value=u.roughnessMap,t(u.roughnessMap,p.roughnessMapTransform)),e.get(u).envMap&&(p.envMapIntensity.value=u.envMapIntensity)}function m(p,u,y){p.ior.value=u.ior,u.sheen>0&&(p.sheenColor.value.copy(u.sheenColor).multiplyScalar(u.sheen),p.sheenRoughness.value=u.sheenRoughness,u.sheenColorMap&&(p.sheenColorMap.value=u.sheenColorMap,t(u.sheenColorMap,p.sheenColorMapTransform)),u.sheenRoughnessMap&&(p.sheenRoughnessMap.value=u.sheenRoughnessMap,t(u.sheenRoughnessMap,p.sheenRoughnessMapTransform))),u.clearcoat>0&&(p.clearcoat.value=u.clearcoat,p.clearcoatRoughness.value=u.clearcoatRoughness,u.clearcoatMap&&(p.clearcoatMap.value=u.clearcoatMap,t(u.clearcoatMap,p.clearcoatMapTransform)),u.clearcoatRoughnessMap&&(p.clearcoatRoughnessMap.value=u.clearcoatRoughnessMap,t(u.clearcoatRoughnessMap,p.clearcoatRoughnessMapTransform)),u.clearcoatNormalMap&&(p.clearcoatNormalMap.value=u.clearcoatNormalMap,t(u.clearcoatNormalMap,p.clearcoatNormalMapTransform),p.clearcoatNormalScale.value.copy(u.clearcoatNormalScale),u.side===Pt&&p.clearcoatNormalScale.value.negate())),u.iridescence>0&&(p.iridescence.value=u.iridescence,p.iridescenceIOR.value=u.iridescenceIOR,p.iridescenceThicknessMinimum.value=u.iridescenceThicknessRange[0],p.iridescenceThicknessMaximum.value=u.iridescenceThicknessRange[1],u.iridescenceMap&&(p.iridescenceMap.value=u.iridescenceMap,t(u.iridescenceMap,p.iridescenceMapTransform)),u.iridescenceThicknessMap&&(p.iridescenceThicknessMap.value=u.iridescenceThicknessMap,t(u.iridescenceThicknessMap,p.iridescenceThicknessMapTransform))),u.transmission>0&&(p.transmission.value=u.transmission,p.transmissionSamplerMap.value=y.texture,p.transmissionSamplerSize.value.set(y.width,y.height),u.transmissionMap&&(p.transmissionMap.value=u.transmissionMap,t(u.transmissionMap,p.transmissionMapTransform)),p.thickness.value=u.thickness,u.thicknessMap&&(p.thicknessMap.value=u.thicknessMap,t(u.thicknessMap,p.thicknessMapTransform)),p.attenuationDistance.value=u.attenuationDistance,p.attenuationColor.value.copy(u.attenuationColor)),u.anisotropy>0&&(p.anisotropyVector.value.set(u.anisotropy*Math.cos(u.anisotropyRotation),u.anisotropy*Math.sin(u.anisotropyRotation)),u.anisotropyMap&&(p.anisotropyMap.value=u.anisotropyMap,t(u.anisotropyMap,p.anisotropyMapTransform))),p.specularIntensity.value=u.specularIntensity,p.specularColor.value.copy(u.specularColor),u.specularColorMap&&(p.specularColorMap.value=u.specularColorMap,t(u.specularColorMap,p.specularColorMapTransform)),u.specularIntensityMap&&(p.specularIntensityMap.value=u.specularIntensityMap,t(u.specularIntensityMap,p.specularIntensityMapTransform))}function v(p,u){u.matcap&&(p.matcap.value=u.matcap)}function x(p,u){const y=e.get(u).light;p.referencePosition.value.setFromMatrixPosition(y.matrixWorld),p.nearDistance.value=y.shadow.camera.near,p.farDistance.value=y.shadow.camera.far}return{refreshFogUniforms:i,refreshMaterialUniforms:r}}function mp(n,e,t,i){let r={},s={},o=[];const a=t.isWebGL2?n.getParameter(n.MAX_UNIFORM_BUFFER_BINDINGS):0;function l(y,g){const w=g.program;i.uniformBlockBinding(y,w)}function c(y,g){let w=r[y.id];w===void 0&&(v(y),w=h(y),r[y.id]=w,y.addEventListener("dispose",p));const b=g.program;i.updateUBOMapping(y,b);const R=e.render.frame;s[y.id]!==R&&(f(y),s[y.id]=R)}function h(y){const g=d();y.__bindingPointIndex=g;const w=n.createBuffer(),b=y.__size,R=y.usage;return n.bindBuffer(n.UNIFORM_BUFFER,w),n.bufferData(n.UNIFORM_BUFFER,b,R),n.bindBuffer(n.UNIFORM_BUFFER,null),n.bindBufferBase(n.UNIFORM_BUFFER,g,w),w}function d(){for(let y=0;y<a;y++)if(o.indexOf(y)===-1)return o.push(y),y;return console.error("THREE.WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function f(y){const g=r[y.id],w=y.uniforms,b=y.__cache;n.bindBuffer(n.UNIFORM_BUFFER,g);for(let R=0,A=w.length;R<A;R++){const B=w[R];if(m(B,R,b)===!0){const M=B.__offset,T=Array.isArray(B.value)?B.value:[B.value];let X=0;for(let Z=0;Z<T.length;Z++){const ne=T[Z],P=x(ne);typeof ne=="number"?(B.__data[0]=ne,n.bufferSubData(n.UNIFORM_BUFFER,M+X,B.__data)):ne.isMatrix3?(B.__data[0]=ne.elements[0],B.__data[1]=ne.elements[1],B.__data[2]=ne.elements[2],B.__data[3]=ne.elements[0],B.__data[4]=ne.elements[3],B.__data[5]=ne.elements[4],B.__data[6]=ne.elements[5],B.__data[7]=ne.elements[0],B.__data[8]=ne.elements[6],B.__data[9]=ne.elements[7],B.__data[10]=ne.elements[8],B.__data[11]=ne.elements[0]):(ne.toArray(B.__data,X),X+=P.storage/Float32Array.BYTES_PER_ELEMENT)}n.bufferSubData(n.UNIFORM_BUFFER,M,B.__data)}}n.bindBuffer(n.UNIFORM_BUFFER,null)}function m(y,g,w){const b=y.value;if(w[g]===void 0){if(typeof b=="number")w[g]=b;else{const R=Array.isArray(b)?b:[b],A=[];for(let B=0;B<R.length;B++)A.push(R[B].clone());w[g]=A}return!0}else if(typeof b=="number"){if(w[g]!==b)return w[g]=b,!0}else{const R=Array.isArray(w[g])?w[g]:[w[g]],A=Array.isArray(b)?b:[b];for(let B=0;B<R.length;B++){const M=R[B];if(M.equals(A[B])===!1)return M.copy(A[B]),!0}}return!1}function v(y){const g=y.uniforms;let w=0;const b=16;let R=0;for(let A=0,B=g.length;A<B;A++){const M=g[A],T={boundary:0,storage:0},X=Array.isArray(M.value)?M.value:[M.value];for(let Z=0,ne=X.length;Z<ne;Z++){const P=X[Z],H=x(P);T.boundary+=H.boundary,T.storage+=H.storage}if(M.__data=new Float32Array(T.storage/Float32Array.BYTES_PER_ELEMENT),M.__offset=w,A>0){R=w%b;const Z=b-R;R!==0&&Z-T.boundary<0&&(w+=b-R,M.__offset=w)}w+=T.storage}return R=w%b,R>0&&(w+=b-R),y.__size=w,y.__cache={},this}function x(y){const g={boundary:0,storage:0};return typeof y=="number"?(g.boundary=4,g.storage=4):y.isVector2?(g.boundary=8,g.storage=8):y.isVector3||y.isColor?(g.boundary=16,g.storage=12):y.isVector4?(g.boundary=16,g.storage=16):y.isMatrix3?(g.boundary=48,g.storage=48):y.isMatrix4?(g.boundary=64,g.storage=64):y.isTexture?console.warn("THREE.WebGLRenderer: Texture samplers can not be part of an uniforms group."):console.warn("THREE.WebGLRenderer: Unsupported uniform value type.",y),g}function p(y){const g=y.target;g.removeEventListener("dispose",p);const w=o.indexOf(g.__bindingPointIndex);o.splice(w,1),n.deleteBuffer(r[g.id]),delete r[g.id],delete s[g.id]}function u(){for(const y in r)n.deleteBuffer(r[y]);o=[],r={},s={}}return{bind:l,update:c,dispose:u}}class Go{constructor(e={}){const{canvas:t=dc(),context:i=null,depth:r=!0,stencil:s=!0,alpha:o=!1,antialias:a=!1,premultipliedAlpha:l=!0,preserveDrawingBuffer:c=!1,powerPreference:h="default",failIfMajorPerformanceCaveat:d=!1}=e;this.isWebGLRenderer=!0;let f;i!==null?f=i.getContextAttributes().alpha:f=o;const m=new Uint32Array(4),v=new Int32Array(4);let x=null,p=null;const u=[],y=[];this.domElement=t,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this._outputColorSpace=Mt,this._useLegacyLights=!1,this.toneMapping=An,this.toneMappingExposure=1;const g=this;let w=!1,b=0,R=0,A=null,B=-1,M=null;const T=new mt,X=new mt;let Z=null;const ne=new Je(0);let P=0,H=t.width,q=t.height,Y=1,te=null,j=null;const Q=new mt(0,0,H,q),D=new mt(0,0,H,q);let F=!1;const pe=new bs;let fe=!1,I=!1,k=null;const ae=new ut,J=new Xe,he=new z,ve={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};function _e(){return A===null?Y:1}let U=i;function ke(S,O){for(let G=0;G<S.length;G++){const W=S[G],V=t.getContext(W,O);if(V!==null)return V}return null}try{const S={alpha:!0,depth:r,stencil:s,antialias:a,premultipliedAlpha:l,preserveDrawingBuffer:c,powerPreference:h,failIfMajorPerformanceCaveat:d};if("setAttribute"in t&&t.setAttribute("data-engine",`three.js r${xs}`),t.addEventListener("webglcontextlost",ze,!1),t.addEventListener("webglcontextrestored",L,!1),t.addEventListener("webglcontextcreationerror",me,!1),U===null){const O=["webgl2","webgl","experimental-webgl"];if(g.isWebGL1Renderer===!0&&O.shift(),U=ke(O,S),U===null)throw ke(O)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}typeof WebGLRenderingContext<"u"&&U instanceof WebGLRenderingContext&&console.warn("THREE.WebGLRenderer: WebGL 1 support was deprecated in r153 and will be removed in r163."),U.getShaderPrecisionFormat===void 0&&(U.getShaderPrecisionFormat=function(){return{rangeMin:1,rangeMax:1,precision:1}})}catch(S){throw console.error("THREE.WebGLRenderer: "+S.message),S}let ue,xe,Ae,De,Me,Ee,Le,Ie,Ve,E,_,N,ie,ee,oe,Te,le,ge,C,re,$,Ue,Ce,we;function Se(){ue=new Td(U),xe=new vd(U,ue,e),ue.init(xe),Ue=new cp(U,ue,xe),Ae=new op(U,ue,xe),De=new wd(U),Me=new Yf,Ee=new lp(U,ue,Ae,Me,xe,Ue,De),Le=new Md(g),Ie=new yd(g),Ve=new Oc(U,xe),Ce=new gd(U,ue,Ve,xe),E=new bd(U,Ve,De,Ce),_=new Pd(U,E,Ve,De),C=new Ld(U,xe,Ee),Te=new xd(Me),N=new qf(g,Le,Ie,ue,xe,Ce,Te),ie=new pp(g,Me),ee=new Kf,oe=new tp(ue,xe),ge=new md(g,Le,Ie,Ae,_,f,l),le=new ap(g,_,xe),we=new mp(U,De,xe,Ae),re=new _d(U,ue,De,xe),$=new Ad(U,ue,De,xe),De.programs=N.programs,g.capabilities=xe,g.extensions=ue,g.properties=Me,g.renderLists=ee,g.shadowMap=le,g.state=Ae,g.info=De}Se();const ye=new fp(g,U);this.xr=ye,this.getContext=function(){return U},this.getContextAttributes=function(){return U.getContextAttributes()},this.forceContextLoss=function(){const S=ue.get("WEBGL_lose_context");S&&S.loseContext()},this.forceContextRestore=function(){const S=ue.get("WEBGL_lose_context");S&&S.restoreContext()},this.getPixelRatio=function(){return Y},this.setPixelRatio=function(S){S!==void 0&&(Y=S,this.setSize(H,q,!1))},this.getSize=function(S){return S.set(H,q)},this.setSize=function(S,O,G=!0){if(ye.isPresenting){console.warn("THREE.WebGLRenderer: Can't change size while VR device is presenting.");return}H=S,q=O,t.width=Math.floor(S*Y),t.height=Math.floor(O*Y),G===!0&&(t.style.width=S+"px",t.style.height=O+"px"),this.setViewport(0,0,S,O)},this.getDrawingBufferSize=function(S){return S.set(H*Y,q*Y).floor()},this.setDrawingBufferSize=function(S,O,G){H=S,q=O,Y=G,t.width=Math.floor(S*G),t.height=Math.floor(O*G),this.setViewport(0,0,S,O)},this.getCurrentViewport=function(S){return S.copy(T)},this.getViewport=function(S){return S.copy(Q)},this.setViewport=function(S,O,G,W){S.isVector4?Q.set(S.x,S.y,S.z,S.w):Q.set(S,O,G,W),Ae.viewport(T.copy(Q).multiplyScalar(Y).floor())},this.getScissor=function(S){return S.copy(D)},this.setScissor=function(S,O,G,W){S.isVector4?D.set(S.x,S.y,S.z,S.w):D.set(S,O,G,W),Ae.scissor(X.copy(D).multiplyScalar(Y).floor())},this.getScissorTest=function(){return F},this.setScissorTest=function(S){Ae.setScissorTest(F=S)},this.setOpaqueSort=function(S){te=S},this.setTransparentSort=function(S){j=S},this.getClearColor=function(S){return S.copy(ge.getClearColor())},this.setClearColor=function(){ge.setClearColor.apply(ge,arguments)},this.getClearAlpha=function(){return ge.getClearAlpha()},this.setClearAlpha=function(){ge.setClearAlpha.apply(ge,arguments)},this.clear=function(S=!0,O=!0,G=!0){let W=0;if(S){let V=!1;if(A!==null){const Re=A.texture.format;V=Re===So||Re===Mo||Re===xo}if(V){const Re=A.texture.type,Ne=Re===wn||Re===yn||Re===Ms||Re===Gn||Re===_o||Re===vo,Oe=ge.getClearColor(),Be=ge.getClearAlpha(),We=Oe.r,He=Oe.g,Ge=Oe.b;Ne?(m[0]=We,m[1]=He,m[2]=Ge,m[3]=Be,U.clearBufferuiv(U.COLOR,0,m)):(v[0]=We,v[1]=He,v[2]=Ge,v[3]=Be,U.clearBufferiv(U.COLOR,0,v))}else W|=U.COLOR_BUFFER_BIT}O&&(W|=U.DEPTH_BUFFER_BIT),G&&(W|=U.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),U.clear(W)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){t.removeEventListener("webglcontextlost",ze,!1),t.removeEventListener("webglcontextrestored",L,!1),t.removeEventListener("webglcontextcreationerror",me,!1),ee.dispose(),oe.dispose(),Me.dispose(),Le.dispose(),Ie.dispose(),_.dispose(),Ce.dispose(),we.dispose(),N.dispose(),ye.dispose(),ye.removeEventListener("sessionstart",nt),ye.removeEventListener("sessionend",je),k&&(k.dispose(),k=null),de.stop()};function ze(S){S.preventDefault(),console.log("THREE.WebGLRenderer: Context Lost."),w=!0}function L(){console.log("THREE.WebGLRenderer: Context Restored."),w=!1;const S=De.autoReset,O=le.enabled,G=le.autoUpdate,W=le.needsUpdate,V=le.type;Se(),De.autoReset=S,le.enabled=O,le.autoUpdate=G,le.needsUpdate=W,le.type=V}function me(S){console.error("THREE.WebGLRenderer: A WebGL context could not be created. Reason: ",S.statusMessage)}function se(S){const O=S.target;O.removeEventListener("dispose",se),K(O)}function K(S){ce(S),Me.remove(S)}function ce(S){const O=Me.get(S).programs;O!==void 0&&(O.forEach(function(G){N.releaseProgram(G)}),S.isShaderMaterial&&N.releaseShaderCache(S))}this.renderBufferDirect=function(S,O,G,W,V,Re){O===null&&(O=ve);const Ne=V.isMesh&&V.matrixWorld.determinant()<0,Oe=Dt(S,O,G,W,V);Ae.setMaterial(W,Ne);let Be=G.index,We=1;if(W.wireframe===!0){if(Be=E.getWireframeAttribute(G),Be===void 0)return;We=2}const He=G.drawRange,Ge=G.attributes.position;let it=He.start*We,_t=(He.start+He.count)*We;Re!==null&&(it=Math.max(it,Re.start*We),_t=Math.min(_t,(Re.start+Re.count)*We)),Be!==null?(it=Math.max(it,0),_t=Math.min(_t,Be.count)):Ge!=null&&(it=Math.max(it,0),_t=Math.min(_t,Ge.count));const et=_t-it;if(et<0||et===1/0)return;Ce.setup(V,W,Oe,G,Be);let vt,tt=re;if(Be!==null&&(vt=Ve.get(Be),tt=$,tt.setIndex(vt)),V.isMesh)W.wireframe===!0?(Ae.setLineWidth(W.wireframeLinewidth*_e()),tt.setMode(U.LINES)):tt.setMode(U.TRIANGLES);else if(V.isLine){let qe=W.linewidth;qe===void 0&&(qe=1),Ae.setLineWidth(qe*_e()),V.isLineSegments?tt.setMode(U.LINES):V.isLineLoop?tt.setMode(U.LINE_LOOP):tt.setMode(U.LINE_STRIP)}else V.isPoints?tt.setMode(U.POINTS):V.isSprite&&tt.setMode(U.TRIANGLES);if(V.isInstancedMesh)tt.renderInstances(it,et,V.count);else if(G.isInstancedBufferGeometry){const qe=G._maxInstanceCount!==void 0?G._maxInstanceCount:1/0,Cn=Math.min(G.instanceCount,qe);tt.renderInstances(it,et,Cn)}else tt.render(it,et)};function Pe(S,O,G){S.transparent===!0&&S.side===dn&&S.forceSinglePass===!1?(S.side=Pt,S.needsUpdate=!0,Jt(S,O,G),S.side=Rn,S.needsUpdate=!0,Jt(S,O,G),S.side=dn):Jt(S,O,G)}this.compile=function(S,O,G=null){G===null&&(G=S),p=oe.get(G),p.init(),y.push(p),G.traverseVisible(function(V){V.isLight&&V.layers.test(O.layers)&&(p.pushLight(V),V.castShadow&&p.pushShadow(V))}),S!==G&&S.traverseVisible(function(V){V.isLight&&V.layers.test(O.layers)&&(p.pushLight(V),V.castShadow&&p.pushShadow(V))}),p.setupLights(g._useLegacyLights);const W=new Set;return S.traverse(function(V){const Re=V.material;if(Re)if(Array.isArray(Re))for(let Ne=0;Ne<Re.length;Ne++){const Oe=Re[Ne];Pe(Oe,G,V),W.add(Oe)}else Pe(Re,G,V),W.add(Re)}),y.pop(),p=null,W},this.compileAsync=function(S,O,G=null){const W=this.compile(S,O,G);return new Promise(V=>{function Re(){if(W.forEach(function(Ne){Me.get(Ne).currentProgram.isReady()&&W.delete(Ne)}),W.size===0){V(S);return}setTimeout(Re,10)}ue.get("KHR_parallel_shader_compile")!==null?Re():setTimeout(Re,10)})};let Fe=null;function Ze(S){Fe&&Fe(S)}function nt(){de.stop()}function je(){de.start()}const de=new No;de.setAnimationLoop(Ze),typeof self<"u"&&de.setContext(self),this.setAnimationLoop=function(S){Fe=S,ye.setAnimationLoop(S),S===null?de.stop():de.start()},ye.addEventListener("sessionstart",nt),ye.addEventListener("sessionend",je),this.render=function(S,O){if(O!==void 0&&O.isCamera!==!0){console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(w===!0)return;S.matrixWorldAutoUpdate===!0&&S.updateMatrixWorld(),O.parent===null&&O.matrixWorldAutoUpdate===!0&&O.updateMatrixWorld(),ye.enabled===!0&&ye.isPresenting===!0&&(ye.cameraAutoUpdate===!0&&ye.updateCamera(O),O=ye.getCamera()),S.isScene===!0&&S.onBeforeRender(g,S,O,A),p=oe.get(S,y.length),p.init(),y.push(p),ae.multiplyMatrices(O.projectionMatrix,O.matrixWorldInverse),pe.setFromProjectionMatrix(ae),I=this.localClippingEnabled,fe=Te.init(this.clippingPlanes,I),x=ee.get(S,u.length),x.init(),u.push(x),ot(S,O,0,g.sortObjects),x.finish(),g.sortObjects===!0&&x.sort(te,j),this.info.render.frame++,fe===!0&&Te.beginShadows();const G=p.state.shadowsArray;if(le.render(G,S,O),fe===!0&&Te.endShadows(),this.info.autoReset===!0&&this.info.reset(),ge.render(x,S),p.setupLights(g._useLegacyLights),O.isArrayCamera){const W=O.cameras;for(let V=0,Re=W.length;V<Re;V++){const Ne=W[V];St(x,S,Ne,Ne.viewport)}}else St(x,S,O);A!==null&&(Ee.updateMultisampleRenderTarget(A),Ee.updateRenderTargetMipmap(A)),S.isScene===!0&&S.onAfterRender(g,S,O),Ce.resetDefaultState(),B=-1,M=null,y.pop(),y.length>0?p=y[y.length-1]:p=null,u.pop(),u.length>0?x=u[u.length-1]:x=null};function ot(S,O,G,W){if(S.visible===!1)return;if(S.layers.test(O.layers)){if(S.isGroup)G=S.renderOrder;else if(S.isLOD)S.autoUpdate===!0&&S.update(O);else if(S.isLight)p.pushLight(S),S.castShadow&&p.pushShadow(S);else if(S.isSprite){if(!S.frustumCulled||pe.intersectsSprite(S)){W&&he.setFromMatrixPosition(S.matrixWorld).applyMatrix4(ae);const Ne=_.update(S),Oe=S.material;Oe.visible&&x.push(S,Ne,Oe,G,he.z,null)}}else if((S.isMesh||S.isLine||S.isPoints)&&(!S.frustumCulled||pe.intersectsObject(S))){const Ne=_.update(S),Oe=S.material;if(W&&(S.boundingSphere!==void 0?(S.boundingSphere===null&&S.computeBoundingSphere(),he.copy(S.boundingSphere.center)):(Ne.boundingSphere===null&&Ne.computeBoundingSphere(),he.copy(Ne.boundingSphere.center)),he.applyMatrix4(S.matrixWorld).applyMatrix4(ae)),Array.isArray(Oe)){const Be=Ne.groups;for(let We=0,He=Be.length;We<He;We++){const Ge=Be[We],it=Oe[Ge.materialIndex];it&&it.visible&&x.push(S,Ne,it,G,he.z,Ge)}}else Oe.visible&&x.push(S,Ne,Oe,G,he.z,null)}}const Re=S.children;for(let Ne=0,Oe=Re.length;Ne<Oe;Ne++)ot(Re[Ne],O,G,W)}function St(S,O,G,W){const V=S.opaque,Re=S.transmissive,Ne=S.transparent;p.setupLightsView(G),fe===!0&&Te.setGlobalState(g.clippingPlanes,G),Re.length>0&&tn(V,Re,O,G),W&&Ae.viewport(T.copy(W)),V.length>0&&$e(V,O,G),Re.length>0&&$e(Re,O,G),Ne.length>0&&$e(Ne,O,G),Ae.buffers.depth.setTest(!0),Ae.buffers.depth.setMask(!0),Ae.buffers.color.setMask(!0),Ae.setPolygonOffset(!1)}function tn(S,O,G,W){if((G.isScene===!0?G.overrideMaterial:null)!==null)return;const Re=xe.isWebGL2;k===null&&(k=new Wn(1,1,{generateMipmaps:!0,type:ue.has("EXT_color_buffer_half_float")?Fi:wn,minFilter:Ni,samples:Re?4:0})),g.getDrawingBufferSize(J),Re?k.setSize(J.x,J.y):k.setSize(Mr(J.x),Mr(J.y));const Ne=g.getRenderTarget();g.setRenderTarget(k),g.getClearColor(ne),P=g.getClearAlpha(),P<1&&g.setClearColor(16777215,.5),g.clear();const Oe=g.toneMapping;g.toneMapping=An,$e(S,G,W),Ee.updateMultisampleRenderTarget(k),Ee.updateRenderTargetMipmap(k);let Be=!1;for(let We=0,He=O.length;We<He;We++){const Ge=O[We],it=Ge.object,_t=Ge.geometry,et=Ge.material,vt=Ge.group;if(et.side===dn&&it.layers.test(W.layers)){const tt=et.side;et.side=Pt,et.needsUpdate=!0,nn(it,G,W,_t,et,vt),et.side=tt,et.needsUpdate=!0,Be=!0}}Be===!0&&(Ee.updateMultisampleRenderTarget(k),Ee.updateRenderTargetMipmap(k)),g.setRenderTarget(Ne),g.setClearColor(ne,P),g.toneMapping=Oe}function $e(S,O,G){const W=O.isScene===!0?O.overrideMaterial:null;for(let V=0,Re=S.length;V<Re;V++){const Ne=S[V],Oe=Ne.object,Be=Ne.geometry,We=W===null?Ne.material:W,He=Ne.group;Oe.layers.test(G.layers)&&nn(Oe,O,G,Be,We,He)}}function nn(S,O,G,W,V,Re){S.onBeforeRender(g,O,G,W,V,Re),S.modelViewMatrix.multiplyMatrices(G.matrixWorldInverse,S.matrixWorld),S.normalMatrix.getNormalMatrix(S.modelViewMatrix),V.onBeforeRender(g,O,G,W,S,Re),V.transparent===!0&&V.side===dn&&V.forceSinglePass===!1?(V.side=Pt,V.needsUpdate=!0,g.renderBufferDirect(G,O,W,V,S,Re),V.side=Rn,V.needsUpdate=!0,g.renderBufferDirect(G,O,W,V,S,Re),V.side=dn):g.renderBufferDirect(G,O,W,V,S,Re),S.onAfterRender(g,O,G,W,V,Re)}function Jt(S,O,G){O.isScene!==!0&&(O=ve);const W=Me.get(S),V=p.state.lights,Re=p.state.shadowsArray,Ne=V.state.version,Oe=N.getParameters(S,V.state,Re,O,G),Be=N.getProgramCacheKey(Oe);let We=W.programs;W.environment=S.isMeshStandardMaterial?O.environment:null,W.fog=O.fog,W.envMap=(S.isMeshStandardMaterial?Ie:Le).get(S.envMap||W.environment),We===void 0&&(S.addEventListener("dispose",se),We=new Map,W.programs=We);let He=We.get(Be);if(He!==void 0){if(W.currentProgram===He&&W.lightsStateVersion===Ne)return Bt(S,Oe),He}else Oe.uniforms=N.getUniforms(S),S.onBuild(G,Oe,g),S.onBeforeCompile(Oe,g),He=N.acquireProgram(Oe,Be),We.set(Be,He),W.uniforms=Oe.uniforms;const Ge=W.uniforms;return(!S.isShaderMaterial&&!S.isRawShaderMaterial||S.clipping===!0)&&(Ge.clippingPlanes=Te.uniform),Bt(S,Oe),W.needsLights=Ct(S),W.lightsStateVersion=Ne,W.needsLights&&(Ge.ambientLightColor.value=V.state.ambient,Ge.lightProbe.value=V.state.probe,Ge.directionalLights.value=V.state.directional,Ge.directionalLightShadows.value=V.state.directionalShadow,Ge.spotLights.value=V.state.spot,Ge.spotLightShadows.value=V.state.spotShadow,Ge.rectAreaLights.value=V.state.rectArea,Ge.ltc_1.value=V.state.rectAreaLTC1,Ge.ltc_2.value=V.state.rectAreaLTC2,Ge.pointLights.value=V.state.point,Ge.pointLightShadows.value=V.state.pointShadow,Ge.hemisphereLights.value=V.state.hemi,Ge.directionalShadowMap.value=V.state.directionalShadowMap,Ge.directionalShadowMatrix.value=V.state.directionalShadowMatrix,Ge.spotShadowMap.value=V.state.spotShadowMap,Ge.spotLightMatrix.value=V.state.spotLightMatrix,Ge.spotLightMap.value=V.state.spotLightMap,Ge.pointShadowMap.value=V.state.pointShadowMap,Ge.pointShadowMatrix.value=V.state.pointShadowMatrix),W.currentProgram=He,W.uniformsList=null,He}function gn(S){if(S.uniformsList===null){const O=S.currentProgram.getUniforms();S.uniformsList=pr.seqWithValue(O.seq,S.uniforms)}return S.uniformsList}function Bt(S,O){const G=Me.get(S);G.outputColorSpace=O.outputColorSpace,G.instancing=O.instancing,G.instancingColor=O.instancingColor,G.skinning=O.skinning,G.morphTargets=O.morphTargets,G.morphNormals=O.morphNormals,G.morphColors=O.morphColors,G.morphTargetsCount=O.morphTargetsCount,G.numClippingPlanes=O.numClippingPlanes,G.numIntersection=O.numClipIntersection,G.vertexAlphas=O.vertexAlphas,G.vertexTangents=O.vertexTangents,G.toneMapping=O.toneMapping}function Dt(S,O,G,W,V){O.isScene!==!0&&(O=ve),Ee.resetTextureUnits();const Re=O.fog,Ne=W.isMeshStandardMaterial?O.environment:null,Oe=A===null?g.outputColorSpace:A.isXRRenderTarget===!0?A.texture.colorSpace:mn,Be=(W.isMeshStandardMaterial?Ie:Le).get(W.envMap||Ne),We=W.vertexColors===!0&&!!G.attributes.color&&G.attributes.color.itemSize===4,He=!!G.attributes.tangent&&(!!W.normalMap||W.anisotropy>0),Ge=!!G.morphAttributes.position,it=!!G.morphAttributes.normal,_t=!!G.morphAttributes.color;let et=An;W.toneMapped&&(A===null||A.isXRRenderTarget===!0)&&(et=g.toneMapping);const vt=G.morphAttributes.position||G.morphAttributes.normal||G.morphAttributes.color,tt=vt!==void 0?vt.length:0,qe=Me.get(W),Cn=p.state.lights;if(fe===!0&&(I===!0||S!==M)){const xt=S===M&&W.id===B;Te.setState(W,S,xt)}let st=!1;W.version===qe.__version?(qe.needsLights&&qe.lightsStateVersion!==Cn.state.version||qe.outputColorSpace!==Oe||V.isInstancedMesh&&qe.instancing===!1||!V.isInstancedMesh&&qe.instancing===!0||V.isSkinnedMesh&&qe.skinning===!1||!V.isSkinnedMesh&&qe.skinning===!0||V.isInstancedMesh&&qe.instancingColor===!0&&V.instanceColor===null||V.isInstancedMesh&&qe.instancingColor===!1&&V.instanceColor!==null||qe.envMap!==Be||W.fog===!0&&qe.fog!==Re||qe.numClippingPlanes!==void 0&&(qe.numClippingPlanes!==Te.numPlanes||qe.numIntersection!==Te.numIntersection)||qe.vertexAlphas!==We||qe.vertexTangents!==He||qe.morphTargets!==Ge||qe.morphNormals!==it||qe.morphColors!==_t||qe.toneMapping!==et||xe.isWebGL2===!0&&qe.morphTargetsCount!==tt)&&(st=!0):(st=!0,qe.__version=W.version);let Lt=qe.currentProgram;st===!0&&(Lt=Jt(W,O,V));let jn=!1,rn=!1,sn=!1;const ct=Lt.getUniforms(),Ut=qe.uniforms;if(Ae.useProgram(Lt.program)&&(jn=!0,rn=!0,sn=!0),W.id!==B&&(B=W.id,rn=!0),jn||M!==S){ct.setValue(U,"projectionMatrix",S.projectionMatrix),ct.setValue(U,"viewMatrix",S.matrixWorldInverse);const xt=ct.map.cameraPosition;xt!==void 0&&xt.setValue(U,he.setFromMatrixPosition(S.matrixWorld)),xe.logarithmicDepthBuffer&&ct.setValue(U,"logDepthBufFC",2/(Math.log(S.far+1)/Math.LN2)),(W.isMeshPhongMaterial||W.isMeshToonMaterial||W.isMeshLambertMaterial||W.isMeshBasicMaterial||W.isMeshStandardMaterial||W.isShaderMaterial)&&ct.setValue(U,"isOrthographic",S.isOrthographicCamera===!0),M!==S&&(M=S,rn=!0,sn=!0)}if(V.isSkinnedMesh){ct.setOptional(U,V,"bindMatrix"),ct.setOptional(U,V,"bindMatrixInverse");const xt=V.skeleton;xt&&(xe.floatVertexTextures?(xt.boneTexture===null&&xt.computeBoneTexture(),ct.setValue(U,"boneTexture",xt.boneTexture,Ee),ct.setValue(U,"boneTextureSize",xt.boneTextureSize)):console.warn("THREE.WebGLRenderer: SkinnedMesh can only be used with WebGL 2. With WebGL 1 OES_texture_float and vertex textures support is required."))}const Ln=G.morphAttributes;if((Ln.position!==void 0||Ln.normal!==void 0||Ln.color!==void 0&&xe.isWebGL2===!0)&&C.update(V,G,Lt),(rn||qe.receiveShadow!==V.receiveShadow)&&(qe.receiveShadow=V.receiveShadow,ct.setValue(U,"receiveShadow",V.receiveShadow)),W.isMeshGouraudMaterial&&W.envMap!==null&&(Ut.envMap.value=Be,Ut.flipEnvMap.value=Be.isCubeTexture&&Be.isRenderTargetTexture===!1?-1:1),rn&&(ct.setValue(U,"toneMappingExposure",g.toneMappingExposure),qe.needsLights&&lt(Ut,sn),Re&&W.fog===!0&&ie.refreshFogUniforms(Ut,Re),ie.refreshMaterialUniforms(Ut,W,Y,q,k),pr.upload(U,gn(qe),Ut,Ee)),W.isShaderMaterial&&W.uniformsNeedUpdate===!0&&(pr.upload(U,gn(qe),Ut,Ee),W.uniformsNeedUpdate=!1),W.isSpriteMaterial&&ct.setValue(U,"center",V.center),ct.setValue(U,"modelViewMatrix",V.modelViewMatrix),ct.setValue(U,"normalMatrix",V.normalMatrix),ct.setValue(U,"modelMatrix",V.matrixWorld),W.isShaderMaterial||W.isRawShaderMaterial){const xt=W.uniformsGroups;for(let Ti=0,wr=xt.length;Ti<wr;Ti++)if(xe.isWebGL2){const Gi=xt[Ti];we.update(Gi,Lt),we.bind(Gi,Lt)}else console.warn("THREE.WebGLRenderer: Uniform Buffer Objects can only be used with WebGL 2.")}return Lt}function lt(S,O){S.ambientLightColor.needsUpdate=O,S.lightProbe.needsUpdate=O,S.directionalLights.needsUpdate=O,S.directionalLightShadows.needsUpdate=O,S.pointLights.needsUpdate=O,S.pointLightShadows.needsUpdate=O,S.spotLights.needsUpdate=O,S.spotLightShadows.needsUpdate=O,S.rectAreaLights.needsUpdate=O,S.hemisphereLights.needsUpdate=O}function Ct(S){return S.isMeshLambertMaterial||S.isMeshToonMaterial||S.isMeshPhongMaterial||S.isMeshStandardMaterial||S.isShadowMaterial||S.isShaderMaterial&&S.lights===!0}this.getActiveCubeFace=function(){return b},this.getActiveMipmapLevel=function(){return R},this.getRenderTarget=function(){return A},this.setRenderTargetTextures=function(S,O,G){Me.get(S.texture).__webglTexture=O,Me.get(S.depthTexture).__webglTexture=G;const W=Me.get(S);W.__hasExternalTextures=!0,W.__hasExternalTextures&&(W.__autoAllocateDepthBuffer=G===void 0,W.__autoAllocateDepthBuffer||ue.has("WEBGL_multisampled_render_to_texture")===!0&&(console.warn("THREE.WebGLRenderer: Render-to-texture extension was disabled because an external texture was provided"),W.__useRenderToTexture=!1))},this.setRenderTargetFramebuffer=function(S,O){const G=Me.get(S);G.__webglFramebuffer=O,G.__useDefaultFramebuffer=O===void 0},this.setRenderTarget=function(S,O=0,G=0){A=S,b=O,R=G;let W=!0,V=null,Re=!1,Ne=!1;if(S){const Be=Me.get(S);Be.__useDefaultFramebuffer!==void 0?(Ae.bindFramebuffer(U.FRAMEBUFFER,null),W=!1):Be.__webglFramebuffer===void 0?Ee.setupRenderTarget(S):Be.__hasExternalTextures&&Ee.rebindTextures(S,Me.get(S.texture).__webglTexture,Me.get(S.depthTexture).__webglTexture);const We=S.texture;(We.isData3DTexture||We.isDataArrayTexture||We.isCompressedArrayTexture)&&(Ne=!0);const He=Me.get(S).__webglFramebuffer;S.isWebGLCubeRenderTarget?(Array.isArray(He[O])?V=He[O][G]:V=He[O],Re=!0):xe.isWebGL2&&S.samples>0&&Ee.useMultisampledRTT(S)===!1?V=Me.get(S).__webglMultisampledFramebuffer:Array.isArray(He)?V=He[G]:V=He,T.copy(S.viewport),X.copy(S.scissor),Z=S.scissorTest}else T.copy(Q).multiplyScalar(Y).floor(),X.copy(D).multiplyScalar(Y).floor(),Z=F;if(Ae.bindFramebuffer(U.FRAMEBUFFER,V)&&xe.drawBuffers&&W&&Ae.drawBuffers(S,V),Ae.viewport(T),Ae.scissor(X),Ae.setScissorTest(Z),Re){const Be=Me.get(S.texture);U.framebufferTexture2D(U.FRAMEBUFFER,U.COLOR_ATTACHMENT0,U.TEXTURE_CUBE_MAP_POSITIVE_X+O,Be.__webglTexture,G)}else if(Ne){const Be=Me.get(S.texture),We=O||0;U.framebufferTextureLayer(U.FRAMEBUFFER,U.COLOR_ATTACHMENT0,Be.__webglTexture,G||0,We)}B=-1},this.readRenderTargetPixels=function(S,O,G,W,V,Re,Ne){if(!(S&&S.isWebGLRenderTarget)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let Oe=Me.get(S).__webglFramebuffer;if(S.isWebGLCubeRenderTarget&&Ne!==void 0&&(Oe=Oe[Ne]),Oe){Ae.bindFramebuffer(U.FRAMEBUFFER,Oe);try{const Be=S.texture,We=Be.format,He=Be.type;if(We!==Kt&&Ue.convert(We)!==U.getParameter(U.IMPLEMENTATION_COLOR_READ_FORMAT)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}const Ge=He===Fi&&(ue.has("EXT_color_buffer_half_float")||xe.isWebGL2&&ue.has("EXT_color_buffer_float"));if(He!==wn&&Ue.convert(He)!==U.getParameter(U.IMPLEMENTATION_COLOR_READ_TYPE)&&!(He===Tn&&(xe.isWebGL2||ue.has("OES_texture_float")||ue.has("WEBGL_color_buffer_float")))&&!Ge){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}O>=0&&O<=S.width-W&&G>=0&&G<=S.height-V&&U.readPixels(O,G,W,V,Ue.convert(We),Ue.convert(He),Re)}finally{const Be=A!==null?Me.get(A).__webglFramebuffer:null;Ae.bindFramebuffer(U.FRAMEBUFFER,Be)}}},this.copyFramebufferToTexture=function(S,O,G=0){const W=Math.pow(2,-G),V=Math.floor(O.image.width*W),Re=Math.floor(O.image.height*W);Ee.setTexture2D(O,0),U.copyTexSubImage2D(U.TEXTURE_2D,G,0,0,S.x,S.y,V,Re),Ae.unbindTexture()},this.copyTextureToTexture=function(S,O,G,W=0){const V=O.image.width,Re=O.image.height,Ne=Ue.convert(G.format),Oe=Ue.convert(G.type);Ee.setTexture2D(G,0),U.pixelStorei(U.UNPACK_FLIP_Y_WEBGL,G.flipY),U.pixelStorei(U.UNPACK_PREMULTIPLY_ALPHA_WEBGL,G.premultiplyAlpha),U.pixelStorei(U.UNPACK_ALIGNMENT,G.unpackAlignment),O.isDataTexture?U.texSubImage2D(U.TEXTURE_2D,W,S.x,S.y,V,Re,Ne,Oe,O.image.data):O.isCompressedTexture?U.compressedTexSubImage2D(U.TEXTURE_2D,W,S.x,S.y,O.mipmaps[0].width,O.mipmaps[0].height,Ne,O.mipmaps[0].data):U.texSubImage2D(U.TEXTURE_2D,W,S.x,S.y,Ne,Oe,O.image),W===0&&G.generateMipmaps&&U.generateMipmap(U.TEXTURE_2D),Ae.unbindTexture()},this.copyTextureToTexture3D=function(S,O,G,W,V=0){if(g.isWebGL1Renderer){console.warn("THREE.WebGLRenderer.copyTextureToTexture3D: can only be used with WebGL2.");return}const Re=S.max.x-S.min.x+1,Ne=S.max.y-S.min.y+1,Oe=S.max.z-S.min.z+1,Be=Ue.convert(W.format),We=Ue.convert(W.type);let He;if(W.isData3DTexture)Ee.setTexture3D(W,0),He=U.TEXTURE_3D;else if(W.isDataArrayTexture)Ee.setTexture2DArray(W,0),He=U.TEXTURE_2D_ARRAY;else{console.warn("THREE.WebGLRenderer.copyTextureToTexture3D: only supports THREE.DataTexture3D and THREE.DataTexture2DArray.");return}U.pixelStorei(U.UNPACK_FLIP_Y_WEBGL,W.flipY),U.pixelStorei(U.UNPACK_PREMULTIPLY_ALPHA_WEBGL,W.premultiplyAlpha),U.pixelStorei(U.UNPACK_ALIGNMENT,W.unpackAlignment);const Ge=U.getParameter(U.UNPACK_ROW_LENGTH),it=U.getParameter(U.UNPACK_IMAGE_HEIGHT),_t=U.getParameter(U.UNPACK_SKIP_PIXELS),et=U.getParameter(U.UNPACK_SKIP_ROWS),vt=U.getParameter(U.UNPACK_SKIP_IMAGES),tt=G.isCompressedTexture?G.mipmaps[0]:G.image;U.pixelStorei(U.UNPACK_ROW_LENGTH,tt.width),U.pixelStorei(U.UNPACK_IMAGE_HEIGHT,tt.height),U.pixelStorei(U.UNPACK_SKIP_PIXELS,S.min.x),U.pixelStorei(U.UNPACK_SKIP_ROWS,S.min.y),U.pixelStorei(U.UNPACK_SKIP_IMAGES,S.min.z),G.isDataTexture||G.isData3DTexture?U.texSubImage3D(He,V,O.x,O.y,O.z,Re,Ne,Oe,Be,We,tt.data):G.isCompressedArrayTexture?(console.warn("THREE.WebGLRenderer.copyTextureToTexture3D: untested support for compressed srcTexture."),U.compressedTexSubImage3D(He,V,O.x,O.y,O.z,Re,Ne,Oe,Be,tt.data)):U.texSubImage3D(He,V,O.x,O.y,O.z,Re,Ne,Oe,Be,We,tt),U.pixelStorei(U.UNPACK_ROW_LENGTH,Ge),U.pixelStorei(U.UNPACK_IMAGE_HEIGHT,it),U.pixelStorei(U.UNPACK_SKIP_PIXELS,_t),U.pixelStorei(U.UNPACK_SKIP_ROWS,et),U.pixelStorei(U.UNPACK_SKIP_IMAGES,vt),V===0&&W.generateMipmaps&&U.generateMipmap(He),Ae.unbindTexture()},this.initTexture=function(S){S.isCubeTexture?Ee.setTextureCube(S,0):S.isData3DTexture?Ee.setTexture3D(S,0):S.isDataArrayTexture||S.isCompressedArrayTexture?Ee.setTexture2DArray(S,0):Ee.setTexture2D(S,0),Ae.unbindTexture()},this.resetState=function(){b=0,R=0,A=null,Ae.reset(),Ce.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return fn}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;const t=this.getContext();t.drawingBufferColorSpace=e===Ss?"display-p3":"srgb",t.unpackColorSpace=Qe.workingColorSpace===yr?"display-p3":"srgb"}get physicallyCorrectLights(){return console.warn("THREE.WebGLRenderer: The property .physicallyCorrectLights has been removed. Set renderer.useLegacyLights instead."),!this.useLegacyLights}set physicallyCorrectLights(e){console.warn("THREE.WebGLRenderer: The property .physicallyCorrectLights has been removed. Set renderer.useLegacyLights instead."),this.useLegacyLights=!e}get outputEncoding(){return console.warn("THREE.WebGLRenderer: Property .outputEncoding has been removed. Use .outputColorSpace instead."),this.outputColorSpace===Mt?kn:Eo}set outputEncoding(e){console.warn("THREE.WebGLRenderer: Property .outputEncoding has been removed. Use .outputColorSpace instead."),this.outputColorSpace=e===kn?Mt:mn}get useLegacyLights(){return console.warn("THREE.WebGLRenderer: The property .useLegacyLights has been deprecated. Migrate your lighting according to the following guide: https://discourse.threejs.org/t/updates-to-lighting-in-three-js-r155/53733."),this._useLegacyLights}set useLegacyLights(e){console.warn("THREE.WebGLRenderer: The property .useLegacyLights has been deprecated. Migrate your lighting according to the following guide: https://discourse.threejs.org/t/updates-to-lighting-in-three-js-r155/53733."),this._useLegacyLights=e}}class gp extends Go{}gp.prototype.isWebGL1Renderer=!0;class _p extends gt{constructor(){super(),this.isScene=!0,this.type="Scene",this.background=null,this.environment=null,this.fog=null,this.backgroundBlurriness=0,this.backgroundIntensity=1,this.overrideMaterial=null,typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}copy(e,t){return super.copy(e,t),e.background!==null&&(this.background=e.background.clone()),e.environment!==null&&(this.environment=e.environment.clone()),e.fog!==null&&(this.fog=e.fog.clone()),this.backgroundBlurriness=e.backgroundBlurriness,this.backgroundIntensity=e.backgroundIntensity,e.overrideMaterial!==null&&(this.overrideMaterial=e.overrideMaterial.clone()),this.matrixAutoUpdate=e.matrixAutoUpdate,this}toJSON(e){const t=super.toJSON(e);return this.fog!==null&&(t.object.fog=this.fog.toJSON()),this.backgroundBlurriness>0&&(t.object.backgroundBlurriness=this.backgroundBlurriness),this.backgroundIntensity!==1&&(t.object.backgroundIntensity=this.backgroundIntensity),t}}class gs extends Ei{constructor(e){super(),this.isLineBasicMaterial=!0,this.type="LineBasicMaterial",this.color=new Je(16777215),this.map=null,this.linewidth=1,this.linecap="round",this.linejoin="round",this.fog=!0,this.setValues(e)}copy(e){return super.copy(e),this.color.copy(e.color),this.map=e.map,this.linewidth=e.linewidth,this.linecap=e.linecap,this.linejoin=e.linejoin,this.fog=e.fog,this}}const Za=new z,$a=new z,Ja=new ut,is=new ys,hr=new Tr;class ur extends gt{constructor(e=new en,t=new gs){super(),this.isLine=!0,this.type="Line",this.geometry=e,this.material=t,this.updateMorphTargets()}copy(e,t){return super.copy(e,t),this.material=Array.isArray(e.material)?e.material.slice():e.material,this.geometry=e.geometry,this}computeLineDistances(){const e=this.geometry;if(e.index===null){const t=e.attributes.position,i=[0];for(let r=1,s=t.count;r<s;r++)Za.fromBufferAttribute(t,r-1),$a.fromBufferAttribute(t,r),i[r]=i[r-1],i[r]+=Za.distanceTo($a);e.setAttribute("lineDistance",new $t(i,1))}else console.warn("THREE.Line.computeLineDistances(): Computation only possible with non-indexed BufferGeometry.");return this}raycast(e,t){const i=this.geometry,r=this.matrixWorld,s=e.params.Line.threshold,o=i.drawRange;if(i.boundingSphere===null&&i.computeBoundingSphere(),hr.copy(i.boundingSphere),hr.applyMatrix4(r),hr.radius+=s,e.ray.intersectsSphere(hr)===!1)return;Ja.copy(r).invert(),is.copy(e.ray).applyMatrix4(Ja);const a=s/((this.scale.x+this.scale.y+this.scale.z)/3),l=a*a,c=new z,h=new z,d=new z,f=new z,m=this.isLineSegments?2:1,v=i.index,p=i.attributes.position;if(v!==null){const u=Math.max(0,o.start),y=Math.min(v.count,o.start+o.count);for(let g=u,w=y-1;g<w;g+=m){const b=v.getX(g),R=v.getX(g+1);if(c.fromBufferAttribute(p,b),h.fromBufferAttribute(p,R),is.distanceSqToSegment(c,h,f,d)>l)continue;f.applyMatrix4(this.matrixWorld);const B=e.ray.origin.distanceTo(f);B<e.near||B>e.far||t.push({distance:B,point:d.clone().applyMatrix4(this.matrixWorld),index:g,face:null,faceIndex:null,object:this})}}else{const u=Math.max(0,o.start),y=Math.min(p.count,o.start+o.count);for(let g=u,w=y-1;g<w;g+=m){if(c.fromBufferAttribute(p,g),h.fromBufferAttribute(p,g+1),is.distanceSqToSegment(c,h,f,d)>l)continue;f.applyMatrix4(this.matrixWorld);const R=e.ray.origin.distanceTo(f);R<e.near||R>e.far||t.push({distance:R,point:d.clone().applyMatrix4(this.matrixWorld),index:g,face:null,faceIndex:null,object:this})}}}updateMorphTargets(){const t=this.geometry.morphAttributes,i=Object.keys(t);if(i.length>0){const r=t[i[0]];if(r!==void 0){this.morphTargetInfluences=[],this.morphTargetDictionary={};for(let s=0,o=r.length;s<o;s++){const a=r[s].name||String(s);this.morphTargetInfluences.push(0),this.morphTargetDictionary[a]=s}}}}}class zn extends en{constructor(e=1,t=32,i=16,r=0,s=Math.PI*2,o=0,a=Math.PI){super(),this.type="SphereGeometry",this.parameters={radius:e,widthSegments:t,heightSegments:i,phiStart:r,phiLength:s,thetaStart:o,thetaLength:a},t=Math.max(3,Math.floor(t)),i=Math.max(2,Math.floor(i));const l=Math.min(o+a,Math.PI);let c=0;const h=[],d=new z,f=new z,m=[],v=[],x=[],p=[];for(let u=0;u<=i;u++){const y=[],g=u/i;let w=0;u===0&&o===0?w=.5/t:u===i&&l===Math.PI&&(w=-.5/t);for(let b=0;b<=t;b++){const R=b/t;d.x=-e*Math.cos(r+R*s)*Math.sin(o+g*a),d.y=e*Math.cos(o+g*a),d.z=e*Math.sin(r+R*s)*Math.sin(o+g*a),v.push(d.x,d.y,d.z),f.copy(d).normalize(),x.push(f.x,f.y,f.z),p.push(R+w,1-g),y.push(c++)}h.push(y)}for(let u=0;u<i;u++)for(let y=0;y<t;y++){const g=h[u][y+1],w=h[u][y],b=h[u+1][y],R=h[u+1][y+1];(u!==0||o>0)&&m.push(g,w,R),(u!==i-1||l<Math.PI)&&m.push(w,b,R)}this.setIndex(m),this.setAttribute("position",new $t(v,3)),this.setAttribute("normal",new $t(x,3)),this.setAttribute("uv",new $t(p,2))}copy(e){return super.copy(e),this.parameters=Object.assign({},e.parameters),this}static fromJSON(e){return new zn(e.radius,e.widthSegments,e.heightSegments,e.phiStart,e.phiLength,e.thetaStart,e.thetaLength)}}class dr extends Ei{constructor(e){super(),this.isMeshStandardMaterial=!0,this.defines={STANDARD:""},this.type="MeshStandardMaterial",this.color=new Je(16777215),this.roughness=1,this.metalness=0,this.map=null,this.lightMap=null,this.lightMapIntensity=1,this.aoMap=null,this.aoMapIntensity=1,this.emissive=new Je(0),this.emissiveIntensity=1,this.emissiveMap=null,this.bumpMap=null,this.bumpScale=1,this.normalMap=null,this.normalMapType=yo,this.normalScale=new Xe(1,1),this.displacementMap=null,this.displacementScale=1,this.displacementBias=0,this.roughnessMap=null,this.metalnessMap=null,this.alphaMap=null,this.envMap=null,this.envMapIntensity=1,this.wireframe=!1,this.wireframeLinewidth=1,this.wireframeLinecap="round",this.wireframeLinejoin="round",this.flatShading=!1,this.fog=!0,this.setValues(e)}copy(e){return super.copy(e),this.defines={STANDARD:""},this.color.copy(e.color),this.roughness=e.roughness,this.metalness=e.metalness,this.map=e.map,this.lightMap=e.lightMap,this.lightMapIntensity=e.lightMapIntensity,this.aoMap=e.aoMap,this.aoMapIntensity=e.aoMapIntensity,this.emissive.copy(e.emissive),this.emissiveMap=e.emissiveMap,this.emissiveIntensity=e.emissiveIntensity,this.bumpMap=e.bumpMap,this.bumpScale=e.bumpScale,this.normalMap=e.normalMap,this.normalMapType=e.normalMapType,this.normalScale.copy(e.normalScale),this.displacementMap=e.displacementMap,this.displacementScale=e.displacementScale,this.displacementBias=e.displacementBias,this.roughnessMap=e.roughnessMap,this.metalnessMap=e.metalnessMap,this.alphaMap=e.alphaMap,this.envMap=e.envMap,this.envMapIntensity=e.envMapIntensity,this.wireframe=e.wireframe,this.wireframeLinewidth=e.wireframeLinewidth,this.wireframeLinecap=e.wireframeLinecap,this.wireframeLinejoin=e.wireframeLinejoin,this.flatShading=e.flatShading,this.fog=e.fog,this}}class Rs extends gt{constructor(e,t=1){super(),this.isLight=!0,this.type="Light",this.color=new Je(e),this.intensity=t}dispose(){}copy(e,t){return super.copy(e,t),this.color.copy(e.color),this.intensity=e.intensity,this}toJSON(e){const t=super.toJSON(e);return t.object.color=this.color.getHex(),t.object.intensity=this.intensity,this.groundColor!==void 0&&(t.object.groundColor=this.groundColor.getHex()),this.distance!==void 0&&(t.object.distance=this.distance),this.angle!==void 0&&(t.object.angle=this.angle),this.decay!==void 0&&(t.object.decay=this.decay),this.penumbra!==void 0&&(t.object.penumbra=this.penumbra),this.shadow!==void 0&&(t.object.shadow=this.shadow.toJSON()),t}}class vp extends Rs{constructor(e,t,i){super(e,i),this.isHemisphereLight=!0,this.type="HemisphereLight",this.position.copy(gt.DEFAULT_UP),this.updateMatrix(),this.groundColor=new Je(t)}copy(e,t){return super.copy(e,t),this.groundColor.copy(e.groundColor),this}}const rs=new ut,Qa=new z,eo=new z;class xp{constructor(e){this.camera=e,this.bias=0,this.normalBias=0,this.radius=1,this.blurSamples=8,this.mapSize=new Xe(512,512),this.map=null,this.mapPass=null,this.matrix=new ut,this.autoUpdate=!0,this.needsUpdate=!1,this._frustum=new bs,this._frameExtents=new Xe(1,1),this._viewportCount=1,this._viewports=[new mt(0,0,1,1)]}getViewportCount(){return this._viewportCount}getFrustum(){return this._frustum}updateMatrices(e){const t=this.camera,i=this.matrix;Qa.setFromMatrixPosition(e.matrixWorld),t.position.copy(Qa),eo.setFromMatrixPosition(e.target.matrixWorld),t.lookAt(eo),t.updateMatrixWorld(),rs.multiplyMatrices(t.projectionMatrix,t.matrixWorldInverse),this._frustum.setFromProjectionMatrix(rs),i.set(.5,0,0,.5,0,.5,0,.5,0,0,.5,.5,0,0,0,1),i.multiply(rs)}getViewport(e){return this._viewports[e]}getFrameExtents(){return this._frameExtents}dispose(){this.map&&this.map.dispose(),this.mapPass&&this.mapPass.dispose()}copy(e){return this.camera=e.camera.clone(),this.bias=e.bias,this.radius=e.radius,this.mapSize.copy(e.mapSize),this}clone(){return new this.constructor().copy(this)}toJSON(){const e={};return this.bias!==0&&(e.bias=this.bias),this.normalBias!==0&&(e.normalBias=this.normalBias),this.radius!==1&&(e.radius=this.radius),(this.mapSize.x!==512||this.mapSize.y!==512)&&(e.mapSize=this.mapSize.toArray()),e.camera=this.camera.toJSON(!1).object,delete e.camera.matrix,e}}class Mp extends xp{constructor(){super(new Fo(-5,5,5,-5,.5,500)),this.isDirectionalLightShadow=!0}}class Sp extends Rs{constructor(e,t){super(e,t),this.isDirectionalLight=!0,this.type="DirectionalLight",this.position.copy(gt.DEFAULT_UP),this.updateMatrix(),this.target=new gt,this.shadow=new Mp}dispose(){this.shadow.dispose()}copy(e){return super.copy(e),this.target=e.target.clone(),this.shadow=e.shadow.clone(),this}}class Ep extends Rs{constructor(e,t){super(e,t),this.isAmbientLight=!0,this.type="AmbientLight"}}class to{constructor(e=1,t=0,i=0){return this.radius=e,this.phi=t,this.theta=i,this}set(e,t,i){return this.radius=e,this.phi=t,this.theta=i,this}copy(e){return this.radius=e.radius,this.phi=e.phi,this.theta=e.theta,this}makeSafe(){return this.phi=Math.max(1e-6,Math.min(Math.PI-1e-6,this.phi)),this}setFromVector3(e){return this.setFromCartesianCoords(e.x,e.y,e.z)}setFromCartesianCoords(e,t,i){return this.radius=Math.sqrt(e*e+t*t+i*i),this.radius===0?(this.theta=0,this.phi=0):(this.theta=Math.atan2(e,i),this.phi=Math.acos(Tt(t/this.radius,-1,1))),this}clone(){return new this.constructor().copy(this)}}typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("register",{detail:{revision:xs}}));typeof window<"u"&&(window.__THREE__?console.warn("WARNING: Multiple instances of Three.js being imported."):window.__THREE__=xs);const no={type:"change"},ss={type:"start"},io={type:"end"},fr=new ys,ro=new En,yp=Math.cos(70*uc.DEG2RAD);class Tp extends Yn{constructor(e,t){super(),this.object=e,this.domElement=t,this.domElement.style.touchAction="none",this.enabled=!0,this.target=new z,this.cursor=new z,this.minDistance=0,this.maxDistance=1/0,this.minZoom=0,this.maxZoom=1/0,this.minTargetRadius=0,this.maxTargetRadius=1/0,this.minPolarAngle=0,this.maxPolarAngle=Math.PI,this.minAzimuthAngle=-1/0,this.maxAzimuthAngle=1/0,this.enableDamping=!1,this.dampingFactor=.05,this.enableZoom=!0,this.zoomSpeed=1,this.enableRotate=!0,this.rotateSpeed=1,this.enablePan=!0,this.panSpeed=1,this.screenSpacePanning=!0,this.keyPanSpeed=7,this.zoomToCursor=!1,this.autoRotate=!1,this.autoRotateSpeed=2,this.keys={LEFT:"ArrowLeft",UP:"ArrowUp",RIGHT:"ArrowRight",BOTTOM:"ArrowDown"},this.mouseButtons={LEFT:Kn.ROTATE,MIDDLE:Kn.DOLLY,RIGHT:Kn.PAN},this.touches={ONE:Zn.ROTATE,TWO:Zn.DOLLY_PAN},this.target0=this.target.clone(),this.position0=this.object.position.clone(),this.zoom0=this.object.zoom,this._domElementKeyEvents=null,this.getPolarAngle=function(){return a.phi},this.getAzimuthalAngle=function(){return a.theta},this.getDistance=function(){return this.object.position.distanceTo(this.target)},this.listenToKeyEvents=function(C){C.addEventListener("keydown",_),this._domElementKeyEvents=C},this.stopListenToKeyEvents=function(){this._domElementKeyEvents.removeEventListener("keydown",_),this._domElementKeyEvents=null},this.saveState=function(){i.target0.copy(i.target),i.position0.copy(i.object.position),i.zoom0=i.object.zoom},this.reset=function(){i.target.copy(i.target0),i.object.position.copy(i.position0),i.object.zoom=i.zoom0,i.object.updateProjectionMatrix(),i.dispatchEvent(no),i.update(),s=r.NONE},this.update=function(){const C=new z,re=new Xn().setFromUnitVectors(e.up,new z(0,1,0)),$=re.clone().invert(),Ue=new z,Ce=new Xn,we=new z,Se=2*Math.PI;return function(ze=null){const L=i.object.position;C.copy(L).sub(i.target),C.applyQuaternion(re),a.setFromVector3(C),i.autoRotate&&s===r.NONE&&X(M(ze)),i.enableDamping?(a.theta+=l.theta*i.dampingFactor,a.phi+=l.phi*i.dampingFactor):(a.theta+=l.theta,a.phi+=l.phi);let me=i.minAzimuthAngle,se=i.maxAzimuthAngle;isFinite(me)&&isFinite(se)&&(me<-Math.PI?me+=Se:me>Math.PI&&(me-=Se),se<-Math.PI?se+=Se:se>Math.PI&&(se-=Se),me<=se?a.theta=Math.max(me,Math.min(se,a.theta)):a.theta=a.theta>(me+se)/2?Math.max(me,a.theta):Math.min(se,a.theta)),a.phi=Math.max(i.minPolarAngle,Math.min(i.maxPolarAngle,a.phi)),a.makeSafe(),i.enableDamping===!0?i.target.addScaledVector(h,i.dampingFactor):i.target.add(h),i.target.sub(i.cursor),i.target.clampLength(i.minTargetRadius,i.maxTargetRadius),i.target.add(i.cursor),i.zoomToCursor&&R||i.object.isOrthographicCamera?a.radius=j(a.radius):a.radius=j(a.radius*c),C.setFromSpherical(a),C.applyQuaternion($),L.copy(i.target).add(C),i.object.lookAt(i.target),i.enableDamping===!0?(l.theta*=1-i.dampingFactor,l.phi*=1-i.dampingFactor,h.multiplyScalar(1-i.dampingFactor)):(l.set(0,0,0),h.set(0,0,0));let K=!1;if(i.zoomToCursor&&R){let ce=null;if(i.object.isPerspectiveCamera){const Pe=C.length();ce=j(Pe*c);const Fe=Pe-ce;i.object.position.addScaledVector(w,Fe),i.object.updateMatrixWorld()}else if(i.object.isOrthographicCamera){const Pe=new z(b.x,b.y,0);Pe.unproject(i.object),i.object.zoom=Math.max(i.minZoom,Math.min(i.maxZoom,i.object.zoom/c)),i.object.updateProjectionMatrix(),K=!0;const Fe=new z(b.x,b.y,0);Fe.unproject(i.object),i.object.position.sub(Fe).add(Pe),i.object.updateMatrixWorld(),ce=C.length()}else console.warn("WARNING: OrbitControls.js encountered an unknown camera type - zoom to cursor disabled."),i.zoomToCursor=!1;ce!==null&&(this.screenSpacePanning?i.target.set(0,0,-1).transformDirection(i.object.matrix).multiplyScalar(ce).add(i.object.position):(fr.origin.copy(i.object.position),fr.direction.set(0,0,-1).transformDirection(i.object.matrix),Math.abs(i.object.up.dot(fr.direction))<yp?e.lookAt(i.target):(ro.setFromNormalAndCoplanarPoint(i.object.up,i.target),fr.intersectPlane(ro,i.target))))}else i.object.isOrthographicCamera&&(i.object.zoom=Math.max(i.minZoom,Math.min(i.maxZoom,i.object.zoom/c)),i.object.updateProjectionMatrix(),K=!0);return c=1,R=!1,K||Ue.distanceToSquared(i.object.position)>o||8*(1-Ce.dot(i.object.quaternion))>o||we.distanceToSquared(i.target)>0?(i.dispatchEvent(no),Ue.copy(i.object.position),Ce.copy(i.object.quaternion),we.copy(i.target),K=!1,!0):!1}}(),this.dispose=function(){i.domElement.removeEventListener("contextmenu",ee),i.domElement.removeEventListener("pointerdown",Me),i.domElement.removeEventListener("pointercancel",Le),i.domElement.removeEventListener("wheel",E),i.domElement.removeEventListener("pointermove",Ee),i.domElement.removeEventListener("pointerup",Le),i._domElementKeyEvents!==null&&(i._domElementKeyEvents.removeEventListener("keydown",_),i._domElementKeyEvents=null)};const i=this,r={NONE:-1,ROTATE:0,DOLLY:1,PAN:2,TOUCH_ROTATE:3,TOUCH_PAN:4,TOUCH_DOLLY_PAN:5,TOUCH_DOLLY_ROTATE:6};let s=r.NONE;const o=1e-6,a=new to,l=new to;let c=1;const h=new z,d=new Xe,f=new Xe,m=new Xe,v=new Xe,x=new Xe,p=new Xe,u=new Xe,y=new Xe,g=new Xe,w=new z,b=new Xe;let R=!1;const A=[],B={};function M(C){return C!==null?2*Math.PI/60*i.autoRotateSpeed*C:2*Math.PI/60/60*i.autoRotateSpeed}function T(){return Math.pow(.95,i.zoomSpeed)}function X(C){l.theta-=C}function Z(C){l.phi-=C}const ne=function(){const C=new z;return function($,Ue){C.setFromMatrixColumn(Ue,0),C.multiplyScalar(-$),h.add(C)}}(),P=function(){const C=new z;return function($,Ue){i.screenSpacePanning===!0?C.setFromMatrixColumn(Ue,1):(C.setFromMatrixColumn(Ue,0),C.crossVectors(i.object.up,C)),C.multiplyScalar($),h.add(C)}}(),H=function(){const C=new z;return function($,Ue){const Ce=i.domElement;if(i.object.isPerspectiveCamera){const we=i.object.position;C.copy(we).sub(i.target);let Se=C.length();Se*=Math.tan(i.object.fov/2*Math.PI/180),ne(2*$*Se/Ce.clientHeight,i.object.matrix),P(2*Ue*Se/Ce.clientHeight,i.object.matrix)}else i.object.isOrthographicCamera?(ne($*(i.object.right-i.object.left)/i.object.zoom/Ce.clientWidth,i.object.matrix),P(Ue*(i.object.top-i.object.bottom)/i.object.zoom/Ce.clientHeight,i.object.matrix)):(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - pan disabled."),i.enablePan=!1)}}();function q(C){i.object.isPerspectiveCamera||i.object.isOrthographicCamera?c/=C:(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled."),i.enableZoom=!1)}function Y(C){i.object.isPerspectiveCamera||i.object.isOrthographicCamera?c*=C:(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled."),i.enableZoom=!1)}function te(C){if(!i.zoomToCursor)return;R=!0;const re=i.domElement.getBoundingClientRect(),$=C.clientX-re.left,Ue=C.clientY-re.top,Ce=re.width,we=re.height;b.x=$/Ce*2-1,b.y=-(Ue/we)*2+1,w.set(b.x,b.y,1).unproject(i.object).sub(i.object.position).normalize()}function j(C){return Math.max(i.minDistance,Math.min(i.maxDistance,C))}function Q(C){d.set(C.clientX,C.clientY)}function D(C){te(C),u.set(C.clientX,C.clientY)}function F(C){v.set(C.clientX,C.clientY)}function pe(C){f.set(C.clientX,C.clientY),m.subVectors(f,d).multiplyScalar(i.rotateSpeed);const re=i.domElement;X(2*Math.PI*m.x/re.clientHeight),Z(2*Math.PI*m.y/re.clientHeight),d.copy(f),i.update()}function fe(C){y.set(C.clientX,C.clientY),g.subVectors(y,u),g.y>0?q(T()):g.y<0&&Y(T()),u.copy(y),i.update()}function I(C){x.set(C.clientX,C.clientY),p.subVectors(x,v).multiplyScalar(i.panSpeed),H(p.x,p.y),v.copy(x),i.update()}function k(C){te(C),C.deltaY<0?Y(T()):C.deltaY>0&&q(T()),i.update()}function ae(C){let re=!1;switch(C.code){case i.keys.UP:C.ctrlKey||C.metaKey||C.shiftKey?Z(2*Math.PI*i.rotateSpeed/i.domElement.clientHeight):H(0,i.keyPanSpeed),re=!0;break;case i.keys.BOTTOM:C.ctrlKey||C.metaKey||C.shiftKey?Z(-2*Math.PI*i.rotateSpeed/i.domElement.clientHeight):H(0,-i.keyPanSpeed),re=!0;break;case i.keys.LEFT:C.ctrlKey||C.metaKey||C.shiftKey?X(2*Math.PI*i.rotateSpeed/i.domElement.clientHeight):H(i.keyPanSpeed,0),re=!0;break;case i.keys.RIGHT:C.ctrlKey||C.metaKey||C.shiftKey?X(-2*Math.PI*i.rotateSpeed/i.domElement.clientHeight):H(-i.keyPanSpeed,0),re=!0;break}re&&(C.preventDefault(),i.update())}function J(){if(A.length===1)d.set(A[0].pageX,A[0].pageY);else{const C=.5*(A[0].pageX+A[1].pageX),re=.5*(A[0].pageY+A[1].pageY);d.set(C,re)}}function he(){if(A.length===1)v.set(A[0].pageX,A[0].pageY);else{const C=.5*(A[0].pageX+A[1].pageX),re=.5*(A[0].pageY+A[1].pageY);v.set(C,re)}}function ve(){const C=A[0].pageX-A[1].pageX,re=A[0].pageY-A[1].pageY,$=Math.sqrt(C*C+re*re);u.set(0,$)}function _e(){i.enableZoom&&ve(),i.enablePan&&he()}function U(){i.enableZoom&&ve(),i.enableRotate&&J()}function ke(C){if(A.length==1)f.set(C.pageX,C.pageY);else{const $=ge(C),Ue=.5*(C.pageX+$.x),Ce=.5*(C.pageY+$.y);f.set(Ue,Ce)}m.subVectors(f,d).multiplyScalar(i.rotateSpeed);const re=i.domElement;X(2*Math.PI*m.x/re.clientHeight),Z(2*Math.PI*m.y/re.clientHeight),d.copy(f)}function ue(C){if(A.length===1)x.set(C.pageX,C.pageY);else{const re=ge(C),$=.5*(C.pageX+re.x),Ue=.5*(C.pageY+re.y);x.set($,Ue)}p.subVectors(x,v).multiplyScalar(i.panSpeed),H(p.x,p.y),v.copy(x)}function xe(C){const re=ge(C),$=C.pageX-re.x,Ue=C.pageY-re.y,Ce=Math.sqrt($*$+Ue*Ue);y.set(0,Ce),g.set(0,Math.pow(y.y/u.y,i.zoomSpeed)),q(g.y),u.copy(y)}function Ae(C){i.enableZoom&&xe(C),i.enablePan&&ue(C)}function De(C){i.enableZoom&&xe(C),i.enableRotate&&ke(C)}function Me(C){i.enabled!==!1&&(A.length===0&&(i.domElement.setPointerCapture(C.pointerId),i.domElement.addEventListener("pointermove",Ee),i.domElement.addEventListener("pointerup",Le)),oe(C),C.pointerType==="touch"?N(C):Ie(C))}function Ee(C){i.enabled!==!1&&(C.pointerType==="touch"?ie(C):Ve(C))}function Le(C){Te(C),A.length===0&&(i.domElement.releasePointerCapture(C.pointerId),i.domElement.removeEventListener("pointermove",Ee),i.domElement.removeEventListener("pointerup",Le)),i.dispatchEvent(io),s=r.NONE}function Ie(C){let re;switch(C.button){case 0:re=i.mouseButtons.LEFT;break;case 1:re=i.mouseButtons.MIDDLE;break;case 2:re=i.mouseButtons.RIGHT;break;default:re=-1}switch(re){case Kn.DOLLY:if(i.enableZoom===!1)return;D(C),s=r.DOLLY;break;case Kn.ROTATE:if(C.ctrlKey||C.metaKey||C.shiftKey){if(i.enablePan===!1)return;F(C),s=r.PAN}else{if(i.enableRotate===!1)return;Q(C),s=r.ROTATE}break;case Kn.PAN:if(C.ctrlKey||C.metaKey||C.shiftKey){if(i.enableRotate===!1)return;Q(C),s=r.ROTATE}else{if(i.enablePan===!1)return;F(C),s=r.PAN}break;default:s=r.NONE}s!==r.NONE&&i.dispatchEvent(ss)}function Ve(C){switch(s){case r.ROTATE:if(i.enableRotate===!1)return;pe(C);break;case r.DOLLY:if(i.enableZoom===!1)return;fe(C);break;case r.PAN:if(i.enablePan===!1)return;I(C);break}}function E(C){i.enabled===!1||i.enableZoom===!1||s!==r.NONE||(C.preventDefault(),i.dispatchEvent(ss),k(C),i.dispatchEvent(io))}function _(C){i.enabled===!1||i.enablePan===!1||ae(C)}function N(C){switch(le(C),A.length){case 1:switch(i.touches.ONE){case Zn.ROTATE:if(i.enableRotate===!1)return;J(),s=r.TOUCH_ROTATE;break;case Zn.PAN:if(i.enablePan===!1)return;he(),s=r.TOUCH_PAN;break;default:s=r.NONE}break;case 2:switch(i.touches.TWO){case Zn.DOLLY_PAN:if(i.enableZoom===!1&&i.enablePan===!1)return;_e(),s=r.TOUCH_DOLLY_PAN;break;case Zn.DOLLY_ROTATE:if(i.enableZoom===!1&&i.enableRotate===!1)return;U(),s=r.TOUCH_DOLLY_ROTATE;break;default:s=r.NONE}break;default:s=r.NONE}s!==r.NONE&&i.dispatchEvent(ss)}function ie(C){switch(le(C),s){case r.TOUCH_ROTATE:if(i.enableRotate===!1)return;ke(C),i.update();break;case r.TOUCH_PAN:if(i.enablePan===!1)return;ue(C),i.update();break;case r.TOUCH_DOLLY_PAN:if(i.enableZoom===!1&&i.enablePan===!1)return;Ae(C),i.update();break;case r.TOUCH_DOLLY_ROTATE:if(i.enableZoom===!1&&i.enableRotate===!1)return;De(C),i.update();break;default:s=r.NONE}}function ee(C){i.enabled!==!1&&C.preventDefault()}function oe(C){A.push(C)}function Te(C){delete B[C.pointerId];for(let re=0;re<A.length;re++)if(A[re].pointerId==C.pointerId){A.splice(re,1);return}}function le(C){let re=B[C.pointerId];re===void 0&&(re=new Xe,B[C.pointerId]=re),re.set(C.pageX,C.pageY)}function ge(C){const re=C.pointerId===A[0].pointerId?A[1]:A[0];return B[re.pointerId]}i.domElement.addEventListener("contextmenu",ee),i.domElement.addEventListener("pointerdown",Me),i.domElement.addEventListener("pointercancel",Le),i.domElement.addEventListener("wheel",E,{passive:!1}),this.update()}}/*!
 * satellite-js v5.0.0
 * (c) 2013 Shashwat Kandadai and UCSC
 * https://github.com/shashwatak/satellite-js
 * License: MIT
 */var bt=Math.PI,at=bt*2,Pi=bt/180,bp=180/bt,Ap=1440,wp=398600.8,Ft=6378.135,pn=60/Math.sqrt(Ft*Ft*Ft/wp),as=Ft*pn/60,Rp=1/pn,Bn=.001082616,Cp=-253881e-11,Lp=-165597e-11,Hn=Cp/Bn,zi=2/3;function Pp(n,e){for(var t=[31,n%4===0?29:28,31,30,31,30,31,31,30,31,30,31],i=Math.floor(e),r=1,s=0;i>s+t[r-1]&&r<12;)s+=t[r-1],r+=1;var o=r,a=i-s,l=(e-i)*24,c=Math.floor(l);l=(l-c)*60;var h=Math.floor(l),d=(l-h)*60;return{mon:o,day:a,hr:c,minute:h,sec:d}}function so(n,e,t,i,r,s){var o=arguments.length>6&&arguments[6]!==void 0?arguments[6]:0;return 367*n-Math.floor(7*(n+Math.floor((e+9)/12))*.25)+Math.floor(275*e/9)+t+17210135e-1+((o/6e4+s/60+r)/60+i)/24}function Cs(n,e,t,i,r,s,o){if(n instanceof Date){var a=n;return so(a.getUTCFullYear(),a.getUTCMonth()+1,a.getUTCDate(),a.getUTCHours(),a.getUTCMinutes(),a.getUTCSeconds(),a.getUTCMilliseconds())}return so(n,e,t,i,r,s,o)}function Vo(n,e){var t=n.e3,i=n.ee2,r=n.peo,s=n.pgho,o=n.pho,a=n.pinco,l=n.plo,c=n.se2,h=n.se3,d=n.sgh2,f=n.sgh3,m=n.sgh4,v=n.sh2,x=n.sh3,p=n.si2,u=n.si3,y=n.sl2,g=n.sl3,w=n.sl4,b=n.t,R=n.xgh2,A=n.xgh3,B=n.xgh4,M=n.xh2,T=n.xh3,X=n.xi2,Z=n.xi3,ne=n.xl2,P=n.xl3,H=n.xl4,q=n.zmol,Y=n.zmos,te=e.init,j=e.opsmode,Q=e.ep,D=e.inclp,F=e.nodep,pe=e.argpp,fe=e.mp,I,k,ae,J,he,ve,_e,U,ke,ue,xe,Ae,De,Me,Ee,Le,Ie,Ve,E,_,N,ie=119459e-10,ee=.01675,oe=.00015835218,Te=.0549;N=Y+ie*b,te==="y"&&(N=Y),_=N+2*ee*Math.sin(N),Ie=Math.sin(_),ue=.5*Ie*Ie-.25,xe=-.5*Ie*Math.cos(_);var le=c*ue+h*xe,ge=p*ue+u*xe,C=y*ue+g*xe+w*Ie,re=d*ue+f*xe+m*Ie,$=v*ue+x*xe;N=q+oe*b,te==="y"&&(N=q),_=N+2*Te*Math.sin(N),Ie=Math.sin(_),ue=.5*Ie*Ie-.25,xe=-.5*Ie*Math.cos(_);var Ue=i*ue+t*xe,Ce=X*ue+Z*xe,we=ne*ue+P*xe+H*Ie,Se=R*ue+A*xe+B*Ie,ye=M*ue+T*xe;return Ae=le+Ue,Ee=ge+Ce,Le=C+we,De=re+Se,Me=$+ye,te==="n"&&(Ae-=r,Ee-=a,Le-=l,De-=s,Me-=o,D+=Ee,Q+=Ae,J=Math.sin(D),ae=Math.cos(D),D>=.2?(Me/=J,De-=ae*Me,pe+=De,F+=Me,fe+=Le):(ve=Math.sin(F),he=Math.cos(F),I=J*ve,k=J*he,_e=Me*he+Ee*ae*ve,U=-Me*ve+Ee*ae*he,I+=_e,k+=U,F%=at,F<0&&j==="a"&&(F+=at),Ve=fe+pe+ae*F,ke=Le+De-Ee*F*J,Ve+=ke,E=F,F=Math.atan2(I,k),F<0&&j==="a"&&(F+=at),Math.abs(E-F)>bt&&(F<E?F+=at:F-=at),fe+=Le,pe=Ve-fe-ae*F)),{ep:Q,inclp:D,nodep:F,argpp:pe,mp:fe}}function Dp(n){var e=n.epoch,t=n.ep,i=n.argpp,r=n.tc,s=n.inclp,o=n.nodep,a=n.np,l,c,h,d,f,m,v,x,p,u,y,g,w,b,R,A,B,M,T,X,Z,ne,P,H,q,Y,te,j,Q,D,F,pe,fe,I,k,ae,J,he,ve,_e,U,ke,ue,xe,Ae,De,Me,Ee,Le,Ie,Ve,E,_,N,ie,ee,oe,Te,le,ge,C,re,$,Ue=.01675,Ce=.0549,we=29864797e-13,Se=47968065e-14,ye=.39785416,ze=.91744867,L=.1945905,me=-.98088458,se=a,K=t,ce=Math.sin(o),Pe=Math.cos(o),Fe=Math.sin(i),Ze=Math.cos(i),nt=Math.sin(s),je=Math.cos(s),de=K*K,ot=1-de,St=Math.sqrt(ot),tn=0,$e=0,nn=0,Jt=0,gn=0,Bt=e+18261.5+r/1440,Dt=(4.523602-.00092422029*Bt)%at,lt=Math.sin(Dt),Ct=Math.cos(Dt),S=.91375164-.03568096*Ct,O=Math.sqrt(1-S*S),G=.089683511*lt/O,W=Math.sqrt(1-G*G),V=5.8351514+.001944368*Bt,Re=.39785416*lt/O,Ne=W*Ct+.91744867*G*lt;Re=Math.atan2(Re,Ne),Re+=V-Dt;var Oe=Math.cos(Re),Be=Math.sin(Re);X=L,Z=me,H=ze,q=ye,ne=Pe,P=ce,y=we;for(var We=1/se,He=0;He<2;)He+=1,l=X*ne+Z*H*P,h=-Z*ne+X*H*P,v=-X*P+Z*H*ne,x=Z*q,p=Z*P+X*H*ne,u=X*q,c=je*v+nt*x,d=je*p+nt*u,f=-nt*v+je*x,m=-nt*p+je*u,g=l*Ze+c*Fe,w=h*Ze+d*Fe,b=-l*Fe+c*Ze,R=-h*Fe+d*Ze,A=f*Fe,B=m*Fe,M=f*Ze,T=m*Ze,C=12*g*g-3*b*b,re=24*g*w-6*b*R,$=12*w*w-3*R*R,E=3*(l*l+c*c)+C*de,_=6*(l*h+c*d)+re*de,N=3*(h*h+d*d)+$*de,ie=-6*l*f+de*(-24*g*M-6*b*A),ee=-6*(l*m+h*f)+de*(-24*(w*M+g*T)+-6*(b*B+R*A)),oe=-6*h*m+de*(-24*w*T-6*R*B),Te=6*c*f+de*(24*g*A-6*b*M),le=6*(d*f+c*m)+de*(24*(w*A+g*B)-6*(R*M+b*T)),ge=6*d*m+de*(24*w*B-6*R*T),E=E+E+ot*C,_=_+_+ot*re,N=N+N+ot*$,Me=y*We,De=-.5*Me/St,Ee=Me*St,Ae=-15*K*Ee,Le=g*b+w*R,Ie=w*b+g*R,Ve=w*R-g*b,He===1&&(Y=Ae,te=De,j=Me,Q=Ee,D=Le,F=Ie,pe=Ve,fe=E,I=_,k=N,ae=ie,J=ee,he=oe,ve=Te,_e=le,U=ge,ke=C,ue=re,xe=$,X=Oe,Z=Be,H=S,q=O,ne=W*Pe+G*ce,P=ce*W-Pe*G,y=Se);var Ge=(4.7199672+(.2299715*Bt-V))%at,it=(6.2565837+.017201977*Bt)%at,_t=2*Y*F,et=2*Y*pe,vt=2*te*J,tt=2*te*(he-ae),qe=-2*j*I,Cn=-2*j*(k-fe),st=-2*j*(-21-9*de)*Ue,Lt=2*Q*ue,jn=2*Q*(xe-ke),rn=-18*Q*Ue,sn=-2*te*_e,ct=-2*te*(U-ve),Ut=2*Ae*Ie,Ln=2*Ae*Ve,xt=2*De*ee,Ti=2*De*(oe-ie),wr=-2*Me*_,Gi=-2*Me*(N-E),qo=-2*Me*(-21-9*de)*Ce,Yo=2*Ee*re,jo=2*Ee*($-C),Ko=-18*Ee*Ce,Zo=-2*De*le,$o=-2*De*(ge-Te);return{snodm:ce,cnodm:Pe,sinim:nt,cosim:je,sinomm:Fe,cosomm:Ze,day:Bt,e3:Ln,ee2:Ut,em:K,emsq:de,gam:V,peo:tn,pgho:Jt,pho:gn,pinco:$e,plo:nn,rtemsq:St,se2:_t,se3:et,sgh2:Lt,sgh3:jn,sgh4:rn,sh2:sn,sh3:ct,si2:vt,si3:tt,sl2:qe,sl3:Cn,sl4:st,s1:Ae,s2:De,s3:Me,s4:Ee,s5:Le,s6:Ie,s7:Ve,ss1:Y,ss2:te,ss3:j,ss4:Q,ss5:D,ss6:F,ss7:pe,sz1:fe,sz2:I,sz3:k,sz11:ae,sz12:J,sz13:he,sz21:ve,sz22:_e,sz23:U,sz31:ke,sz32:ue,sz33:xe,xgh2:Yo,xgh3:jo,xgh4:Ko,xh2:Zo,xh3:$o,xi2:xt,xi3:Ti,xl2:wr,xl3:Gi,xl4:qo,nm:se,z1:E,z2:_,z3:N,z11:ie,z12:ee,z13:oe,z21:Te,z22:le,z23:ge,z31:C,z32:re,z33:$,zmol:Ge,zmos:it}}function Up(n){var e=n.cosim,t=n.argpo,i=n.s1,r=n.s2,s=n.s3,o=n.s4,a=n.s5,l=n.sinim,c=n.ss1,h=n.ss2,d=n.ss3,f=n.ss4,m=n.ss5,v=n.sz1,x=n.sz3,p=n.sz11,u=n.sz13,y=n.sz21,g=n.sz23,w=n.sz31,b=n.sz33,R=n.t,A=n.tc,B=n.gsto,M=n.mo,T=n.mdot,X=n.no,Z=n.nodeo,ne=n.nodedot,P=n.xpidot,H=n.z1,q=n.z3,Y=n.z11,te=n.z13,j=n.z21,Q=n.z23,D=n.z31,F=n.z33,pe=n.ecco,fe=n.eccsq,I=n.emsq,k=n.em,ae=n.argpm,J=n.inclm,he=n.mm,ve=n.nm,_e=n.nodem,U=n.irez,ke=n.atime,ue=n.d2201,xe=n.d2211,Ae=n.d3210,De=n.d3222,Me=n.d4410,Ee=n.d4422,Le=n.d5220,Ie=n.d5232,Ve=n.d5421,E=n.d5433,_=n.dedt,N=n.didt,ie=n.dmdt,ee=n.dnodt,oe=n.domdt,Te=n.del1,le=n.del2,ge=n.del3,C=n.xfact,re=n.xlamo,$=n.xli,Ue=n.xni,Ce,we,Se,ye,ze,L,me,se,K,ce,Pe,Fe,Ze,nt,je,de,ot,St,tn,$e,nn,Jt,gn,Bt,Dt,lt,Ct,S,O,G,W,V,Re=17891679e-13,Ne=21460748e-13,Oe=22123015e-14,Be=17891679e-13,We=73636953e-16,He=21765803e-16,Ge=.0043752690880113,it=37393792e-14,_t=11428639e-14,et=.00015835218,vt=119459e-10;U=0,ve<.0052359877&&ve>.0034906585&&(U=1),ve>=.00826&&ve<=.00924&&k>=.5&&(U=2);var tt=c*vt*m,qe=h*vt*(p+u),Cn=-vt*d*(v+x-14-6*I),st=f*vt*(w+b-6),Lt=-vt*h*(y+g);(J<.052359877||J>bt-.052359877)&&(Lt=0),l!==0&&(Lt/=l);var jn=st-e*Lt;_=tt+i*et*a,N=qe+r*et*(Y+te),ie=Cn-et*s*(H+q-14-6*I);var rn=o*et*(D+F-6),sn=-et*r*(j+Q);(J<.052359877||J>bt-.052359877)&&(sn=0),oe=jn+rn,ee=Lt,l!==0&&(oe-=e/l*sn,ee+=sn/l);var ct=0,Ut=(B+A*Ge)%at;if(k+=_*R,J+=N*R,ae+=oe*R,_e+=ee*R,he+=ie*R,U!==0){if(G=Math.pow(ve/pn,zi),U===2){W=e*e;var Ln=k;k=pe;var xt=I;I=fe,V=k*I,nt=-.306-(k-.64)*.44,k<=.65?(je=3.616-13.247*k+16.29*I,ot=-19.302+117.39*k-228.419*I+156.591*V,St=-18.9068+109.7927*k-214.6334*I+146.5816*V,tn=-41.122+242.694*k-471.094*I+313.953*V,$e=-146.407+841.88*k-1629.014*I+1083.435*V,nn=-532.114+3017.977*k-5740.032*I+3708.276*V):(je=-72.099+331.819*k-508.738*I+266.724*V,ot=-346.844+1582.851*k-2415.925*I+1246.113*V,St=-342.585+1554.908*k-2366.899*I+1215.972*V,tn=-1052.797+4758.686*k-7193.992*I+3651.957*V,$e=-3581.69+16178.11*k-24462.77*I+12422.52*V,k>.715?nn=-5149.66+29936.92*k-54087.36*I+31324.56*V:nn=1464.74-4664.75*k+3763.64*I),k<.7?(Bt=-919.2277+4988.61*k-9064.77*I+5542.21*V,Jt=-822.71072+4568.6173*k-8491.4146*I+5337.524*V,gn=-853.666+4690.25*k-8624.77*I+5341.4*V):(Bt=-37995.78+161616.52*k-229838.2*I+109377.94*V,Jt=-51752.104+218913.95*k-309468.16*I+146349.42*V,gn=-40023.88+170470.89*k-242699.48*I+115605.82*V),Dt=l*l,Ce=.75*(1+2*e+W),we=1.5*Dt,ye=1.875*l*(1-2*e-3*W),ze=-1.875*l*(1+2*e-3*W),me=35*Dt*Ce,se=39.375*Dt*Dt,K=9.84375*l*(Dt*(1-2*e-5*W)+.33333333*(-2+4*e+6*W)),ce=l*(4.92187512*Dt*(-2-4*e+10*W)+6.56250012*(1+2*e-3*W)),Pe=29.53125*l*(2-8*e+W*(-12+8*e+10*W)),Fe=29.53125*l*(-2-8*e+W*(12+8*e-10*W)),S=ve*ve,O=G*G,Ct=3*S*O,lt=Ct*Be,ue=lt*Ce*nt,xe=lt*we*je,Ct*=G,lt=Ct*it,Ae=lt*ye*ot,De=lt*ze*St,Ct*=G,lt=2*Ct*We,Me=lt*me*tn,Ee=lt*se*$e,Ct*=G,lt=Ct*_t,Le=lt*K*nn,Ie=lt*ce*gn,lt=2*Ct*He,Ve=lt*Pe*Jt,E=lt*Fe*Bt,re=(M+Z+Z-(Ut+Ut))%at,C=T+ie+2*(ne+ee-Ge)-X,k=Ln,I=xt}U===1&&(Ze=1+I*(-2.5+.8125*I),ot=1+2*I,de=1+I*(-6+6.60937*I),Ce=.75*(1+e)*(1+e),Se=.9375*l*l*(1+3*e)-.75*(1+e),L=1+e,L*=1.875*L*L,Te=3*ve*ve*G*G,le=2*Te*Ce*Ze*Re,ge=3*Te*L*de*Oe*G,Te=Te*Se*ot*Ne*G,re=(M+Z+t-Ut)%at,C=T+P+ie+oe+ee-(X+Ge)),$=re,Ue=X,ke=0,ve=X+ct}return{em:k,argpm:ae,inclm:J,mm:he,nm:ve,nodem:_e,irez:U,atime:ke,d2201:ue,d2211:xe,d3210:Ae,d3222:De,d4410:Me,d4422:Ee,d5220:Le,d5232:Ie,d5421:Ve,d5433:E,dedt:_,didt:N,dmdt:ie,dndt:ct,dnodt:ee,domdt:oe,del1:Te,del2:le,del3:ge,xfact:C,xlamo:re,xli:$,xni:Ue}}function ao(n){var e=(n-2451545)/36525,t=-62e-7*e*e*e+.093104*e*e+(876600*3600+8640184812866e-6)*e+67310.54841;return t=t*Pi/240%at,t<0&&(t+=at),t}function _s(){return(arguments.length<=0?void 0:arguments[0])instanceof Date||arguments.length>1?ao(Cs.apply(void 0,arguments)):ao.apply(void 0,arguments)}function Ip(n){var e=n.ecco,t=n.epoch,i=n.inclo,r=n.opsmode,s=n.no,o=e*e,a=1-o,l=Math.sqrt(a),c=Math.cos(i),h=c*c,d=Math.pow(pn/s,zi),f=.75*Bn*(3*h-1)/(l*a),m=f/(d*d),v=d*(1-m*m-m*(1/3+134*m*m/81));m=f/(v*v),s/=1+m;var x=Math.pow(pn/s,zi),p=Math.sin(i),u=x*a,y=1-5*h,g=-y-h-h,w=1/x,b=u*u,R=x*(1-e),A="n",B;if(r==="a"){var M=t-7305,T=Math.floor(M+1e-8),X=M-T,Z=.017202791694070362,ne=1.7321343856509375,P=5075514194322695e-30,H=Z+at;B=(ne+Z*T+H*X+M*M*P)%at,B<0&&(B+=at)}else B=_s(t+24332815e-1);return{no:s,method:A,ainv:w,ao:x,con41:g,con42:y,cosio:c,cosio2:h,eccsq:o,omeosq:a,posq:b,rp:R,rteosq:l,sinio:p,gsto:B}}function Np(n){var e=n.irez,t=n.d2201,i=n.d2211,r=n.d3210,s=n.d3222,o=n.d4410,a=n.d4422,l=n.d5220,c=n.d5232,h=n.d5421,d=n.d5433,f=n.dedt,m=n.del1,v=n.del2,x=n.del3,p=n.didt,u=n.dmdt,y=n.dnodt,g=n.domdt,w=n.argpo,b=n.argpdot,R=n.t,A=n.tc,B=n.gsto,M=n.xfact,T=n.xlamo,X=n.no,Z=n.atime,ne=n.em,P=n.argpm,H=n.inclm,q=n.xli,Y=n.mm,te=n.xni,j=n.nodem,Q=n.nm,D=.13130908,F=2.8843198,pe=.37448087,fe=5.7686396,I=.95240898,k=1.8014998,ae=1.050833,J=4.4108898,he=.0043752690880113,ve=720,_e=-720,U=259200,ke,ue,xe,Ae,De,Me,Ee,Le,Ie=0,Ve=0,E=(B+A*he)%at;if(ne+=f*R,H+=p*R,P+=g*R,j+=y*R,Y+=u*R,e!==0){(Z===0||R*Z<=0||Math.abs(R)<Math.abs(Z))&&(Z=0,te=X,q=T),R>0?ke=ve:ke=_e;for(var _=381;_===381;)e!==2?(Ee=m*Math.sin(q-D)+v*Math.sin(2*(q-F))+x*Math.sin(3*(q-pe)),De=te+M,Me=m*Math.cos(q-D)+2*v*Math.cos(2*(q-F))+3*x*Math.cos(3*(q-pe)),Me*=De):(Le=w+b*Z,xe=Le+Le,ue=q+q,Ee=t*Math.sin(xe+q-fe)+i*Math.sin(q-fe)+r*Math.sin(Le+q-I)+s*Math.sin(-Le+q-I)+o*Math.sin(xe+ue-k)+a*Math.sin(ue-k)+l*Math.sin(Le+q-ae)+c*Math.sin(-Le+q-ae)+h*Math.sin(Le+ue-J)+d*Math.sin(-Le+ue-J),De=te+M,Me=t*Math.cos(xe+q-fe)+i*Math.cos(q-fe)+r*Math.cos(Le+q-I)+s*Math.cos(-Le+q-I)+l*Math.cos(Le+q-ae)+c*Math.cos(-Le+q-ae)+2*(o*Math.cos(xe+ue-k)+a*Math.cos(ue-k)+h*Math.cos(Le+ue-J)+d*Math.cos(-Le+ue-J)),Me*=De),Math.abs(R-Z)>=ve?_=381:(Ve=R-Z,_=0),_===381&&(q+=De*ke+Ee*U,te+=Ee*ke+Me*U,Z+=ke);Q=te+Ee*Ve+Me*Ve*Ve*.5,Ae=q+De*Ve+Ee*Ve*Ve*.5,e!==1?(Y=Ae-2*j+2*E,Ie=Q-X):(Y=Ae-j-P+E,Ie=Q-X),Q=X+Ie}return{atime:Z,em:ne,argpm:P,inclm:H,xli:q,mm:Y,xni:te,nodem:j,dndt:Ie,nm:Q}}function ko(n,e){var t,i,r,s,o,a,l,c,h,d,f,m,v,x,p,u,y,g,w,b,R,A,B,M,T,X,Z,ne=15e-13;n.t=e,n.error=0;var P=n.mo+n.mdot*n.t,H=n.argpo+n.argpdot*n.t,q=n.nodeo+n.nodedot*n.t;h=H,R=P;var Y=n.t*n.t;if(B=q+n.nodecf*Y,y=1-n.cc1*n.t,g=n.bstar*n.cc4*n.t,w=n.t2cof*Y,n.isimp!==1){l=n.omgcof*n.t;var te=1+n.eta*Math.cos(P);a=n.xmcof*(te*te*te-n.delmo),u=l+a,R=P+u,h=H-u,m=Y*n.t,v=m*n.t,y=y-n.d2*Y-n.d3*m-n.d4*v,g+=n.bstar*n.cc5*(Math.sin(R)-n.sinmao),w=w+n.t3cof*m+v*(n.t4cof+n.t*n.t5cof)}A=n.no;var j=n.ecco;if(b=n.inclo,n.method==="d"){x=n.t;var Q={irez:n.irez,d2201:n.d2201,d2211:n.d2211,d3210:n.d3210,d3222:n.d3222,d4410:n.d4410,d4422:n.d4422,d5220:n.d5220,d5232:n.d5232,d5421:n.d5421,d5433:n.d5433,dedt:n.dedt,del1:n.del1,del2:n.del2,del3:n.del3,didt:n.didt,dmdt:n.dmdt,dnodt:n.dnodt,domdt:n.domdt,argpo:n.argpo,argpdot:n.argpdot,t:n.t,tc:x,gsto:n.gsto,xfact:n.xfact,xlamo:n.xlamo,no:n.no,atime:n.atime,em:j,argpm:h,inclm:b,xli:n.xli,mm:R,xni:n.xni,nodem:B,nm:A},D=Np(Q);j=D.em,h=D.argpm,b=D.inclm,R=D.mm,B=D.nodem,A=D.nm}if(A<=0)return n.error=2,[!1,!1];var F=Math.pow(pn/A,zi)*y*y;if(A=pn/Math.pow(F,1.5),j-=g,j>=1||j<-.001)return n.error=1,[!1,!1];j<1e-6&&(j=1e-6),R+=n.no*w,T=R+h+B,B%=at,h%=at,T%=at,R=(T-h-B)%at;var pe=Math.sin(b),fe=Math.cos(b),I=j;if(M=b,d=h,Z=B,X=R,s=pe,r=fe,n.method==="d"){var k={inclo:n.inclo,init:"n",ep:I,inclp:M,nodep:Z,argpp:d,mp:X,opsmode:n.operationmode},ae=Vo(n,k);if(I=ae.ep,Z=ae.nodep,d=ae.argpp,X=ae.mp,M=ae.inclp,M<0&&(M=-M,Z+=bt,d-=bt),I<0||I>1)return n.error=3,[!1,!1]}n.method==="d"&&(s=Math.sin(M),r=Math.cos(M),n.aycof=-.5*Hn*s,Math.abs(r+1)>15e-13?n.xlcof=-.25*Hn*s*(3+5*r)/(1+r):n.xlcof=-.25*Hn*s*(3+5*r)/ne);var J=I*Math.cos(d);u=1/(F*(1-I*I));var he=I*Math.sin(d)+u*n.aycof,ve=X+d+Z+u*n.xlcof*J,_e=(ve-Z)%at;c=_e,p=9999.9;for(var U=1;Math.abs(p)>=1e-12&&U<=10;)i=Math.sin(c),t=Math.cos(c),p=1-t*J-i*he,p=(_e-he*t+J*i-c)/p,Math.abs(p)>=.95&&(p>0?p=.95:p=-.95),c+=p,U+=1;var ke=J*t+he*i,ue=J*i-he*t,xe=J*J+he*he,Ae=F*(1-xe);if(Ae<0)return n.error=4,[!1,!1];var De=F*(1-ke),Me=Math.sqrt(F)*ue/De,Ee=Math.sqrt(Ae)/De,Le=Math.sqrt(1-xe);u=ue/(1+Le);var Ie=F/De*(i-he-J*u),Ve=F/De*(t-J+he*u);f=Math.atan2(Ie,Ve);var E=(Ve+Ve)*Ie,_=1-2*Ie*Ie;u=1/Ae;var N=.5*Bn*u,ie=N*u;n.method==="d"&&(o=r*r,n.con41=3*o-1,n.x1mth2=1-o,n.x7thm1=7*o-1);var ee=De*(1-1.5*ie*Le*n.con41)+.5*N*n.x1mth2*_;if(ee<1)return n.error=6,{position:!1,velocity:!1};f-=.25*ie*n.x7thm1*E;var oe=Z+1.5*ie*r*E,Te=M+1.5*ie*r*s*_,le=Me-A*N*n.x1mth2*E/pn,ge=Ee+A*N*(n.x1mth2*_+1.5*n.con41)/pn,C=Math.sin(f),re=Math.cos(f),$=Math.sin(oe),Ue=Math.cos(oe),Ce=Math.sin(Te),we=Math.cos(Te),Se=-$*we,ye=Ue*we,ze=Se*C+Ue*re,L=ye*C+$*re,me=Ce*C,se=Se*re-Ue*C,K=ye*re-$*C,ce=Ce*re,Pe={x:ee*ze*Ft,y:ee*L*Ft,z:ee*me*Ft},Fe={x:(le*ze+ge*se)*as,y:(le*L+ge*K)*as,z:(le*me+ge*ce)*as};return{position:Pe,velocity:Fe}}function Fp(n,e){var t=e.opsmode,i=e.satn,r=e.epoch,s=e.xbstar,o=e.xecco,a=e.xargpo,l=e.xinclo,c=e.xmo,h=e.xno,d=e.xnodeo,f,m,v,x,p,u,y,g,w,b,R,A,B,M,T,X,Z,ne,P,H,q,Y,te,j,Q,D,F,pe,fe,I,k,ae,J,he,ve,_e,U,ke,ue,xe,Ae,De,Me,Ee,Le,Ie,Ve,E,_,N,ie,ee,oe,Te,le,ge,C=15e-13;n.isimp=0,n.method="n",n.aycof=0,n.con41=0,n.cc1=0,n.cc4=0,n.cc5=0,n.d2=0,n.d3=0,n.d4=0,n.delmo=0,n.eta=0,n.argpdot=0,n.omgcof=0,n.sinmao=0,n.t=0,n.t2cof=0,n.t3cof=0,n.t4cof=0,n.t5cof=0,n.x1mth2=0,n.x7thm1=0,n.mdot=0,n.nodedot=0,n.xlcof=0,n.xmcof=0,n.nodecf=0,n.irez=0,n.d2201=0,n.d2211=0,n.d3210=0,n.d3222=0,n.d4410=0,n.d4422=0,n.d5220=0,n.d5232=0,n.d5421=0,n.d5433=0,n.dedt=0,n.del1=0,n.del2=0,n.del3=0,n.didt=0,n.dmdt=0,n.dnodt=0,n.domdt=0,n.e3=0,n.ee2=0,n.peo=0,n.pgho=0,n.pho=0,n.pinco=0,n.plo=0,n.se2=0,n.se3=0,n.sgh2=0,n.sgh3=0,n.sgh4=0,n.sh2=0,n.sh3=0,n.si2=0,n.si3=0,n.sl2=0,n.sl3=0,n.sl4=0,n.gsto=0,n.xfact=0,n.xgh2=0,n.xgh3=0,n.xgh4=0,n.xh2=0,n.xh3=0,n.xi2=0,n.xi3=0,n.xl2=0,n.xl3=0,n.xl4=0,n.xlamo=0,n.zmol=0,n.zmos=0,n.atime=0,n.xli=0,n.xni=0,n.bstar=s,n.ecco=o,n.argpo=a,n.inclo=l,n.mo=c,n.no=h,n.nodeo=d,n.operationmode=t;var re=78/Ft+1,$=42/Ft,Ue=$*$*$*$;n.init="y",n.t=0;var Ce={satn:i,ecco:n.ecco,epoch:r,inclo:n.inclo,no:n.no,method:n.method,opsmode:n.operationmode},we=Ip(Ce),Se=we.ao,ye=we.con42,ze=we.cosio,L=we.cosio2,me=we.eccsq,se=we.omeosq,K=we.posq,ce=we.rp,Pe=we.rteosq,Fe=we.sinio;if(n.no=we.no,n.con41=we.con41,n.gsto=we.gsto,n.a=Math.pow(n.no*Rp,-2/3),n.alta=n.a*(1+n.ecco)-1,n.altp=n.a*(1-n.ecco)-1,n.error=0,se>=0||n.no>=0){if(n.isimp=0,ce<220/Ft+1&&(n.isimp=1),F=re,q=Ue,ne=(ce-1)*Ft,ne<156){F=ne-78,ne<98&&(F=20);var Ze=(120-F)/Ft;q=Ze*Ze*Ze*Ze,F=F/Ft+1}P=1/K,Ie=1/(Se-F),n.eta=Se*n.ecco*Ie,A=n.eta*n.eta,R=n.ecco*n.eta,H=Math.abs(1-A),u=q*Math.pow(Ie,4),y=u/Math.pow(H,3.5),x=y*n.no*(Se*(1+1.5*A+R*(4+A))+.375*Bn*Ie/H*n.con41*(8+3*A*(8+A))),n.cc1=n.bstar*x,p=0,n.ecco>1e-4&&(p=-2*u*Ie*Hn*n.no*Fe/n.ecco),n.x1mth2=1-L,n.cc4=2*n.no*y*Se*se*(n.eta*(2+.5*A)+n.ecco*(.5+2*A)-Bn*Ie/(Se*H)*(-3*n.con41*(1-2*R+A*(1.5-.5*R))+.75*n.x1mth2*(2*A-R*(1+A))*Math.cos(2*n.argpo))),n.cc5=2*y*Se*se*(1+2.75*(A+R)+R*A),g=L*L,Me=1.5*Bn*P*n.no,Ee=.5*Me*Bn*P,Le=-.46875*Lp*P*P*n.no,n.mdot=n.no+.5*Me*Pe*n.con41+.0625*Ee*Pe*(13-78*L+137*g),n.argpdot=-.5*Me*ye+.0625*Ee*(7-114*L+395*g)+Le*(3-36*L+49*g),E=-Me*ze,n.nodedot=E+(.5*Ee*(4-19*L)+2*Le*(3-7*L))*ze,Ve=n.argpdot+n.nodedot,n.omgcof=n.bstar*p*Math.cos(n.argpo),n.xmcof=0,n.ecco>1e-4&&(n.xmcof=-zi*u*n.bstar/R),n.nodecf=3.5*se*E*n.cc1,n.t2cof=1.5*n.cc1,Math.abs(ze+1)>15e-13?n.xlcof=-.25*Hn*Fe*(3+5*ze)/(1+ze):n.xlcof=-.25*Hn*Fe*(3+5*ze)/C,n.aycof=-.5*Hn*Fe;var nt=1+n.eta*Math.cos(n.mo);if(n.delmo=nt*nt*nt,n.sinmao=Math.sin(n.mo),n.x7thm1=7*L-1,2*bt/n.no>=225){n.method="d",n.isimp=1,Ae=0,T=n.inclo;var je={epoch:r,ep:n.ecco,argpp:n.argpo,tc:Ae,inclp:n.inclo,nodep:n.nodeo,np:n.no,e3:n.e3,ee2:n.ee2,peo:n.peo,pgho:n.pgho,pho:n.pho,pinco:n.pinco,plo:n.plo,se2:n.se2,se3:n.se3,sgh2:n.sgh2,sgh3:n.sgh3,sgh4:n.sgh4,sh2:n.sh2,sh3:n.sh3,si2:n.si2,si3:n.si3,sl2:n.sl2,sl3:n.sl3,sl4:n.sl4,xgh2:n.xgh2,xgh3:n.xgh3,xgh4:n.xgh4,xh2:n.xh2,xh3:n.xh3,xi2:n.xi2,xi3:n.xi3,xl2:n.xl2,xl3:n.xl3,xl4:n.xl4,zmol:n.zmol,zmos:n.zmos},de=Dp(je);n.e3=de.e3,n.ee2=de.ee2,n.peo=de.peo,n.pgho=de.pgho,n.pho=de.pho,n.pinco=de.pinco,n.plo=de.plo,n.se2=de.se2,n.se3=de.se3,n.sgh2=de.sgh2,n.sgh3=de.sgh3,n.sgh4=de.sgh4,n.sh2=de.sh2,n.sh3=de.sh3,n.si2=de.si2,n.si3=de.si3,n.sl2=de.sl2,n.sl3=de.sl3,n.sl4=de.sl4,m=de.sinim,f=de.cosim,w=de.em,b=de.emsq,Y=de.s1,te=de.s2,j=de.s3,Q=de.s4,D=de.s5,pe=de.ss1,fe=de.ss2,I=de.ss3,k=de.ss4,ae=de.ss5,J=de.sz1,he=de.sz3,ve=de.sz11,_e=de.sz13,U=de.sz21,ke=de.sz23,ue=de.sz31,xe=de.sz33,n.xgh2=de.xgh2,n.xgh3=de.xgh3,n.xgh4=de.xgh4,n.xh2=de.xh2,n.xh3=de.xh3,n.xi2=de.xi2,n.xi3=de.xi3,n.xl2=de.xl2,n.xl3=de.xl3,n.xl4=de.xl4,n.zmol=de.zmol,n.zmos=de.zmos,Z=de.nm,_=de.z1,N=de.z3,ie=de.z11,ee=de.z13,oe=de.z21,Te=de.z23,le=de.z31,ge=de.z33;var ot={inclo:T,init:n.init,ep:n.ecco,inclp:n.inclo,nodep:n.nodeo,argpp:n.argpo,mp:n.mo,opsmode:n.operationmode},St=Vo(n,ot);n.ecco=St.ep,n.inclo=St.inclp,n.nodeo=St.nodep,n.argpo=St.argpp,n.mo=St.mp,B=0,M=0,X=0;var tn={cosim:f,emsq:b,argpo:n.argpo,s1:Y,s2:te,s3:j,s4:Q,s5:D,sinim:m,ss1:pe,ss2:fe,ss3:I,ss4:k,ss5:ae,sz1:J,sz3:he,sz11:ve,sz13:_e,sz21:U,sz23:ke,sz31:ue,sz33:xe,t:n.t,tc:Ae,gsto:n.gsto,mo:n.mo,mdot:n.mdot,no:n.no,nodeo:n.nodeo,nodedot:n.nodedot,xpidot:Ve,z1:_,z3:N,z11:ie,z13:ee,z21:oe,z23:Te,z31:le,z33:ge,ecco:n.ecco,eccsq:me,em:w,argpm:B,inclm:T,mm:X,nm:Z,nodem:M,irez:n.irez,atime:n.atime,d2201:n.d2201,d2211:n.d2211,d3210:n.d3210,d3222:n.d3222,d4410:n.d4410,d4422:n.d4422,d5220:n.d5220,d5232:n.d5232,d5421:n.d5421,d5433:n.d5433,dedt:n.dedt,didt:n.didt,dmdt:n.dmdt,dnodt:n.dnodt,domdt:n.domdt,del1:n.del1,del2:n.del2,del3:n.del3,xfact:n.xfact,xlamo:n.xlamo,xli:n.xli,xni:n.xni},$e=Up(tn);n.irez=$e.irez,n.atime=$e.atime,n.d2201=$e.d2201,n.d2211=$e.d2211,n.d3210=$e.d3210,n.d3222=$e.d3222,n.d4410=$e.d4410,n.d4422=$e.d4422,n.d5220=$e.d5220,n.d5232=$e.d5232,n.d5421=$e.d5421,n.d5433=$e.d5433,n.dedt=$e.dedt,n.didt=$e.didt,n.dmdt=$e.dmdt,n.dnodt=$e.dnodt,n.domdt=$e.domdt,n.del1=$e.del1,n.del2=$e.del2,n.del3=$e.del3,n.xfact=$e.xfact,n.xlamo=$e.xlamo,n.xli=$e.xli,n.xni=$e.xni}n.isimp!==1&&(v=n.cc1*n.cc1,n.d2=4*Se*Ie*v,De=n.d2*Ie*n.cc1/3,n.d3=(17*Se+F)*De,n.d4=.5*De*Se*Ie*(221*Se+31*F)*n.cc1,n.t3cof=n.d2+2*v,n.t4cof=.25*(3*n.d3+n.cc1*(12*n.d2+10*v)),n.t5cof=.2*(3*n.d4+12*n.cc1*n.d3+6*n.d2*n.d2+15*v*(2*n.d2+v)))}ko(n,0),n.init="n"}function Op(n,e){var t="i",i=1440/(2*bt),r=0,s={};s.error=0,s.satnum=n.substring(2,7),s.epochyr=parseInt(n.substring(18,20),10),s.epochdays=parseFloat(n.substring(20,32)),s.ndot=parseFloat(n.substring(33,43)),s.nddot=parseFloat(".".concat(parseInt(n.substring(44,50),10),"E").concat(n.substring(50,52))),s.bstar=parseFloat("".concat(n.substring(53,54),".").concat(parseInt(n.substring(54,59),10),"E").concat(n.substring(59,61))),s.inclo=parseFloat(e.substring(8,16)),s.nodeo=parseFloat(e.substring(17,25)),s.ecco=parseFloat(".".concat(e.substring(26,33))),s.argpo=parseFloat(e.substring(34,42)),s.mo=parseFloat(e.substring(43,51)),s.no=parseFloat(e.substring(52,63)),s.no/=i,s.inclo*=Pi,s.nodeo*=Pi,s.argpo*=Pi,s.mo*=Pi,s.epochyr<57?r=s.epochyr+2e3:r=s.epochyr+1900;var o=Pp(r,s.epochdays),a=o.mon,l=o.day,c=o.hr,h=o.minute,d=o.sec;return s.jdsatepoch=Cs(r,a,l,c,h,d),Fp(s,{opsmode:t,satn:s.satnum,epoch:s.jdsatepoch-24332815e-1,xbstar:s.bstar,xecco:s.ecco,xargpo:s.argpo,xinclo:s.inclo,xmo:s.mo,xno:s.no,xnodeo:s.nodeo}),s}function zp(n){return Bp(n)||Hp(n)||Gp(n)||Vp()}function Bp(n){if(Array.isArray(n))return vs(n)}function Hp(n){if(typeof Symbol<"u"&&n[Symbol.iterator]!=null||n["@@iterator"]!=null)return Array.from(n)}function Gp(n,e){if(n){if(typeof n=="string")return vs(n,e);var t=Object.prototype.toString.call(n).slice(8,-1);if(t==="Object"&&n.constructor&&(t=n.constructor.name),t==="Map"||t==="Set")return Array.from(n);if(t==="Arguments"||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(t))return vs(n,e)}}function vs(n,e){(e==null||e>n.length)&&(e=n.length);for(var t=0,i=new Array(e);t<e;t++)i[t]=n[t];return i}function Vp(){throw new TypeError(`Invalid attempt to spread non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}function oo(){for(var n=arguments.length,e=new Array(n),t=0;t<n;t++)e[t]=arguments[t];var i=e[0],r=Array.prototype.slice.call(e,1),s=Cs.apply(void 0,zp(r)),o=(s-i.jdsatepoch)*Ap;return ko(i,o)}function Wo(n){return n*bp}function lo(n){if(n<-bt/2||n>bt/2)throw new RangeError("Latitude radians must be in range [-pi/2; pi/2].");return Wo(n)}function co(n){if(n<-bt||n>bt)throw new RangeError("Longitude radians must be in range [-pi; pi].");return Wo(n)}function ho(n,e){for(var t=6378.137,i=6356.7523142,r=Math.sqrt(n.x*n.x+n.y*n.y),s=(t-i)/t,o=2*s-s*s,a=Math.atan2(n.y,n.x)-e;a<-bt;)a+=at;for(;a>bt;)a-=at;for(var l=20,c=0,h=Math.atan2(n.z,Math.sqrt(n.x*n.x+n.y*n.y)),d;c<l;)d=1/Math.sqrt(1-o*(Math.sin(h)*Math.sin(h))),h=Math.atan2(n.z+t*d*o*Math.sin(h),r),c+=1;var f=r/Math.cos(h)-t*d;return{longitude:a,latitude:h,height:f}}var kp=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};function Wp(n){return n&&n.__esModule&&Object.prototype.hasOwnProperty.call(n,"default")?n.default:n}var Xo={exports:{}};(function(n,e){(function(t,i){n.exports=i()})(kp,function(){var t=function(){function i(m){return o.appendChild(m.dom),m}function r(m){for(var v=0;v<o.children.length;v++)o.children[v].style.display=v===m?"block":"none";s=m}var s=0,o=document.createElement("div");o.style.cssText="position:fixed;top:0;left:0;cursor:pointer;opacity:0.9;z-index:10000",o.addEventListener("click",function(m){m.preventDefault(),r(++s%o.children.length)},!1);var a=(performance||Date).now(),l=a,c=0,h=i(new t.Panel("FPS","#0ff","#002")),d=i(new t.Panel("MS","#0f0","#020"));if(self.performance&&self.performance.memory)var f=i(new t.Panel("MB","#f08","#201"));return r(0),{REVISION:16,dom:o,addPanel:i,showPanel:r,begin:function(){a=(performance||Date).now()},end:function(){c++;var m=(performance||Date).now();if(d.update(m-a,200),m>l+1e3&&(h.update(1e3*c/(m-l),100),l=m,c=0,f)){var v=performance.memory;f.update(v.usedJSHeapSize/1048576,v.jsHeapSizeLimit/1048576)}return m},update:function(){a=this.end()},domElement:o,setMode:r}};return t.Panel=function(i,r,s){var o=1/0,a=0,l=Math.round,c=l(window.devicePixelRatio||1),h=80*c,d=48*c,f=3*c,m=2*c,v=3*c,x=15*c,p=74*c,u=30*c,y=document.createElement("canvas");y.width=h,y.height=d,y.style.cssText="width:80px;height:48px";var g=y.getContext("2d");return g.font="bold "+9*c+"px Helvetica,Arial,sans-serif",g.textBaseline="top",g.fillStyle=s,g.fillRect(0,0,h,d),g.fillStyle=r,g.fillText(i,f,m),g.fillRect(v,x,p,u),g.fillStyle=s,g.globalAlpha=.9,g.fillRect(v,x,p,u),{dom:y,update:function(w,b){o=Math.min(o,w),a=Math.max(a,w),g.fillStyle=s,g.globalAlpha=1,g.fillRect(0,0,h,x),g.fillStyle=r,g.fillText(l(w)+" "+i+" ("+l(o)+"-"+l(a)+")",f,m),g.drawImage(y,v+c,x,p-c,u,v,x,p-c,u),g.fillRect(v+p-c,x,c,u),g.fillStyle=s,g.globalAlpha=.9,g.fillRect(v+p-c,x,c,l((1-w/b)*u))}}},t})})(Xo);var Xp=Xo.exports;const qp=Wp(Xp);function Yp(n){let e,t,i,r,s,o,a=!0,l=!1,c,h;const d=6371,f=1,m=f/d,v=5e-4,x=23.4*(Math.PI/180),p=[];let u=1,y;const g=new qp;g.showPanel(0),window.addEventListener("keydown",I=>{(I.key==="R"||I.key==="r")&&(a=!a)}),window.addEventListener("keydown",I=>{(I.key==="W"||I.key==="w")&&(l=!l,s.traverse(function(k){k.isMesh&&(k.material.wireframe=l,k.material.needsUpdate=!0)}))});function w(){e=new _p,t=new Vt(5,window.innerWidth/window.innerHeight,.1,1e3),t.position.set(0,0,800),t.rotation.x=-x,t.position.z=66,i=new Go({alpha:!0}),i.setSize(window.innerWidth,window.innerHeight),i.setClearColor(12632256,0),i.shadowMap.enabled=!0,i.shadowMap.type=fo,document.getElementById(n).appendChild(i.domElement),r=new Tp(t,i.domElement),r.enableDamping=!0,r.enableZoom=!0,r.enablePan=!1,r.dampingFactor=.25,r.zoomSpeed=.666,r.rotateSpeed=.25,r.minDistance=10,r.maxDistance=100,b(),s=new Li,s.rotation.z=x,e.add(s),R(),T("Mercury",12500670,2439.7),T("Venus",16768324,6051.8),T("Earth",2254591,6371),T("Mars",16729122,3389.5),T("Jupiter",14540202,69911),T("Saturn",15654331,58232),T("Uranus",11206655,25362),T("Neptune",4482815,24622),q(),X(),Y(),pe(),window.addEventListener("resize",fe,!1),H()}function b(){const I=new Ep(4210752,1);e.add(I),c=new Sp(9079434,100),c.position.set(10,0,0),c.castShadow=!0,e.add(c);const ae=new vp(16777147,526368,.5);e.add(ae);const J=f*109/1e3,he=new zn(J,64,64),ve=new Ts({color:16777147,emissive:16753920,opacity:.8,alphaHash:!0});new Ot(he,ve).position.copy(c.position)}function R(){const I=f*.273,k=new dr({color:16777215,roughness:1,metalness:0,opacity:.5,alphaHash:!0}),ae=new zn(I,32,32);y=new Ot(ae,k),s.add(y)}function A(I){if(!y)return;const k=27.32,J=384400*m,he=2*Math.PI*I/(k*24*3600*1e3),ve=.0549,_e=J*(Math.cos(he)-ve),U=J*Math.sin(he)*Math.sqrt(1-ve**2);y.position.set(_e,0,U)}const B=.05;function M(I,k){const ae={Mercury:{a:5791e4*B,e:.205,i:7,T:.24},Venus:{a:1082e5*B,e:.007,i:3.4,T:.62},Earth:{a:1496e5*B,e:.017,i:0,T:1},Mars:{a:2279e5*B,e:.093,i:1.85,T:1.88},Jupiter:{a:7785e5*B,e:.049,i:1.3,T:11.86},Saturn:{a:1429e6*B,e:.056,i:2.49,T:29.46},Uranus:{a:2871e6*B,e:.046,i:.77,T:84.01},Neptune:{a:4495e6*B,e:.009,i:1.77,T:164.8}},{a:J,e:he,i:ve,T:_e}=ae[I],U=2*Math.PI*k/_e,ke=J*(Math.cos(U)-he)*m*u,ue=J*Math.sin(U)*Math.sqrt(1-he**2)*m*u,xe=Math.cos(ve*(Math.PI/180)),Ae=Math.sin(ve*(Math.PI/180)),De=0*xe-ue*Ae,Me=0*Ae+ue*xe,Ee=c.position;return new z(ke+Ee.x,De+Ee.y,Me+Ee.z)}function T(I,k,ae){const J=f*(ae/d)*m,he=new zn(J,32,32),ve=new dr({color:k}),_e=new Ot(he,ve);e.add(_e),p.push({name:I,mesh:_e})}function X(){fetch("https://orbital-bbfd.onrender.com/satellites").then(I=>{if(!I.ok)throw new Error("Server fetch failed");return I.json()}).then(I=>{ne(I)}).catch(I=>{console.warn("Error fetching TLE data from server:",I),console.log("Attempting to load data from local static file..."),fetch("data/cachedSatellites.json").then(k=>{if(!k.ok)throw new Error("Local file fetch failed");return k.json()}).then(k=>{console.log("Loaded TLE data from local static file."),ne(k)}).catch(k=>{console.error("Failed to load TLE data from both server and local file:",k)})})}let Z=[];function ne(I){Z.length===0?I.forEach(k=>{const ae=Op(k.tleLine1,k.tleLine2),J=new Date,he=oo(ae,J),ve=_s(J),_e=ho(he.position,ve),U=lo(_e.latitude),ke=co(_e.longitude);let ue=_e.height*m*u;const xe=F(U,ke,f+ue),Ae=new zn(.004,1,1),De=new dr({color:16711680,wireframe:!0,opacity:.75,alphaHash:!0,depthTest:!0,metalness:1}),Me=new Ot(Ae,De);Me.position.copy(xe),Me.userData.isSatellite=!0,s.add(Me),Z.push({mesh:Me,satrec:ae})}):P()}function P(){const I=new Date,k=_s(I);Z.forEach(({mesh:ae,satrec:J})=>{const he=oo(J,I),ve=ho(he.position,k),_e=lo(ve.latitude),U=co(ve.longitude);let ke=ve.height*m*u;const ue=F(_e,U,f+ke);ae.position.copy(ue)})}function H(I){g.begin(),o=requestAnimationFrame(H),p.forEach(({name:k,mesh:ae})=>{const J=M(k,I/1e3);ae.position.copy(J)}),a&&(s.rotation.y+=v),r.update(),A(I),i.render(e,t),g.end()}function q(){const I=new zn(f,64,64),k=new dr({color:0,opacity:.95,roughness:2,metalness:.5,emissive:0,transparent:!0,alphaHash:!0,wireframe:l});h=new Ot(I,k),h.castShadow=!0,h.receiveShadow=!0,s.add(h)}return w(),{dispose(){window.removeEventListener("resize",fe),cancelAnimationFrame(o);const I=document.getElementById(n);I&&i.domElement&&I.removeChild(i.domElement)}};async function Y(){console.log("Attempting to load data...");const I=["data/ne_110m_coastline.geojson","data/ne_110m_graticules_10.geojson","data/ne_110m_land.geojson","data/ne_110m_ocean.geojson"];try{const k=I.map(ae=>fetch(ae).then(J=>{if(!J.ok)throw new Error(`Network response was not ok for ${ae}`);return J.json()}).then(J=>(te(ae,J),"loaded")).catch(J=>{throw console.error(`Error loading ${ae}:`,J),J}));await Promise.all(k),console.log("All GeoJSON data loaded successfully.")}catch(k){console.error("Failed to load some GeoJSON data:",k)}}function te(I,k){switch(I){case"data/ne_110m_graticules_10.geojson":console.log("Loaded graticules:",k),Q(k);break;case"data/ne_110m_coastline.geojson":console.log("loaded coastlines:",k),j(k);break;case"data/ne_110m_land.geojson":console.log("loaded land:",k);break;case"data/ne_110m_ocean.geojson":console.log("loaded land:",k);break;default:console.warn("Unrecognized GeoJSON URL:",I);break}}function j(I){const k=new gs({color:16777215,opacity:.75,alphaHash:!0}),ae=1;I.features.forEach(J=>{const he=J.geometry.coordinates;if(J.geometry.type==="LineString"){const ve=D(he,ae),_e=new ur(ve,k);s.add(_e)}else J.geometry.type==="MultiLineString"&&he.forEach(ve=>{const _e=D(ve,ae),U=new ur(_e,k);s.add(U)})})}function Q(I){const k=new gs({color:11184810,opacity:.35,alphaHash:!0,linewidth:1}),ae=f;I.features.forEach(J=>{const he=J.geometry.coordinates;if(J.geometry.type==="LineString"){const ve=D(he,ae),_e=new ur(ve,k);s.add(_e)}else J.geometry.type==="MultiLineString"&&he.forEach(ve=>{const _e=D(ve,ae),U=new ur(_e,k);s.add(U)})})}function D(I,k){const ae=new en,J=[];I.forEach(([ve,_e])=>{const U=F(_e,ve,k);J.push(U.x,U.y,U.z)});const he=new Float32Array(J);return ae.setAttribute("position",new Zt(he,3)),ae}function F(I,k,ae){const J=(90-I)*(Math.PI/180),he=(k+180)*(Math.PI/180),ve=-ae*Math.sin(J)*Math.cos(he),_e=ae*Math.sin(J)*Math.sin(he),U=ae*Math.cos(J);return new z(ve,U,_e)}function pe(){const I=document.getElementById("compression-slider"),k=document.getElementById("compression-value");k.textContent=u,I.addEventListener("change",ae=>{u=parseFloat(ae.target.value),k.textContent=u.toFixed(3),P()})}function fe(){t.aspect=window.innerWidth/window.innerHeight,t.updateProjectionMatrix(),i.setSize(window.innerWidth,window.innerHeight)}}const jp="threeContainer1";Yp(jp);
