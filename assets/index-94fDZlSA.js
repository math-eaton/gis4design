...
`)+`
`+u);const g=y+p+o,w=y+u+a,b=Ga(r,r.VERTEX_SHADER,g),R=Ga(r,r.FRAGMENT_SHADER,w);r.attachShader(x,b),r.attachShader(x,R),t.index0AttributeName!==void 0?r.bindAttribLocation(x,0,t.index0AttributeName):t.morphTargets===!0&&r.bindAttribLocation(x,0,"position"),r.linkProgram(x);function A(k){if(n.debug.checkShaderErrors){const q=r.getProgramInfoLog(x).trim(),ne=r.getShaderInfoLog(b).trim(),D=r.getShaderInfoLog(R).trim();let z=!0,W=!0;if(r.getProgramParameter(x,r.LINK_STATUS)===!1)if(z=!1,typeof n.debug.onShaderError=="function")n.debug.onShaderError(r,x,b,R);else{const X=Va(r,b,"vertex"),ee=Va(r,R,"fragment");console.error("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(x,r.VALIDATE_STATUS)+`

Program Info Log: `+q+`
`+X+`
`+ee)}else q!==""?console.warn("THREE.WebGLProgram: Program Info Log:",q):(ne===""||D==="")&&(W=!1);W&&(k.diagnostics={runnable:z,programLog:q,vertexShader:{log:ne,prefix:p},fragmentShader:{log:D,prefix:u}})}r.deleteShader(b),r.deleteShader(R),G=new pr(r,x),M=Pf(r,x)}let G;this.getUniforms=function(){return G===void 0&&A(this),G};let M;this.getAttributes=function(){return M===void 0&&A(this),M};let T=t.rendererExtensionParallelShaderCompile===!1;return this.isReady=function(){return T===!1&&(T=r.getProgramParameter(x,yf)),T},this.destroy=function(){i.releaseStatesOfProgram(this),r.deleteProgram(x),this.program=void 0},this.type=t.shaderType,this.name=t.shaderName,this.id=Tf++,this.cacheKey=e,this.usedTimes=1,this.program=x,this.vertexShader=b,this.fragmentShader=R,this}let kf=0;class Wf{constructor(){this.shaderCache=new Map,this.materialCache=new Map}update(e){const t=e.vertexShader,i=e.fragmentShader,r=this._getShaderStage(t),s=this._getShaderStage(i),o=this._getShaderCacheForMaterial(e);return o.has(r)===!1&&(o.add(r),r.usedTimes++),o.has(s)===!1&&(o.add(s),s.usedTimes++),this}remove(e){const t=this.materialCache.get(e);for(const i of t)i.usedTimes--,i.usedTimes===0&&this.shaderCache.delete(i.code);return this.materialCache.delete(e),this}getVertexShaderID(e){return this._getShaderStage(e.vertexShader).id}getFragmentShaderID(e){return this._getShaderStage(e.fragmentShader).id}dispose(){this.shaderCache.clear(),this.materialCache.clear()}_getShaderCacheForMaterial(e){const t=this.materialCache;let i=t.get(e);return i===void 0&&(i=new Set,t.set(e,i)),i}_getShaderStage(e){const t=this.shaderCache;let i=t.get(e);return i===void 0&&(i=new Xf(e),t.set(e,i)),i}}class Xf{constructor(e){this.id=kf++,this.code=e,this.usedTimes=0}}function qf(n,e,t,i,r,s,o){const a=new Ro,l=new Wf,c=[],h=r.isWebGL2,d=r.logarithmicDepthBuffer,f=r.vertexTextures;let m=r.precision;const _={MeshDepthMaterial:"depth",MeshDistanceMaterial:"distanceRGBA",MeshNormalMaterial:"normal",MeshBasicMaterial:"basic",MeshLambertMaterial:"lambert",MeshPhongMaterial:"phong",MeshToonMaterial:"toon",MeshStandardMaterial:"physical",MeshPhysicalMaterial:"physical",MeshMatcapMaterial:"matcap",LineBasicMaterial:"basic",LineDashedMaterial:"dashed",PointsMaterial:"points",ShadowMaterial:"shadow",SpriteMaterial:"sprite"};function x(M){return M===0?"uv":`uv${M}`}function p(M,T,k,q,ne){const D=q.fog,z=ne.geometry,W=M.isMeshStandardMaterial?q.environment:null,X=(M.isMeshStandardMaterial?t:e).get(M.envMap||W),ee=X&&X.mapping===Er?X.image.height:null,Y=_[M.type];M.precision!==null&&(m=r.getMaxPrecision(M.precision),m!==M.precision&&console.warn("THREE.WebGLProgram.getParameters:",M.precision,"not supported, using",m,"instead."));const J=z.morphAttributes.position||z.morphAttributes.normal||z.morphAttributes.color,U=J!==void 0?J.length:0;let F=0;z.morphAttributes.position!==void 0&&(F=1),z.morphAttributes.normal!==void 0&&(F=2),z.morphAttributes.color!==void 0&&(F=3);let ge,pe,$,de;if(Y){const Ze=Qt[Y];ge=Ze.vertexShader,pe=Ze.fragmentShader}else ge=M.vertexShader,pe=M.fragmentShader,l.update(M),$=l.getVertexShaderID(M),de=l.getFragmentShaderID(M);const Le=n.getRenderTarget(),xe=ne.isInstancedMesh===!0,K=!!M.map,ie=!!M.matcap,ce=!!X,L=!!M.aoMap,De=!!M.lightMap,Q=!!M.bumpMap,ae=!!M.normalMap,me=!!M.displacementMap,Ie=!!M.emissiveMap,Me=!!M.metalnessMap,Se=!!M.roughnessMap,Re=M.anisotropy>0,Ue=M.clearcoat>0,ze=M.iridescence>0,E=M.sheen>0,v=M.transmission>0,I=Re&&!!M.anisotropyMap,re=Ue&&!!M.clearcoatMap,te=Ue&&!!M.clearcoatNormalMap,le=Ue&&!!M.clearcoatRoughnessMap,Te=ze&&!!M.iridescenceMap,he=ze&&!!M.iridescenceThicknessMap,ve=E&&!!M.sheenColorMap,C=E&&!!M.sheenRoughnessMap,se=!!M.specularMap,Z=!!M.specularColorMap,Ne=!!M.specularIntensityMap,Ce=v&&!!M.transmissionMap,Ae=v&&!!M.thicknessMap,Ee=!!M.gradientMap,ye=!!M.alphaMap,He=M.alphaTest>0,P=!!M.alphaHash,_e=!!M.extensions,oe=!!z.attributes.uv1,j=!!z.attributes.uv2,ue=!!z.attributes.uv3;let Pe=An;return M.toneMapped&&(Le===null||Le.isXRRenderTarget===!0)&&(Pe=n.toneMapping),{isWebGL2:h,shaderID:Y,shaderType:M.type,shaderName:M.name,vertexShader:ge,fragmentShader:pe,defines:M.defines,customVertexShaderID:$,customFragmentShaderID:de,isRawShaderMaterial:M.isRawShaderMaterial===!0,glslVersion:M.glslVersion,precision:m,instancing:xe,instancingColor:xe&&ne.instanceColor!==null,supportsVertexTextures:f,outputColorSpace:Le===null?n.outputColorSpace:Le.isXRRenderTarget===!0?Le.texture.colorSpace:mn,map:K,matcap:ie,envMap:ce,envMapMode:ce&&X.mapping,envMapCubeUVHeight:ee,aoMap:L,lightMap:De,bumpMap:Q,normalMap:ae,displacementMap:f&&me,emissiveMap:Ie,normalMapObjectSpace:ae&&M.normalMapType===Vl,normalMapTangentSpace:ae&&M.normalMapType===yo,metalnessMap:Me,roughnessMap:Se,anisotropy:Re,anisotropyMap:I,clearcoat:Ue,clearcoatMap:re,clearcoatNormalMap:te,clearcoatRoughnessMap:le,iridescence:ze,iridescenceMap:Te,iridescenceThicknessMap:he,sheen:E,sheenColorMap:ve,sheenRoughnessMap:C,specularMap:se,specularColorMap:Z,specularIntensityMap:Ne,transmission:v,transmissionMap:Ce,thicknessMap:Ae,gradientMap:Ee,opaque:M.transparent===!1&&M.blending===mi,alphaMap:ye,alphaTest:He,alphaHash:P,combine:M.combine,mapUv:K&&x(M.map.channel),aoMapUv:L&&x(M.aoMap.channel),lightMapUv:De&&x(M.lightMap.channel),bumpMapUv:Q&&x(M.bumpMap.channel),normalMapUv:ae&&x(M.normalMap.channel),displacementMapUv:me&&x(M.displacementMap.channel),emissiveMapUv:Ie&&x(M.emissiveMap.channel),metalnessMapUv:Me&&x(M.metalnessMap.channel),roughnessMapUv:Se&&x(M.roughnessMap.channel),anisotropyMapUv:I&&x(M.anisotropyMap.channel),clearcoatMapUv:re&&x(M.clearcoatMap.channel),clearcoatNormalMapUv:te&&x(M.clearcoatNormalMap.channel),clearcoatRoughnessMapUv:le&&x(M.clearcoatRoughnessMap.channel),iridescenceMapUv:Te&&x(M.iridescenceMap.channel),iridescenceThicknessMapUv:he&&x(M.iridescenceThicknessMap.channel),sheenColorMapUv:ve&&x(M.sheenColorMap.channel),sheenRoughnessMapUv:C&&x(M.sheenRoughnessMap.channel),specularMapUv:se&&x(M.specularMap.channel),specularColorMapUv:Z&&x(M.specularColorMap.channel),specularIntensityMapUv:Ne&&x(M.specularIntensityMap.channel),transmissionMapUv:Ce&&x(M.transmissionMap.channel),thicknessMapUv:Ae&&x(M.thicknessMap.channel),alphaMapUv:ye&&x(M.alphaMap.channel),vertexTangents:!!z.attributes.tangent&&(ae||Re),vertexColors:M.vertexColors,vertexAlphas:M.vertexColors===!0&&!!z.attributes.color&&z.attributes.color.itemSize===4,vertexUv1s:oe,vertexUv2s:j,vertexUv3s:ue,pointsUvs:ne.isPoints===!0&&!!z.attributes.uv&&(K||ye),fog:!!D,useFog:M.fog===!0,fogExp2:D&&D.isFogExp2,flatShading:M.flatShading===!0,sizeAttenuation:M.sizeAttenuation===!0,logarithmicDepthBuffer:d,skinning:ne.isSkinnedMesh===!0,morphTargets:z.morphAttributes.position!==void 0,morphNormals:z.morphAttributes.normal!==void 0,morphColors:z.morphAttributes.color!==void 0,morphTargetsCount:U,morphTextureStride:F,numDirLights:T.directional.length,numPointLights:T.point.length,numSpotLights:T.spot.length,numSpotLightMaps:T.spotLightMap.length,numRectAreaLights:T.rectArea.length,numHemiLights:T.hemi.length,numDirLightShadows:T.directionalShadowMap.length,numPointLightShadows:T.pointShadowMap.length,numSpotLightShadows:T.spotShadowMap.length,numSpotLightShadowsWithMaps:T.numSpotLightShadowsWithMaps,numLightProbes:T.numLightProbes,numClippingPlanes:o.numPlanes,numClipIntersection:o.numIntersection,dithering:M.dithering,shadowMapEnabled:n.shadowMap.enabled&&k.length>0,shadowMapType:n.shadowMap.type,toneMapping:Pe,useLegacyLights:n._useLegacyLights,decodeVideoTexture:K&&M.map.isVideoTexture===!0&&Qe.getTransfer(M.map.colorSpace)===rt,premultipliedAlpha:M.premultipliedAlpha,doubleSided:M.side===dn,flipSided:M.side===Pt,useDepthPacking:M.depthPacking>=0,depthPacking:M.depthPacking||0,index0AttributeName:M.index0AttributeName,extensionDerivatives:_e&&M.extensions.derivatives===!0,extensionFragDepth:_e&&M.extensions.fragDepth===!0,extensionDrawBuffers:_e&&M.extensions.drawBuffers===!0,extensionShaderTextureLOD:_e&&M.extensions.shaderTextureLOD===!0,rendererExtensionFragDepth:h||i.has("EXT_frag_depth"),rendererExtensionDrawBuffers:h||i.has("WEBGL_draw_buffers"),rendererExtensionShaderTextureLod:h||i.has("EXT_shader_texture_lod"),rendererExtensionParallelShaderCompile:i.has("KHR_parallel_shader_compile"),customProgramCacheKey:M.customProgramCacheKey()}}function u(M){const T=[];if(M.shaderID?T.push(M.shaderID):(T.push(M.customVertexShaderID),T.push(M.customFragmentShaderID)),M.defines!==void 0)for(const k in M.defines)T.push(k),T.push(M.defines[k]);return M.isRawShaderMaterial===!1&&(y(T,M),g(T,M),T.push(n.outputColorSpace)),T.push(M.customProgramCacheKey),T.join()}function y(M,T){M.push(T.precision),M.push(T.outputColorSpace),M.push(T.envMapMode),M.push(T.envMapCubeUVHeight),M.push(T.mapUv),M.push(T.alphaMapUv),M.push(T.lightMapUv),M.push(T.aoMapUv),M.push(T.bumpMapUv),M.push(T.normalMapUv),M.push(T.displacementMapUv),M.push(T.emissiveMapUv),M.push(T.metalnessMapUv),M.push(T.roughnessMapUv),M.push(T.anisotropyMapUv),M.push(T.clearcoatMapUv),M.push(T.clearcoatNormalMapUv),M.push(T.clearcoatRoughnessMapUv),M.push(T.iridescenceMapUv),M.push(T.iridescenceThicknessMapUv),M.push(T.sheenColorMapUv),M.push(T.sheenRoughnessMapUv),M.push(T.specularMapUv),M.push(T.specularColorMapUv),M.push(T.specularIntensityMapUv),M.push(T.transmissionMapUv),M.push(T.thicknessMapUv),M.push(T.combine),M.push(T.fogExp2),M.push(T.sizeAttenuation),M.push(T.morphTargetsCount),M.push(T.morphAttributeCount),M.push(T.numDirLights),M.push(T.numPointLights),M.push(T.numSpotLights),M.push(T.numSpotLightMaps),M.push(T.numHemiLights),M.push(T.numRectAreaLights),M.push(T.numDirLightShadows),M.push(T.numPointLightShadows),M.push(T.numSpotLightShadows),M.push(T.numSpotLightShadowsWithMaps),M.push(T.numLightProbes),M.push(T.shadowMapType),M.push(T.toneMapping),M.push(T.numClippingPlanes),M.push(T.numClipIntersection),M.push(T.depthPacking)}function g(M,T){a.disableAll(),T.isWebGL2&&a.enable(0),T.supportsVertexTextures&&a.enable(1),T.instancing&&a.enable(2),T.instancingColor&&a.enable(3),T.matcap&&a.enable(4),T.envMap&&a.enable(5),T.normalMapObjectSpace&&a.enable(6),T.normalMapTangentSpace&&a.enable(7),T.clearcoat&&a.enable(8),T.iridescence&&a.enable(9),T.alphaTest&&a.enable(10),T.vertexColors&&a.enable(11),T.vertexAlphas&&a.enable(12),T.vertexUv1s&&a.enable(13),T.vertexUv2s&&a.enable(14),T.vertexUv3s&&a.enable(15),T.vertexTangents&&a.enable(16),T.anisotropy&&a.enable(17),T.alphaHash&&a.enable(18),M.push(a.mask),a.disableAll(),T.fog&&a.enable(0),T.useFog&&a.enable(1),T.flatShading&&a.enable(2),T.logarithmicDepthBuffer&&a.enable(3),T.skinning&&a.enable(4),T.morphTargets&&a.enable(5),T.morphNormals&&a.enable(6),T.morphColors&&a.enable(7),T.premultipliedAlpha&&a.enable(8),T.shadowMapEnabled&&a.enable(9),T.useLegacyLights&&a.enable(10),T.doubleSided&&a.enable(11),T.flipSided&&a.enable(12),T.useDepthPacking&&a.enable(13),T.dithering&&a.enable(14),T.transmission&&a.enable(15),T.sheen&&a.enable(16),T.opaque&&a.enable(17),T.pointsUvs&&a.enable(18),T.decodeVideoTexture&&a.enable(19),M.push(a.mask)}function w(M){const T=_[M.type];let k;if(T){const q=Qt[T];k=Lc.clone(q.uniforms)}else k=M.uniforms;return k}function b(M,T){let k;for(let q=0,ne=c.length;q<ne;q++){const D=c[q];if(D.cacheKey===T){k=D,++k.usedTimes;break}}return k===void 0&&(k=new Vf(n,T,M,s),c.push(k)),k}function R(M){if(--M.usedTimes===0){const T=c.indexOf(M);c[T]=c[c.length-1],c.pop(),M.destroy()}}function A(M){l.remove(M)}function G(){l.dispose()}return{getParameters:p,getProgramCacheKey:u,getUniforms:w,acquireProgram:b,releaseProgram:R,releaseShaderCache:A,programs:c,dispose:G}}function Yf(){let n=new WeakMap;function e(s){let o=n.get(s);return o===void 0&&(o={},n.set(s,o)),o}function t(s){n.delete(s)}function i(s,o,a){n.get(s)[o]=a}function r(){n=new WeakMap}return{get:e,remove:t,update:i,dispose:r}}function jf(n,e){return n.groupOrder!==e.groupOrder?n.groupOrder-e.groupOrder:n.renderOrder!==e.renderOrder?n.renderOrder-e.renderOrder:n.material.id!==e.material.id?n.material.id-e.material.id:n.z!==e.z?n.z-e.z:n.id-e.id}function Ya(n,e){return n.groupOrder!==e.groupOrder?n.groupOrder-e.groupOrder:n.renderOrder!==e.renderOrder?n.renderOrder-e.renderOrder:n.z!==e.z?e.z-n.z:n.id-e.id}function ja(){const n=[];let e=0;const t=[],i=[],r=[];function s(){e=0,t.length=0,i.length=0,r.length=0}function o(d,f,m,_,x,p){let u=n[e];return u===void 0?(u={id:d.id,object:d,geometry:f,material:m,groupOrder:_,renderOrder:d.renderOrder,z:x,group:p},n[e]=u):(u.id=d.id,u.object=d,u.geometry=f,u.material=m,u.groupOrder=_,u.renderOrder=d.renderOrder,u.z=x,u.group=p),e++,u}function a(d,f,m,_,x,p){const u=o(d,f,m,_,x,p);m.transmission>0?i.push(u):m.transparent===!0?r.push(u):t.push(u)}function l(d,f,m,_,x,p){const u=o(d,f,m,_,x,p);m.transmission>0?i.unshift(u):m.transparent===!0?r.unshift(u):t.unshift(u)}function c(d,f){t.length>1&&t.sort(d||jf),i.length>1&&i.sort(f||Ya),r.length>1&&r.sort(f||Ya)}function h(){for(let d=e,f=n.length;d<f;d++){const m=n[d];if(m.id===null)break;m.id=null,m.object=null,m.geometry=null,m.material=null,m.group=null}}return{opaque:t,transmissive:i,transparent:r,init:s,push:a,unshift:l,finish:h,sort:c}}function Kf(){let n=new WeakMap;function e(i,r){const s=n.get(i);let o;return s===void 0?(o=new ja,n.set(i,[o])):r>=s.length?(o=new ja,s.push(o)):o=s[r],o}function t(){n=new WeakMap}return{get:e,dispose:t}}function Zf(){const n={};return{get:function(e){if(n[e.id]!==void 0)return n[e.id];let t;switch(e.type){case"DirectionalLight":t={direction:new O,color:new Je};break;case"SpotLight":t={position:new O,direction:new O,color:new Je,distance:0,coneCos:0,penumbraCos:0,decay:0};break;case"PointLight":t={position:new O,color:new Je,distance:0,decay:0};break;case"HemisphereLight":t={direction:new O,skyColor:new Je,groundColor:new Je};break;case"RectAreaLight":t={color:new Je,position:new O,halfWidth:new O,halfHeight:new O};break}return n[e.id]=t,t}}}function $f(){const n={};return{get:function(e){if(n[e.id]!==void 0)return n[e.id];let t;switch(e.type){case"DirectionalLight":t={shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Xe};break;case"SpotLight":t={shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Xe};break;case"PointLight":t={shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Xe,shadowCameraNear:1,shadowCameraFar:1e3};break}return n[e.id]=t,t}}}let Jf=0;function Qf(n,e){return(e.castShadow?2:0)-(n.castShadow?2:0)+(e.map?1:0)-(n.map?1:0)}function ep(n,e){const t=new Zf,i=$f(),r={version:0,hash:{directionalLength:-1,pointLength:-1,spotLength:-1,rectAreaLength:-1,hemiLength:-1,numDirectionalShadows:-1,numPointShadows:-1,numSpotShadows:-1,numSpotMaps:-1,numLightProbes:-1},ambient:[0,0,0],probe:[],directional:[],directionalShadow:[],directionalShadowMap:[],directionalShadowMatrix:[],spot:[],spotLightMap:[],spotShadow:[],spotShadowMap:[],spotLightMatrix:[],rectArea:[],rectAreaLTC1:null,rectAreaLTC2:null,point:[],pointShadow:[],pointShadowMap:[],pointShadowMatrix:[],hemi:[],numSpotLightShadowsWithMaps:0,numLightProbes:0};for(let h=0;h<9;h++)r.probe.push(new O);const s=new O,o=new ut,a=new ut;function l(h,d){let f=0,m=0,_=0;for(let q=0;q<9;q++)r.probe[q].set(0,0,0);let x=0,p=0,u=0,y=0,g=0,w=0,b=0,R=0,A=0,G=0,M=0;h.sort(Qf);const T=d===!0?Math.PI:1;for(let q=0,ne=h.length;q<ne;q++){const D=h[q],z=D.color,W=D.intensity,X=D.distance,ee=D.shadow&&D.shadow.map?D.shadow.map.texture:null;if(D.isAmbientLight)f+=z.r*W*T,m+=z.g*W*T,_+=z.b*W*T;else if(D.isLightProbe){for(let Y=0;Y<9;Y++)r.probe[Y].addScaledVector(D.sh.coefficients[Y],W);M++}else if(D.isDirectionalLight){const Y=t.get(D);if(Y.color.copy(D.color).multiplyScalar(D.intensity*T),D.castShadow){const J=D.shadow,U=i.get(D);U.shadowBias=J.bias,U.shadowNormalBias=J.normalBias,U.shadowRadius=J.radius,U.shadowMapSize=J.mapSize,r.directionalShadow[x]=U,r.directionalShadowMap[x]=ee,r.directionalShadowMatrix[x]=D.shadow.matrix,w++}r.directional[x]=Y,x++}else if(D.isSpotLight){const Y=t.get(D);Y.position.setFromMatrixPosition(D.matrixWorld),Y.color.copy(z).multiplyScalar(W*T),Y.distance=X,Y.coneCos=Math.cos(D.angle),Y.penumbraCos=Math.cos(D.angle*(1-D.penumbra)),Y.decay=D.decay,r.spot[u]=Y;const J=D.shadow;if(D.map&&(r.spotLightMap[A]=D.map,A++,J.updateMatrices(D),D.castShadow&&G++),r.spotLightMatrix[u]=J.matrix,D.castShadow){const U=i.get(D);U.shadowBias=J.bias,U.shadowNormalBias=J.normalBias,U.shadowRadius=J.radius,U.shadowMapSize=J.mapSize,r.spotShadow[u]=U,r.spotShadowMap[u]=ee,R++}u++}else if(D.isRectAreaLight){const Y=t.get(D);Y.color.copy(z).multiplyScalar(W),Y.halfWidth.set(D.width*.5,0,0),Y.halfHeight.set(0,D.height*.5,0),r.rectArea[y]=Y,y++}else if(D.isPointLight){const Y=t.get(D);if(Y.color.copy(D.color).multiplyScalar(D.intensity*T),Y.distance=D.distance,Y.decay=D.decay,D.castShadow){const J=D.shadow,U=i.get(D);U.shadowBias=J.bias,U.shadowNormalBias=J.normalBias,U.shadowRadius=J.radius,U.shadowMapSize=J.mapSize,U.shadowCameraNear=J.camera.near,U.shadowCameraFar=J.camera.far,r.pointShadow[p]=U,r.pointShadowMap[p]=ee,r.pointShadowMatrix[p]=D.shadow.matrix,b++}r.point[p]=Y,p++}else if(D.isHemisphereLight){const Y=t.get(D);Y.skyColor.copy(D.color).multiplyScalar(W*T),Y.groundColor.copy(D.groundColor).multiplyScalar(W*T),r.hemi[g]=Y,g++}}y>0&&(e.isWebGL2||n.has("OES_texture_float_linear")===!0?(r.rectAreaLTC1=be.LTC_FLOAT_1,r.rectAreaLTC2=be.LTC_FLOAT_2):n.has("OES_texture_half_float_linear")===!0?(r.rectAreaLTC1=be.LTC_HALF_1,r.rectAreaLTC2=be.LTC_HALF_2):console.error("THREE.WebGLRenderer: Unable to use RectAreaLight. Missing WebGL extensions.")),r.ambient[0]=f,r.ambient[1]=m,r.ambient[2]=_;const k=r.hash;(k.directionalLength!==x||k.pointLength!==p||k.spotLength!==u||k.rectAreaLength!==y||k.hemiLength!==g||k.numDirectionalShadows!==w||k.numPointShadows!==b||k.numSpotShadows!==R||k.numSpotMaps!==A||k.numLightProbes!==M)&&(r.directional.length=x,r.spot.length=u,r.rectArea.length=y,r.point.length=p,r.hemi.length=g,r.directionalShadow.length=w,r.directionalShadowMap.length=w,r.pointShadow.length=b,r.pointShadowMap.length=b,r.spotShadow.length=R,r.spotShadowMap.length=R,r.directionalShadowMatrix.length=w,r.pointShadowMatrix.length=b,r.spotLightMatrix.length=R+A-G,r.spotLightMap.length=A,r.numSpotLightShadowsWithMaps=G,r.numLightProbes=M,k.directionalLength=x,k.pointLength=p,k.spotLength=u,k.rectAreaLength=y,k.hemiLength=g,k.numDirectionalShadows=w,k.numPointShadows=b,k.numSpotShadows=R,k.numSpotMaps=A,k.numLightProbes=M,r.version=Jf++)}function c(h,d){let f=0,m=0,_=0,x=0,p=0;const u=d.matrixWorldInverse;for(let y=0,g=h.length;y<g;y++){const w=h[y];if(w.isDirectionalLight){const b=r.directional[f];b.direction.setFromMatrixPosition(w.matrixWorld),s.setFromMatrixPosition(w.target.matrixWorld),b.direction.sub(s),b.direction.transformDirection(u),f++}else if(w.isSpotLight){const b=r.spot[_];b.position.setFromMatrixPosition(w.matrixWorld),b.position.applyMatrix4(u),b.direction.setFromMatrixPosition(w.matrixWorld),s.setFromMatrixPosition(w.target.matrixWorld),b.direction.sub(s),b.direction.transformDirection(u),_++}else if(w.isRectAreaLight){const b=r.rectArea[x];b.position.setFromMatrixPosition(w.matrixWorld),b.position.applyMatrix4(u),a.identity(),o.copy(w.matrixWorld),o.premultiply(u),a.extractRotation(o),b.halfWidth.set(w.width*.5,0,0),b.halfHeight.set(0,w.height*.5,0),b.halfWidth.applyMatrix4(a),b.halfHeight.applyMatrix4(a),x++}else if(w.isPointLight){const b=r.point[m];b.position.setFromMatrixPosition(w.matrixWorld),b.position.applyMatrix4(u),m++}else if(w.isHemisphereLight){const b=r.hemi[p];b.direction.setFromMatrixPosition(w.matrixWorld),b.direction.transformDirection(u),p++}}}return{setup:l,setupView:c,state:r}}function Ka(n,e){const t=new ep(n,e),i=[],r=[];function s(){i.length=0,r.length=0}function o(d){i.push(d)}function a(d){r.push(d)}function l(d){t.setup(i,d)}function c(d){t.setupView(i,d)}return{init:s,state:{lightsArray:i,shadowsArray:r,lights:t},setupLights:l,setupLightsView:c,pushLight:o,pushShadow:a}}function tp(n,e){let t=new WeakMap;function i(s,o=0){const a=t.get(s);let l;return a===void 0?(l=new Ka(n,e),t.set(s,[l])):o>=a.length?(l=new Ka(n,e),a.push(l)):l=a[o],l}function r(){t=new WeakMap}return{get:i,dispose:r}}class np extends Ei{constructor(e){super(),this.isMeshDepthMaterial=!0,this.type="MeshDepthMaterial",this.depthPacking=Hl,this.map=null,this.alphaMap=null,this.displacementMap=null,this.displacementScale=1,this.displacementBias=0,this.wireframe=!1,this.wireframeLinewidth=1,this.setValues(e)}copy(e){return super.copy(e),this.depthPacking=e.depthPacking,this.map=e.map,this.alphaMap=e.alphaMap,this.displacementMap=e.displacementMap,this.displacementScale=e.displacementScale,this.displacementBias=e.displacementBias,this.wireframe=e.wireframe,this.wireframeLinewidth=e.wireframeLinewidth,this}}class ip extends Ei{constructor(e){super(),this.isMeshDistanceMaterial=!0,this.type="MeshDistanceMaterial",this.map=null,this.alphaMap=null,this.displacementMap=null,this.displacementScale=1,this.displacementBias=0,this.setValues(e)}copy(e){return super.copy(e),this.map=e.map,this.alphaMap=e.alphaMap,this.displacementMap=e.displacementMap,this.displacementScale=e.displacementScale,this.displacementBias=e.displacementBias,this}}const rp=`void main() {
	gl_Position = vec4( position, 1.0 );
...
}`;function ap(n,e,t){let i=new bs;const r=new Xe,s=new Xe,o=new mt,a=new np({depthPacking:Gl}),l=new ip,c={},h=t.maxTextureSize,d={[Rn]:Pt,[Pt]:Rn,[dn]:dn},f=new qn({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Xe},radius:{value:4}},vertexShader:rp,fragmentShader:sp}),m=f.clone();m.defines.HORIZONTAL_PASS=1;const _=new en;_.setAttribute("position",new Zt(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const x=new Ot(_,f),p=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=uo;let u=this.type;this.render=function(b,R,A){if(p.enabled===!1||p.autoUpdate===!1&&p.needsUpdate===!1||b.length===0)return;const G=n.getRenderTarget(),M=n.getActiveCubeFace(),T=n.getActiveMipmapLevel(),k=n.state;k.setBlending(bn),k.buffers.color.setClear(1,1,1,1),k.buffers.depth.setTest(!0),k.setScissorTest(!1);const q=u!==un&&this.type===un,ne=u===un&&this.type!==un;for(let D=0,z=b.length;D<z;D++){const W=b[D],X=W.shadow;if(X===void 0){console.warn("THREE.WebGLShadowMap:",W,"has no shadow.");continue}if(X.autoUpdate===!1&&X.needsUpdate===!1)continue;r.copy(X.mapSize);const ee=X.getFrameExtents();if(r.multiply(ee),s.copy(X.mapSize),(r.x>h||r.y>h)&&(r.x>h&&(s.x=Math.floor(h/ee.x),r.x=s.x*ee.x,X.mapSize.x=s.x),r.y>h&&(s.y=Math.floor(h/ee.y),r.y=s.y*ee.y,X.mapSize.y=s.y)),X.map===null||q===!0||ne===!0){const J=this.type!==un?{minFilter:Rt,magFilter:Rt}:{};X.map!==null&&X.map.dispose(),X.map=new Wn(r.x,r.y,J),X.map.texture.name=W.name+".shadowMap",X.camera.updateProjectionMatrix()}n.setRenderTarget(X.map),n.clear();const Y=X.getViewportCount();for(let J=0;J<Y;J++){const U=X.getViewport(J);o.set(s.x*U.x,s.y*U.y,s.x*U.z,s.y*U.w),k.viewport(o),X.updateMatrices(W,J),i=X.getFrustum(),w(R,A,X.camera,W,this.type)}X.isPointLightShadow!==!0&&this.type===un&&y(X,A),X.needsUpdate=!1}u=this.type,p.needsUpdate=!1,n.setRenderTarget(G,M,T)};function y(b,R){const A=e.update(x);f.defines.VSM_SAMPLES!==b.blurSamples&&(f.defines.VSM_SAMPLES=b.blurSamples,m.defines.VSM_SAMPLES=b.blurSamples,f.needsUpdate=!0,m.needsUpdate=!0),b.mapPass===null&&(b.mapPass=new Wn(r.x,r.y)),f.uniforms.shadow_pass.value=b.map.texture,f.uniforms.resolution.value=b.mapSize,f.uniforms.radius.value=b.radius,n.setRenderTarget(b.mapPass),n.clear(),n.renderBufferDirect(R,null,A,f,x,null),m.uniforms.shadow_pass.value=b.mapPass.texture,m.uniforms.resolution.value=b.mapSize,m.uniforms.radius.value=b.radius,n.setRenderTarget(b.map),n.clear(),n.renderBufferDirect(R,null,A,m,x,null)}function g(b,R,A,G){let M=null;const T=A.isPointLight===!0?b.customDistanceMaterial:b.customDepthMaterial;if(T!==void 0)M=T;else if(M=A.isPointLight===!0?l:a,n.localClippingEnabled&&R.clipShadows===!0&&Array.isArray(R.clippingPlanes)&&R.clippingPlanes.length!==0||R.displacementMap&&R.displacementScale!==0||R.alphaMap&&R.alphaTest>0||R.map&&R.alphaTest>0){const k=M.uuid,q=R.uuid;let ne=c[k];ne===void 0&&(ne={},c[k]=ne);let D=ne[q];D===void 0&&(D=M.clone(),ne[q]=D),M=D}if(M.visible=R.visible,M.wireframe=R.wireframe,G===un?M.side=R.shadowSide!==null?R.shadowSide:R.side:M.side=R.shadowSide!==null?R.shadowSide:d[R.side],M.alphaMap=R.alphaMap,M.alphaTest=R.alphaTest,M.map=R.map,M.clipShadows=R.clipShadows,M.clippingPlanes=R.clippingPlanes,M.clipIntersection=R.clipIntersection,M.displacementMap=R.displacementMap,M.displacementScale=R.displacementScale,M.displacementBias=R.displacementBias,M.wireframeLinewidth=R.wireframeLinewidth,M.linewidth=R.linewidth,A.isPointLight===!0&&M.isMeshDistanceMaterial===!0){const k=n.properties.get(M);k.light=A}return M}function w(b,R,A,G,M){if(b.visible===!1)return;if(b.layers.test(R.layers)&&(b.isMesh||b.isLine||b.isPoints)&&(b.castShadow||b.receiveShadow&&M===un)&&(!b.frustumCulled||i.intersectsObject(b))){b.modelViewMatrix.multiplyMatrices(A.matrixWorldInverse,b.matrixWorld);const q=e.update(b),ne=b.material;if(Array.isArray(ne)){const D=q.groups;for(let z=0,W=D.length;z<W;z++){const X=D[z],ee=ne[X.materialIndex];if(ee&&ee.visible){const Y=g(b,ee,G,M);n.renderBufferDirect(A,null,q,Y,b,X)}}}else if(ne.visible){const D=g(b,ne,G,M);n.renderBufferDirect(A,null,q,D,b,null)}}const k=b.children;for(let q=0,ne=k.length;q<ne;q++)w(k[q],R,A,G,M)}}function op(n,e,t){const i=t.isWebGL2;function r(){let P=!1;const _e=new mt;let oe=null;const j=new mt(0,0,0,0);return{setMask:function(ue){oe!==ue&&!P&&(n.colorMask(ue,ue,ue,ue),oe=ue)},setLocked:function(ue){P=ue},setClear:function(ue,Pe,Oe,Ze,nt){nt===!0&&(ue*=Ze,Pe*=Ze,Oe*=Ze),_e.set(ue,Pe,Oe,Ze),j.equals(_e)===!1&&(n.clearColor(ue,Pe,Oe,Ze),j.copy(_e))},reset:function(){P=!1,oe=null,j.set(-1,0,0,0)}}}function s(){let P=!1,_e=null,oe=null,j=null;return{setTest:function(ue){ue?K(n.DEPTH_TEST):ie(n.DEPTH_TEST)},setMask:function(ue){_e!==ue&&!P&&(n.depthMask(ue),_e=ue)},setFunc:function(ue){if(oe!==ue){switch(ue){case gl:n.depthFunc(n.NEVER);break;case _l:n.depthFunc(n.ALWAYS);break;case vl:n.depthFunc(n.LESS);break;case mr:n.depthFunc(n.LEQUAL);break;case xl:n.depthFunc(n.EQUAL);break;case Ml:n.depthFunc(n.GEQUAL);break;case Sl:n.depthFunc(n.GREATER);break;case El:n.depthFunc(n.NOTEQUAL);break;default:n.depthFunc(n.LEQUAL)}oe=ue}},setLocked:function(ue){P=ue},setClear:function(ue){j!==ue&&(n.clearDepth(ue),j=ue)},reset:function(){P=!1,_e=null,oe=null,j=null}}}function o(){let P=!1,_e=null,oe=null,j=null,ue=null,Pe=null,Oe=null,Ze=null,nt=null;return{setTest:function(je){P||(je?K(n.STENCIL_TEST):ie(n.STENCIL_TEST))},setMask:function(je){_e!==je&&!P&&(n.stencilMask(je),_e=je)},setFunc:function(je,fe,ot){(oe!==je||j!==fe||ue!==ot)&&(n.stencilFunc(je,fe,ot),oe=je,j=fe,ue=ot)},setOp:function(je,fe,ot){(Pe!==je||Oe!==fe||Ze!==ot)&&(n.stencilOp(je,fe,ot),Pe=je,Oe=fe,Ze=ot)},setLocked:function(je){P=je},setClear:function(je){nt!==je&&(n.clearStencil(je),nt=je)},reset:function(){P=!1,_e=null,oe=null,j=null,ue=null,Pe=null,Oe=null,Ze=null,nt=null}}}const a=new r,l=new s,c=new o,h=new WeakMap,d=new WeakMap;let f={},m={},_=new WeakMap,x=[],p=null,u=!1,y=null,g=null,w=null,b=null,R=null,A=null,G=null,M=new Je(0,0,0),T=0,k=!1,q=null,ne=null,D=null,z=null,W=null;const X=n.getParameter(n.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let ee=!1,Y=0;const J=n.getParameter(n.VERSION);J.indexOf("WebGL")!==-1?(Y=parseFloat(/^WebGL (\d)/.exec(J)[1]),ee=Y>=1):J.indexOf("OpenGL ES")!==-1&&(Y=parseFloat(/^OpenGL ES (\d)/.exec(J)[1]),ee=Y>=2);let U=null,F={};const ge=n.getParameter(n.SCISSOR_BOX),pe=n.getParameter(n.VIEWPORT),$=new mt().fromArray(ge),de=new mt().fromArray(pe);function Le(P,_e,oe,j){const ue=new Uint8Array(4),Pe=n.createTexture();n.bindTexture(P,Pe),n.texParameteri(P,n.TEXTURE_MIN_FILTER,n.NEAREST),n.texParameteri(P,n.TEXTURE_MAG_FILTER,n.NEAREST);for(let Oe=0;Oe<oe;Oe++)i&&(P===n.TEXTURE_3D||P===n.TEXTURE_2D_ARRAY)?n.texImage3D(_e,0,n.RGBA,1,1,j,0,n.RGBA,n.UNSIGNED_BYTE,ue):n.texImage2D(_e+Oe,0,n.RGBA,1,1,0,n.RGBA,n.UNSIGNED_BYTE,ue);return Pe}const xe={};xe[n.TEXTURE_2D]=Le(n.TEXTURE_2D,n.TEXTURE_2D,1),xe[n.TEXTURE_CUBE_MAP]=Le(n.TEXTURE_CUBE_MAP,n.TEXTURE_CUBE_MAP_POSITIVE_X,6),i&&(xe[n.TEXTURE_2D_ARRAY]=Le(n.TEXTURE_2D_ARRAY,n.TEXTURE_2D_ARRAY,1,1),xe[n.TEXTURE_3D]=Le(n.TEXTURE_3D,n.TEXTURE_3D,1,1)),a.setClear(0,0,0,1),l.setClear(1),c.setClear(0),K(n.DEPTH_TEST),l.setFunc(mr),Me(!1),Se(Ls),K(n.CULL_FACE),me(bn);function K(P){f[P]!==!0&&(n.enable(P),f[P]=!0)}function ie(P){f[P]!==!1&&(n.disable(P),f[P]=!1)}function ce(P,_e){return m[P]!==_e?(n.bindFramebuffer(P,_e),m[P]=_e,i&&(P===n.DRAW_FRAMEBUFFER&&(m[n.FRAMEBUFFER]=_e),P===n.FRAMEBUFFER&&(m[n.DRAW_FRAMEBUFFER]=_e)),!0):!1}function L(P,_e){let oe=x,j=!1;if(P)if(oe=_.get(_e),oe===void 0&&(oe=[],_.set(_e,oe)),P.isWebGLMultipleRenderTargets){const ue=P.texture;if(oe.length!==ue.length||oe[0]!==n.COLOR_ATTACHMENT0){for(let Pe=0,Oe=ue.length;Pe<Oe;Pe++)oe[Pe]=n.COLOR_ATTACHMENT0+Pe;oe.length=ue.length,j=!0}}else oe[0]!==n.COLOR_ATTACHMENT0&&(oe[0]=n.COLOR_ATTACHMENT0,j=!0);else oe[0]!==n.BACK&&(oe[0]=n.BACK,j=!0);j&&(t.isWebGL2?n.drawBuffers(oe):e.get("WEBGL_draw_buffers").drawBuffersWEBGL(oe))}function De(P){return p!==P?(n.useProgram(P),p=P,!0):!1}const Q={[Fn]:n.FUNC_ADD,[tl]:n.FUNC_SUBTRACT,[nl]:n.FUNC_REVERSE_SUBTRACT};if(i)Q[Is]=n.MIN,Q[Ns]=n.MAX;else{const P=e.get("EXT_blend_minmax");P!==null&&(Q[Is]=P.MIN_EXT,Q[Ns]=P.MAX_EXT)}const ae={[il]:n.ZERO,[rl]:n.ONE,[sl]:n.SRC_COLOR,[os]:n.SRC_ALPHA,[ul]:n.SRC_ALPHA_SATURATE,[cl]:n.DST_COLOR,[ol]:n.DST_ALPHA,[al]:n.ONE_MINUS_SRC_COLOR,[ls]:n.ONE_MINUS_SRC_ALPHA,[hl]:n.ONE_MINUS_DST_COLOR,[ll]:n.ONE_MINUS_DST_ALPHA,[dl]:n.CONSTANT_COLOR,[fl]:n.ONE_MINUS_CONSTANT_COLOR,[pl]:n.CONSTANT_ALPHA,[ml]:n.ONE_MINUS_CONSTANT_ALPHA};function me(P,_e,oe,j,ue,Pe,Oe,Ze,nt,je){if(P===bn){u===!0&&(ie(n.BLEND),u=!1);return}if(u===!1&&(K(n.BLEND),u=!0),P!==el){if(P!==y||je!==k){if((g!==Fn||R!==Fn)&&(n.blendEquation(n.FUNC_ADD),g=Fn,R=Fn),je)switch(P){case mi:n.blendFuncSeparate(n.ONE,n.ONE_MINUS_SRC_ALPHA,n.ONE,n.ONE_MINUS_SRC_ALPHA);break;case Ps:n.blendFunc(n.ONE,n.ONE);break;case Ds:n.blendFuncSeparate(n.ZERO,n.ONE_MINUS_SRC_COLOR,n.ZERO,n.ONE);break;case Us:n.blendFuncSeparate(n.ZERO,n.SRC_COLOR,n.ZERO,n.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",P);break}else switch(P){case mi:n.blendFuncSeparate(n.SRC_ALPHA,n.ONE_MINUS_SRC_ALPHA,n.ONE,n.ONE_MINUS_SRC_ALPHA);break;case Ps:n.blendFunc(n.SRC_ALPHA,n.ONE);break;case Ds:n.blendFuncSeparate(n.ZERO,n.ONE_MINUS_SRC_COLOR,n.ZERO,n.ONE);break;case Us:n.blendFunc(n.ZERO,n.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",P);break}w=null,b=null,A=null,G=null,M.set(0,0,0),T=0,y=P,k=je}return}ue=ue||_e,Pe=Pe||oe,Oe=Oe||j,(_e!==g||ue!==R)&&(n.blendEquationSeparate(Q[_e],Q[ue]),g=_e,R=ue),(oe!==w||j!==b||Pe!==A||Oe!==G)&&(n.blendFuncSeparate(ae[oe],ae[j],ae[Pe],ae[Oe]),w=oe,b=j,A=Pe,G=Oe),(Ze.equals(M)===!1||nt!==T)&&(n.blendColor(Ze.r,Ze.g,Ze.b,nt),M.copy(Ze),T=nt),y=P,k=!1}function Ie(P,_e){P.side===dn?ie(n.CULL_FACE):K(n.CULL_FACE);let oe=P.side===Pt;_e&&(oe=!oe),Me(oe),P.blending===mi&&P.transparent===!1?me(bn):me(P.blending,P.blendEquation,P.blendSrc,P.blendDst,P.blendEquationAlpha,P.blendSrcAlpha,P.blendDstAlpha,P.blendColor,P.blendAlpha,P.premultipliedAlpha),l.setFunc(P.depthFunc),l.setTest(P.depthTest),l.setMask(P.depthWrite),a.setMask(P.colorWrite);const j=P.stencilWrite;c.setTest(j),j&&(c.setMask(P.stencilWriteMask),c.setFunc(P.stencilFunc,P.stencilRef,P.stencilFuncMask),c.setOp(P.stencilFail,P.stencilZFail,P.stencilZPass)),Ue(P.polygonOffset,P.polygonOffsetFactor,P.polygonOffsetUnits),P.alphaToCoverage===!0?K(n.SAMPLE_ALPHA_TO_COVERAGE):ie(n.SAMPLE_ALPHA_TO_COVERAGE)}function Me(P){q!==P&&(P?n.frontFace(n.CW):n.frontFace(n.CCW),q=P)}function Se(P){P!==Jo?(K(n.CULL_FACE),P!==ne&&(P===Ls?n.cullFace(n.BACK):P===Qo?n.cullFace(n.FRONT):n.cullFace(n.FRONT_AND_BACK))):ie(n.CULL_FACE),ne=P}function Re(P){P!==D&&(ee&&n.lineWidth(P),D=P)}function Ue(P,_e,oe){P?(K(n.POLYGON_OFFSET_FILL),(z!==_e||W!==oe)&&(n.polygonOffset(_e,oe),z=_e,W=oe)):ie(n.POLYGON_OFFSET_FILL)}function ze(P){P?K(n.SCISSOR_TEST):ie(n.SCISSOR_TEST)}function E(P){P===void 0&&(P=n.TEXTURE0+X-1),U!==P&&(n.activeTexture(P),U=P)}function v(P,_e,oe){oe===void 0&&(U===null?oe=n.TEXTURE0+X-1:oe=U);let j=F[oe];j===void 0&&(j={type:void 0,texture:void 0},F[oe]=j),(j.type!==P||j.texture!==_e)&&(U!==oe&&(n.activeTexture(oe),U=oe),n.bindTexture(P,_e||xe[P]),j.type=P,j.texture=_e)}function I(){const P=F[U];P!==void 0&&P.type!==void 0&&(n.bindTexture(P.type,null),P.type=void 0,P.texture=void 0)}function re(){try{n.compressedTexImage2D.apply(n,arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function te(){try{n.compressedTexImage3D.apply(n,arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function le(){try{n.texSubImage2D.apply(n,arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function Te(){try{n.texSubImage3D.apply(n,arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function he(){try{n.compressedTexSubImage2D.apply(n,arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function ve(){try{n.compressedTexSubImage3D.apply(n,arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function C(){try{n.texStorage2D.apply(n,arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function se(){try{n.texStorage3D.apply(n,arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function Z(){try{n.texImage2D.apply(n,arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function Ne(){try{n.texImage3D.apply(n,arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function Ce(P){$.equals(P)===!1&&(n.scissor(P.x,P.y,P.z,P.w),$.copy(P))}function Ae(P){de.equals(P)===!1&&(n.viewport(P.x,P.y,P.z,P.w),de.copy(P))}function Ee(P,_e){let oe=d.get(_e);oe===void 0&&(oe=new WeakMap,d.set(_e,oe));let j=oe.get(P);j===void 0&&(j=n.getUniformBlockIndex(_e,P.name),oe.set(P,j))}function ye(P,_e){const j=d.get(_e).get(P);h.get(_e)!==j&&(n.uniformBlockBinding(_e,j,P.__bindingPointIndex),h.set(_e,j))}function He(){n.disable(n.BLEND),n.disable(n.CULL_FACE),n.disable(n.DEPTH_TEST),n.disable(n.POLYGON_OFFSET_FILL),n.disable(n.SCISSOR_TEST),n.disable(n.STENCIL_TEST),n.disable(n.SAMPLE_ALPHA_TO_COVERAGE),n.blendEquation(n.FUNC_ADD),n.blendFunc(n.ONE,n.ZERO),n.blendFuncSeparate(n.ONE,n.ZERO,n.ONE,n.ZERO),n.blendColor(0,0,0,0),n.colorMask(!0,!0,!0,!0),n.clearColor(0,0,0,0),n.depthMask(!0),n.depthFunc(n.LESS),n.clearDepth(1),n.stencilMask(4294967295),n.stencilFunc(n.ALWAYS,0,4294967295),n.stencilOp(n.KEEP,n.KEEP,n.KEEP),n.clearStencil(0),n.cullFace(n.BACK),n.frontFace(n.CCW),n.polygonOffset(0,0),n.activeTexture(n.TEXTURE0),n.bindFramebuffer(n.FRAMEBUFFER,null),i===!0&&(n.bindFramebuffer(n.DRAW_FRAMEBUFFER,null),n.bindFramebuffer(n.READ_FRAMEBUFFER,null)),n.useProgram(null),n.lineWidth(1),n.scissor(0,0,n.canvas.width,n.canvas.height),n.viewport(0,0,n.canvas.width,n.canvas.height),f={},U=null,F={},m={},_=new WeakMap,x=[],p=null,u=!1,y=null,g=null,w=null,b=null,R=null,A=null,G=null,M=new Je(0,0,0),T=0,k=!1,q=null,ne=null,D=null,z=null,W=null,$.set(0,0,n.canvas.width,n.canvas.height),de.set(0,0,n.canvas.width,n.canvas.height),a.reset(),l.reset(),c.reset()}return{buffers:{color:a,depth:l,stencil:c},enable:K,disable:ie,bindFramebuffer:ce,drawBuffers:L,useProgram:De,setBlending:me,setMaterial:Ie,setFlipSided:Me,setCullFace:Se,setLineWidth:Re,setPolygonOffset:Ue,setScissorTest:ze,activeTexture:E,bindTexture:v,unbindTexture:I,compressedTexImage2D:re,compressedTexImage3D:te,texImage2D:Z,texImage3D:Ne,updateUBOMapping:Ee,uniformBlockBinding:ye,texStorage2D:C,texStorage3D:se,texSubImage2D:le,texSubImage3D:Te,compressedTexSubImage2D:he,compressedTexSubImage3D:ve,scissor:Ce,viewport:Ae,reset:He}}function lp(n,e,t,i,r,s,o){const a=r.isWebGL2,l=r.maxTextures,c=r.maxCubemapSize,h=r.maxTextureSize,d=r.maxSamples,f=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,m=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),_=new WeakMap;let x;const p=new WeakMap;let u=!1;try{u=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function y(E,v){return u?new OffscreenCanvas(E,v):Sr("canvas")}function g(E,v,I,re){let te=1;if((E.width>re||E.height>re)&&(te=re/Math.max(E.width,E.height)),te<1||v===!0)if(typeof HTMLImageElement<"u"&&E instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&E instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&E instanceof ImageBitmap){const le=v?Mr:Math.floor,Te=le(te*E.width),he=le(te*E.height);x===void 0&&(x=y(Te,he));const ve=I?y(Te,he):x;return ve.width=Te,ve.height=he,ve.getContext("2d").drawImage(E,0,0,Te,he),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+E.width+"x"+E.height+") to ("+Te+"x"+he+")."),ve}else return"data"in E&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+E.width+"x"+E.height+")."),E;return E}function w(E){return ps(E.width)&&ps(E.height)}function b(E){return a?!1:E.wrapS!==jt||E.wrapT!==jt||E.minFilter!==Rt&&E.minFilter!==Gt}function R(E,v){return E.generateMipmaps&&v&&E.minFilter!==Rt&&E.minFilter!==Gt}function A(E){n.generateMipmap(E)}function G(E,v,I,re,te=!1){if(a===!1)return v;if(E!==null){if(n[E]!==void 0)return n[E];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+E+"'")}let le=v;if(v===n.RED&&(I===n.FLOAT&&(le=n.R32F),I===n.HALF_FLOAT&&(le=n.R16F),I===n.UNSIGNED_BYTE&&(le=n.R8)),v===n.RED_INTEGER&&(I===n.UNSIGNED_BYTE&&(le=n.R8UI),I===n.UNSIGNED_SHORT&&(le=n.R16UI),I===n.UNSIGNED_INT&&(le=n.R32UI),I===n.BYTE&&(le=n.R8I),I===n.SHORT&&(le=n.R16I),I===n.INT&&(le=n.R32I)),v===n.RG&&(I===n.FLOAT&&(le=n.RG32F),I===n.HALF_FLOAT&&(le=n.RG16F),I===n.UNSIGNED_BYTE&&(le=n.RG8)),v===n.RGBA){const Te=te?gr:Qe.getTransfer(re);I===n.FLOAT&&(le=n.RGBA32F),I===n.HALF_FLOAT&&(le=n.RGBA16F),I===n.UNSIGNED_BYTE&&(le=Te===rt?n.SRGB8_ALPHA8:n.RGBA8),I===n.UNSIGNED_SHORT_4_4_4_4&&(le=n.RGBA4),I===n.UNSIGNED_SHORT_5_5_5_1&&(le=n.RGB5_A1)}return(le===n.R16F||le===n.R32F||le===n.RG16F||le===n.RG32F||le===n.RGBA16F||le===n.RGBA32F)&&e.get("EXT_color_buffer_float"),le}function M(E,v,I){return R(E,I)===!0||E.isFramebufferTexture&&E.minFilter!==Rt&&E.minFilter!==Gt?Math.log2(Math.max(v.width,v.height))+1:E.mipmaps!==void 0&&E.mipmaps.length>0?E.mipmaps.length:E.isCompressedTexture&&Array.isArray(E.image)?v.mipmaps.length:1}function T(E){return E===Rt||E===Fs||E===Rr?n.NEAREST:n.LINEAR}function k(E){const v=E.target;v.removeEventListener("dispose",k),ne(v),v.isVideoTexture&&_.delete(v)}function q(E){const v=E.target;v.removeEventListener("dispose",q),z(v)}function ne(E){const v=i.get(E);if(v.__webglInit===void 0)return;const I=E.source,re=p.get(I);if(re){const te=re[v.__cacheKey];te.usedTimes--,te.usedTimes===0&&D(E),Object.keys(re).length===0&&p.delete(I)}i.remove(E)}function D(E){const v=i.get(E);n.deleteTexture(v.__webglTexture);const I=E.source,re=p.get(I);delete re[v.__cacheKey],o.memory.textures--}function z(E){const v=E.texture,I=i.get(E),re=i.get(v);if(re.__webglTexture!==void 0&&(n.deleteTexture(re.__webglTexture),o.memory.textures--),E.depthTexture&&E.depthTexture.dispose(),E.isWebGLCubeRenderTarget)for(let te=0;te<6;te++){if(Array.isArray(I.__webglFramebuffer[te]))for(let le=0;le<I.__webglFramebuffer[te].length;le++)n.deleteFramebuffer(I.__webglFramebuffer[te][le]);else n.deleteFramebuffer(I.__webglFramebuffer[te]);I.__webglDepthbuffer&&n.deleteRenderbuffer(I.__webglDepthbuffer[te])}else{if(Array.isArray(I.__webglFramebuffer))for(let te=0;te<I.__webglFramebuffer.length;te++)n.deleteFramebuffer(I.__webglFramebuffer[te]);else n.deleteFramebuffer(I.__webglFramebuffer);if(I.__webglDepthbuffer&&n.deleteRenderbuffer(I.__webglDepthbuffer),I.__webglMultisampledFramebuffer&&n.deleteFramebuffer(I.__webglMultisampledFramebuffer),I.__webglColorRenderbuffer)for(let te=0;te<I.__webglColorRenderbuffer.length;te++)I.__webglColorRenderbuffer[te]&&n.deleteRenderbuffer(I.__webglColorRenderbuffer[te]);I.__webglDepthRenderbuffer&&n.deleteRenderbuffer(I.__webglDepthRenderbuffer)}if(E.isWebGLMultipleRenderTargets)for(let te=0,le=v.length;te<le;te++){const Te=i.get(v[te]);Te.__webglTexture&&(n.deleteTexture(Te.__webglTexture),o.memory.textures--),i.remove(v[te])}i.remove(v),i.remove(E)}let W=0;function X(){W=0}function ee(){const E=W;return E>=l&&console.warn("THREE.WebGLTextures: Trying to use "+E+" texture units while this GPU supports only "+l),W+=1,E}function Y(E){const v=[];return v.push(E.wrapS),v.push(E.wrapT),v.push(E.wrapR||0),v.push(E.magFilter),v.push(E.minFilter),v.push(E.anisotropy),v.push(E.internalFormat),v.push(E.format),v.push(E.type),v.push(E.generateMipmaps),v.push(E.premultiplyAlpha),v.push(E.flipY),v.push(E.unpackAlignment),v.push(E.colorSpace),v.join()}function J(E,v){const I=i.get(E);if(E.isVideoTexture&&Ue(E),E.isRenderTargetTexture===!1&&E.version>0&&I.__version!==E.version){const re=E.image;if(re===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(re.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{K(I,E,v);return}}t.bindTexture(n.TEXTURE_2D,I.__webglTexture,n.TEXTURE0+v)}function U(E,v){const I=i.get(E);if(E.version>0&&I.__version!==E.version){K(I,E,v);return}t.bindTexture(n.TEXTURE_2D_ARRAY,I.__webglTexture,n.TEXTURE0+v)}function F(E,v){const I=i.get(E);if(E.version>0&&I.__version!==E.version){K(I,E,v);return}t.bindTexture(n.TEXTURE_3D,I.__webglTexture,n.TEXTURE0+v)}function ge(E,v){const I=i.get(E);if(E.version>0&&I.__version!==E.version){ie(I,E,v);return}t.bindTexture(n.TEXTURE_CUBE_MAP,I.__webglTexture,n.TEXTURE0+v)}const pe={[us]:n.REPEAT,[jt]:n.CLAMP_TO_EDGE,[ds]:n.MIRRORED_REPEAT},$={[Rt]:n.NEAREST,[Fs]:n.NEAREST_MIPMAP_NEAREST,[Rr]:n.NEAREST_MIPMAP_LINEAR,[Gt]:n.LINEAR,[Ll]:n.LINEAR_MIPMAP_NEAREST,[Ni]:n.LINEAR_MIPMAP_LINEAR},de={[kl]:n.NEVER,[Zl]:n.ALWAYS,[Wl]:n.LESS,[ql]:n.LEQUAL,[Xl]:n.EQUAL,[Kl]:n.GEQUAL,[Yl]:n.GREATER,[jl]:n.NOTEQUAL};function Le(E,v,I){if(I?(n.texParameteri(E,n.TEXTURE_WRAP_S,pe[v.wrapS]),n.texParameteri(E,n.TEXTURE_WRAP_T,pe[v.wrapT]),(E===n.TEXTURE_3D||E===n.TEXTURE_2D_ARRAY)&&n.texParameteri(E,n.TEXTURE_WRAP_R,pe[v.wrapR]),n.texParameteri(E,n.TEXTURE_MAG_FILTER,$[v.magFilter]),n.texParameteri(E,n.TEXTURE_MIN_FILTER,$[v.minFilter])):(n.texParameteri(E,n.TEXTURE_WRAP_S,n.CLAMP_TO_EDGE),n.texParameteri(E,n.TEXTURE_WRAP_T,n.CLAMP_TO_EDGE),(E===n.TEXTURE_3D||E===n.TEXTURE_2D_ARRAY)&&n.texParameteri(E,n.TEXTURE_WRAP_R,n.CLAMP_TO_EDGE),(v.wrapS!==jt||v.wrapT!==jt)&&console.warn("THREE.WebGLRenderer: Texture is not power of two. Texture.wrapS and Texture.wrapT should be set to THREE.ClampToEdgeWrapping."),n.texParameteri(E,n.TEXTURE_MAG_FILTER,T(v.magFilter)),n.texParameteri(E,n.TEXTURE_MIN_FILTER,T(v.minFilter)),v.minFilter!==Rt&&v.minFilter!==Gt&&console.warn("THREE.WebGLRenderer: Texture is not power of two. Texture.minFilter should be set to THREE.NearestFilter or THREE.LinearFilter.")),v.compareFunction&&(n.texParameteri(E,n.TEXTURE_COMPARE_MODE,n.COMPARE_REF_TO_TEXTURE),n.texParameteri(E,n.TEXTURE_COMPARE_FUNC,de[v.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){const re=e.get("EXT_texture_filter_anisotropic");if(v.magFilter===Rt||v.minFilter!==Rr&&v.minFilter!==Ni||v.type===Tn&&e.has("OES_texture_float_linear")===!1||a===!1&&v.type===Fi&&e.has("OES_texture_half_float_linear")===!1)return;(v.anisotropy>1||i.get(v).__currentAnisotropy)&&(n.texParameterf(E,re.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(v.anisotropy,r.getMaxAnisotropy())),i.get(v).__currentAnisotropy=v.anisotropy)}}function xe(E,v){let I=!1;E.__webglInit===void 0&&(E.__webglInit=!0,v.addEventListener("dispose",k));const re=v.source;let te=p.get(re);te===void 0&&(te={},p.set(re,te));const le=Y(v);if(le!==E.__cacheKey){te[le]===void 0&&(te[le]={texture:n.createTexture(),usedTimes:0},o.memory.textures++,I=!0),te[le].usedTimes++;const Te=te[E.__cacheKey];Te!==void 0&&(te[E.__cacheKey].usedTimes--,Te.usedTimes===0&&D(v)),E.__cacheKey=le,E.__webglTexture=te[le].texture}return I}function K(E,v,I){let re=n.TEXTURE_2D;(v.isDataArrayTexture||v.isCompressedArrayTexture)&&(re=n.TEXTURE_2D_ARRAY),v.isData3DTexture&&(re=n.TEXTURE_3D);const te=xe(E,v),le=v.source;t.bindTexture(re,E.__webglTexture,n.TEXTURE0+I);const Te=i.get(le);if(le.version!==Te.__version||te===!0){t.activeTexture(n.TEXTURE0+I);const he=Qe.getPrimaries(Qe.workingColorSpace),ve=v.colorSpace===kt?null:Qe.getPrimaries(v.colorSpace),C=v.colorSpace===kt||he===ve?n.NONE:n.BROWSER_DEFAULT_WEBGL;n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,v.flipY),n.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,v.premultiplyAlpha),n.pixelStorei(n.UNPACK_ALIGNMENT,v.unpackAlignment),n.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,C);const se=b(v)&&w(v.image)===!1;let Z=g(v.image,se,!1,h);Z=ze(v,Z);const Ne=w(Z)||a,Ce=s.convert(v.format,v.colorSpace);let Ae=s.convert(v.type),Ee=G(v.internalFormat,Ce,Ae,v.colorSpace,v.isVideoTexture);Le(re,v,Ne);let ye;const He=v.mipmaps,P=a&&v.isVideoTexture!==!0,_e=Te.__version===void 0||te===!0,oe=M(v,Z,Ne);if(v.isDepthTexture)Ee=n.DEPTH_COMPONENT,a?v.type===Tn?Ee=n.DEPTH_COMPONENT32F:v.type===yn?Ee=n.DEPTH_COMPONENT24:v.type===Gn?Ee=n.DEPTH24_STENCIL8:Ee=n.DEPTH_COMPONENT16:v.type===Tn&&console.error("WebGLRenderer: Floating point depth texture requires WebGL2."),v.format===Vn&&Ee===n.DEPTH_COMPONENT&&v.type!==Ms&&v.type!==yn&&(console.warn("THREE.WebGLRenderer: Use UnsignedShortType or UnsignedIntType for DepthFormat DepthTexture."),v.type=yn,Ae=s.convert(v.type)),v.format===xi&&Ee===n.DEPTH_COMPONENT&&(Ee=n.DEPTH_STENCIL,v.type!==Gn&&(console.warn("THREE.WebGLRenderer: Use UnsignedInt248Type for DepthStencilFormat DepthTexture."),v.type=Gn,Ae=s.convert(v.type))),_e&&(P?t.texStorage2D(n.TEXTURE_2D,1,Ee,Z.width,Z.height):t.texImage2D(n.TEXTURE_2D,0,Ee,Z.width,Z.height,0,Ce,Ae,null));else if(v.isDataTexture)if(He.length>0&&Ne){P&&_e&&t.texStorage2D(n.TEXTURE_2D,oe,Ee,He[0].width,He[0].height);for(let j=0,ue=He.length;j<ue;j++)ye=He[j],P?t.texSubImage2D(n.TEXTURE_2D,j,0,0,ye.width,ye.height,Ce,Ae,ye.data):t.texImage2D(n.TEXTURE_2D,j,Ee,ye.width,ye.height,0,Ce,Ae,ye.data);v.generateMipmaps=!1}else P?(_e&&t.texStorage2D(n.TEXTURE_2D,oe,Ee,Z.width,Z.height),t.texSubImage2D(n.TEXTURE_2D,0,0,0,Z.width,Z.height,Ce,Ae,Z.data)):t.texImage2D(n.TEXTURE_2D,0,Ee,Z.width,Z.height,0,Ce,Ae,Z.data);else if(v.isCompressedTexture)if(v.isCompressedArrayTexture){P&&_e&&t.texStorage3D(n.TEXTURE_2D_ARRAY,oe,Ee,He[0].width,He[0].height,Z.depth);for(let j=0,ue=He.length;j<ue;j++)ye=He[j],v.format!==Kt?Ce!==null?P?t.compressedTexSubImage3D(n.TEXTURE_2D_ARRAY,j,0,0,0,ye.width,ye.height,Z.depth,Ce,ye.data,0,0):t.compressedTexImage3D(n.TEXTURE_2D_ARRAY,j,Ee,ye.width,ye.height,Z.depth,0,ye.data,0,0):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):P?t.texSubImage3D(n.TEXTURE_2D_ARRAY,j,0,0,0,ye.width,ye.height,Z.depth,Ce,Ae,ye.data):t.texImage3D(n.TEXTURE_2D_ARRAY,j,Ee,ye.width,ye.height,Z.depth,0,Ce,Ae,ye.data)}else{P&&_e&&t.texStorage2D(n.TEXTURE_2D,oe,Ee,He[0].width,He[0].height);for(let j=0,ue=He.length;j<ue;j++)ye=He[j],v.format!==Kt?Ce!==null?P?t.compressedTexSubImage2D(n.TEXTURE_2D,j,0,0,ye.width,ye.height,Ce,ye.data):t.compressedTexImage2D(n.TEXTURE_2D,j,Ee,ye.width,ye.height,0,ye.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):P?t.texSubImage2D(n.TEXTURE_2D,j,0,0,ye.width,ye.height,Ce,Ae,ye.data):t.texImage2D(n.TEXTURE_2D,j,Ee,ye.width,ye.height,0,Ce,Ae,ye.data)}else if(v.isDataArrayTexture)P?(_e&&t.texStorage3D(n.TEXTURE_2D_ARRAY,oe,Ee,Z.width,Z.height,Z.depth),t.texSubImage3D(n.TEXTURE_2D_ARRAY,0,0,0,0,Z.width,Z.height,Z.depth,Ce,Ae,Z.data)):t.texImage3D(n.TEXTURE_2D_ARRAY,0,Ee,Z.width,Z.height,Z.depth,0,Ce,Ae,Z.data);else if(v.isData3DTexture)P?(_e&&t.texStorage3D(n.TEXTURE_3D,oe,Ee,Z.width,Z.height,Z.depth),t.texSubImage3D(n.TEXTURE_3D,0,0,0,0,Z.width,Z.height,Z.depth,Ce,Ae,Z.data)):t.texImage3D(n.TEXTURE_3D,0,Ee,Z.width,Z.height,Z.depth,0,Ce,Ae,Z.data);else if(v.isFramebufferTexture){if(_e)if(P)t.texStorage2D(n.TEXTURE_2D,oe,Ee,Z.width,Z.height);else{let j=Z.width,ue=Z.height;for(let Pe=0;Pe<oe;Pe++)t.texImage2D(n.TEXTURE_2D,Pe,Ee,j,ue,0,Ce,Ae,null),j>>=1,ue>>=1}}else if(He.length>0&&Ne){P&&_e&&t.texStorage2D(n.TEXTURE_2D,oe,Ee,He[0].width,He[0].height);for(let j=0,ue=He.length;j<ue;j++)ye=He[j],P?t.texSubImage2D(n.TEXTURE_2D,j,0,0,Ce,Ae,ye):t.texImage2D(n.TEXTURE_2D,j,Ee,Ce,Ae,ye);v.generateMipmaps=!1}else P?(_e&&t.texStorage2D(n.TEXTURE_2D,oe,Ee,Z.width,Z.height),t.texSubImage2D(n.TEXTURE_2D,0,0,0,Ce,Ae,Z)):t.texImage2D(n.TEXTURE_2D,0,Ee,Ce,Ae,Z);R(v,Ne)&&A(re),Te.__version=le.version,v.onUpdate&&v.onUpdate(v)}E.__version=v.version}function ie(E,v,I){if(v.image.length!==6)return;const re=xe(E,v),te=v.source;t.bindTexture(n.TEXTURE_CUBE_MAP,E.__webglTexture,n.TEXTURE0+I);const le=i.get(te);if(te.version!==le.__version||re===!0){t.activeTexture(n.TEXTURE0+I);const Te=Qe.getPrimaries(Qe.workingColorSpace),he=v.colorSpace===kt?null:Qe.getPrimaries(v.colorSpace),ve=v.colorSpace===kt||Te===he?n.NONE:n.BROWSER_DEFAULT_WEBGL;n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,v.flipY),n.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,v.premultiplyAlpha),n.pixelStorei(n.UNPACK_ALIGNMENT,v.unpackAlignment),n.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,ve);const C=v.isCompressedTexture||v.image[0].isCompressedTexture,se=v.image[0]&&v.image[0].isDataTexture,Z=[];for(let j=0;j<6;j++)!C&&!se?Z[j]=g(v.image[j],!1,!0,c):Z[j]=se?v.image[j].image:v.image[j],Z[j]=ze(v,Z[j]);const Ne=Z[0],Ce=w(Ne)||a,Ae=s.convert(v.format,v.colorSpace),Ee=s.convert(v.type),ye=G(v.internalFormat,Ae,Ee,v.colorSpace),He=a&&v.isVideoTexture!==!0,P=le.__version===void 0||re===!0;let _e=M(v,Ne,Ce);Le(n.TEXTURE_CUBE_MAP,v,Ce);let oe;if(C){He&&P&&t.texStorage2D(n.TEXTURE_CUBE_MAP,_e,ye,Ne.width,Ne.height);for(let j=0;j<6;j++){oe=Z[j].mipmaps;for(let ue=0;ue<oe.length;ue++){const Pe=oe[ue];v.format!==Kt?Ae!==null?He?t.compressedTexSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+j,ue,0,0,Pe.width,Pe.height,Ae,Pe.data):t.compressedTexImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+j,ue,ye,Pe.width,Pe.height,0,Pe.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):He?t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+j,ue,0,0,Pe.width,Pe.height,Ae,Ee,Pe.data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+j,ue,ye,Pe.width,Pe.height,0,Ae,Ee,Pe.data)}}}else{oe=v.mipmaps,He&&P&&(oe.length>0&&_e++,t.texStorage2D(n.TEXTURE_CUBE_MAP,_e,ye,Z[0].width,Z[0].height));for(let j=0;j<6;j++)if(se){He?t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+j,0,0,0,Z[j].width,Z[j].height,Ae,Ee,Z[j].data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+j,0,ye,Z[j].width,Z[j].height,0,Ae,Ee,Z[j].data);for(let ue=0;ue<oe.length;ue++){const Oe=oe[ue].image[j].image;He?t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+j,ue+1,0,0,Oe.width,Oe.height,Ae,Ee,Oe.data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+j,ue+1,ye,Oe.width,Oe.height,0,Ae,Ee,Oe.data)}}else{He?t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+j,0,0,0,Ae,Ee,Z[j]):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+j,0,ye,Ae,Ee,Z[j]);for(let ue=0;ue<oe.length;ue++){const Pe=oe[ue];He?t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+j,ue+1,0,0,Ae,Ee,Pe.image[j]):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+j,ue+1,ye,Ae,Ee,Pe.image[j])}}}R(v,Ce)&&A(n.TEXTURE_CUBE_MAP),le.__version=te.version,v.onUpdate&&v.onUpdate(v)}E.__version=v.version}function ce(E,v,I,re,te,le){const Te=s.convert(I.format,I.colorSpace),he=s.convert(I.type),ve=G(I.internalFormat,Te,he,I.colorSpace);if(!i.get(v).__hasExternalTextures){const se=Math.max(1,v.width>>le),Z=Math.max(1,v.height>>le);te===n.TEXTURE_3D||te===n.TEXTURE_2D_ARRAY?t.texImage3D(te,le,ve,se,Z,v.depth,0,Te,he,null):t.texImage2D(te,le,ve,se,Z,0,Te,he,null)}t.bindFramebuffer(n.FRAMEBUFFER,E),Re(v)?f.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,re,te,i.get(I).__webglTexture,0,Se(v)):(te===n.TEXTURE_2D||te>=n.TEXTURE_CUBE_MAP_POSITIVE_X&&te<=n.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&n.framebufferTexture2D(n.FRAMEBUFFER,re,te,i.get(I).__webglTexture,le),t.bindFramebuffer(n.FRAMEBUFFER,null)}function L(E,v,I){if(n.bindRenderbuffer(n.RENDERBUFFER,E),v.depthBuffer&&!v.stencilBuffer){let re=a===!0?n.DEPTH_COMPONENT24:n.DEPTH_COMPONENT16;if(I||Re(v)){const te=v.depthTexture;te&&te.isDepthTexture&&(te.type===Tn?re=n.DEPTH_COMPONENT32F:te.type===yn&&(re=n.DEPTH_COMPONENT24));const le=Se(v);Re(v)?f.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,le,re,v.width,v.height):n.renderbufferStorageMultisample(n.RENDERBUFFER,le,re,v.width,v.height)}else n.renderbufferStorage(n.RENDERBUFFER,re,v.width,v.height);n.framebufferRenderbuffer(n.FRAMEBUFFER,n.DEPTH_ATTACHMENT,n.RENDERBUFFER,E)}else if(v.depthBuffer&&v.stencilBuffer){const re=Se(v);I&&Re(v)===!1?n.renderbufferStorageMultisample(n.RENDERBUFFER,re,n.DEPTH24_STENCIL8,v.width,v.height):Re(v)?f.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,re,n.DEPTH24_STENCIL8,v.width,v.height):n.renderbufferStorage(n.RENDERBUFFER,n.DEPTH_STENCIL,v.width,v.height),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.DEPTH_STENCIL_ATTACHMENT,n.RENDERBUFFER,E)}else{const re=v.isWebGLMultipleRenderTargets===!0?v.texture:[v.texture];for(let te=0;te<re.length;te++){const le=re[te],Te=s.convert(le.format,le.colorSpace),he=s.convert(le.type),ve=G(le.internalFormat,Te,he,le.colorSpace),C=Se(v);I&&Re(v)===!1?n.renderbufferStorageMultisample(n.RENDERBUFFER,C,ve,v.width,v.height):Re(v)?f.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,C,ve,v.width,v.height):n.renderbufferStorage(n.RENDERBUFFER,ve,v.width,v.height)}}n.bindRenderbuffer(n.RENDERBUFFER,null)}function De(E,v){if(v&&v.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(t.bindFramebuffer(n.FRAMEBUFFER,E),!(v.depthTexture&&v.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");(!i.get(v.depthTexture).__webglTexture||v.depthTexture.image.width!==v.width||v.depthTexture.image.height!==v.height)&&(v.depthTexture.image.width=v.width,v.depthTexture.image.height=v.height,v.depthTexture.needsUpdate=!0),J(v.depthTexture,0);const re=i.get(v.depthTexture).__webglTexture,te=Se(v);if(v.depthTexture.format===Vn)Re(v)?f.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,n.DEPTH_ATTACHMENT,n.TEXTURE_2D,re,0,te):n.framebufferTexture2D(n.FRAMEBUFFER,n.DEPTH_ATTACHMENT,n.TEXTURE_2D,re,0);else if(v.depthTexture.format===xi)Re(v)?f.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,n.DEPTH_STENCIL_ATTACHMENT,n.TEXTURE_2D,re,0,te):n.framebufferTexture2D(n.FRAMEBUFFER,n.DEPTH_STENCIL_ATTACHMENT,n.TEXTURE_2D,re,0);else throw new Error("Unknown depthTexture format")}function Q(E){const v=i.get(E),I=E.isWebGLCubeRenderTarget===!0;if(E.depthTexture&&!v.__autoAllocateDepthBuffer){if(I)throw new Error("target.depthTexture not supported in Cube render targets");De(v.__webglFramebuffer,E)}else if(I){v.__webglDepthbuffer=[];for(let re=0;re<6;re++)t.bindFramebuffer(n.FRAMEBUFFER,v.__webglFramebuffer[re]),v.__webglDepthbuffer[re]=n.createRenderbuffer(),L(v.__webglDepthbuffer[re],E,!1)}else t.bindFramebuffer(n.FRAMEBUFFER,v.__webglFramebuffer),v.__webglDepthbuffer=n.createRenderbuffer(),L(v.__webglDepthbuffer,E,!1);t.bindFramebuffer(n.FRAMEBUFFER,null)}function ae(E,v,I){const re=i.get(E);v!==void 0&&ce(re.__webglFramebuffer,E,E.texture,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,0),I!==void 0&&Q(E)}function me(E){const v=E.texture,I=i.get(E),re=i.get(v);E.addEventListener("dispose",q),E.isWebGLMultipleRenderTargets!==!0&&(re.__webglTexture===void 0&&(re.__webglTexture=n.createTexture()),re.__version=v.version,o.memory.textures++);const te=E.isWebGLCubeRenderTarget===!0,le=E.isWebGLMultipleRenderTargets===!0,Te=w(E)||a;if(te){I.__webglFramebuffer=[];for(let he=0;he<6;he++)if(a&&v.mipmaps&&v.mipmaps.length>0){I.__webglFramebuffer[he]=[];for(let ve=0;ve<v.mipmaps.length;ve++)I.__webglFramebuffer[he][ve]=n.createFramebuffer()}else I.__webglFramebuffer[he]=n.createFramebuffer()}else{if(a&&v.mipmaps&&v.mipmaps.length>0){I.__webglFramebuffer=[];for(let he=0;he<v.mipmaps.length;he++)I.__webglFramebuffer[he]=n.createFramebuffer()}else I.__webglFramebuffer=n.createFramebuffer();if(le)if(r.drawBuffers){const he=E.texture;for(let ve=0,C=he.length;ve<C;ve++){const se=i.get(he[ve]);se.__webglTexture===void 0&&(se.__webglTexture=n.createTexture(),o.memory.textures++)}}else console.warn("THREE.WebGLRenderer: WebGLMultipleRenderTargets can only be used with WebGL2 or WEBGL_draw_buffers extension.");if(a&&E.samples>0&&Re(E)===!1){const he=le?v:[v];I.__webglMultisampledFramebuffer=n.createFramebuffer(),I.__webglColorRenderbuffer=[],t.bindFramebuffer(n.FRAMEBUFFER,I.__webglMultisampledFramebuffer);for(let ve=0;ve<he.length;ve++){const C=he[ve];I.__webglColorRenderbuffer[ve]=n.createRenderbuffer(),n.bindRenderbuffer(n.RENDERBUFFER,I.__webglColorRenderbuffer[ve]);const se=s.convert(C.format,C.colorSpace),Z=s.convert(C.type),Ne=G(C.internalFormat,se,Z,C.colorSpace,E.isXRRenderTarget===!0),Ce=Se(E);n.renderbufferStorageMultisample(n.RENDERBUFFER,Ce,Ne,E.width,E.height),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+ve,n.RENDERBUFFER,I.__webglColorRenderbuffer[ve])}n.bindRenderbuffer(n.RENDERBUFFER,null),E.depthBuffer&&(I.__webglDepthRenderbuffer=n.createRenderbuffer(),L(I.__webglDepthRenderbuffer,E,!0)),t.bindFramebuffer(n.FRAMEBUFFER,null)}}if(te){t.bindTexture(n.TEXTURE_CUBE_MAP,re.__webglTexture),Le(n.TEXTURE_CUBE_MAP,v,Te);for(let he=0;he<6;he++)if(a&&v.mipmaps&&v.mipmaps.length>0)for(let ve=0;ve<v.mipmaps.length;ve++)ce(I.__webglFramebuffer[he][ve],E,v,n.COLOR_ATTACHMENT0,n.TEXTURE_CUBE_MAP_POSITIVE_X+he,ve);else ce(I.__webglFramebuffer[he],E,v,n.COLOR_ATTACHMENT0,n.TEXTURE_CUBE_MAP_POSITIVE_X+he,0);R(v,Te)&&A(n.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(le){const he=E.texture;for(let ve=0,C=he.length;ve<C;ve++){const se=he[ve],Z=i.get(se);t.bindTexture(n.TEXTURE_2D,Z.__webglTexture),Le(n.TEXTURE_2D,se,Te),ce(I.__webglFramebuffer,E,se,n.COLOR_ATTACHMENT0+ve,n.TEXTURE_2D,0),R(se,Te)&&A(n.TEXTURE_2D)}t.unbindTexture()}else{let he=n.TEXTURE_2D;if((E.isWebGL3DRenderTarget||E.isWebGLArrayRenderTarget)&&(a?he=E.isWebGL3DRenderTarget?n.TEXTURE_3D:n.TEXTURE_2D_ARRAY:console.error("THREE.WebGLTextures: THREE.Data3DTexture and THREE.DataArrayTexture only supported with WebGL2.")),t.bindTexture(he,re.__webglTexture),Le(he,v,Te),a&&v.mipmaps&&v.mipmaps.length>0)for(let ve=0;ve<v.mipmaps.length;ve++)ce(I.__webglFramebuffer[ve],E,v,n.COLOR_ATTACHMENT0,he,ve);else ce(I.__webglFramebuffer,E,v,n.COLOR_ATTACHMENT0,he,0);R(v,Te)&&A(he),t.unbindTexture()}E.depthBuffer&&Q(E)}function Ie(E){const v=w(E)||a,I=E.isWebGLMultipleRenderTargets===!0?E.texture:[E.texture];for(let re=0,te=I.length;re<te;re++){const le=I[re];if(R(le,v)){const Te=E.isWebGLCubeRenderTarget?n.TEXTURE_CUBE_MAP:n.TEXTURE_2D,he=i.get(le).__webglTexture;t.bindTexture(Te,he),A(Te),t.unbindTexture()}}}function Me(E){if(a&&E.samples>0&&Re(E)===!1){const v=E.isWebGLMultipleRenderTargets?E.texture:[E.texture],I=E.width,re=E.height;let te=n.COLOR_BUFFER_BIT;const le=[],Te=E.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,he=i.get(E),ve=E.isWebGLMultipleRenderTargets===!0;if(ve)for(let C=0;C<v.length;C++)t.bindFramebuffer(n.FRAMEBUFFER,he.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+C,n.RENDERBUFFER,null),t.bindFramebuffer(n.FRAMEBUFFER,he.__webglFramebuffer),n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0+C,n.TEXTURE_2D,null,0);t.bindFramebuffer(n.READ_FRAMEBUFFER,he.__webglMultisampledFramebuffer),t.bindFramebuffer(n.DRAW_FRAMEBUFFER,he.__webglFramebuffer);for(let C=0;C<v.length;C++){le.push(n.COLOR_ATTACHMENT0+C),E.depthBuffer&&le.push(Te);const se=he.__ignoreDepthValues!==void 0?he.__ignoreDepthValues:!1;if(se===!1&&(E.depthBuffer&&(te|=n.DEPTH_BUFFER_BIT),E.stencilBuffer&&(te|=n.STENCIL_BUFFER_BIT)),ve&&n.framebufferRenderbuffer(n.READ_FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.RENDERBUFFER,he.__webglColorRenderbuffer[C]),se===!0&&(n.invalidateFramebuffer(n.READ_FRAMEBUFFER,[Te]),n.invalidateFramebuffer(n.DRAW_FRAMEBUFFER,[Te])),ve){const Z=i.get(v[C]).__webglTexture;n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,Z,0)}n.blitFramebuffer(0,0,I,re,0,0,I,re,te,n.NEAREST),m&&n.invalidateFramebuffer(n.READ_FRAMEBUFFER,le)}if(t.bindFramebuffer(n.READ_FRAMEBUFFER,null),t.bindFramebuffer(n.DRAW_FRAMEBUFFER,null),ve)for(let C=0;C<v.length;C++){t.bindFramebuffer(n.FRAMEBUFFER,he.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+C,n.RENDERBUFFER,he.__webglColorRenderbuffer[C]);const se=i.get(v[C]).__webglTexture;t.bindFramebuffer(n.FRAMEBUFFER,he.__webglFramebuffer),n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0+C,n.TEXTURE_2D,se,0)}t.bindFramebuffer(n.DRAW_FRAMEBUFFER,he.__webglMultisampledFramebuffer)}}function Se(E){return Math.min(d,E.samples)}function Re(E){const v=i.get(E);return a&&E.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&v.__useRenderToTexture!==!1}function Ue(E){const v=o.render.frame;_.get(E)!==v&&(_.set(E,v),E.update())}function ze(E,v){const I=E.colorSpace,re=E.format,te=E.type;return E.isCompressedTexture===!0||E.isVideoTexture===!0||E.format===fs||I!==mn&&I!==kt&&(Qe.getTransfer(I)===rt?a===!1?e.has("EXT_sRGB")===!0&&re===Kt?(E.format=fs,E.minFilter=Gt,E.generateMipmaps=!1):v=bo.sRGBToLinear(v):(re!==Kt||te!==wn)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",I)),v}this.allocateTextureUnit=ee,this.resetTextureUnits=X,this.setTexture2D=J,this.setTexture2DArray=U,this.setTexture3D=F,this.setTextureCube=ge,this.rebindTextures=ae,this.setupRenderTarget=me,this.updateRenderTargetMipmap=Ie,this.updateMultisampleRenderTarget=Me,this.setupDepthRenderbuffer=Q,this.setupFrameBufferTexture=ce,this.useMultisampledRTT=Re}function cp(n,e,t){const i=t.isWebGL2;function r(s,o=kt){let a;const l=Qe.getTransfer(o);if(s===wn)return n.UNSIGNED_BYTE;if(s===_o)return n.UNSIGNED_SHORT_4_4_4_4;if(s===vo)return n.UNSIGNED_SHORT_5_5_5_1;if(s===Pl)return n.BYTE;if(s===Dl)return n.SHORT;if(s===Ms)return n.UNSIGNED_SHORT;if(s===go)return n.INT;if(s===yn)return n.UNSIGNED_INT;if(s===Tn)return n.FLOAT;if(s===Fi)return i?n.HALF_FLOAT:(a=e.get("OES_texture_half_float"),a!==null?a.HALF_FLOAT_OES:null);if(s===Ul)return n.ALPHA;if(s===Kt)return n.RGBA;if(s===Il)return n.LUMINANCE;if(s===Nl)return n.LUMINANCE_ALPHA;if(s===Vn)return n.DEPTH_COMPONENT;if(s===xi)return n.DEPTH_STENCIL;if(s===fs)return a=e.get("EXT_sRGB"),a!==null?a.SRGB_ALPHA_EXT:null;if(s===Fl)return n.RED;if(s===xo)return n.RED_INTEGER;if(s===Ol)return n.RG;if(s===Mo)return n.RG_INTEGER;if(s===So)return n.RGBA_INTEGER;if(s===Cr||s===Lr||s===Pr||s===Dr)if(l===rt)if(a=e.get("WEBGL_compressed_texture_s3tc_srgb"),a!==null){if(s===Cr)return a.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(s===Lr)return a.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(s===Pr)return a.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(s===Dr)return a.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(a=e.get("WEBGL_compressed_texture_s3tc"),a!==null){if(s===Cr)return a.COMPRESSED_RGB_S3TC_DXT1_EXT;if(s===Lr)return a.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(s===Pr)return a.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(s===Dr)return a.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(s===Os||s===zs||s===Bs||s===Hs)if(a=e.get("WEBGL_compressed_texture_pvrtc"),a!==null){if(s===Os)return a.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(s===zs)return a.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(s===Bs)return a.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(s===Hs)return a.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(s===zl)return a=e.get("WEBGL_compressed_texture_etc1"),a!==null?a.COMPRESSED_RGB_ETC1_WEBGL:null;if(s===Gs||s===Vs)if(a=e.get("WEBGL_compressed_texture_etc"),a!==null){if(s===Gs)return l===rt?a.COMPRESSED_SRGB8_ETC2:a.COMPRESSED_RGB8_ETC2;if(s===Vs)return l===rt?a.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:a.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(s===ks||s===Ws||s===Xs||s===qs||s===Ys||s===js||s===Ks||s===Zs||s===$s||s===Js||s===Qs||s===ea||s===ta||s===na)if(a=e.get("WEBGL_compressed_texture_astc"),a!==null){if(s===ks)return l===rt?a.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:a.COMPRESSED_RGBA_ASTC_4x4_KHR;if(s===Ws)return l===rt?a.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:a.COMPRESSED_RGBA_ASTC_5x4_KHR;if(s===Xs)return l===rt?a.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:a.COMPRESSED_RGBA_ASTC_5x5_KHR;if(s===qs)return l===rt?a.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:a.COMPRESSED_RGBA_ASTC_6x5_KHR;if(s===Ys)return l===rt?a.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:a.COMPRESSED_RGBA_ASTC_6x6_KHR;if(s===js)return l===rt?a.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:a.COMPRESSED_RGBA_ASTC_8x5_KHR;if(s===Ks)return l===rt?a.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:a.COMPRESSED_RGBA_ASTC_8x6_KHR;if(s===Zs)return l===rt?a.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:a.COMPRESSED_RGBA_ASTC_8x8_KHR;if(s===$s)return l===rt?a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:a.COMPRESSED_RGBA_ASTC_10x5_KHR;if(s===Js)return l===rt?a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:a.COMPRESSED_RGBA_ASTC_10x6_KHR;if(s===Qs)return l===rt?a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:a.COMPRESSED_RGBA_ASTC_10x8_KHR;if(s===ea)return l===rt?a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:a.COMPRESSED_RGBA_ASTC_10x10_KHR;if(s===ta)return l===rt?a.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:a.COMPRESSED_RGBA_ASTC_12x10_KHR;if(s===na)return l===rt?a.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:a.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(s===Ur||s===ia||s===ra)if(a=e.get("EXT_texture_compression_bptc"),a!==null){if(s===Ur)return l===rt?a.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:a.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(s===ia)return a.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(s===ra)return a.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(s===Bl||s===sa||s===aa||s===oa)if(a=e.get("EXT_texture_compression_rgtc"),a!==null){if(s===Ur)return a.COMPRESSED_RED_RGTC1_EXT;if(s===sa)return a.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(s===aa)return a.COMPRESSED_RED_GREEN_RGTC2_EXT;if(s===oa)return a.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return s===Gn?i?n.UNSIGNED_INT_24_8:(a=e.get("WEBGL_depth_texture"),a!==null?a.UNSIGNED_INT_24_8_WEBGL:null):n[s]!==void 0?n[s]:null}return{convert:r}}class hp extends Vt{constructor(e=[]){super(),this.isArrayCamera=!0,this.cameras=e}}class Li extends gt{constructor(){super(),this.isGroup=!0,this.type="Group"}}const up={type:"move"};class ns{constructor(){this._targetRay=null,this._grip=null,this._hand=null}getHandSpace(){return this._hand===null&&(this._hand=new Li,this._hand.matrixAutoUpdate=!1,this._hand.visible=!1,this._hand.joints={},this._hand.inputState={pinching:!1}),this._hand}getTargetRaySpace(){return this._targetRay===null&&(this._targetRay=new Li,this._targetRay.matrixAutoUpdate=!1,this._targetRay.visible=!1,this._targetRay.hasLinearVelocity=!1,this._targetRay.linearVelocity=new O,this._targetRay.hasAngularVelocity=!1,this._targetRay.angularVelocity=new O),this._targetRay}getGripSpace(){return this._grip===null&&(this._grip=new Li,this._grip.matrixAutoUpdate=!1,this._grip.visible=!1,this._grip.hasLinearVelocity=!1,this._grip.linearVelocity=new O,this._grip.hasAngularVelocity=!1,this._grip.angularVelocity=new O),this._grip}dispatchEvent(e){return this._targetRay!==null&&this._targetRay.dispatchEvent(e),this._grip!==null&&this._grip.dispatchEvent(e),this._hand!==null&&this._hand.dispatchEvent(e),this}connect(e){if(e&&e.hand){const t=this._hand;if(t)for(const i of e.hand.values())this._getHandJoint(t,i)}return this.dispatchEvent({type:"connected",data:e}),this}disconnect(e){return this.dispatchEvent({type:"disconnected",data:e}),this._targetRay!==null&&(this._targetRay.visible=!1),this._grip!==null&&(this._grip.visible=!1),this._hand!==null&&(this._hand.visible=!1),this}update(e,t,i){let r=null,s=null,o=null;const a=this._targetRay,l=this._grip,c=this._hand;if(e&&t.session.visibilityState!=="visible-blurred"){if(c&&e.hand){o=!0;for(const x of e.hand.values()){const p=t.getJointPose(x,i),u=this._getHandJoint(c,x);p!==null&&(u.matrix.fromArray(p.transform.matrix),u.matrix.decompose(u.position,u.rotation,u.scale),u.matrixWorldNeedsUpdate=!0,u.jointRadius=p.radius),u.visible=p!==null}const h=c.joints["index-finger-tip"],d=c.joints["thumb-tip"],f=h.position.distanceTo(d.position),m=.02,_=.005;c.inputState.pinching&&f>m+_?(c.inputState.pinching=!1,this.dispatchEvent({type:"pinchend",handedness:e.handedness,target:this})):!c.inputState.pinching&&f<=m-_&&(c.inputState.pinching=!0,this.dispatchEvent({type:"pinchstart",handedness:e.handedness,target:this}))}else l!==null&&e.gripSpace&&(s=t.getPose(e.gripSpace,i),s!==null&&(l.matrix.fromArray(s.transform.matrix),l.matrix.decompose(l.position,l.rotation,l.scale),l.matrixWorldNeedsUpdate=!0,s.linearVelocity?(l.hasLinearVelocity=!0,l.linearVelocity.copy(s.linearVelocity)):l.hasLinearVelocity=!1,s.angularVelocity?(l.hasAngularVelocity=!0,l.angularVelocity.copy(s.angularVelocity)):l.hasAngularVelocity=!1));a!==null&&(r=t.getPose(e.targetRaySpace,i),r===null&&s!==null&&(r=s),r!==null&&(a.matrix.fromArray(r.transform.matrix),a.matrix.decompose(a.position,a.rotation,a.scale),a.matrixWorldNeedsUpdate=!0,r.linearVelocity?(a.hasLinearVelocity=!0,a.linearVelocity.copy(r.linearVelocity)):a.hasLinearVelocity=!1,r.angularVelocity?(a.hasAngularVelocity=!0,a.angularVelocity.copy(r.angularVelocity)):a.hasAngularVelocity=!1,this.dispatchEvent(up)))}return a!==null&&(a.visible=r!==null),l!==null&&(l.visible=s!==null),c!==null&&(c.visible=o!==null),this}_getHandJoint(e,t){if(e.joints[t.jointName]===void 0){const i=new Li;i.matrixAutoUpdate=!1,i.visible=!1,e.joints[t.jointName]=i,e.add(i)}return e.joints[t.jointName]}}class dp extends zt{constructor(e,t,i,r,s,o,a,l,c,h){if(h=h!==void 0?h:Vn,h!==Vn&&h!==xi)throw new Error("DepthTexture format must be either THREE.DepthFormat or THREE.DepthStencilFormat");i===void 0&&h===Vn&&(i=yn),i===void 0&&h===xi&&(i=Gn),super(null,r,s,o,a,l,h,i,c),this.isDepthTexture=!0,this.image={width:e,height:t},this.magFilter=a!==void 0?a:Rt,this.minFilter=l!==void 0?l:Rt,this.flipY=!1,this.generateMipmaps=!1,this.compareFunction=null}copy(e){return super.copy(e),this.compareFunction=e.compareFunction,this}toJSON(e){const t=super.toJSON(e);return this.compareFunction!==null&&(t.compareFunction=this.compareFunction),t}}class fp extends Yn{constructor(e,t){super();const i=this;let r=null,s=1,o=null,a="local-floor",l=1,c=null,h=null,d=null,f=null,m=null,_=null;const x=t.getContextAttributes();let p=null,u=null;const y=[],g=[],w=new Vt;w.layers.enable(1),w.viewport=new mt;const b=new Vt;b.layers.enable(2),b.viewport=new mt;const R=[w,b],A=new hp;A.layers.enable(1),A.layers.enable(2);let G=null,M=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(U){let F=y[U];return F===void 0&&(F=new ns,y[U]=F),F.getTargetRaySpace()},this.getControllerGrip=function(U){let F=y[U];return F===void 0&&(F=new ns,y[U]=F),F.getGripSpace()},this.getHand=function(U){let F=y[U];return F===void 0&&(F=new ns,y[U]=F),F.getHandSpace()};function T(U){const F=g.indexOf(U.inputSource);if(F===-1)return;const ge=y[F];ge!==void 0&&(ge.update(U.inputSource,U.frame,c||o),ge.dispatchEvent({type:U.type,data:U.inputSource}))}function k(){r.removeEventListener("select",T),r.removeEventListener("selectstart",T),r.removeEventListener("selectend",T),r.removeEventListener("squeeze",T),r.removeEventListener("squeezestart",T),r.removeEventListener("squeezeend",T),r.removeEventListener("end",k),r.removeEventListener("inputsourceschange",q);for(let U=0;U<y.length;U++){const F=g[U];F!==null&&(g[U]=null,y[U].disconnect(F))}G=null,M=null,e.setRenderTarget(p),m=null,f=null,d=null,r=null,u=null,J.stop(),i.isPresenting=!1,i.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(U){s=U,i.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(U){a=U,i.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return c||o},this.setReferenceSpace=function(U){c=U},this.getBaseLayer=function(){return f!==null?f:m},this.getBinding=function(){return d},this.getFrame=function(){return _},this.getSession=function(){return r},this.setSession=async function(U){if(r=U,r!==null){if(p=e.getRenderTarget(),r.addEventListener("select",T),r.addEventListener("selectstart",T),r.addEventListener("selectend",T),r.addEventListener("squeeze",T),r.addEventListener("squeezestart",T),r.addEventListener("squeezeend",T),r.addEventListener("end",k),r.addEventListener("inputsourceschange",q),x.xrCompatible!==!0&&await t.makeXRCompatible(),r.renderState.layers===void 0||e.capabilities.isWebGL2===!1){const F={antialias:r.renderState.layers===void 0?x.antialias:!0,alpha:!0,depth:x.depth,stencil:x.stencil,framebufferScaleFactor:s};m=new XRWebGLLayer(r,t,F),r.updateRenderState({baseLayer:m}),u=new Wn(m.framebufferWidth,m.framebufferHeight,{format:Kt,type:wn,colorSpace:e.outputColorSpace,stencilBuffer:x.stencil})}else{let F=null,ge=null,pe=null;x.depth&&(pe=x.stencil?t.DEPTH24_STENCIL8:t.DEPTH_COMPONENT24,F=x.stencil?xi:Vn,ge=x.stencil?Gn:yn);const $={colorFormat:t.RGBA8,depthFormat:pe,scaleFactor:s};d=new XRWebGLBinding(r,t),f=d.createProjectionLayer($),r.updateRenderState({layers:[f]}),u=new Wn(f.textureWidth,f.textureHeight,{format:Kt,type:wn,depthTexture:new dp(f.textureWidth,f.textureHeight,ge,void 0,void 0,void 0,void 0,void 0,void 0,F),stencilBuffer:x.stencil,colorSpace:e.outputColorSpace,samples:x.antialias?4:0});const de=e.properties.get(u);de.__ignoreDepthValues=f.ignoreDepthValues}u.isXRRenderTarget=!0,this.setFoveation(l),c=null,o=await r.requestReferenceSpace(a),J.setContext(r),J.start(),i.isPresenting=!0,i.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(r!==null)return r.environmentBlendMode};function q(U){for(let F=0;F<U.removed.length;F++){const ge=U.removed[F],pe=g.indexOf(ge);pe>=0&&(g[pe]=null,y[pe].disconnect(ge))}for(let F=0;F<U.added.length;F++){const ge=U.added[F];let pe=g.indexOf(ge);if(pe===-1){for(let de=0;de<y.length;de++)if(de>=g.length){g.push(ge),pe=de;break}else if(g[de]===null){g[de]=ge,pe=de;break}if(pe===-1)break}const $=y[pe];$&&$.connect(ge)}}const ne=new O,D=new O;function z(U,F,ge){ne.setFromMatrixPosition(F.matrixWorld),D.setFromMatrixPosition(ge.matrixWorld);const pe=ne.distanceTo(D),$=F.projectionMatrix.elements,de=ge.projectionMatrix.elements,Le=$[14]/($[10]-1),xe=$[14]/($[10]+1),K=($[9]+1)/$[5],ie=($[9]-1)/$[5],ce=($[8]-1)/$[0],L=(de[8]+1)/de[0],De=Le*ce,Q=Le*L,ae=pe/(-ce+L),me=ae*-ce;F.matrixWorld.decompose(U.position,U.quaternion,U.scale),U.translateX(me),U.translateZ(ae),U.matrixWorld.compose(U.position,U.quaternion,U.scale),U.matrixWorldInverse.copy(U.matrixWorld).invert();const Ie=Le+ae,Me=xe+ae,Se=De-me,Re=Q+(pe-me),Ue=K*xe/Me*Ie,ze=ie*xe/Me*Ie;U.projectionMatrix.makePerspective(Se,Re,Ue,ze,Ie,Me),U.projectionMatrixInverse.copy(U.projectionMatrix).invert()}function W(U,F){F===null?U.matrixWorld.copy(U.matrix):U.matrixWorld.multiplyMatrices(F.matrixWorld,U.matrix),U.matrixWorldInverse.copy(U.matrixWorld).invert()}this.updateCamera=function(U){if(r===null)return;A.near=b.near=w.near=U.near,A.far=b.far=w.far=U.far,(G!==A.near||M!==A.far)&&(r.updateRenderState({depthNear:A.near,depthFar:A.far}),G=A.near,M=A.far);const F=U.parent,ge=A.cameras;W(A,F);for(let pe=0;pe<ge.length;pe++)W(ge[pe],F);ge.length===2?z(A,w,b):A.projectionMatrix.copy(w.projectionMatrix),X(U,A,F)};function X(U,F,ge){ge===null?U.matrix.copy(F.matrixWorld):(U.matrix.copy(ge.matrixWorld),U.matrix.invert(),U.matrix.multiply(F.matrixWorld)),U.matrix.decompose(U.position,U.quaternion,U.scale),U.updateMatrixWorld(!0),U.projectionMatrix.copy(F.projectionMatrix),U.projectionMatrixInverse.copy(F.projectionMatrixInverse),U.isPerspectiveCamera&&(U.fov=Oi*2*Math.atan(1/U.projectionMatrix.elements[5]),U.zoom=1)}this.getCamera=function(){return A},this.getFoveation=function(){if(!(f===null&&m===null))return l},this.setFoveation=function(U){l=U,f!==null&&(f.fixedFoveation=U),m!==null&&m.fixedFoveation!==void 0&&(m.fixedFoveation=U)};let ee=null;function Y(U,F){if(h=F.getViewerPose(c||o),_=F,h!==null){const ge=h.views;m!==null&&(e.setRenderTargetFramebuffer(u,m.framebuffer),e.setRenderTarget(u));let pe=!1;ge.length!==A.cameras.length&&(A.cameras.length=0,pe=!0);for(let $=0;$<ge.length;$++){const de=ge[$];let Le=null;if(m!==null)Le=m.getViewport(de);else{const K=d.getViewSubImage(f,de);Le=K.viewport,$===0&&(e.setRenderTargetTextures(u,K.colorTexture,f.ignoreDepthValues?void 0:K.depthStencilTexture),e.setRenderTarget(u))}let xe=R[$];xe===void 0&&(xe=new Vt,xe.layers.enable($),xe.viewport=new mt,R[$]=xe),xe.matrix.fromArray(de.transform.matrix),xe.matrix.decompose(xe.position,xe.quaternion,xe.scale),xe.projectionMatrix.fromArray(de.projectionMatrix),xe.projectionMatrixInverse.copy(xe.projectionMatrix).invert(),xe.viewport.set(Le.x,Le.y,Le.width,Le.height),$===0&&(A.matrix.copy(xe.matrix),A.matrix.decompose(A.position,A.quaternion,A.scale)),pe===!0&&A.cameras.push(xe)}}for(let ge=0;ge<y.length;ge++){const pe=g[ge],$=y[ge];pe!==null&&$!==void 0&&$.update(pe,F,c||o)}ee&&ee(U,F),F.detectedPlanes&&i.dispatchEvent({type:"planesdetected",data:F}),_=null}const J=new No;J.setAnimationLoop(Y),this.setAnimationLoop=function(U){ee=U},this.dispose=function(){}}}function pp(n,e){function t(p,u){p.matrixAutoUpdate===!0&&p.updateMatrix(),u.value.copy(p.matrix)}function i(p,u){u.color.getRGB(p.fogColor.value,Do(n)),u.isFog?(p.fogNear.value=u.near,p.fogFar.value=u.far):u.isFogExp2&&(p.fogDensity.value=u.density)}function r(p,u,y,g,w){u.isMeshBasicMaterial||u.isMeshLambertMaterial?s(p,u):u.isMeshToonMaterial?(s(p,u),d(p,u)):u.isMeshPhongMaterial?(s(p,u),h(p,u)):u.isMeshStandardMaterial?(s(p,u),f(p,u),u.isMeshPhysicalMaterial&&m(p,u,w)):u.isMeshMatcapMaterial?(s(p,u),_(p,u)):u.isMeshDepthMaterial?s(p,u):u.isMeshDistanceMaterial?(s(p,u),x(p,u)):u.isMeshNormalMaterial?s(p,u):u.isLineBasicMaterial?(o(p,u),u.isLineDashedMaterial&&a(p,u)):u.isPointsMaterial?l(p,u,y,g):u.isSpriteMaterial?c(p,u):u.isShadowMaterial?(p.color.value.copy(u.color),p.opacity.value=u.opacity):u.isShaderMaterial&&(u.uniformsNeedUpdate=!1)}function s(p,u){p.opacity.value=u.opacity,u.color&&p.diffuse.value.copy(u.color),u.emissive&&p.emissive.value.copy(u.emissive).multiplyScalar(u.emissiveIntensity),u.map&&(p.map.value=u.map,t(u.map,p.mapTransform)),u.alphaMap&&(p.alphaMap.value=u.alphaMap,t(u.alphaMap,p.alphaMapTransform)),u.bumpMap&&(p.bumpMap.value=u.bumpMap,t(u.bumpMap,p.bumpMapTransform),p.bumpScale.value=u.bumpScale,u.side===Pt&&(p.bumpScale.value*=-1)),u.normalMap&&(p.normalMap.value=u.normalMap,t(u.normalMap,p.normalMapTransform),p.normalScale.value.copy(u.normalScale),u.side===Pt&&p.normalScale.value.negate()),u.displacementMap&&(p.displacementMap.value=u.displacementMap,t(u.displacementMap,p.displacementMapTransform),p.displacementScale.value=u.displacementScale,p.displacementBias.value=u.displacementBias),u.emissiveMap&&(p.emissiveMap.value=u.emissiveMap,t(u.emissiveMap,p.emissiveMapTransform)),u.specularMap&&(p.specularMap.value=u.specularMap,t(u.specularMap,p.specularMapTransform)),u.alphaTest>0&&(p.alphaTest.value=u.alphaTest);const y=e.get(u).envMap;if(y&&(p.envMap.value=y,p.flipEnvMap.value=y.isCubeTexture&&y.isRenderTargetTexture===!1?-1:1,p.reflectivity.value=u.reflectivity,p.ior.value=u.ior,p.refractionRatio.value=u.refractionRatio),u.lightMap){p.lightMap.value=u.lightMap;const g=n._useLegacyLights===!0?Math.PI:1;p.lightMapIntensity.value=u.lightMapIntensity*g,t(u.lightMap,p.lightMapTransform)}u.aoMap&&(p.aoMap.value=u.aoMap,p.aoMapIntensity.value=u.aoMapIntensity,t(u.aoMap,p.aoMapTransform))}function o(p,u){p.diffuse.value.copy(u.color),p.opacity.value=u.opacity,u.map&&(p.map.value=u.map,t(u.map,p.mapTransform))}function a(p,u){p.dashSize.value=u.dashSize,p.totalSize.value=u.dashSize+u.gapSize,p.scale.value=u.scale}function l(p,u,y,g){p.diffuse.value.copy(u.color),p.opacity.value=u.opacity,p.size.value=u.size*y,p.scale.value=g*.5,u.map&&(p.map.value=u.map,t(u.map,p.uvTransform)),u.alphaMap&&(p.alphaMap.value=u.alphaMap,t(u.alphaMap,p.alphaMapTransform)),u.alphaTest>0&&(p.alphaTest.value=u.alphaTest)}function c(p,u){p.diffuse.value.copy(u.color),p.opacity.value=u.opacity,p.rotation.value=u.rotation,u.map&&(p.map.value=u.map,t(u.map,p.mapTransform)),u.alphaMap&&(p.alphaMap.value=u.alphaMap,t(u.alphaMap,p.alphaMapTransform)),u.alphaTest>0&&(p.alphaTest.value=u.alphaTest)}function h(p,u){p.specular.value.copy(u.specular),p.shininess.value=Math.max(u.shininess,1e-4)}function d(p,u){u.gradientMap&&(p.gradientMap.value=u.gradientMap)}function f(p,u){p.metalness.value=u.metalness,u.metalnessMap&&(p.metalnessMap.value=u.metalnessMap,t(u.metalnessMap,p.metalnessMapTransform)),p.roughness.value=u.roughness,u.roughnessMap&&(p.roughnessMap.value=u.roughnessMap,t(u.roughnessMap,p.roughnessMapTransform)),e.get(u).envMap&&(p.envMapIntensity.value=u.envMapIntensity)}function m(p,u,y){p.ior.value=u.ior,u.sheen>0&&(p.sheenColor.value.copy(u.sheenColor).multiplyScalar(u.sheen),p.sheenRoughness.value=u.sheenRoughness,u.sheenColorMap&&(p.sheenColorMap.value=u.sheenColorMap,t(u.sheenColorMap,p.sheenColorMapTransform)),u.sheenRoughnessMap&&(p.sheenRoughnessMap.value=u.sheenRoughnessMap,t(u.sheenRoughnessMap,p.sheenRoughnessMapTransform))),u.clearcoat>0&&(p.clearcoat.value=u.clearcoat,p.clearcoatRoughness.value=u.clearcoatRoughness,u.clearcoatMap&&(p.clearcoatMap.value=u.clearcoatMap,t(u.clearcoatMap,p.clearcoatMapTransform)),u.clearcoatRoughnessMap&&(p.clearcoatRoughnessMap.value=u.clearcoatRoughnessMap,t(u.clearcoatRoughnessMap,p.clearcoatRoughnessMapTransform)),u.clearcoatNormalMap&&(p.clearcoatNormalMap.value=u.clearcoatNormalMap,t(u.clearcoatNormalMap,p.clearcoatNormalMapTransform),p.clearcoatNormalScale.value.copy(u.clearcoatNormalScale),u.side===Pt&&p.clearcoatNormalScale.value.negate())),u.iridescence>0&&(p.iridescence.value=u.iridescence,p.iridescenceIOR.value=u.iridescenceIOR,p.iridescenceThicknessMinimum.value=u.iridescenceThicknessRange[0],p.iridescenceThicknessMaximum.value=u.iridescenceThicknessRange[1],u.iridescenceMap&&(p.iridescenceMap.value=u.iridescenceMap,t(u.iridescenceMap,p.iridescenceMapTransform)),u.iridescenceThicknessMap&&(p.iridescenceThicknessMap.value=u.iridescenceThicknessMap,t(u.iridescenceThicknessMap,p.iridescenceThicknessMapTransform))),u.transmission>0&&(p.transmission.value=u.transmission,p.transmissionSamplerMap.value=y.texture,p.transmissionSamplerSize.value.set(y.width,y.height),u.transmissionMap&&(p.transmissionMap.value=u.transmissionMap,t(u.transmissionMap,p.transmissionMapTransform)),p.thickness.value=u.thickness,u.thicknessMap&&(p.thicknessMap.value=u.thicknessMap,t(u.thicknessMap,p.thicknessMapTransform)),p.attenuationDistance.value=u.attenuationDistance,p.attenuationColor.value.copy(u.attenuationColor)),u.anisotropy>0&&(p.anisotropyVector.value.set(u.anisotropy*Math.cos(u.anisotropyRotation),u.anisotropy*Math.sin(u.anisotropyRotation)),u.anisotropyMap&&(p.anisotropyMap.value=u.anisotropyMap,t(u.anisotropyMap,p.anisotropyMapTransform))),p.specularIntensity.value=u.specularIntensity,p.specularColor.value.copy(u.specularColor),u.specularColorMap&&(p.specularColorMap.value=u.specularColorMap,t(u.specularColorMap,p.specularColorMapTransform)),u.specularIntensityMap&&(p.specularIntensityMap.value=u.specularIntensityMap,t(u.specularIntensityMap,p.specularIntensityMapTransform))}function _(p,u){u.matcap&&(p.matcap.value=u.matcap)}function x(p,u){const y=e.get(u).light;p.referencePosition.value.setFromMatrixPosition(y.matrixWorld),p.nearDistance.value=y.shadow.camera.near,p.farDistance.value=y.shadow.camera.far}return{refreshFogUniforms:i,refreshMaterialUniforms:r}}function mp(n,e,t,i){let r={},s={},o=[];const a=t.isWebGL2?n.getParameter(n.MAX_UNIFORM_BUFFER_BINDINGS):0;function l(y,g){const w=g.program;i.uniformBlockBinding(y,w)}function c(y,g){let w=r[y.id];w===void 0&&(_(y),w=h(y),r[y.id]=w,y.addEventListener("dispose",p));const b=g.program;i.updateUBOMapping(y,b);const R=e.render.frame;s[y.id]!==R&&(f(y),s[y.id]=R)}function h(y){const g=d();y.__bindingPointIndex=g;const w=n.createBuffer(),b=y.__size,R=y.usage;return n.bindBuffer(n.UNIFORM_BUFFER,w),n.bufferData(n.UNIFORM_BUFFER,b,R),n.bindBuffer(n.UNIFORM_BUFFER,null),n.bindBufferBase(n.UNIFORM_BUFFER,g,w),w}function d(){for(let y=0;y<a;y++)if(o.indexOf(y)===-1)return o.push(y),y;return console.error("THREE.WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function f(y){const g=r[y.id],w=y.uniforms,b=y.__cache;n.bindBuffer(n.UNIFORM_BUFFER,g);for(let R=0,A=w.length;R<A;R++){const G=w[R];if(m(G,R,b)===!0){const M=G.__offset,T=Array.isArray(G.value)?G.value:[G.value];let k=0;for(let q=0;q<T.length;q++){const ne=T[q],D=x(ne);typeof ne=="number"?(G.__data[0]=ne,n.bufferSubData(n.UNIFORM_BUFFER,M+k,G.__data)):ne.isMatrix3?(G.__data[0]=ne.elements[0],G.__data[1]=ne.elements[1],G.__data[2]=ne.elements[2],G.__data[3]=ne.elements[0],G.__data[4]=ne.elements[3],G.__data[5]=ne.elements[4],G.__data[6]=ne.elements[5],G.__data[7]=ne.elements[0],G.__data[8]=ne.elements[6],G.__data[9]=ne.elements[7],G.__data[10]=ne.elements[8],G.__data[11]=ne.elements[0]):(ne.toArray(G.__data,k),k+=D.storage/Float32Array.BYTES_PER_ELEMENT)}n.bufferSubData(n.UNIFORM_BUFFER,M,G.__data)}}n.bindBuffer(n.UNIFORM_BUFFER,null)}function m(y,g,w){const b=y.value;if(w[g]===void 0){if(typeof b=="number")w[g]=b;else{const R=Array.isArray(b)?b:[b],A=[];for(let G=0;G<R.length;G++)A.push(R[G].clone());w[g]=A}return!0}else if(typeof b=="number"){if(w[g]!==b)return w[g]=b,!0}else{const R=Array.isArray(w[g])?w[g]:[w[g]],A=Array.isArray(b)?b:[b];for(let G=0;G<R.length;G++){const M=R[G];if(M.equals(A[G])===!1)return M.copy(A[G]),!0}}return!1}function _(y){const g=y.uniforms;let w=0;const b=16;let R=0;for(let A=0,G=g.length;A<G;A++){const M=g[A],T={boundary:0,storage:0},k=Array.isArray(M.value)?M.value:[M.value];for(let q=0,ne=k.length;q<ne;q++){const D=k[q],z=x(D);T.boundary+=z.boundary,T.storage+=z.storage}if(M.__data=new Float32Array(T.storage/Float32Array.BYTES_PER_ELEMENT),M.__offset=w,A>0){R=w%b;const q=b-R;R!==0&&q-T.boundary<0&&(w+=b-R,M.__offset=w)}w+=T.storage}return R=w%b,R>0&&(w+=b-R),y.__size=w,y.__cache={},this}function x(y){const g={boundary:0,storage:0};return typeof y=="number"?(g.boundary=4,g.storage=4):y.isVector2?(g.boundary=8,g.storage=8):y.isVector3||y.isColor?(g.boundary=16,g.storage=12):y.isVector4?(g.boundary=16,g.storage=16):y.isMatrix3?(g.boundary=48,g.storage=48):y.isMatrix4?(g.boundary=64,g.storage=64):y.isTexture?console.warn("THREE.WebGLRenderer: Texture samplers can not be part of an uniforms group."):console.warn("THREE.WebGLRenderer: Unsupported uniform value type.",y),g}function p(y){const g=y.target;g.removeEventListener("dispose",p);const w=o.indexOf(g.__bindingPointIndex);o.splice(w,1),n.deleteBuffer(r[g.id]),delete r[g.id],delete s[g.id]}function u(){for(const y in r)n.deleteBuffer(r[y]);o=[],r={},s={}}return{bind:l,update:c,dispose:u}}class Go{constructor(e={}){const{canvas:t=dc(),context:i=null,depth:r=!0,stencil:s=!0,alpha:o=!1,antialias:a=!1,premultipliedAlpha:l=!0,preserveDrawingBuffer:c=!1,powerPreference:h="default",failIfMajorPerformanceCaveat:d=!1}=e;this.isWebGLRenderer=!0;let f;i!==null?f=i.getContextAttributes().alpha:f=o;const m=new Uint32Array(4),_=new Int32Array(4);let x=null,p=null;const u=[],y=[];this.domElement=t,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this._outputColorSpace=Mt,this._useLegacyLights=!1,this.toneMapping=An,this.toneMappingExposure=1;const g=this;let w=!1,b=0,R=0,A=null,G=-1,M=null;const T=new mt,k=new mt;let q=null;const ne=new Je(0);let D=0,z=t.width,W=t.height,X=1,ee=null,Y=null;const J=new mt(0,0,z,W),U=new mt(0,0,z,W);let F=!1;const ge=new bs;let pe=!1,$=!1,de=null;const Le=new ut,xe=new Xe,K=new O,ie={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};function ce(){return A===null?X:1}let L=i;function De(S,N){for(let B=0;B<S.length;B++){const V=S[B],H=t.getContext(V,N);if(H!==null)return H}return null}try{const S={alpha:!0,depth:r,stencil:s,antialias:a,premultipliedAlpha:l,preserveDrawingBuffer:c,powerPreference:h,failIfMajorPerformanceCaveat:d};if("setAttribute"in t&&t.setAttribute("data-engine",`three.js r${xs}`),t.addEventListener("webglcontextlost",He,!1),t.addEventListener("webglcontextrestored",P,!1),t.addEventListener("webglcontextcreationerror",_e,!1),L===null){const N=["webgl2","webgl","experimental-webgl"];if(g.isWebGL1Renderer===!0&&N.shift(),L=De(N,S),L===null)throw De(N)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}typeof WebGLRenderingContext<"u"&&L instanceof WebGLRenderingContext&&console.warn("THREE.WebGLRenderer: WebGL 1 support was deprecated in r153 and will be removed in r163."),L.getShaderPrecisionFormat===void 0&&(L.getShaderPrecisionFormat=function(){return{rangeMin:1,rangeMax:1,precision:1}})}catch(S){throw console.error("THREE.WebGLRenderer: "+S.message),S}let Q,ae,me,Ie,Me,Se,Re,Ue,ze,E,v,I,re,te,le,Te,he,ve,C,se,Z,Ne,Ce,Ae;function Ee(){Q=new Td(L),ae=new vd(L,Q,e),Q.init(ae),Ne=new cp(L,Q,ae),me=new op(L,Q,ae),Ie=new wd(L),Me=new Yf,Se=new lp(L,Q,me,Me,ae,Ne,Ie),Re=new Md(g),Ue=new yd(g),ze=new Oc(L,ae),Ce=new gd(L,Q,ze,ae),E=new bd(L,ze,Ie,Ce),v=new Pd(L,E,ze,Ie),C=new Ld(L,ae,Se),Te=new xd(Me),I=new qf(g,Re,Ue,Q,ae,Ce,Te),re=new pp(g,Me),te=new Kf,le=new tp(Q,ae),ve=new md(g,Re,Ue,me,v,f,l),he=new ap(g,v,ae),Ae=new mp(L,Ie,ae,me),se=new _d(L,Q,Ie,ae),Z=new Ad(L,Q,Ie,ae),Ie.programs=I.programs,g.capabilities=ae,g.extensions=Q,g.properties=Me,g.renderLists=te,g.shadowMap=he,g.state=me,g.info=Ie}Ee();const ye=new fp(g,L);this.xr=ye,this.getContext=function(){return L},this.getContextAttributes=function(){return L.getContextAttributes()},this.forceContextLoss=function(){const S=Q.get("WEBGL_lose_context");S&&S.loseContext()},this.forceContextRestore=function(){const S=Q.get("WEBGL_lose_context");S&&S.restoreContext()},this.getPixelRatio=function(){return X},this.setPixelRatio=function(S){S!==void 0&&(X=S,this.setSize(z,W,!1))},this.getSize=function(S){return S.set(z,W)},this.setSize=function(S,N,B=!0){if(ye.isPresenting){console.warn("THREE.WebGLRenderer: Can't change size while VR device is presenting.");return}z=S,W=N,t.width=Math.floor(S*X),t.height=Math.floor(N*X),B===!0&&(t.style.width=S+"px",t.style.height=N+"px"),this.setViewport(0,0,S,N)},this.getDrawingBufferSize=function(S){return S.set(z*X,W*X).floor()},this.setDrawingBufferSize=function(S,N,B){z=S,W=N,X=B,t.width=Math.floor(S*B),t.height=Math.floor(N*B),this.setViewport(0,0,S,N)},this.getCurrentViewport=function(S){return S.copy(T)},this.getViewport=function(S){return S.copy(J)},this.setViewport=function(S,N,B,V){S.isVector4?J.set(S.x,S.y,S.z,S.w):J.set(S,N,B,V),me.viewport(T.copy(J).multiplyScalar(X).floor())},this.getScissor=function(S){return S.copy(U)},this.setScissor=function(S,N,B,V){S.isVector4?U.set(S.x,S.y,S.z,S.w):U.set(S,N,B,V),me.scissor(k.copy(U).multiplyScalar(X).floor())},this.getScissorTest=function(){return F},this.setScissorTest=function(S){me.setScissorTest(F=S)},this.setOpaqueSort=function(S){ee=S},this.setTransparentSort=function(S){Y=S},this.getClearColor=function(S){return S.copy(ve.getClearColor())},this.setClearColor=function(){ve.setClearColor.apply(ve,arguments)},this.getClearAlpha=function(){return ve.getClearAlpha()},this.setClearAlpha=function(){ve.setClearAlpha.apply(ve,arguments)},this.clear=function(S=!0,N=!0,B=!0){let V=0;if(S){let H=!1;if(A!==null){const we=A.texture.format;H=we===So||we===Mo||we===xo}if(H){const we=A.texture.type,Fe=we===wn||we===yn||we===Ms||we===Gn||we===_o||we===vo,Be=ve.getClearColor(),Ge=ve.getClearAlpha(),We=Be.r,Ve=Be.g,ke=Be.b;Fe?(m[0]=We,m[1]=Ve,m[2]=ke,m[3]=Ge,L.clearBufferuiv(L.COLOR,0,m)):(_[0]=We,_[1]=Ve,_[2]=ke,_[3]=Ge,L.clearBufferiv(L.COLOR,0,_))}else V|=L.COLOR_BUFFER_BIT}N&&(V|=L.DEPTH_BUFFER_BIT),B&&(V|=L.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),L.clear(V)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){t.removeEventListener("webglcontextlost",He,!1),t.removeEventListener("webglcontextrestored",P,!1),t.removeEventListener("webglcontextcreationerror",_e,!1),te.dispose(),le.dispose(),Me.dispose(),Re.dispose(),Ue.dispose(),v.dispose(),Ce.dispose(),Ae.dispose(),I.dispose(),ye.dispose(),ye.removeEventListener("sessionstart",nt),ye.removeEventListener("sessionend",je),de&&(de.dispose(),de=null),fe.stop()};function He(S){S.preventDefault(),console.log("THREE.WebGLRenderer: Context Lost."),w=!0}function P(){console.log("THREE.WebGLRenderer: Context Restored."),w=!1;const S=Ie.autoReset,N=he.enabled,B=he.autoUpdate,V=he.needsUpdate,H=he.type;Ee(),Ie.autoReset=S,he.enabled=N,he.autoUpdate=B,he.needsUpdate=V,he.type=H}function _e(S){console.error("THREE.WebGLRenderer: A WebGL context could not be created. Reason: ",S.statusMessage)}function oe(S){const N=S.target;N.removeEventListener("dispose",oe),j(N)}function j(S){ue(S),Me.remove(S)}function ue(S){const N=Me.get(S).programs;N!==void 0&&(N.forEach(function(B){I.releaseProgram(B)}),S.isShaderMaterial&&I.releaseShaderCache(S))}this.renderBufferDirect=function(S,N,B,V,H,we){N===null&&(N=ie);const Fe=H.isMesh&&H.matrixWorld.determinant()<0,Be=Dt(S,N,B,V,H);me.setMaterial(V,Fe);let Ge=B.index,We=1;if(V.wireframe===!0){if(Ge=E.getWireframeAttribute(B),Ge===void 0)return;We=2}const Ve=B.drawRange,ke=B.attributes.position;let it=Ve.start*We,_t=(Ve.start+Ve.count)*We;we!==null&&(it=Math.max(it,we.start*We),_t=Math.min(_t,(we.start+we.count)*We)),Ge!==null?(it=Math.max(it,0),_t=Math.min(_t,Ge.count)):ke!=null&&(it=Math.max(it,0),_t=Math.min(_t,ke.count));const et=_t-it;if(et<0||et===1/0)return;Ce.setup(H,V,Be,B,Ge);let vt,tt=se;if(Ge!==null&&(vt=ze.get(Ge),tt=Z,tt.setIndex(vt)),H.isMesh)V.wireframe===!0?(me.setLineWidth(V.wireframeLinewidth*ce()),tt.setMode(L.LINES)):tt.setMode(L.TRIANGLES);else if(H.isLine){let qe=V.linewidth;qe===void 0&&(qe=1),me.setLineWidth(qe*ce()),H.isLineSegments?tt.setMode(L.LINES):H.isLineLoop?tt.setMode(L.LINE_LOOP):tt.setMode(L.LINE_STRIP)}else H.isPoints?tt.setMode(L.POINTS):H.isSprite&&tt.setMode(L.TRIANGLES);if(H.isInstancedMesh)tt.renderInstances(it,et,H.count);else if(B.isInstancedBufferGeometry){const qe=B._maxInstanceCount!==void 0?B._maxInstanceCount:1/0,Cn=Math.min(B.instanceCount,qe);tt.renderInstances(it,et,Cn)}else tt.render(it,et)};function Pe(S,N,B){S.transparent===!0&&S.side===dn&&S.forceSinglePass===!1?(S.side=Pt,S.needsUpdate=!0,Jt(S,N,B),S.side=Rn,S.needsUpdate=!0,Jt(S,N,B),S.side=dn):Jt(S,N,B)}this.compile=function(S,N,B=null){B===null&&(B=S),p=le.get(B),p.init(),y.push(p),B.traverseVisible(function(H){H.isLight&&H.layers.test(N.layers)&&(p.pushLight(H),H.castShadow&&p.pushShadow(H))}),S!==B&&S.traverseVisible(function(H){H.isLight&&H.layers.test(N.layers)&&(p.pushLight(H),H.castShadow&&p.pushShadow(H))}),p.setupLights(g._useLegacyLights);const V=new Set;return S.traverse(function(H){const we=H.material;if(we)if(Array.isArray(we))for(let Fe=0;Fe<we.length;Fe++){const Be=we[Fe];Pe(Be,B,H),V.add(Be)}else Pe(we,B,H),V.add(we)}),y.pop(),p=null,V},this.compileAsync=function(S,N,B=null){const V=this.compile(S,N,B);return new Promise(H=>{function we(){if(V.forEach(function(Fe){Me.get(Fe).currentProgram.isReady()&&V.delete(Fe)}),V.size===0){H(S);return}setTimeout(we,10)}Q.get("KHR_parallel_shader_compile")!==null?we():setTimeout(we,10)})};let Oe=null;function Ze(S){Oe&&Oe(S)}function nt(){fe.stop()}function je(){fe.start()}const fe=new No;fe.setAnimationLoop(Ze),typeof self<"u"&&fe.setContext(self),this.setAnimationLoop=function(S){Oe=S,ye.setAnimationLoop(S),S===null?fe.stop():fe.start()},ye.addEventListener("sessionstart",nt),ye.addEventListener("sessionend",je),this.render=function(S,N){if(N!==void 0&&N.isCamera!==!0){console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(w===!0)return;S.matrixWorldAutoUpdate===!0&&S.updateMatrixWorld(),N.parent===null&&N.matrixWorldAutoUpdate===!0&&N.updateMatrixWorld(),ye.enabled===!0&&ye.isPresenting===!0&&(ye.cameraAutoUpdate===!0&&ye.updateCamera(N),N=ye.getCamera()),S.isScene===!0&&S.onBeforeRender(g,S,N,A),p=le.get(S,y.length),p.init(),y.push(p),Le.multiplyMatrices(N.projectionMatrix,N.matrixWorldInverse),ge.setFromProjectionMatrix(Le),$=this.localClippingEnabled,pe=Te.init(this.clippingPlanes,$),x=te.get(S,u.length),x.init(),u.push(x),ot(S,N,0,g.sortObjects),x.finish(),g.sortObjects===!0&&x.sort(ee,Y),this.info.render.frame++,pe===!0&&Te.beginShadows();const B=p.state.shadowsArray;if(he.render(B,S,N),pe===!0&&Te.endShadows(),this.info.autoReset===!0&&this.info.reset(),ve.render(x,S),p.setupLights(g._useLegacyLights),N.isArrayCamera){const V=N.cameras;for(let H=0,we=V.length;H<we;H++){const Fe=V[H];St(x,S,Fe,Fe.viewport)}}else St(x,S,N);A!==null&&(Se.updateMultisampleRenderTarget(A),Se.updateRenderTargetMipmap(A)),S.isScene===!0&&S.onAfterRender(g,S,N),Ce.resetDefaultState(),G=-1,M=null,y.pop(),y.length>0?p=y[y.length-1]:p=null,u.pop(),u.length>0?x=u[u.length-1]:x=null};function ot(S,N,B,V){if(S.visible===!1)return;if(S.layers.test(N.layers)){if(S.isGroup)B=S.renderOrder;else if(S.isLOD)S.autoUpdate===!0&&S.update(N);else if(S.isLight)p.pushLight(S),S.castShadow&&p.pushShadow(S);else if(S.isSprite){if(!S.frustumCulled||ge.intersectsSprite(S)){V&&K.setFromMatrixPosition(S.matrixWorld).applyMatrix4(Le);const Fe=v.update(S),Be=S.material;Be.visible&&x.push(S,Fe,Be,B,K.z,null)}}else if((S.isMesh||S.isLine||S.isPoints)&&(!S.frustumCulled||ge.intersectsObject(S))){const Fe=v.update(S),Be=S.material;if(V&&(S.boundingSphere!==void 0?(S.boundingSphere===null&&S.computeBoundingSphere(),K.copy(S.boundingSphere.center)):(Fe.boundingSphere===null&&Fe.computeBoundingSphere(),K.copy(Fe.boundingSphere.center)),K.applyMatrix4(S.matrixWorld).applyMatrix4(Le)),Array.isArray(Be)){const Ge=Fe.groups;for(let We=0,Ve=Ge.length;We<Ve;We++){const ke=Ge[We],it=Be[ke.materialIndex];it&&it.visible&&x.push(S,Fe,it,B,K.z,ke)}}else Be.visible&&x.push(S,Fe,Be,B,K.z,null)}}const we=S.children;for(let Fe=0,Be=we.length;Fe<Be;Fe++)ot(we[Fe],N,B,V)}function St(S,N,B,V){const H=S.opaque,we=S.transmissive,Fe=S.transparent;p.setupLightsView(B),pe===!0&&Te.setGlobalState(g.clippingPlanes,B),we.length>0&&tn(H,we,N,B),V&&me.viewport(T.copy(V)),H.length>0&&$e(H,N,B),we.length>0&&$e(we,N,B),Fe.length>0&&$e(Fe,N,B),me.buffers.depth.setTest(!0),me.buffers.depth.setMask(!0),me.buffers.color.setMask(!0),me.setPolygonOffset(!1)}function tn(S,N,B,V){if((B.isScene===!0?B.overrideMaterial:null)!==null)return;const we=ae.isWebGL2;de===null&&(de=new Wn(1,1,{generateMipmaps:!0,type:Q.has("EXT_color_buffer_half_float")?Fi:wn,minFilter:Ni,samples:we?4:0})),g.getDrawingBufferSize(xe),we?de.setSize(xe.x,xe.y):de.setSize(Mr(xe.x),Mr(xe.y));const Fe=g.getRenderTarget();g.setRenderTarget(de),g.getClearColor(ne),D=g.getClearAlpha(),D<1&&g.setClearColor(16777215,.5),g.clear();const Be=g.toneMapping;g.toneMapping=An,$e(S,B,V),Se.updateMultisampleRenderTarget(de),Se.updateRenderTargetMipmap(de);let Ge=!1;for(let We=0,Ve=N.length;We<Ve;We++){const ke=N[We],it=ke.object,_t=ke.geometry,et=ke.material,vt=ke.group;if(et.side===dn&&it.layers.test(V.layers)){const tt=et.side;et.side=Pt,et.needsUpdate=!0,nn(it,B,V,_t,et,vt),et.side=tt,et.needsUpdate=!0,Ge=!0}}Ge===!0&&(Se.updateMultisampleRenderTarget(de),Se.updateRenderTargetMipmap(de)),g.setRenderTarget(Fe),g.setClearColor(ne,D),g.toneMapping=Be}function $e(S,N,B){const V=N.isScene===!0?N.overrideMaterial:null;for(let H=0,we=S.length;H<we;H++){const Fe=S[H],Be=Fe.object,Ge=Fe.geometry,We=V===null?Fe.material:V,Ve=Fe.group;Be.layers.test(B.layers)&&nn(Be,N,B,Ge,We,Ve)}}function nn(S,N,B,V,H,we){S.onBeforeRender(g,N,B,V,H,we),S.modelViewMatrix.multiplyMatrices(B.matrixWorldInverse,S.matrixWorld),S.normalMatrix.getNormalMatrix(S.modelViewMatrix),H.onBeforeRender(g,N,B,V,S,we),H.transparent===!0&&H.side===dn&&H.forceSinglePass===!1?(H.side=Pt,H.needsUpdate=!0,g.renderBufferDirect(B,N,V,H,S,we),H.side=Rn,H.needsUpdate=!0,g.renderBufferDirect(B,N,V,H,S,we),H.side=dn):g.renderBufferDirect(B,N,V,H,S,we),S.onAfterRender(g,N,B,V,H,we)}function Jt(S,N,B){N.isScene!==!0&&(N=ie);const V=Me.get(S),H=p.state.lights,we=p.state.shadowsArray,Fe=H.state.version,Be=I.getParameters(S,H.state,we,N,B),Ge=I.getProgramCacheKey(Be);let We=V.programs;V.environment=S.isMeshStandardMaterial?N.environment:null,V.fog=N.fog,V.envMap=(S.isMeshStandardMaterial?Ue:Re).get(S.envMap||V.environment),We===void 0&&(S.addEventListener("dispose",oe),We=new Map,V.programs=We);let Ve=We.get(Ge);if(Ve!==void 0){if(V.currentProgram===Ve&&V.lightsStateVersion===Fe)return Bt(S,Be),Ve}else Be.uniforms=I.getUniforms(S),S.onBuild(B,Be,g),S.onBeforeCompile(Be,g),Ve=I.acquireProgram(Be,Ge),We.set(Ge,Ve),V.uniforms=Be.uniforms;const ke=V.uniforms;return(!S.isShaderMaterial&&!S.isRawShaderMaterial||S.clipping===!0)&&(ke.clippingPlanes=Te.uniform),Bt(S,Be),V.needsLights=Ct(S),V.lightsStateVersion=Fe,V.needsLights&&(ke.ambientLightColor.value=H.state.ambient,ke.lightProbe.value=H.state.probe,ke.directionalLights.value=H.state.directional,ke.directionalLightShadows.value=H.state.directionalShadow,ke.spotLights.value=H.state.spot,ke.spotLightShadows.value=H.state.spotShadow,ke.rectAreaLights.value=H.state.rectArea,ke.ltc_1.value=H.state.rectAreaLTC1,ke.ltc_2.value=H.state.rectAreaLTC2,ke.pointLights.value=H.state.point,ke.pointLightShadows.value=H.state.pointShadow,ke.hemisphereLights.value=H.state.hemi,ke.directionalShadowMap.value=H.state.directionalShadowMap,ke.directionalShadowMatrix.value=H.state.directionalShadowMatrix,ke.spotShadowMap.value=H.state.spotShadowMap,ke.spotLightMatrix.value=H.state.spotLightMatrix,ke.spotLightMap.value=H.state.spotLightMap,ke.pointShadowMap.value=H.state.pointShadowMap,ke.pointShadowMatrix.value=H.state.pointShadowMatrix),V.currentProgram=Ve,V.uniformsList=null,Ve}function gn(S){if(S.uniformsList===null){const N=S.currentProgram.getUniforms();S.uniformsList=pr.seqWithValue(N.seq,S.uniforms)}return S.uniformsList}function Bt(S,N){const B=Me.get(S);B.outputColorSpace=N.outputColorSpace,B.instancing=N.instancing,B.instancingColor=N.instancingColor,B.skinning=N.skinning,B.morphTargets=N.morphTargets,B.morphNormals=N.morphNormals,B.morphColors=N.morphColors,B.morphTargetsCount=N.morphTargetsCount,B.numClippingPlanes=N.numClippingPlanes,B.numIntersection=N.numClipIntersection,B.vertexAlphas=N.vertexAlphas,B.vertexTangents=N.vertexTangents,B.toneMapping=N.toneMapping}function Dt(S,N,B,V,H){N.isScene!==!0&&(N=ie),Se.resetTextureUnits();const we=N.fog,Fe=V.isMeshStandardMaterial?N.environment:null,Be=A===null?g.outputColorSpace:A.isXRRenderTarget===!0?A.texture.colorSpace:mn,Ge=(V.isMeshStandardMaterial?Ue:Re).get(V.envMap||Fe),We=V.vertexColors===!0&&!!B.attributes.color&&B.attributes.color.itemSize===4,Ve=!!B.attributes.tangent&&(!!V.normalMap||V.anisotropy>0),ke=!!B.morphAttributes.position,it=!!B.morphAttributes.normal,_t=!!B.morphAttributes.color;let et=An;V.toneMapped&&(A===null||A.isXRRenderTarget===!0)&&(et=g.toneMapping);const vt=B.morphAttributes.position||B.morphAttributes.normal||B.morphAttributes.color,tt=vt!==void 0?vt.length:0,qe=Me.get(V),Cn=p.state.lights;if(pe===!0&&($===!0||S!==M)){const xt=S===M&&V.id===G;Te.setState(V,S,xt)}let st=!1;V.version===qe.__version?(qe.needsLights&&qe.lightsStateVersion!==Cn.state.version||qe.outputColorSpace!==Be||H.isInstancedMesh&&qe.instancing===!1||!H.isInstancedMesh&&qe.instancing===!0||H.isSkinnedMesh&&qe.skinning===!1||!H.isSkinnedMesh&&qe.skinning===!0||H.isInstancedMesh&&qe.instancingColor===!0&&H.instanceColor===null||H.isInstancedMesh&&qe.instancingColor===!1&&H.instanceColor!==null||qe.envMap!==Ge||V.fog===!0&&qe.fog!==we||qe.numClippingPlanes!==void 0&&(qe.numClippingPlanes!==Te.numPlanes||qe.numIntersection!==Te.numIntersection)||qe.vertexAlphas!==We||qe.vertexTangents!==Ve||qe.morphTargets!==ke||qe.morphNormals!==it||qe.morphColors!==_t||qe.toneMapping!==et||ae.isWebGL2===!0&&qe.morphTargetsCount!==tt)&&(st=!0):(st=!0,qe.__version=V.version);let Lt=qe.currentProgram;st===!0&&(Lt=Jt(V,N,H));let jn=!1,rn=!1,sn=!1;const ct=Lt.getUniforms(),Ut=qe.uniforms;if(me.useProgram(Lt.program)&&(jn=!0,rn=!0,sn=!0),V.id!==G&&(G=V.id,rn=!0),jn||M!==S){ct.setValue(L,"projectionMatrix",S.projectionMatrix),ct.setValue(L,"viewMatrix",S.matrixWorldInverse);const xt=ct.map.cameraPosition;xt!==void 0&&xt.setValue(L,K.setFromMatrixPosition(S.matrixWorld)),ae.logarithmicDepthBuffer&&ct.setValue(L,"logDepthBufFC",2/(Math.log(S.far+1)/Math.LN2)),(V.isMeshPhongMaterial||V.isMeshToonMaterial||V.isMeshLambertMaterial||V.isMeshBasicMaterial||V.isMeshStandardMaterial||V.isShaderMaterial)&&ct.setValue(L,"isOrthographic",S.isOrthographicCamera===!0),M!==S&&(M=S,rn=!0,sn=!0)}if(H.isSkinnedMesh){ct.setOptional(L,H,"bindMatrix"),ct.setOptional(L,H,"bindMatrixInverse");const xt=H.skeleton;xt&&(ae.floatVertexTextures?(xt.boneTexture===null&&xt.computeBoneTexture(),ct.setValue(L,"boneTexture",xt.boneTexture,Se),ct.setValue(L,"boneTextureSize",xt.boneTextureSize)):console.warn("THREE.WebGLRenderer: SkinnedMesh can only be used with WebGL 2. With WebGL 1 OES_texture_float and vertex textures support is required."))}const Ln=B.morphAttributes;if((Ln.position!==void 0||Ln.normal!==void 0||Ln.color!==void 0&&ae.isWebGL2===!0)&&C.update(H,B,Lt),(rn||qe.receiveShadow!==H.receiveShadow)&&(qe.receiveShadow=H.receiveShadow,ct.setValue(L,"receiveShadow",H.receiveShadow)),V.isMeshGouraudMaterial&&V.envMap!==null&&(Ut.envMap.value=Ge,Ut.flipEnvMap.value=Ge.isCubeTexture&&Ge.isRenderTargetTexture===!1?-1:1),rn&&(ct.setValue(L,"toneMappingExposure",g.toneMappingExposure),qe.needsLights&&lt(Ut,sn),we&&V.fog===!0&&re.refreshFogUniforms(Ut,we),re.refreshMaterialUniforms(Ut,V,X,W,de),pr.upload(L,gn(qe),Ut,Se)),V.isShaderMaterial&&V.uniformsNeedUpdate===!0&&(pr.upload(L,gn(qe),Ut,Se),V.uniformsNeedUpdate=!1),V.isSpriteMaterial&&ct.setValue(L,"center",H.center),ct.setValue(L,"modelViewMatrix",H.modelViewMatrix),ct.setValue(L,"normalMatrix",H.normalMatrix),ct.setValue(L,"modelMatrix",H.matrixWorld),V.isShaderMaterial||V.isRawShaderMaterial){const xt=V.uniformsGroups;for(let Ti=0,wr=xt.length;Ti<wr;Ti++)if(ae.isWebGL2){const Gi=xt[Ti];Ae.update(Gi,Lt),Ae.bind(Gi,Lt)}else console.warn("THREE.WebGLRenderer: Uniform Buffer Objects can only be used with WebGL 2.")}return Lt}function lt(S,N){S.ambientLightColor.needsUpdate=N,S.lightProbe.needsUpdate=N,S.directionalLights.needsUpdate=N,S.directionalLightShadows.needsUpdate=N,S.pointLights.needsUpdate=N,S.pointLightShadows.needsUpdate=N,S.spotLights.needsUpdate=N,S.spotLightShadows.needsUpdate=N,S.rectAreaLights.needsUpdate=N,S.hemisphereLights.needsUpdate=N}function Ct(S){return S.isMeshLambertMaterial||S.isMeshToonMaterial||S.isMeshPhongMaterial||S.isMeshStandardMaterial||S.isShadowMaterial||S.isShaderMaterial&&S.lights===!0}this.getActiveCubeFace=function(){return b},this.getActiveMipmapLevel=function(){return R},this.getRenderTarget=function(){return A},this.setRenderTargetTextures=function(S,N,B){Me.get(S.texture).__webglTexture=N,Me.get(S.depthTexture).__webglTexture=B;const V=Me.get(S);V.__hasExternalTextures=!0,V.__hasExternalTextures&&(V.__autoAllocateDepthBuffer=B===void 0,V.__autoAllocateDepthBuffer||Q.has("WEBGL_multisampled_render_to_texture")===!0&&(console.warn("THREE.WebGLRenderer: Render-to-texture extension was disabled because an external texture was provided"),V.__useRenderToTexture=!1))},this.setRenderTargetFramebuffer=function(S,N){const B=Me.get(S);B.__webglFramebuffer=N,B.__useDefaultFramebuffer=N===void 0},this.setRenderTarget=function(S,N=0,B=0){A=S,b=N,R=B;let V=!0,H=null,we=!1,Fe=!1;if(S){const Ge=Me.get(S);Ge.__useDefaultFramebuffer!==void 0?(me.bindFramebuffer(L.FRAMEBUFFER,null),V=!1):Ge.__webglFramebuffer===void 0?Se.setupRenderTarget(S):Ge.__hasExternalTextures&&Se.rebindTextures(S,Me.get(S.texture).__webglTexture,Me.get(S.depthTexture).__webglTexture);const We=S.texture;(We.isData3DTexture||We.isDataArrayTexture||We.isCompressedArrayTexture)&&(Fe=!0);const Ve=Me.get(S).__webglFramebuffer;S.isWebGLCubeRenderTarget?(Array.isArray(Ve[N])?H=Ve[N][B]:H=Ve[N],we=!0):ae.isWebGL2&&S.samples>0&&Se.useMultisampledRTT(S)===!1?H=Me.get(S).__webglMultisampledFramebuffer:Array.isArray(Ve)?H=Ve[B]:H=Ve,T.copy(S.viewport),k.copy(S.scissor),q=S.scissorTest}else T.copy(J).multiplyScalar(X).floor(),k.copy(U).multiplyScalar(X).floor(),q=F;if(me.bindFramebuffer(L.FRAMEBUFFER,H)&&ae.drawBuffers&&V&&me.drawBuffers(S,H),me.viewport(T),me.scissor(k),me.setScissorTest(q),we){const Ge=Me.get(S.texture);L.framebufferTexture2D(L.FRAMEBUFFER,L.COLOR_ATTACHMENT0,L.TEXTURE_CUBE_MAP_POSITIVE_X+N,Ge.__webglTexture,B)}else if(Fe){const Ge=Me.get(S.texture),We=N||0;L.framebufferTextureLayer(L.FRAMEBUFFER,L.COLOR_ATTACHMENT0,Ge.__webglTexture,B||0,We)}G=-1},this.readRenderTargetPixels=function(S,N,B,V,H,we,Fe){if(!(S&&S.isWebGLRenderTarget)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let Be=Me.get(S).__webglFramebuffer;if(S.isWebGLCubeRenderTarget&&Fe!==void 0&&(Be=Be[Fe]),Be){me.bindFramebuffer(L.FRAMEBUFFER,Be);try{const Ge=S.texture,We=Ge.format,Ve=Ge.type;if(We!==Kt&&Ne.convert(We)!==L.getParameter(L.IMPLEMENTATION_COLOR_READ_FORMAT)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}const ke=Ve===Fi&&(Q.has("EXT_color_buffer_half_float")||ae.isWebGL2&&Q.has("EXT_color_buffer_float"));if(Ve!==wn&&Ne.convert(Ve)!==L.getParameter(L.IMPLEMENTATION_COLOR_READ_TYPE)&&!(Ve===Tn&&(ae.isWebGL2||Q.has("OES_texture_float")||Q.has("WEBGL_color_buffer_float")))&&!ke){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}N>=0&&N<=S.width-V&&B>=0&&B<=S.height-H&&L.readPixels(N,B,V,H,Ne.convert(We),Ne.convert(Ve),we)}finally{const Ge=A!==null?Me.get(A).__webglFramebuffer:null;me.bindFramebuffer(L.FRAMEBUFFER,Ge)}}},this.copyFramebufferToTexture=function(S,N,B=0){const V=Math.pow(2,-B),H=Math.floor(N.image.width*V),we=Math.floor(N.image.height*V);Se.setTexture2D(N,0),L.copyTexSubImage2D(L.TEXTURE_2D,B,0,0,S.x,S.y,H,we),me.unbindTexture()},this.copyTextureToTexture=function(S,N,B,V=0){const H=N.image.width,we=N.image.height,Fe=Ne.convert(B.format),Be=Ne.convert(B.type);Se.setTexture2D(B,0),L.pixelStorei(L.UNPACK_FLIP_Y_WEBGL,B.flipY),L.pixelStorei(L.UNPACK_PREMULTIPLY_ALPHA_WEBGL,B.premultiplyAlpha),L.pixelStorei(L.UNPACK_ALIGNMENT,B.unpackAlignment),N.isDataTexture?L.texSubImage2D(L.TEXTURE_2D,V,S.x,S.y,H,we,Fe,Be,N.image.data):N.isCompressedTexture?L.compressedTexSubImage2D(L.TEXTURE_2D,V,S.x,S.y,N.mipmaps[0].width,N.mipmaps[0].height,Fe,N.mipmaps[0].data):L.texSubImage2D(L.TEXTURE_2D,V,S.x,S.y,Fe,Be,N.image),V===0&&B.generateMipmaps&&L.generateMipmap(L.TEXTURE_2D),me.unbindTexture()},this.copyTextureToTexture3D=function(S,N,B,V,H=0){if(g.isWebGL1Renderer){console.warn("THREE.WebGLRenderer.copyTextureToTexture3D: can only be used with WebGL2.");return}const we=S.max.x-S.min.x+1,Fe=S.max.y-S.min.y+1,Be=S.max.z-S.min.z+1,Ge=Ne.convert(V.format),We=Ne.convert(V.type);let Ve;if(V.isData3DTexture)Se.setTexture3D(V,0),Ve=L.TEXTURE_3D;else if(V.isDataArrayTexture)Se.setTexture2DArray(V,0),Ve=L.TEXTURE_2D_ARRAY;else{console.warn("THREE.WebGLRenderer.copyTextureToTexture3D: only supports THREE.DataTexture3D and THREE.DataTexture2DArray.");return}L.pixelStorei(L.UNPACK_FLIP_Y_WEBGL,V.flipY),L.pixelStorei(L.UNPACK_PREMULTIPLY_ALPHA_WEBGL,V.premultiplyAlpha),L.pixelStorei(L.UNPACK_ALIGNMENT,V.unpackAlignment);const ke=L.getParameter(L.UNPACK_ROW_LENGTH),it=L.getParameter(L.UNPACK_IMAGE_HEIGHT),_t=L.getParameter(L.UNPACK_SKIP_PIXELS),et=L.getParameter(L.UNPACK_SKIP_ROWS),vt=L.getParameter(L.UNPACK_SKIP_IMAGES),tt=B.isCompressedTexture?B.mipmaps[0]:B.image;L.pixelStorei(L.UNPACK_ROW_LENGTH,tt.width),L.pixelStorei(L.UNPACK_IMAGE_HEIGHT,tt.height),L.pixelStorei(L.UNPACK_SKIP_PIXELS,S.min.x),L.pixelStorei(L.UNPACK_SKIP_ROWS,S.min.y),L.pixelStorei(L.UNPACK_SKIP_IMAGES,S.min.z),B.isDataTexture||B.isData3DTexture?L.texSubImage3D(Ve,H,N.x,N.y,N.z,we,Fe,Be,Ge,We,tt.data):B.isCompressedArrayTexture?(console.warn("THREE.WebGLRenderer.copyTextureToTexture3D: untested support for compressed srcTexture."),L.compressedTexSubImage3D(Ve,H,N.x,N.y,N.z,we,Fe,Be,Ge,tt.data)):L.texSubImage3D(Ve,H,N.x,N.y,N.z,we,Fe,Be,Ge,We,tt),L.pixelStorei(L.UNPACK_ROW_LENGTH,ke),L.pixelStorei(L.UNPACK_IMAGE_HEIGHT,it),L.pixelStorei(L.UNPACK_SKIP_PIXELS,_t),L.pixelStorei(L.UNPACK_SKIP_ROWS,et),L.pixelStorei(L.UNPACK_SKIP_IMAGES,vt),H===0&&V.generateMipmaps&&L.generateMipmap(Ve),me.unbindTexture()},this.initTexture=function(S){S.isCubeTexture?Se.setTextureCube(S,0):S.isData3DTexture?Se.setTexture3D(S,0):S.isDataArrayTexture||S.isCompressedArrayTexture?Se.setTexture2DArray(S,0):Se.setTexture2D(S,0),me.unbindTexture()},this.resetState=function(){b=0,R=0,A=null,me.reset(),Ce.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return fn}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;const t=this.getContext();t.drawingBufferColorSpace=e===Ss?"display-p3":"srgb",t.unpackColorSpace=Qe.workingColorSpace===yr?"display-p3":"srgb"}get physicallyCorrectLights(){return console.warn("THREE.WebGLRenderer: The property .physicallyCorrectLights has been removed. Set renderer.useLegacyLights instead."),!this.useLegacyLights}set physicallyCorrectLights(e){console.warn("THREE.WebGLRenderer: The property .physicallyCorrectLights has been removed. Set renderer.useLegacyLights instead."),this.useLegacyLights=!e}get outputEncoding(){return console.warn("THREE.WebGLRenderer: Property .outputEncoding has been removed. Use .outputColorSpace instead."),this.outputColorSpace===Mt?kn:Eo}set outputEncoding(e){console.warn("THREE.WebGLRenderer: Property .outputEncoding has been removed. Use .outputColorSpace instead."),this.outputColorSpace=e===kn?Mt:mn}get useLegacyLights(){return console.warn("THREE.WebGLRenderer: The property .useLegacyLights has been deprecated. Migrate your lighting according to the following guide: https://discourse.threejs.org/t/updates-to-lighting-in-three-js-r155/53733."),this._useLegacyLights}set useLegacyLights(e){console.warn("THREE.WebGLRenderer: The property .useLegacyLights has been deprecated. Migrate your lighting according to the following guide: https://discourse.threejs.org/t/updates-to-lighting-in-three-js-r155/53733."),this._useLegacyLights=e}}class gp extends Go{}gp.prototype.isWebGL1Renderer=!0;class _p extends gt{constructor(){super(),this.isScene=!0,this.type="Scene",this.background=null,this.environment=null,this.fog=null,this.backgroundBlurriness=0,this.backgroundIntensity=1,this.overrideMaterial=null,typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}copy(e,t){return super.copy(e,t),e.background!==null&&(this.background=e.background.clone()),e.environment!==null&&(this.environment=e.environment.clone()),e.fog!==null&&(this.fog=e.fog.clone()),this.backgroundBlurriness=e.backgroundBlurriness,this.backgroundIntensity=e.backgroundIntensity,e.overrideMaterial!==null&&(this.overrideMaterial=e.overrideMaterial.clone()),this.matrixAutoUpdate=e.matrixAutoUpdate,this}toJSON(e){const t=super.toJSON(e);return this.fog!==null&&(t.object.fog=this.fog.toJSON()),this.backgroundBlurriness>0&&(t.object.backgroundBlurriness=this.backgroundBlurriness),this.backgroundIntensity!==1&&(t.object.backgroundIntensity=this.backgroundIntensity),t}}class gs extends Ei{constructor(e){super(),this.isLineBasicMaterial=!0,this.type="LineBasicMaterial",this.color=new Je(16777215),this.map=null,this.linewidth=1,this.linecap="round",this.linejoin="round",this.fog=!0,this.setValues(e)}copy(e){return super.copy(e),this.color.copy(e.color),this.map=e.map,this.linewidth=e.linewidth,this.linecap=e.linecap,this.linejoin=e.linejoin,this.fog=e.fog,this}}const Za=new O,$a=new O,Ja=new ut,is=new ys,hr=new Tr;class ur extends gt{constructor(e=new en,t=new gs){super(),this.isLine=!0,this.type="Line",this.geometry=e,this.material=t,this.updateMorphTargets()}copy(e,t){return super.copy(e,t),this.material=Array.isArray(e.material)?e.material.slice():e.material,this.geometry=e.geometry,this}computeLineDistances(){const e=this.geometry;if(e.index===null){const t=e.attributes.position,i=[0];for(let r=1,s=t.count;r<s;r++)Za.fromBufferAttribute(t,r-1),$a.fromBufferAttribute(t,r),i[r]=i[r-1],i[r]+=Za.distanceTo($a);e.setAttribute("lineDistance",new $t(i,1))}else console.warn("THREE.Line.computeLineDistances(): Computation only possible with non-indexed BufferGeometry.");return this}raycast(e,t){const i=this.geometry,r=this.matrixWorld,s=e.params.Line.threshold,o=i.drawRange;if(i.boundingSphere===null&&i.computeBoundingSphere(),hr.copy(i.boundingSphere),hr.applyMatrix4(r),hr.radius+=s,e.ray.intersectsSphere(hr)===!1)return;Ja.copy(r).invert(),is.copy(e.ray).applyMatrix4(Ja);const a=s/((this.scale.x+this.scale.y+this.scale.z)/3),l=a*a,c=new O,h=new O,d=new O,f=new O,m=this.isLineSegments?2:1,_=i.index,p=i.attributes.position;if(_!==null){const u=Math.max(0,o.start),y=Math.min(_.count,o.start+o.count);for(let g=u,w=y-1;g<w;g+=m){const b=_.getX(g),R=_.getX(g+1);if(c.fromBufferAttribute(p,b),h.fromBufferAttribute(p,R),is.distanceSqToSegment(c,h,f,d)>l)continue;f.applyMatrix4(this.matrixWorld);const G=e.ray.origin.distanceTo(f);G<e.near||G>e.far||t.push({distance:G,point:d.clone().applyMatrix4(this.matrixWorld),index:g,face:null,faceIndex:null,object:this})}}else{const u=Math.max(0,o.start),y=Math.min(p.count,o.start+o.count);for(let g=u,w=y-1;g<w;g+=m){if(c.fromBufferAttribute(p,g),h.fromBufferAttribute(p,g+1),is.distanceSqToSegment(c,h,f,d)>l)continue;f.applyMatrix4(this.matrixWorld);const R=e.ray.origin.distanceTo(f);R<e.near||R>e.far||t.push({distance:R,point:d.clone().applyMatrix4(this.matrixWorld),index:g,face:null,faceIndex:null,object:this})}}}updateMorphTargets(){const t=this.geometry.morphAttributes,i=Object.keys(t);if(i.length>0){const r=t[i[0]];if(r!==void 0){this.morphTargetInfluences=[],this.morphTargetDictionary={};for(let s=0,o=r.length;s<o;s++){const a=r[s].name||String(s);this.morphTargetInfluences.push(0),this.morphTargetDictionary[a]=s}}}}}class zn extends en{constructor(e=1,t=32,i=16,r=0,s=Math.PI*2,o=0,a=Math.PI){super(),this.type="SphereGeometry",this.parameters={radius:e,widthSegments:t,heightSegments:i,phiStart:r,phiLength:s,thetaStart:o,thetaLength:a},t=Math.max(3,Math.floor(t)),i=Math.max(2,Math.floor(i));const l=Math.min(o+a,Math.PI);let c=0;const h=[],d=new O,f=new O,m=[],_=[],x=[],p=[];for(let u=0;u<=i;u++){const y=[],g=u/i;let w=0;u===0&&o===0?w=.5/t:u===i&&l===Math.PI&&(w=-.5/t);for(let b=0;b<=t;b++){const R=b/t;d.x=-e*Math.cos(r+R*s)*Math.sin(o+g*a),d.y=e*Math.cos(o+g*a),d.z=e*Math.sin(r+R*s)*Math.sin(o+g*a),_.push(d.x,d.y,d.z),f.copy(d).normalize(),x.push(f.x,f.y,f.z),p.push(R+w,1-g),y.push(c++)}h.push(y)}for(let u=0;u<i;u++)for(let y=0;y<t;y++){const g=h[u][y+1],w=h[u][y],b=h[u+1][y],R=h[u+1][y+1];(u!==0||o>0)&&m.push(g,w,R),(u!==i-1||l<Math.PI)&&m.push(w,b,R)}this.setIndex(m),this.setAttribute("position",new $t(_,3)),this.setAttribute("normal",new $t(x,3)),this.setAttribute("uv",new $t(p,2))}copy(e){return super.copy(e),this.parameters=Object.assign({},e.parameters),this}static fromJSON(e){return new zn(e.radius,e.widthSegments,e.heightSegments,e.phiStart,e.phiLength,e.thetaStart,e.thetaLength)}}class dr extends Ei{constructor(e){super(),this.isMeshStandardMaterial=!0,this.defines={STANDARD:""},this.type="MeshStandardMaterial",this.color=new Je(16777215),this.roughness=1,this.metalness=0,this.map=null,this.lightMap=null,this.lightMapIntensity=1,this.aoMap=null,this.aoMapIntensity=1,this.emissive=new Je(0),this.emissiveIntensity=1,this.emissiveMap=null,this.bumpMap=null,this.bumpScale=1,this.normalMap=null,this.normalMapType=yo,this.normalScale=new Xe(1,1),this.displacementMap=null,this.displacementScale=1,this.displacementBias=0,this.roughnessMap=null,this.metalnessMap=null,this.alphaMap=null,this.envMap=null,this.envMapIntensity=1,this.wireframe=!1,this.wireframeLinewidth=1,this.wireframeLinecap="round",this.wireframeLinejoin="round",this.flatShading=!1,this.fog=!0,this.setValues(e)}copy(e){return super.copy(e),this.defines={STANDARD:""},this.color.copy(e.color),this.roughness=e.roughness,this.metalness=e.metalness,this.map=e.map,this.lightMap=e.lightMap,this.lightMapIntensity=e.lightMapIntensity,this.aoMap=e.aoMap,this.aoMapIntensity=e.aoMapIntensity,this.emissive.copy(e.emissive),this.emissiveMap=e.emissiveMap,this.emissiveIntensity=e.emissiveIntensity,this.bumpMap=e.bumpMap,this.bumpScale=e.bumpScale,this.normalMap=e.normalMap,this.normalMapType=e.normalMapType,this.normalScale.copy(e.normalScale),this.displacementMap=e.displacementMap,this.displacementScale=e.displacementScale,this.displacementBias=e.displacementBias,this.roughnessMap=e.roughnessMap,this.metalnessMap=e.metalnessMap,this.alphaMap=e.alphaMap,this.envMap=e.envMap,this.envMapIntensity=e.envMapIntensity,this.wireframe=e.wireframe,this.wireframeLinewidth=e.wireframeLinewidth,this.wireframeLinecap=e.wireframeLinecap,this.wireframeLinejoin=e.wireframeLinejoin,this.flatShading=e.flatShading,this.fog=e.fog,this}}class Rs extends gt{constructor(e,t=1){super(),this.isLight=!0,this.type="Light",this.color=new Je(e),this.intensity=t}dispose(){}copy(e,t){return super.copy(e,t),this.color.copy(e.color),this.intensity=e.intensity,this}toJSON(e){const t=super.toJSON(e);return t.object.color=this.color.getHex(),t.object.intensity=this.intensity,this.groundColor!==void 0&&(t.object.groundColor=this.groundColor.getHex()),this.distance!==void 0&&(t.object.distance=this.distance),this.angle!==void 0&&(t.object.angle=this.angle),this.decay!==void 0&&(t.object.decay=this.decay),this.penumbra!==void 0&&(t.object.penumbra=this.penumbra),this.shadow!==void 0&&(t.object.shadow=this.shadow.toJSON()),t}}class vp extends Rs{constructor(e,t,i){super(e,i),this.isHemisphereLight=!0,this.type="HemisphereLight",this.position.copy(gt.DEFAULT_UP),this.updateMatrix(),this.groundColor=new Je(t)}copy(e,t){return super.copy(e,t),this.groundColor.copy(e.groundColor),this}}const rs=new ut,Qa=new O,eo=new O;class xp{constructor(e){this.camera=e,this.bias=0,this.normalBias=0,this.radius=1,this.blurSamples=8,this.mapSize=new Xe(512,512),this.map=null,this.mapPass=null,this.matrix=new ut,this.autoUpdate=!0,this.needsUpdate=!1,this._frustum=new bs,this._frameExtents=new Xe(1,1),this._viewportCount=1,this._viewports=[new mt(0,0,1,1)]}getViewportCount(){return this._viewportCount}getFrustum(){return this._frustum}updateMatrices(e){const t=this.camera,i=this.matrix;Qa.setFromMatrixPosition(e.matrixWorld),t.position.copy(Qa),eo.setFromMatrixPosition(e.target.matrixWorld),t.lookAt(eo),t.updateMatrixWorld(),rs.multiplyMatrices(t.projectionMatrix,t.matrixWorldInverse),this._frustum.setFromProjectionMatrix(rs),i.set(.5,0,0,.5,0,.5,0,.5,0,0,.5,.5,0,0,0,1),i.multiply(rs)}getViewport(e){return this._viewports[e]}getFrameExtents(){return this._frameExtents}dispose(){this.map&&this.map.dispose(),this.mapPass&&this.mapPass.dispose()}copy(e){return this.camera=e.camera.clone(),this.bias=e.bias,this.radius=e.radius,this.mapSize.copy(e.mapSize),this}clone(){return new this.constructor().copy(this)}toJSON(){const e={};return this.bias!==0&&(e.bias=this.bias),this.normalBias!==0&&(e.normalBias=this.normalBias),this.radius!==1&&(e.radius=this.radius),(this.mapSize.x!==512||this.mapSize.y!==512)&&(e.mapSize=this.mapSize.toArray()),e.camera=this.camera.toJSON(!1).object,delete e.camera.matrix,e}}class Mp extends xp{constructor(){super(new Fo(-5,5,5,-5,.5,500)),this.isDirectionalLightShadow=!0}}class Sp extends Rs{constructor(e,t){super(e,t),this.isDirectionalLight=!0,this.type="DirectionalLight",this.position.copy(gt.DEFAULT_UP),this.updateMatrix(),this.target=new gt,this.shadow=new Mp}dispose(){this.shadow.dispose()}copy(e){return super.copy(e),this.target=e.target.clone(),this.shadow=e.shadow.clone(),this}}class Ep extends Rs{constructor(e,t){super(e,t),this.isAmbientLight=!0,this.type="AmbientLight"}}class to{constructor(e=1,t=0,i=0){return this.radius=e,this.phi=t,this.theta=i,this}set(e,t,i){return this.radius=e,this.phi=t,this.theta=i,this}copy(e){return this.radius=e.radius,this.phi=e.phi,this.theta=e.theta,this}makeSafe(){return this.phi=Math.max(1e-6,Math.min(Math.PI-1e-6,this.phi)),this}setFromVector3(e){return this.setFromCartesianCoords(e.x,e.y,e.z)}setFromCartesianCoords(e,t,i){return this.radius=Math.sqrt(e*e+t*t+i*i),this.radius===0?(this.theta=0,this.phi=0):(this.theta=Math.atan2(e,i),this.phi=Math.acos(Tt(t/this.radius,-1,1))),this}clone(){return new this.constructor().copy(this)}}typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("register",{detail:{revision:xs}}));typeof window<"u"&&(window.__THREE__?console.warn("WARNING: Multiple instances of Three.js being imported."):window.__THREE__=xs);const no={type:"change"},ss={type:"start"},io={type:"end"},fr=new ys,ro=new En,yp=Math.cos(70*uc.DEG2RAD);class Tp extends Yn{constructor(e,t){super(),this.object=e,this.domElement=t,this.domElement.style.touchAction="none",this.enabled=!0,this.target=new O,this.cursor=new O,this.minDistance=0,this.maxDistance=1/0,this.minZoom=0,this.maxZoom=1/0,this.minTargetRadius=0,this.maxTargetRadius=1/0,this.minPolarAngle=0,this.maxPolarAngle=Math.PI,this.minAzimuthAngle=-1/0,this.maxAzimuthAngle=1/0,this.enableDamping=!1,this.dampingFactor=.05,this.enableZoom=!0,this.zoomSpeed=1,this.enableRotate=!0,this.rotateSpeed=1,this.enablePan=!0,this.panSpeed=1,this.screenSpacePanning=!0,this.keyPanSpeed=7,this.zoomToCursor=!1,this.autoRotate=!1,this.autoRotateSpeed=2,this.keys={LEFT:"ArrowLeft",UP:"ArrowUp",RIGHT:"ArrowRight",BOTTOM:"ArrowDown"},this.mouseButtons={LEFT:Kn.ROTATE,MIDDLE:Kn.DOLLY,RIGHT:Kn.PAN},this.touches={ONE:Zn.ROTATE,TWO:Zn.DOLLY_PAN},this.target0=this.target.clone(),this.position0=this.object.position.clone(),this.zoom0=this.object.zoom,this._domElementKeyEvents=null,this.getPolarAngle=function(){return a.phi},this.getAzimuthalAngle=function(){return a.theta},this.getDistance=function(){return this.object.position.distanceTo(this.target)},this.listenToKeyEvents=function(C){C.addEventListener("keydown",v),this._domElementKeyEvents=C},this.stopListenToKeyEvents=function(){this._domElementKeyEvents.removeEventListener("keydown",v),this._domElementKeyEvents=null},this.saveState=function(){i.target0.copy(i.target),i.position0.copy(i.object.position),i.zoom0=i.object.zoom},this.reset=function(){i.target.copy(i.target0),i.object.position.copy(i.position0),i.object.zoom=i.zoom0,i.object.updateProjectionMatrix(),i.dispatchEvent(no),i.update(),s=r.NONE},this.update=function(){const C=new O,se=new Xn().setFromUnitVectors(e.up,new O(0,1,0)),Z=se.clone().invert(),Ne=new O,Ce=new Xn,Ae=new O,Ee=2*Math.PI;return function(He=null){const P=i.object.position;C.copy(P).sub(i.target),C.applyQuaternion(se),a.setFromVector3(C),i.autoRotate&&s===r.NONE&&k(M(He)),i.enableDamping?(a.theta+=l.theta*i.dampingFactor,a.phi+=l.phi*i.dampingFactor):(a.theta+=l.theta,a.phi+=l.phi);let _e=i.minAzimuthAngle,oe=i.maxAzimuthAngle;isFinite(_e)&&isFinite(oe)&&(_e<-Math.PI?_e+=Ee:_e>Math.PI&&(_e-=Ee),oe<-Math.PI?oe+=Ee:oe>Math.PI&&(oe-=Ee),_e<=oe?a.theta=Math.max(_e,Math.min(oe,a.theta)):a.theta=a.theta>(_e+oe)/2?Math.max(_e,a.theta):Math.min(oe,a.theta)),a.phi=Math.max(i.minPolarAngle,Math.min(i.maxPolarAngle,a.phi)),a.makeSafe(),i.enableDamping===!0?i.target.addScaledVector(h,i.dampingFactor):i.target.add(h),i.target.sub(i.cursor),i.target.clampLength(i.minTargetRadius,i.maxTargetRadius),i.target.add(i.cursor),i.zoomToCursor&&R||i.object.isOrthographicCamera?a.radius=Y(a.radius):a.radius=Y(a.radius*c),C.setFromSpherical(a),C.applyQuaternion(Z),P.copy(i.target).add(C),i.object.lookAt(i.target),i.enableDamping===!0?(l.theta*=1-i.dampingFactor,l.phi*=1-i.dampingFactor,h.multiplyScalar(1-i.dampingFactor)):(l.set(0,0,0),h.set(0,0,0));let j=!1;if(i.zoomToCursor&&R){let ue=null;if(i.object.isPerspectiveCamera){const Pe=C.length();ue=Y(Pe*c);const Oe=Pe-ue;i.object.position.addScaledVector(w,Oe),i.object.updateMatrixWorld()}else if(i.object.isOrthographicCamera){const Pe=new O(b.x,b.y,0);Pe.unproject(i.object),i.object.zoom=Math.max(i.minZoom,Math.min(i.maxZoom,i.object.zoom/c)),i.object.updateProjectionMatrix(),j=!0;const Oe=new O(b.x,b.y,0);Oe.unproject(i.object),i.object.position.sub(Oe).add(Pe),i.object.updateMatrixWorld(),ue=C.length()}else console.warn("WARNING: OrbitControls.js encountered an unknown camera type - zoom to cursor disabled."),i.zoomToCursor=!1;ue!==null&&(this.screenSpacePanning?i.target.set(0,0,-1).transformDirection(i.object.matrix).multiplyScalar(ue).add(i.object.position):(fr.origin.copy(i.object.position),fr.direction.set(0,0,-1).transformDirection(i.object.matrix),Math.abs(i.object.up.dot(fr.direction))<yp?e.lookAt(i.target):(ro.setFromNormalAndCoplanarPoint(i.object.up,i.target),fr.intersectPlane(ro,i.target))))}else i.object.isOrthographicCamera&&(i.object.zoom=Math.max(i.minZoom,Math.min(i.maxZoom,i.object.zoom/c)),i.object.updateProjectionMatrix(),j=!0);return c=1,R=!1,j||Ne.distanceToSquared(i.object.position)>o||8*(1-Ce.dot(i.object.quaternion))>o||Ae.distanceToSquared(i.target)>0?(i.dispatchEvent(no),Ne.copy(i.object.position),Ce.copy(i.object.quaternion),Ae.copy(i.target),j=!1,!0):!1}}(),this.dispose=function(){i.domElement.removeEventListener("contextmenu",te),i.domElement.removeEventListener("pointerdown",Me),i.domElement.removeEventListener("pointercancel",Re),i.domElement.removeEventListener("wheel",E),i.domElement.removeEventListener("pointermove",Se),i.domElement.removeEventListener("pointerup",Re),i._domElementKeyEvents!==null&&(i._domElementKeyEvents.removeEventListener("keydown",v),i._domElementKeyEvents=null)};const i=this,r={NONE:-1,ROTATE:0,DOLLY:1,PAN:2,TOUCH_ROTATE:3,TOUCH_PAN:4,TOUCH_DOLLY_PAN:5,TOUCH_DOLLY_ROTATE:6};let s=r.NONE;const o=1e-6,a=new to,l=new to;let c=1;const h=new O,d=new Xe,f=new Xe,m=new Xe,_=new Xe,x=new Xe,p=new Xe,u=new Xe,y=new Xe,g=new Xe,w=new O,b=new Xe;let R=!1;const A=[],G={};function M(C){return C!==null?2*Math.PI/60*i.autoRotateSpeed*C:2*Math.PI/60/60*i.autoRotateSpeed}function T(){return Math.pow(.95,i.zoomSpeed)}function k(C){l.theta-=C}function q(C){l.phi-=C}const ne=function(){const C=new O;return function(Z,Ne){C.setFromMatrixColumn(Ne,0),C.multiplyScalar(-Z),h.add(C)}}(),D=function(){const C=new O;return function(Z,Ne){i.screenSpacePanning===!0?C.setFromMatrixColumn(Ne,1):(C.setFromMatrixColumn(Ne,0),C.crossVectors(i.object.up,C)),C.multiplyScalar(Z),h.add(C)}}(),z=function(){const C=new O;return function(Z,Ne){const Ce=i.domElement;if(i.object.isPerspectiveCamera){const Ae=i.object.position;C.copy(Ae).sub(i.target);let Ee=C.length();Ee*=Math.tan(i.object.fov/2*Math.PI/180),ne(2*Z*Ee/Ce.clientHeight,i.object.matrix),D(2*Ne*Ee/Ce.clientHeight,i.object.matrix)}else i.object.isOrthographicCamera?(ne(Z*(i.object.right-i.object.left)/i.object.zoom/Ce.clientWidth,i.object.matrix),D(Ne*(i.object.top-i.object.bottom)/i.object.zoom/Ce.clientHeight,i.object.matrix)):(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - pan disabled."),i.enablePan=!1)}}();function W(C){i.object.isPerspectiveCamera||i.object.isOrthographicCamera?c/=C:(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled."),i.enableZoom=!1)}function X(C){i.object.isPerspectiveCamera||i.object.isOrthographicCamera?c*=C:(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled."),i.enableZoom=!1)}function ee(C){if(!i.zoomToCursor)return;R=!0;const se=i.domElement.getBoundingClientRect(),Z=C.clientX-se.left,Ne=C.clientY-se.top,Ce=se.width,Ae=se.height;b.x=Z/Ce*2-1,b.y=-(Ne/Ae)*2+1,w.set(b.x,b.y,1).unproject(i.object).sub(i.object.position).normalize()}function Y(C){return Math.max(i.minDistance,Math.min(i.maxDistance,C))}function J(C){d.set(C.clientX,C.clientY)}function U(C){ee(C),u.set(C.clientX,C.clientY)}function F(C){_.set(C.clientX,C.clientY)}function ge(C){f.set(C.clientX,C.clientY),m.subVectors(f,d).multiplyScalar(i.rotateSpeed);const se=i.domElement;k(2*Math.PI*m.x/se.clientHeight),q(2*Math.PI*m.y/se.clientHeight),d.copy(f),i.update()}function pe(C){y.set(C.clientX,C.clientY),g.subVectors(y,u),g.y>0?W(T()):g.y<0&&X(T()),u.copy(y),i.update()}function $(C){x.set(C.clientX,C.clientY),p.subVectors(x,_).multiplyScalar(i.panSpeed),z(p.x,p.y),_.copy(x),i.update()}function de(C){ee(C),C.deltaY<0?X(T()):C.deltaY>0&&W(T()),i.update()}function Le(C){let se=!1;switch(C.code){case i.keys.UP:C.ctrlKey||C.metaKey||C.shiftKey?q(2*Math.PI*i.rotateSpeed/i.domElement.clientHeight):z(0,i.keyPanSpeed),se=!0;break;case i.keys.BOTTOM:C.ctrlKey||C.metaKey||C.shiftKey?q(-2*Math.PI*i.rotateSpeed/i.domElement.clientHeight):z(0,-i.keyPanSpeed),se=!0;break;case i.keys.LEFT:C.ctrlKey||C.metaKey||C.shiftKey?k(2*Math.PI*i.rotateSpeed/i.domElement.clientHeight):z(i.keyPanSpeed,0),se=!0;break;case i.keys.RIGHT:C.ctrlKey||C.metaKey||C.shiftKey?k(-2*Math.PI*i.rotateSpeed/i.domElement.clientHeight):z(-i.keyPanSpeed,0),se=!0;break}se&&(C.preventDefault(),i.update())}function xe(){if(A.length===1)d.set(A[0].pageX,A[0].pageY);else{const C=.5*(A[0].pageX+A[1].pageX),se=.5*(A[0].pageY+A[1].pageY);d.set(C,se)}}function K(){if(A.length===1)_.set(A[0].pageX,A[0].pageY);else{const C=.5*(A[0].pageX+A[1].pageX),se=.5*(A[0].pageY+A[1].pageY);_.set(C,se)}}function ie(){const C=A[0].pageX-A[1].pageX,se=A[0].pageY-A[1].pageY,Z=Math.sqrt(C*C+se*se);u.set(0,Z)}function ce(){i.enableZoom&&ie(),i.enablePan&&K()}function L(){i.enableZoom&&ie(),i.enableRotate&&xe()}function De(C){if(A.length==1)f.set(C.pageX,C.pageY);else{const Z=ve(C),Ne=.5*(C.pageX+Z.x),Ce=.5*(C.pageY+Z.y);f.set(Ne,Ce)}m.subVectors(f,d).multiplyScalar(i.rotateSpeed);const se=i.domElement;k(2*Math.PI*m.x/se.clientHeight),q(2*Math.PI*m.y/se.clientHeight),d.copy(f)}function Q(C){if(A.length===1)x.set(C.pageX,C.pageY);else{const se=ve(C),Z=.5*(C.pageX+se.x),Ne=.5*(C.pageY+se.y);x.set(Z,Ne)}p.subVectors(x,_).multiplyScalar(i.panSpeed),z(p.x,p.y),_.copy(x)}function ae(C){const se=ve(C),Z=C.pageX-se.x,Ne=C.pageY-se.y,Ce=Math.sqrt(Z*Z+Ne*Ne);y.set(0,Ce),g.set(0,Math.pow(y.y/u.y,i.zoomSpeed)),W(g.y),u.copy(y)}function me(C){i.enableZoom&&ae(C),i.enablePan&&Q(C)}function Ie(C){i.enableZoom&&ae(C),i.enableRotate&&De(C)}function Me(C){i.enabled!==!1&&(A.length===0&&(i.domElement.setPointerCapture(C.pointerId),i.domElement.addEventListener("pointermove",Se),i.domElement.addEventListener("pointerup",Re)),le(C),C.pointerType==="touch"?I(C):Ue(C))}function Se(C){i.enabled!==!1&&(C.pointerType==="touch"?re(C):ze(C))}function Re(C){Te(C),A.length===0&&(i.domElement.releasePointerCapture(C.pointerId),i.domElement.removeEventListener("pointermove",Se),i.domElement.removeEventListener("pointerup",Re)),i.dispatchEvent(io),s=r.NONE}function Ue(C){let se;switch(C.button){case 0:se=i.mouseButtons.LEFT;break;case 1:se=i.mouseButtons.MIDDLE;break;case 2:se=i.mouseButtons.RIGHT;break;default:se=-1}switch(se){case Kn.DOLLY:if(i.enableZoom===!1)return;U(C),s=r.DOLLY;break;case Kn.ROTATE:if(C.ctrlKey||C.metaKey||C.shiftKey){if(i.enablePan===!1)return;F(C),s=r.PAN}else{if(i.enableRotate===!1)return;J(C),s=r.ROTATE}break;case Kn.PAN:if(C.ctrlKey||C.metaKey||C.shiftKey){if(i.enableRotate===!1)return;J(C),s=r.ROTATE}else{if(i.enablePan===!1)return;F(C),s=r.PAN}break;default:s=r.NONE}s!==r.NONE&&i.dispatchEvent(ss)}function ze(C){switch(s){case r.ROTATE:if(i.enableRotate===!1)return;ge(C);break;case r.DOLLY:if(i.enableZoom===!1)return;pe(C);break;case r.PAN:if(i.enablePan===!1)return;$(C);break}}function E(C){i.enabled===!1||i.enableZoom===!1||s!==r.NONE||(C.preventDefault(),i.dispatchEvent(ss),de(C),i.dispatchEvent(io))}function v(C){i.enabled===!1||i.enablePan===!1||Le(C)}function I(C){switch(he(C),A.length){case 1:switch(i.touches.ONE){case Zn.ROTATE:if(i.enableRotate===!1)return;xe(),s=r.TOUCH_ROTATE;break;case Zn.PAN:if(i.enablePan===!1)return;K(),s=r.TOUCH_PAN;break;default:s=r.NONE}break;case 2:switch(i.touches.TWO){case Zn.DOLLY_PAN:if(i.enableZoom===!1&&i.enablePan===!1)return;ce(),s=r.TOUCH_DOLLY_PAN;break;case Zn.DOLLY_ROTATE:if(i.enableZoom===!1&&i.enableRotate===!1)return;L(),s=r.TOUCH_DOLLY_ROTATE;break;default:s=r.NONE}break;default:s=r.NONE}s!==r.NONE&&i.dispatchEvent(ss)}function re(C){switch(he(C),s){case r.TOUCH_ROTATE:if(i.enableRotate===!1)return;De(C),i.update();break;case r.TOUCH_PAN:if(i.enablePan===!1)return;Q(C),i.update();break;case r.TOUCH_DOLLY_PAN:if(i.enableZoom===!1&&i.enablePan===!1)return;me(C),i.update();break;case r.TOUCH_DOLLY_ROTATE:if(i.enableZoom===!1&&i.enableRotate===!1)return;Ie(C),i.update();break;default:s=r.NONE}}function te(C){i.enabled!==!1&&C.preventDefault()}function le(C){A.push(C)}function Te(C){delete G[C.pointerId];for(let se=0;se<A.length;se++)if(A[se].pointerId==C.pointerId){A.splice(se,1);return}}function he(C){let se=G[C.pointerId];se===void 0&&(se=new Xe,G[C.pointerId]=se),se.set(C.pageX,C.pageY)}function ve(C){const se=C.pointerId===A[0].pointerId?A[1]:A[0];return G[se.pointerId]}i.domElement.addEventListener("contextmenu",te),i.domElement.addEventListener("pointerdown",Me),i.domElement.addEventListener("pointercancel",Re),i.domElement.addEventListener("wheel",E,{passive:!1}),this.update()}}/*!
 * satellite-js v5.0.0
 * (c) 2013 Shashwat Kandadai and UCSC
 * https://github.com/shashwatak/satellite-js
 * License: MIT
 */var bt=Math.PI,at=bt*2,Pi=bt/180,bp=180/bt,Ap=1440,wp=398600.8,Ft=6378.135,pn=60/Math.sqrt(Ft*Ft*Ft/wp),as=Ft*pn/60,Rp=1/pn,Bn=.001082616,Cp=-253881e-11,Lp=-165597e-11,Hn=Cp/Bn,zi=2/3;function Pp(n,e){for(var t=[31,n%4===0?29:28,31,30,31,30,31,31,30,31,30,31],i=Math.floor(e),r=1,s=0;i>s+t[r-1]&&r<12;)s+=t[r-1],r+=1;var o=r,a=i-s,l=(e-i)*24,c=Math.floor(l);l=(l-c)*60;var h=Math.floor(l),d=(l-h)*60;return{mon:o,day:a,hr:c,minute:h,sec:d}}function so(n,e,t,i,r,s){var o=arguments.length>6&&arguments[6]!==void 0?arguments[6]:0;return 367*n-Math.floor(7*(n+Math.floor((e+9)/12))*.25)+Math.floor(275*e/9)+t+17210135e-1+((o/6e4+s/60+r)/60+i)/24}function Cs(n,e,t,i,r,s,o){if(n instanceof Date){var a=n;return so(a.getUTCFullYear(),a.getUTCMonth()+1,a.getUTCDate(),a.getUTCHours(),a.getUTCMinutes(),a.getUTCSeconds(),a.getUTCMilliseconds())}return so(n,e,t,i,r,s,o)}function Vo(n,e){var t=n.e3,i=n.ee2,r=n.peo,s=n.pgho,o=n.pho,a=n.pinco,l=n.plo,c=n.se2,h=n.se3,d=n.sgh2,f=n.sgh3,m=n.sgh4,_=n.sh2,x=n.sh3,p=n.si2,u=n.si3,y=n.sl2,g=n.sl3,w=n.sl4,b=n.t,R=n.xgh2,A=n.xgh3,G=n.xgh4,M=n.xh2,T=n.xh3,k=n.xi2,q=n.xi3,ne=n.xl2,D=n.xl3,z=n.xl4,W=n.zmol,X=n.zmos,ee=e.init,Y=e.opsmode,J=e.ep,U=e.inclp,F=e.nodep,ge=e.argpp,pe=e.mp,$,de,Le,xe,K,ie,ce,L,De,Q,ae,me,Ie,Me,Se,Re,Ue,ze,E,v,I,re=119459e-10,te=.01675,le=.00015835218,Te=.0549;I=X+re*b,ee==="y"&&(I=X),v=I+2*te*Math.sin(I),Ue=Math.sin(v),Q=.5*Ue*Ue-.25,ae=-.5*Ue*Math.cos(v);var he=c*Q+h*ae,ve=p*Q+u*ae,C=y*Q+g*ae+w*Ue,se=d*Q+f*ae+m*Ue,Z=_*Q+x*ae;I=W+le*b,ee==="y"&&(I=W),v=I+2*Te*Math.sin(I),Ue=Math.sin(v),Q=.5*Ue*Ue-.25,ae=-.5*Ue*Math.cos(v);var Ne=i*Q+t*ae,Ce=k*Q+q*ae,Ae=ne*Q+D*ae+z*Ue,Ee=R*Q+A*ae+G*Ue,ye=M*Q+T*ae;return me=he+Ne,Se=ve+Ce,Re=C+Ae,Ie=se+Ee,Me=Z+ye,ee==="n"&&(me-=r,Se-=a,Re-=l,Ie-=s,Me-=o,U+=Se,J+=me,xe=Math.sin(U),Le=Math.cos(U),U>=.2?(Me/=xe,Ie-=Le*Me,ge+=Ie,F+=Me,pe+=Re):(ie=Math.sin(F),K=Math.cos(F),$=xe*ie,de=xe*K,ce=Me*K+Se*Le*ie,L=-Me*ie+Se*Le*K,$+=ce,de+=L,F%=at,F<0&&Y==="a"&&(F+=at),ze=pe+ge+Le*F,De=Re+Ie-Se*F*xe,ze+=De,E=F,F=Math.atan2($,de),F<0&&Y==="a"&&(F+=at),Math.abs(E-F)>bt&&(F<E?F+=at:F-=at),pe+=Re,ge=ze-pe-Le*F)),{ep:J,inclp:U,nodep:F,argpp:ge,mp:pe}}function Dp(n){var e=n.epoch,t=n.ep,i=n.argpp,r=n.tc,s=n.inclp,o=n.nodep,a=n.np,l,c,h,d,f,m,_,x,p,u,y,g,w,b,R,A,G,M,T,k,q,ne,D,z,W,X,ee,Y,J,U,F,ge,pe,$,de,Le,xe,K,ie,ce,L,De,Q,ae,me,Ie,Me,Se,Re,Ue,ze,E,v,I,re,te,le,Te,he,ve,C,se,Z,Ne=.01675,Ce=.0549,Ae=29864797e-13,Ee=47968065e-14,ye=.39785416,He=.91744867,P=.1945905,_e=-.98088458,oe=a,j=t,ue=Math.sin(o),Pe=Math.cos(o),Oe=Math.sin(i),Ze=Math.cos(i),nt=Math.sin(s),je=Math.cos(s),fe=j*j,ot=1-fe,St=Math.sqrt(ot),tn=0,$e=0,nn=0,Jt=0,gn=0,Bt=e+18261.5+r/1440,Dt=(4.523602-.00092422029*Bt)%at,lt=Math.sin(Dt),Ct=Math.cos(Dt),S=.91375164-.03568096*Ct,N=Math.sqrt(1-S*S),B=.089683511*lt/N,V=Math.sqrt(1-B*B),H=5.8351514+.001944368*Bt,we=.39785416*lt/N,Fe=V*Ct+.91744867*B*lt;we=Math.atan2(we,Fe),we+=H-Dt;var Be=Math.cos(we),Ge=Math.sin(we);k=P,q=_e,z=He,W=ye,ne=Pe,D=ue,y=Ae;for(var We=1/oe,Ve=0;Ve<2;)Ve+=1,l=k*ne+q*z*D,h=-q*ne+k*z*D,_=-k*D+q*z*ne,x=q*W,p=q*D+k*z*ne,u=k*W,c=je*_+nt*x,d=je*p+nt*u,f=-nt*_+je*x,m=-nt*p+je*u,g=l*Ze+c*Oe,w=h*Ze+d*Oe,b=-l*Oe+c*Ze,R=-h*Oe+d*Ze,A=f*Oe,G=m*Oe,M=f*Ze,T=m*Ze,C=12*g*g-3*b*b,se=24*g*w-6*b*R,Z=12*w*w-3*R*R,E=3*(l*l+c*c)+C*fe,v=6*(l*h+c*d)+se*fe,I=3*(h*h+d*d)+Z*fe,re=-6*l*f+fe*(-24*g*M-6*b*A),te=-6*(l*m+h*f)+fe*(-24*(w*M+g*T)+-6*(b*G+R*A)),le=-6*h*m+fe*(-24*w*T-6*R*G),Te=6*c*f+fe*(24*g*A-6*b*M),he=6*(d*f+c*m)+fe*(24*(w*A+g*G)-6*(R*M+b*T)),ve=6*d*m+fe*(24*w*G-6*R*T),E=E+E+ot*C,v=v+v+ot*se,I=I+I+ot*Z,Me=y*We,Ie=-.5*Me/St,Se=Me*St,me=-15*j*Se,Re=g*b+w*R,Ue=w*b+g*R,ze=w*R-g*b,Ve===1&&(X=me,ee=Ie,Y=Me,J=Se,U=Re,F=Ue,ge=ze,pe=E,$=v,de=I,Le=re,xe=te,K=le,ie=Te,ce=he,L=ve,De=C,Q=se,ae=Z,k=Be,q=Ge,z=S,W=N,ne=V*Pe+B*ue,D=ue*V-Pe*B,y=Ee);var ke=(4.7199672+(.2299715*Bt-H))%at,it=(6.2565837+.017201977*Bt)%at,_t=2*X*F,et=2*X*ge,vt=2*ee*xe,tt=2*ee*(K-Le),qe=-2*Y*$,Cn=-2*Y*(de-pe),st=-2*Y*(-21-9*fe)*Ne,Lt=2*J*Q,jn=2*J*(ae-De),rn=-18*J*Ne,sn=-2*ee*ce,ct=-2*ee*(L-ie),Ut=2*me*Ue,Ln=2*me*ze,xt=2*Ie*te,Ti=2*Ie*(le-re),wr=-2*Me*v,Gi=-2*Me*(I-E),qo=-2*Me*(-21-9*fe)*Ce,Yo=2*Se*se,jo=2*Se*(Z-C),Ko=-18*Se*Ce,Zo=-2*Ie*he,$o=-2*Ie*(ve-Te);return{snodm:ue,cnodm:Pe,sinim:nt,cosim:je,sinomm:Oe,cosomm:Ze,day:Bt,e3:Ln,ee2:Ut,em:j,emsq:fe,gam:H,peo:tn,pgho:Jt,pho:gn,pinco:$e,plo:nn,rtemsq:St,se2:_t,se3:et,sgh2:Lt,sgh3:jn,sgh4:rn,sh2:sn,sh3:ct,si2:vt,si3:tt,sl2:qe,sl3:Cn,sl4:st,s1:me,s2:Ie,s3:Me,s4:Se,s5:Re,s6:Ue,s7:ze,ss1:X,ss2:ee,ss3:Y,ss4:J,ss5:U,ss6:F,ss7:ge,sz1:pe,sz2:$,sz3:de,sz11:Le,sz12:xe,sz13:K,sz21:ie,sz22:ce,sz23:L,sz31:De,sz32:Q,sz33:ae,xgh2:Yo,xgh3:jo,xgh4:Ko,xh2:Zo,xh3:$o,xi2:xt,xi3:Ti,xl2:wr,xl3:Gi,xl4:qo,nm:oe,z1:E,z2:v,z3:I,z11:re,z12:te,z13:le,z21:Te,z22:he,z23:ve,z31:C,z32:se,z33:Z,zmol:ke,zmos:it}}function Up(n){var e=n.cosim,t=n.argpo,i=n.s1,r=n.s2,s=n.s3,o=n.s4,a=n.s5,l=n.sinim,c=n.ss1,h=n.ss2,d=n.ss3,f=n.ss4,m=n.ss5,_=n.sz1,x=n.sz3,p=n.sz11,u=n.sz13,y=n.sz21,g=n.sz23,w=n.sz31,b=n.sz33,R=n.t,A=n.tc,G=n.gsto,M=n.mo,T=n.mdot,k=n.no,q=n.nodeo,ne=n.nodedot,D=n.xpidot,z=n.z1,W=n.z3,X=n.z11,ee=n.z13,Y=n.z21,J=n.z23,U=n.z31,F=n.z33,ge=n.ecco,pe=n.eccsq,$=n.emsq,de=n.em,Le=n.argpm,xe=n.inclm,K=n.mm,ie=n.nm,ce=n.nodem,L=n.irez,De=n.atime,Q=n.d2201,ae=n.d2211,me=n.d3210,Ie=n.d3222,Me=n.d4410,Se=n.d4422,Re=n.d5220,Ue=n.d5232,ze=n.d5421,E=n.d5433,v=n.dedt,I=n.didt,re=n.dmdt,te=n.dnodt,le=n.domdt,Te=n.del1,he=n.del2,ve=n.del3,C=n.xfact,se=n.xlamo,Z=n.xli,Ne=n.xni,Ce,Ae,Ee,ye,He,P,_e,oe,j,ue,Pe,Oe,Ze,nt,je,fe,ot,St,tn,$e,nn,Jt,gn,Bt,Dt,lt,Ct,S,N,B,V,H,we=17891679e-13,Fe=21460748e-13,Be=22123015e-14,Ge=17891679e-13,We=73636953e-16,Ve=21765803e-16,ke=.0043752690880113,it=37393792e-14,_t=11428639e-14,et=.00015835218,vt=119459e-10;L=0,ie<.0052359877&&ie>.0034906585&&(L=1),ie>=.00826&&ie<=.00924&&de>=.5&&(L=2);var tt=c*vt*m,qe=h*vt*(p+u),Cn=-vt*d*(_+x-14-6*$),st=f*vt*(w+b-6),Lt=-vt*h*(y+g);(xe<.052359877||xe>bt-.052359877)&&(Lt=0),l!==0&&(Lt/=l);var jn=st-e*Lt;v=tt+i*et*a,I=qe+r*et*(X+ee),re=Cn-et*s*(z+W-14-6*$);var rn=o*et*(U+F-6),sn=-et*r*(Y+J);(xe<.052359877||xe>bt-.052359877)&&(sn=0),le=jn+rn,te=Lt,l!==0&&(le-=e/l*sn,te+=sn/l);var ct=0,Ut=(G+A*ke)%at;if(de+=v*R,xe+=I*R,Le+=le*R,ce+=te*R,K+=re*R,L!==0){if(B=Math.pow(ie/pn,zi),L===2){V=e*e;var Ln=de;de=ge;var xt=$;$=pe,H=de*$,nt=-.306-(de-.64)*.44,de<=.65?(je=3.616-13.247*de+16.29*$,ot=-19.302+117.39*de-228.419*$+156.591*H,St=-18.9068+109.7927*de-214.6334*$+146.5816*H,tn=-41.122+242.694*de-471.094*$+313.953*H,$e=-146.407+841.88*de-1629.014*$+1083.435*H,nn=-532.114+3017.977*de-5740.032*$+3708.276*H):(je=-72.099+331.819*de-508.738*$+266.724*H,ot=-346.844+1582.851*de-2415.925*$+1246.113*H,St=-342.585+1554.908*de-2366.899*$+1215.972*H,tn=-1052.797+4758.686*de-7193.992*$+3651.957*H,$e=-3581.69+16178.11*de-24462.77*$+12422.52*H,de>.715?nn=-5149.66+29936.92*de-54087.36*$+31324.56*H:nn=1464.74-4664.75*de+3763.64*$),de<.7?(Bt=-919.2277+4988.61*de-9064.77*$+5542.21*H,Jt=-822.71072+4568.6173*de-8491.4146*$+5337.524*H,gn=-853.666+4690.25*de-8624.77*$+5341.4*H):(Bt=-37995.78+161616.52*de-229838.2*$+109377.94*H,Jt=-51752.104+218913.95*de-309468.16*$+146349.42*H,gn=-40023.88+170470.89*de-242699.48*$+115605.82*H),Dt=l*l,Ce=.75*(1+2*e+V),Ae=1.5*Dt,ye=1.875*l*(1-2*e-3*V),He=-1.875*l*(1+2*e-3*V),_e=35*Dt*Ce,oe=39.375*Dt*Dt,j=9.84375*l*(Dt*(1-2*e-5*V)+.33333333*(-2+4*e+6*V)),ue=l*(4.92187512*Dt*(-2-4*e+10*V)+6.56250012*(1+2*e-3*V)),Pe=29.53125*l*(2-8*e+V*(-12+8*e+10*V)),Oe=29.53125*l*(-2-8*e+V*(12+8*e-10*V)),S=ie*ie,N=B*B,Ct=3*S*N,lt=Ct*Ge,Q=lt*Ce*nt,ae=lt*Ae*je,Ct*=B,lt=Ct*it,me=lt*ye*ot,Ie=lt*He*St,Ct*=B,lt=2*Ct*We,Me=lt*_e*tn,Se=lt*oe*$e,Ct*=B,lt=Ct*_t,Re=lt*j*nn,Ue=lt*ue*gn,lt=2*Ct*Ve,ze=lt*Pe*Jt,E=lt*Oe*Bt,se=(M+q+q-(Ut+Ut))%at,C=T+re+2*(ne+te-ke)-k,de=Ln,$=xt}L===1&&(Ze=1+$*(-2.5+.8125*$),ot=1+2*$,fe=1+$*(-6+6.60937*$),Ce=.75*(1+e)*(1+e),Ee=.9375*l*l*(1+3*e)-.75*(1+e),P=1+e,P*=1.875*P*P,Te=3*ie*ie*B*B,he=2*Te*Ce*Ze*we,ve=3*Te*P*fe*Be*B,Te=Te*Ee*ot*Fe*B,se=(M+q+t-Ut)%at,C=T+D+re+le+te-(k+ke)),Z=se,Ne=k,De=0,ie=k+ct}return{em:de,argpm:Le,inclm:xe,mm:K,nm:ie,nodem:ce,irez:L,atime:De,d2201:Q,d2211:ae,d3210:me,d3222:Ie,d4410:Me,d4422:Se,d5220:Re,d5232:Ue,d5421:ze,d5433:E,dedt:v,didt:I,dmdt:re,dndt:ct,dnodt:te,domdt:le,del1:Te,del2:he,del3:ve,xfact:C,xlamo:se,xli:Z,xni:Ne}}function ao(n){var e=(n-2451545)/36525,t=-62e-7*e*e*e+.093104*e*e+(876600*3600+8640184812866e-6)*e+67310.54841;return t=t*Pi/240%at,t<0&&(t+=at),t}function _s(){return(arguments.length<=0?void 0:arguments[0])instanceof Date||arguments.length>1?ao(Cs.apply(void 0,arguments)):ao.apply(void 0,arguments)}function Ip(n){var e=n.ecco,t=n.epoch,i=n.inclo,r=n.opsmode,s=n.no,o=e*e,a=1-o,l=Math.sqrt(a),c=Math.cos(i),h=c*c,d=Math.pow(pn/s,zi),f=.75*Bn*(3*h-1)/(l*a),m=f/(d*d),_=d*(1-m*m-m*(1/3+134*m*m/81));m=f/(_*_),s/=1+m;var x=Math.pow(pn/s,zi),p=Math.sin(i),u=x*a,y=1-5*h,g=-y-h-h,w=1/x,b=u*u,R=x*(1-e),A="n",G;if(r==="a"){var M=t-7305,T=Math.floor(M+1e-8),k=M-T,q=.017202791694070362,ne=1.7321343856509375,D=5075514194322695e-30,z=q+at;G=(ne+q*T+z*k+M*M*D)%at,G<0&&(G+=at)}else G=_s(t+24332815e-1);return{no:s,method:A,ainv:w,ao:x,con41:g,con42:y,cosio:c,cosio2:h,eccsq:o,omeosq:a,posq:b,rp:R,rteosq:l,sinio:p,gsto:G}}function Np(n){var e=n.irez,t=n.d2201,i=n.d2211,r=n.d3210,s=n.d3222,o=n.d4410,a=n.d4422,l=n.d5220,c=n.d5232,h=n.d5421,d=n.d5433,f=n.dedt,m=n.del1,_=n.del2,x=n.del3,p=n.didt,u=n.dmdt,y=n.dnodt,g=n.domdt,w=n.argpo,b=n.argpdot,R=n.t,A=n.tc,G=n.gsto,M=n.xfact,T=n.xlamo,k=n.no,q=n.atime,ne=n.em,D=n.argpm,z=n.inclm,W=n.xli,X=n.mm,ee=n.xni,Y=n.nodem,J=n.nm,U=.13130908,F=2.8843198,ge=.37448087,pe=5.7686396,$=.95240898,de=1.8014998,Le=1.050833,xe=4.4108898,K=.0043752690880113,ie=720,ce=-720,L=259200,De,Q,ae,me,Ie,Me,Se,Re,Ue=0,ze=0,E=(G+A*K)%at;if(ne+=f*R,z+=p*R,D+=g*R,Y+=y*R,X+=u*R,e!==0){(q===0||R*q<=0||Math.abs(R)<Math.abs(q))&&(q=0,ee=k,W=T),R>0?De=ie:De=ce;for(var v=381;v===381;)e!==2?(Se=m*Math.sin(W-U)+_*Math.sin(2*(W-F))+x*Math.sin(3*(W-ge)),Ie=ee+M,Me=m*Math.cos(W-U)+2*_*Math.cos(2*(W-F))+3*x*Math.cos(3*(W-ge)),Me*=Ie):(Re=w+b*q,ae=Re+Re,Q=W+W,Se=t*Math.sin(ae+W-pe)+i*Math.sin(W-pe)+r*Math.sin(Re+W-$)+s*Math.sin(-Re+W-$)+o*Math.sin(ae+Q-de)+a*Math.sin(Q-de)+l*Math.sin(Re+W-Le)+c*Math.sin(-Re+W-Le)+h*Math.sin(Re+Q-xe)+d*Math.sin(-Re+Q-xe),Ie=ee+M,Me=t*Math.cos(ae+W-pe)+i*Math.cos(W-pe)+r*Math.cos(Re+W-$)+s*Math.cos(-Re+W-$)+l*Math.cos(Re+W-Le)+c*Math.cos(-Re+W-Le)+2*(o*Math.cos(ae+Q-de)+a*Math.cos(Q-de)+h*Math.cos(Re+Q-xe)+d*Math.cos(-Re+Q-xe)),Me*=Ie),Math.abs(R-q)>=ie?v=381:(ze=R-q,v=0),v===381&&(W+=Ie*De+Se*L,ee+=Se*De+Me*L,q+=De);J=ee+Se*ze+Me*ze*ze*.5,me=W+Ie*ze+Se*ze*ze*.5,e!==1?(X=me-2*Y+2*E,Ue=J-k):(X=me-Y-D+E,Ue=J-k),J=k+Ue}return{atime:q,em:ne,argpm:D,inclm:z,xli:W,mm:X,xni:ee,nodem:Y,dndt:Ue,nm:J}}function ko(n,e){var t,i,r,s,o,a,l,c,h,d,f,m,_,x,p,u,y,g,w,b,R,A,G,M,T,k,q,ne=15e-13;n.t=e,n.error=0;var D=n.mo+n.mdot*n.t,z=n.argpo+n.argpdot*n.t,W=n.nodeo+n.nodedot*n.t;h=z,R=D;var X=n.t*n.t;if(G=W+n.nodecf*X,y=1-n.cc1*n.t,g=n.bstar*n.cc4*n.t,w=n.t2cof*X,n.isimp!==1){l=n.omgcof*n.t;var ee=1+n.eta*Math.cos(D);a=n.xmcof*(ee*ee*ee-n.delmo),u=l+a,R=D+u,h=z-u,m=X*n.t,_=m*n.t,y=y-n.d2*X-n.d3*m-n.d4*_,g+=n.bstar*n.cc5*(Math.sin(R)-n.sinmao),w=w+n.t3cof*m+_*(n.t4cof+n.t*n.t5cof)}A=n.no;var Y=n.ecco;if(b=n.inclo,n.method==="d"){x=n.t;var J={irez:n.irez,d2201:n.d2201,d2211:n.d2211,d3210:n.d3210,d3222:n.d3222,d4410:n.d4410,d4422:n.d4422,d5220:n.d5220,d5232:n.d5232,d5421:n.d5421,d5433:n.d5433,dedt:n.dedt,del1:n.del1,del2:n.del2,del3:n.del3,didt:n.didt,dmdt:n.dmdt,dnodt:n.dnodt,domdt:n.domdt,argpo:n.argpo,argpdot:n.argpdot,t:n.t,tc:x,gsto:n.gsto,xfact:n.xfact,xlamo:n.xlamo,no:n.no,atime:n.atime,em:Y,argpm:h,inclm:b,xli:n.xli,mm:R,xni:n.xni,nodem:G,nm:A},U=Np(J);Y=U.em,h=U.argpm,b=U.inclm,R=U.mm,G=U.nodem,A=U.nm}if(A<=0)return n.error=2,[!1,!1];var F=Math.pow(pn/A,zi)*y*y;if(A=pn/Math.pow(F,1.5),Y-=g,Y>=1||Y<-.001)return n.error=1,[!1,!1];Y<1e-6&&(Y=1e-6),R+=n.no*w,T=R+h+G,G%=at,h%=at,T%=at,R=(T-h-G)%at;var ge=Math.sin(b),pe=Math.cos(b),$=Y;if(M=b,d=h,q=G,k=R,s=ge,r=pe,n.method==="d"){var de={inclo:n.inclo,init:"n",ep:$,inclp:M,nodep:q,argpp:d,mp:k,opsmode:n.operationmode},Le=Vo(n,de);if($=Le.ep,q=Le.nodep,d=Le.argpp,k=Le.mp,M=Le.inclp,M<0&&(M=-M,q+=bt,d-=bt),$<0||$>1)return n.error=3,[!1,!1]}n.method==="d"&&(s=Math.sin(M),r=Math.cos(M),n.aycof=-.5*Hn*s,Math.abs(r+1)>15e-13?n.xlcof=-.25*Hn*s*(3+5*r)/(1+r):n.xlcof=-.25*Hn*s*(3+5*r)/ne);var xe=$*Math.cos(d);u=1/(F*(1-$*$));var K=$*Math.sin(d)+u*n.aycof,ie=k+d+q+u*n.xlcof*xe,ce=(ie-q)%at;c=ce,p=9999.9;for(var L=1;Math.abs(p)>=1e-12&&L<=10;)i=Math.sin(c),t=Math.cos(c),p=1-t*xe-i*K,p=(ce-K*t+xe*i-c)/p,Math.abs(p)>=.95&&(p>0?p=.95:p=-.95),c+=p,L+=1;var De=xe*t+K*i,Q=xe*i-K*t,ae=xe*xe+K*K,me=F*(1-ae);if(me<0)return n.error=4,[!1,!1];var Ie=F*(1-De),Me=Math.sqrt(F)*Q/Ie,Se=Math.sqrt(me)/Ie,Re=Math.sqrt(1-ae);u=Q/(1+Re);var Ue=F/Ie*(i-K-xe*u),ze=F/Ie*(t-xe+K*u);f=Math.atan2(Ue,ze);var E=(ze+ze)*Ue,v=1-2*Ue*Ue;u=1/me;var I=.5*Bn*u,re=I*u;n.method==="d"&&(o=r*r,n.con41=3*o-1,n.x1mth2=1-o,n.x7thm1=7*o-1);var te=Ie*(1-1.5*re*Re*n.con41)+.5*I*n.x1mth2*v;if(te<1)return n.error=6,{position:!1,velocity:!1};f-=.25*re*n.x7thm1*E;var le=q+1.5*re*r*E,Te=M+1.5*re*r*s*v,he=Me-A*I*n.x1mth2*E/pn,ve=Se+A*I*(n.x1mth2*v+1.5*n.con41)/pn,C=Math.sin(f),se=Math.cos(f),Z=Math.sin(le),Ne=Math.cos(le),Ce=Math.sin(Te),Ae=Math.cos(Te),Ee=-Z*Ae,ye=Ne*Ae,He=Ee*C+Ne*se,P=ye*C+Z*se,_e=Ce*C,oe=Ee*se-Ne*C,j=ye*se-Z*C,ue=Ce*se,Pe={x:te*He*Ft,y:te*P*Ft,z:te*_e*Ft},Oe={x:(he*He+ve*oe)*as,y:(he*P+ve*j)*as,z:(he*_e+ve*ue)*as};return{position:Pe,velocity:Oe}}function Fp(n,e){var t=e.opsmode,i=e.satn,r=e.epoch,s=e.xbstar,o=e.xecco,a=e.xargpo,l=e.xinclo,c=e.xmo,h=e.xno,d=e.xnodeo,f,m,_,x,p,u,y,g,w,b,R,A,G,M,T,k,q,ne,D,z,W,X,ee,Y,J,U,F,ge,pe,$,de,Le,xe,K,ie,ce,L,De,Q,ae,me,Ie,Me,Se,Re,Ue,ze,E,v,I,re,te,le,Te,he,ve,C=15e-13;n.isimp=0,n.method="n",n.aycof=0,n.con41=0,n.cc1=0,n.cc4=0,n.cc5=0,n.d2=0,n.d3=0,n.d4=0,n.delmo=0,n.eta=0,n.argpdot=0,n.omgcof=0,n.sinmao=0,n.t=0,n.t2cof=0,n.t3cof=0,n.t4cof=0,n.t5cof=0,n.x1mth2=0,n.x7thm1=0,n.mdot=0,n.nodedot=0,n.xlcof=0,n.xmcof=0,n.nodecf=0,n.irez=0,n.d2201=0,n.d2211=0,n.d3210=0,n.d3222=0,n.d4410=0,n.d4422=0,n.d5220=0,n.d5232=0,n.d5421=0,n.d5433=0,n.dedt=0,n.del1=0,n.del2=0,n.del3=0,n.didt=0,n.dmdt=0,n.dnodt=0,n.domdt=0,n.e3=0,n.ee2=0,n.peo=0,n.pgho=0,n.pho=0,n.pinco=0,n.plo=0,n.se2=0,n.se3=0,n.sgh2=0,n.sgh3=0,n.sgh4=0,n.sh2=0,n.sh3=0,n.si2=0,n.si3=0,n.sl2=0,n.sl3=0,n.sl4=0,n.gsto=0,n.xfact=0,n.xgh2=0,n.xgh3=0,n.xgh4=0,n.xh2=0,n.xh3=0,n.xi2=0,n.xi3=0,n.xl2=0,n.xl3=0,n.xl4=0,n.xlamo=0,n.zmol=0,n.zmos=0,n.atime=0,n.xli=0,n.xni=0,n.bstar=s,n.ecco=o,n.argpo=a,n.inclo=l,n.mo=c,n.no=h,n.nodeo=d,n.operationmode=t;var se=78/Ft+1,Z=42/Ft,Ne=Z*Z*Z*Z;n.init="y",n.t=0;var Ce={satn:i,ecco:n.ecco,epoch:r,inclo:n.inclo,no:n.no,method:n.method,opsmode:n.operationmode},Ae=Ip(Ce),Ee=Ae.ao,ye=Ae.con42,He=Ae.cosio,P=Ae.cosio2,_e=Ae.eccsq,oe=Ae.omeosq,j=Ae.posq,ue=Ae.rp,Pe=Ae.rteosq,Oe=Ae.sinio;if(n.no=Ae.no,n.con41=Ae.con41,n.gsto=Ae.gsto,n.a=Math.pow(n.no*Rp,-2/3),n.alta=n.a*(1+n.ecco)-1,n.altp=n.a*(1-n.ecco)-1,n.error=0,oe>=0||n.no>=0){if(n.isimp=0,ue<220/Ft+1&&(n.isimp=1),F=se,W=Ne,ne=(ue-1)*Ft,ne<156){F=ne-78,ne<98&&(F=20);var Ze=(120-F)/Ft;W=Ze*Ze*Ze*Ze,F=F/Ft+1}D=1/j,Ue=1/(Ee-F),n.eta=Ee*n.ecco*Ue,A=n.eta*n.eta,R=n.ecco*n.eta,z=Math.abs(1-A),u=W*Math.pow(Ue,4),y=u/Math.pow(z,3.5),x=y*n.no*(Ee*(1+1.5*A+R*(4+A))+.375*Bn*Ue/z*n.con41*(8+3*A*(8+A))),n.cc1=n.bstar*x,p=0,n.ecco>1e-4&&(p=-2*u*Ue*Hn*n.no*Oe/n.ecco),n.x1mth2=1-P,n.cc4=2*n.no*y*Ee*oe*(n.eta*(2+.5*A)+n.ecco*(.5+2*A)-Bn*Ue/(Ee*z)*(-3*n.con41*(1-2*R+A*(1.5-.5*R))+.75*n.x1mth2*(2*A-R*(1+A))*Math.cos(2*n.argpo))),n.cc5=2*y*Ee*oe*(1+2.75*(A+R)+R*A),g=P*P,Me=1.5*Bn*D*n.no,Se=.5*Me*Bn*D,Re=-.46875*Lp*D*D*n.no,n.mdot=n.no+.5*Me*Pe*n.con41+.0625*Se*Pe*(13-78*P+137*g),n.argpdot=-.5*Me*ye+.0625*Se*(7-114*P+395*g)+Re*(3-36*P+49*g),E=-Me*He,n.nodedot=E+(.5*Se*(4-19*P)+2*Re*(3-7*P))*He,ze=n.argpdot+n.nodedot,n.omgcof=n.bstar*p*Math.cos(n.argpo),n.xmcof=0,n.ecco>1e-4&&(n.xmcof=-zi*u*n.bstar/R),n.nodecf=3.5*oe*E*n.cc1,n.t2cof=1.5*n.cc1,Math.abs(He+1)>15e-13?n.xlcof=-.25*Hn*Oe*(3+5*He)/(1+He):n.xlcof=-.25*Hn*Oe*(3+5*He)/C,n.aycof=-.5*Hn*Oe;var nt=1+n.eta*Math.cos(n.mo);if(n.delmo=nt*nt*nt,n.sinmao=Math.sin(n.mo),n.x7thm1=7*P-1,2*bt/n.no>=225){n.method="d",n.isimp=1,me=0,T=n.inclo;var je={epoch:r,ep:n.ecco,argpp:n.argpo,tc:me,inclp:n.inclo,nodep:n.nodeo,np:n.no,e3:n.e3,ee2:n.ee2,peo:n.peo,pgho:n.pgho,pho:n.pho,pinco:n.pinco,plo:n.plo,se2:n.se2,se3:n.se3,sgh2:n.sgh2,sgh3:n.sgh3,sgh4:n.sgh4,sh2:n.sh2,sh3:n.sh3,si2:n.si2,si3:n.si3,sl2:n.sl2,sl3:n.sl3,sl4:n.sl4,xgh2:n.xgh2,xgh3:n.xgh3,xgh4:n.xgh4,xh2:n.xh2,xh3:n.xh3,xi2:n.xi2,xi3:n.xi3,xl2:n.xl2,xl3:n.xl3,xl4:n.xl4,zmol:n.zmol,zmos:n.zmos},fe=Dp(je);n.e3=fe.e3,n.ee2=fe.ee2,n.peo=fe.peo,n.pgho=fe.pgho,n.pho=fe.pho,n.pinco=fe.pinco,n.plo=fe.plo,n.se2=fe.se2,n.se3=fe.se3,n.sgh2=fe.sgh2,n.sgh3=fe.sgh3,n.sgh4=fe.sgh4,n.sh2=fe.sh2,n.sh3=fe.sh3,n.si2=fe.si2,n.si3=fe.si3,n.sl2=fe.sl2,n.sl3=fe.sl3,n.sl4=fe.sl4,m=fe.sinim,f=fe.cosim,w=fe.em,b=fe.emsq,X=fe.s1,ee=fe.s2,Y=fe.s3,J=fe.s4,U=fe.s5,ge=fe.ss1,pe=fe.ss2,$=fe.ss3,de=fe.ss4,Le=fe.ss5,xe=fe.sz1,K=fe.sz3,ie=fe.sz11,ce=fe.sz13,L=fe.sz21,De=fe.sz23,Q=fe.sz31,ae=fe.sz33,n.xgh2=fe.xgh2,n.xgh3=fe.xgh3,n.xgh4=fe.xgh4,n.xh2=fe.xh2,n.xh3=fe.xh3,n.xi2=fe.xi2,n.xi3=fe.xi3,n.xl2=fe.xl2,n.xl3=fe.xl3,n.xl4=fe.xl4,n.zmol=fe.zmol,n.zmos=fe.zmos,q=fe.nm,v=fe.z1,I=fe.z3,re=fe.z11,te=fe.z13,le=fe.z21,Te=fe.z23,he=fe.z31,ve=fe.z33;var ot={inclo:T,init:n.init,ep:n.ecco,inclp:n.inclo,nodep:n.nodeo,argpp:n.argpo,mp:n.mo,opsmode:n.operationmode},St=Vo(n,ot);n.ecco=St.ep,n.inclo=St.inclp,n.nodeo=St.nodep,n.argpo=St.argpp,n.mo=St.mp,G=0,M=0,k=0;var tn={cosim:f,emsq:b,argpo:n.argpo,s1:X,s2:ee,s3:Y,s4:J,s5:U,sinim:m,ss1:ge,ss2:pe,ss3:$,ss4:de,ss5:Le,sz1:xe,sz3:K,sz11:ie,sz13:ce,sz21:L,sz23:De,sz31:Q,sz33:ae,t:n.t,tc:me,gsto:n.gsto,mo:n.mo,mdot:n.mdot,no:n.no,nodeo:n.nodeo,nodedot:n.nodedot,xpidot:ze,z1:v,z3:I,z11:re,z13:te,z21:le,z23:Te,z31:he,z33:ve,ecco:n.ecco,eccsq:_e,em:w,argpm:G,inclm:T,mm:k,nm:q,nodem:M,irez:n.irez,atime:n.atime,d2201:n.d2201,d2211:n.d2211,d3210:n.d3210,d3222:n.d3222,d4410:n.d4410,d4422:n.d4422,d5220:n.d5220,d5232:n.d5232,d5421:n.d5421,d5433:n.d5433,dedt:n.dedt,didt:n.didt,dmdt:n.dmdt,dnodt:n.dnodt,domdt:n.domdt,del1:n.del1,del2:n.del2,del3:n.del3,xfact:n.xfact,xlamo:n.xlamo,xli:n.xli,xni:n.xni},$e=Up(tn);n.irez=$e.irez,n.atime=$e.atime,n.d2201=$e.d2201,n.d2211=$e.d2211,n.d3210=$e.d3210,n.d3222=$e.d3222,n.d4410=$e.d4410,n.d4422=$e.d4422,n.d5220=$e.d5220,n.d5232=$e.d5232,n.d5421=$e.d5421,n.d5433=$e.d5433,n.dedt=$e.dedt,n.didt=$e.didt,n.dmdt=$e.dmdt,n.dnodt=$e.dnodt,n.domdt=$e.domdt,n.del1=$e.del1,n.del2=$e.del2,n.del3=$e.del3,n.xfact=$e.xfact,n.xlamo=$e.xlamo,n.xli=$e.xli,n.xni=$e.xni}n.isimp!==1&&(_=n.cc1*n.cc1,n.d2=4*Ee*Ue*_,Ie=n.d2*Ue*n.cc1/3,n.d3=(17*Ee+F)*Ie,n.d4=.5*Ie*Ee*Ue*(221*Ee+31*F)*n.cc1,n.t3cof=n.d2+2*_,n.t4cof=.25*(3*n.d3+n.cc1*(12*n.d2+10*_)),n.t5cof=.2*(3*n.d4+12*n.cc1*n.d3+6*n.d2*n.d2+15*_*(2*n.d2+_)))}ko(n,0),n.init="n"}function Op(n,e){var t="i",i=1440/(2*bt),r=0,s={};s.error=0,s.satnum=n.substring(2,7),s.epochyr=parseInt(n.substring(18,20),10),s.epochdays=parseFloat(n.substring(20,32)),s.ndot=parseFloat(n.substring(33,43)),s.nddot=parseFloat(".".concat(parseInt(n.substring(44,50),10),"E").concat(n.substring(50,52))),s.bstar=parseFloat("".concat(n.substring(53,54),".").concat(parseInt(n.substring(54,59),10),"E").concat(n.substring(59,61))),s.inclo=parseFloat(e.substring(8,16)),s.nodeo=parseFloat(e.substring(17,25)),s.ecco=parseFloat(".".concat(e.substring(26,33))),s.argpo=parseFloat(e.substring(34,42)),s.mo=parseFloat(e.substring(43,51)),s.no=parseFloat(e.substring(52,63)),s.no/=i,s.inclo*=Pi,s.nodeo*=Pi,s.argpo*=Pi,s.mo*=Pi,s.epochyr<57?r=s.epochyr+2e3:r=s.epochyr+1900;var o=Pp(r,s.epochdays),a=o.mon,l=o.day,c=o.hr,h=o.minute,d=o.sec;return s.jdsatepoch=Cs(r,a,l,c,h,d),Fp(s,{opsmode:t,satn:s.satnum,epoch:s.jdsatepoch-24332815e-1,xbstar:s.bstar,xecco:s.ecco,xargpo:s.argpo,xinclo:s.inclo,xmo:s.mo,xno:s.no,xnodeo:s.nodeo}),s}function zp(n){return Bp(n)||Hp(n)||Gp(n)||Vp()}function Bp(n){if(Array.isArray(n))return vs(n)}function Hp(n){if(typeof Symbol<"u"&&n[Symbol.iterator]!=null||n["@@iterator"]!=null)return Array.from(n)}function Gp(n,e){if(n){if(typeof n=="string")return vs(n,e);var t=Object.prototype.toString.call(n).slice(8,-1);if(t==="Object"&&n.constructor&&(t=n.constructor.name),t==="Map"||t==="Set")return Array.from(n);if(t==="Arguments"||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(t))return vs(n,e)}}function vs(n,e){(e==null||e>n.length)&&(e=n.length);for(var t=0,i=new Array(e);t<e;t++)i[t]=n[t];return i}function Vp(){throw new TypeError(`Invalid attempt to spread non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}function oo(){for(var n=arguments.length,e=new Array(n),t=0;t<n;t++)e[t]=arguments[t];var i=e[0],r=Array.prototype.slice.call(e,1),s=Cs.apply(void 0,zp(r)),o=(s-i.jdsatepoch)*Ap;return ko(i,o)}function Wo(n){return n*bp}function lo(n){if(n<-bt/2||n>bt/2)throw new RangeError("Latitude radians must be in range [-pi/2; pi/2].");return Wo(n)}function co(n){if(n<-bt||n>bt)throw new RangeError("Longitude radians must be in range [-pi; pi].");return Wo(n)}function ho(n,e){for(var t=6378.137,i=6356.7523142,r=Math.sqrt(n.x*n.x+n.y*n.y),s=(t-i)/t,o=2*s-s*s,a=Math.atan2(n.y,n.x)-e;a<-bt;)a+=at;for(;a>bt;)a-=at;for(var l=20,c=0,h=Math.atan2(n.z,Math.sqrt(n.x*n.x+n.y*n.y)),d;c<l;)d=1/Math.sqrt(1-o*(Math.sin(h)*Math.sin(h))),h=Math.atan2(n.z+t*d*o*Math.sin(h),r),c+=1;var f=r/Math.cos(h)-t*d;return{longitude:a,latitude:h,height:f}}var kp=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};function Wp(n){return n&&n.__esModule&&Object.prototype.hasOwnProperty.call(n,"default")?n.default:n}var Xo={exports:{}};(function(n,e){(function(t,i){n.exports=i()})(kp,function(){var t=function(){function i(m){return o.appendChild(m.dom),m}function r(m){for(var _=0;_<o.children.length;_++)o.children[_].style.display=_===m?"block":"none";s=m}var s=0,o=document.createElement("div");o.style.cssText="position:fixed;top:0;left:0;cursor:pointer;opacity:0.9;z-index:10000",o.addEventListener("click",function(m){m.preventDefault(),r(++s%o.children.length)},!1);var a=(performance||Date).now(),l=a,c=0,h=i(new t.Panel("FPS","#0ff","#002")),d=i(new t.Panel("MS","#0f0","#020"));if(self.performance&&self.performance.memory)var f=i(new t.Panel("MB","#f08","#201"));return r(0),{REVISION:16,dom:o,addPanel:i,showPanel:r,begin:function(){a=(performance||Date).now()},end:function(){c++;var m=(performance||Date).now();if(d.update(m-a,200),m>l+1e3&&(h.update(1e3*c/(m-l),100),l=m,c=0,f)){var _=performance.memory;f.update(_.usedJSHeapSize/1048576,_.jsHeapSizeLimit/1048576)}return m},update:function(){a=this.end()},domElement:o,setMode:r}};return t.Panel=function(i,r,s){var o=1/0,a=0,l=Math.round,c=l(window.devicePixelRatio||1),h=80*c,d=48*c,f=3*c,m=2*c,_=3*c,x=15*c,p=74*c,u=30*c,y=document.createElement("canvas");y.width=h,y.height=d,y.style.cssText="width:80px;height:48px";var g=y.getContext("2d");return g.font="bold "+9*c+"px Helvetica,Arial,sans-serif",g.textBaseline="top",g.fillStyle=s,g.fillRect(0,0,h,d),g.fillStyle=r,g.fillText(i,f,m),g.fillRect(_,x,p,u),g.fillStyle=s,g.globalAlpha=.9,g.fillRect(_,x,p,u),{dom:y,update:function(w,b){o=Math.min(o,w),a=Math.max(a,w),g.fillStyle=s,g.globalAlpha=1,g.fillRect(0,0,h,x),g.fillStyle=r,g.fillText(l(w)+" "+i+" ("+l(o)+"-"+l(a)+")",f,m),g.drawImage(y,_+c,x,p-c,u,_,x,p-c,u),g.fillRect(_+p-c,x,c,u),g.fillStyle=s,g.globalAlpha=.9,g.fillRect(_+p-c,x,c,l((1-w/b)*u))}}},t})})(Xo);var Xp=Xo.exports;const qp=Wp(Xp);function Yp(n){let e,t,i,r,s,o,a=!0,l=!1;const c=66,h=2;let d,f;const m=6371,_=1,x=_/m,p=5e-4,u=23.4*(Math.PI/180),y=[];let g=1,w;const b=new qp;b.showPanel(0),window.addEventListener("keydown",K=>{(K.key==="R"||K.key==="r")&&(a=!a)}),window.addEventListener("keydown",K=>{(K.key==="W"||K.key==="w")&&(l=!l,s.traverse(function(ie){ie.isMesh&&(ie.material.wireframe=l,ie.material.needsUpdate=!0)}))});function R(){e=new _p,t=new Vt(5,window.innerWidth/window.innerHeight,.1,1e3),t.position.set(0,0,800),t.rotation.x=-u,t.position.z=66,i=new Go({alpha:!0}),i.setSize(window.innerWidth,window.innerHeight),i.setClearColor(12632256,0),i.shadowMap.enabled=!0,i.shadowMap.type=fo,document.getElementById(n).appendChild(i.domElement),r=new Tp(t,i.domElement),r.enableDamping=!0,r.enableZoom=!0,r.enablePan=!1,r.dampingFactor=.25,r.zoomSpeed=.666,r.rotateSpeed=.25,r.minDistance=10,r.maxDistance=100,X(),A(),s=new Li,s.rotation.z=u,e.add(s),G(),q("Mercury",12500670,2439.7),q("Venus",16768324,6051.8),q("Earth",2254591,6371),q("Mars",16729122,3389.5),q("Jupiter",14540202,69911),q("Saturn",15654331,58232),q("Uranus",11206655,25362),q("Neptune",4482815,24622),Y(),ne(),J(),Le(),window.addEventListener("resize",xe,!1),xe(),ee()}function A(){const K=new Ep(4210752,1);e.add(K),d=new Sp(9079434,100),d.position.set(10,0,0),d.castShadow=!0,e.add(d);const ce=new vp(16777147,526368,.5);e.add(ce);const L=_*109/1e3,De=new zn(L,64,64),Q=new Ts({color:16777147,emissive:16753920,opacity:.8,alphaHash:!0});new Ot(De,Q).position.copy(d.position)}function G(){const K=_*.273,ie=new dr({color:16777215,roughness:1,metalness:0,opacity:.5,alphaHash:!0}),ce=new zn(K,32,32);w=new Ot(ce,ie),s.add(w)}function M(K){if(!w)return;const ie=27.32,L=384400*x,De=2*Math.PI*K/(ie*24*3600*1e3),Q=.0549,ae=L*(Math.cos(De)-Q),me=L*Math.sin(De)*Math.sqrt(1-Q**2);w.position.set(ae,0,me)}const T=.05;function k(K,ie){const ce={Mercury:{a:5791e4*T,e:.205,i:7,T:.24},Venus:{a:1082e5*T,e:.007,i:3.4,T:.62},Earth:{a:1496e5*T,e:.017,i:0,T:1},Mars:{a:2279e5*T,e:.093,i:1.85,T:1.88},Jupiter:{a:7785e5*T,e:.049,i:1.3,T:11.86},Saturn:{a:1429e6*T,e:.056,i:2.49,T:29.46},Uranus:{a:2871e6*T,e:.046,i:.77,T:84.01},Neptune:{a:4495e6*T,e:.009,i:1.77,T:164.8}},{a:L,e:De,i:Q,T:ae}=ce[K],me=2*Math.PI*ie/ae,Ie=L*(Math.cos(me)-De)*x*g,Me=L*Math.sin(me)*Math.sqrt(1-De**2)*x*g,Se=Math.cos(Q*(Math.PI/180)),Re=Math.sin(Q*(Math.PI/180)),Ue=0*Se-Me*Re,ze=0*Re+Me*Se,E=d.position;return new O(Ie+E.x,Ue+E.y,ze+E.z)}function q(K,ie,ce){const L=_*(ce/m)*x,De=new zn(L,32,32),Q=new dr({color:ie}),ae=new Ot(De,Q);e.add(ae),y.push({name:K,mesh:ae})}function ne(){fetch("https://orbital-bbfd.onrender.com/satellites").then(K=>{if(!K.ok)throw new Error("Server fetch failed");return K.json()}).then(K=>{z(K)}).catch(K=>{console.warn("Error fetching TLE data from server:",K),console.log("Attempting to load data from local static file..."),fetch("data/cachedSatellites.json").then(ie=>{if(!ie.ok)throw new Error("Local file fetch failed");return ie.json()}).then(ie=>{console.log("Loaded TLE data from local static file."),z(ie)}).catch(ie=>{console.error("Failed to load TLE data from both server and local file:",ie)})})}let D=[];function z(K){D.length===0?K.forEach(ie=>{const ce=Op(ie.tleLine1,ie.tleLine2),L=new Date,De=oo(ce,L),Q=_s(L),ae=ho(De.position,Q),me=lo(ae.latitude),Ie=co(ae.longitude);let Me=ae.height*x*g;const Se=$(me,Ie,_+Me),Re=new zn(.004,1,1),Ue=new dr({color:16711680,wireframe:!0,opacity:.75,alphaHash:!0,depthTest:!0,metalness:1}),ze=new Ot(Re,Ue);ze.position.copy(Se),ze.userData.isSatellite=!0,s.add(ze),D.push({mesh:ze,satrec:ce})}):W()}function W(){const K=new Date,ie=_s(K);D.forEach(({mesh:ce,satrec:L})=>{const De=oo(L,K),Q=ho(De.position,ie),ae=lo(Q.latitude),me=co(Q.longitude);let Ie=Q.height*x*g;const Me=$(ae,me,_+Ie);ce.position.copy(Me)})}function X(){const K=window.innerWidth<=768;t.position.z=K?c*h:c,K?(r.minDistance=10,r.maxDistance=500):(r.minDistance=10,r.maxDistance=100)}function ee(K){b.begin(),o=requestAnimationFrame(ee),y.forEach(({name:ie,mesh:ce})=>{const L=k(ie,K/1e3);ce.position.copy(L)}),a&&(s.rotation.y+=p),r.update(),M(K),i.render(e,t),b.end()}function Y(){const K=new zn(_,64,64),ie=new dr({color:0,opacity:.95,roughness:2,metalness:.5,emissive:0,transparent:!0,alphaHash:!0,wireframe:l});f=new Ot(K,ie),f.castShadow=!0,f.receiveShadow=!0,s.add(f)}return R(),{dispose(){window.removeEventListener("resize",xe),cancelAnimationFrame(o);const K=document.getElementById(n);K&&i.domElement&&K.removeChild(i.domElement)}};async function J(){console.log("Attempting to load data...");const K=["data/ne_110m_coastline.geojson","data/ne_110m_graticules_10.geojson","data/ne_110m_land.geojson","data/ne_110m_ocean.geojson"];try{const ie=K.map(ce=>fetch(ce).then(L=>{if(!L.ok)throw new Error(`Network response was not ok for ${ce}`);return L.json()}).then(L=>(U(ce,L),"loaded")).catch(L=>{throw console.error(`Error loading ${ce}:`,L),L}));await Promise.all(ie),console.log("All GeoJSON data loaded successfully.")}catch(ie){console.error("Failed to load some GeoJSON data:",ie)}}function U(K,ie){switch(K){case"data/ne_110m_graticules_10.geojson":console.log("Loaded graticules:",ie),ge(ie);break;case"data/ne_110m_coastline.geojson":console.log("loaded coastlines:",ie),F(ie);break;case"data/ne_110m_land.geojson":console.log("loaded land:",ie);break;case"data/ne_110m_ocean.geojson":console.log("loaded land:",ie);break;default:console.warn("Unrecognized GeoJSON URL:",K);break}}function F(K){const ie=new gs({color:16777215,opacity:.75,alphaHash:!0}),ce=1;K.features.forEach(L=>{const De=L.geometry.coordinates;if(L.geometry.type==="LineString"){const Q=pe(De,ce),ae=new ur(Q,ie);s.add(ae)}else L.geometry.type==="MultiLineString"&&De.forEach(Q=>{const ae=pe(Q,ce),me=new ur(ae,ie);s.add(me)})})}function ge(K){const ie=new gs({color:11184810,opacity:.35,alphaHash:!0,linewidth:1}),ce=_;K.features.forEach(L=>{const De=L.geometry.coordinates;if(L.geometry.type==="LineString"){const Q=pe(De,ce),ae=new ur(Q,ie);s.add(ae)}else L.geometry.type==="MultiLineString"&&De.forEach(Q=>{const ae=pe(Q,ce),me=new ur(ae,ie);s.add(me)})})}function pe(K,ie){const ce=new en,L=[];K.forEach(([Q,ae])=>{const me=$(ae,Q,ie);L.push(me.x,me.y,me.z)});const De=new Float32Array(L);return ce.setAttribute("position",new Zt(De,3)),ce}function $(K,ie,ce){const L=(90-K)*(Math.PI/180),De=(ie+180)*(Math.PI/180),Q=-ce*Math.sin(L)*Math.cos(De),ae=ce*Math.sin(L)*Math.sin(De),me=ce*Math.cos(L);return new O(Q,me,ae)}function de(K,ie){let ce;return function(...L){clearTimeout(ce),ce=setTimeout(()=>K.apply(this,L),ie)}}function Le(){const K=document.getElementById("exaggeration-slider"),ie=document.getElementById("exaggeration-value");ie.textContent=g;const ce=de(W,1);K.addEventListener("input",L=>{g=parseFloat(L.target.value),ie.textContent=g.toFixed(1),ce()})}function xe(){t.aspect=window.innerWidth/window.innerHeight,t.updateProjectionMatrix(),i.setSize(window.innerWidth,window.innerHeight);const K=window.innerWidth<=768;t.position.z=K?c*h:c}}const jp="threeContainer1";Yp(jp);
